...
import { SALES_NOTES_LIST_ON_OPPORTUNITY_FRONT_COMPONENT_UID } from 'src/constants/universal-identifiers';
import {
  type RelatedSalesNote,
  fetchSalesNotesForOpportunity,
...
const SalesNotesListOnOpportunity = () => {
  ...
  useEffect(() => {
    ...
    setRecords(null);
    setError(null);
    fetchSalesNotesForOpportunity(opportunityId)
