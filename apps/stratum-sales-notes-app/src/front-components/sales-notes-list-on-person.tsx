...
const SalesNotesListOnPerson = () => {
  ...
  if (records.length === 0) {
    return (
      <div style={emptyStyle}>
        <span>
          No sales notes for this contact yet. Click <b>+ Sales note</b> in the
...
export default defineFrontComponent({
  ...
  description:
    'Lists sales notes the focal Person is an attendee on (via salesNoteAttendee). Each row navigates to the sales note.',
