...
export type Mutation = {
  __typename?: 'Mutation';
  createCustomField: Scalars['String']['output'];
};
...
export type Object = {
  ...
  displayName: Scalars['String']['output'];
  displayNamePlural: Scalars['String']['output'];
  displayNameSingular: Scalars['String']['output'];
