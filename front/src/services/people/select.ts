...
export type OrderByFields = string; //TODO should be an enum generated by codeGen

export type OrderBy = Record<OrderByFields, 'asc' | 'desc'>;

export const reduceSortsToOrderBy = (
  sorts: Array<{ id: OrderByFields; order: 'asc' | 'desc' }>,
): OrderBy[] => {
