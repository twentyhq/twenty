export function canBeCastAsPositiveIntegerOrNull(
    ...
    if (typeof probablePositiveNumberOrNull === 'number') {
      return Number.isInteger(probablePositiveNumberOrNull) && Math.sign(probablePositiveNumberOrNull) === 1;
    }
  ...
  export function castAsPositiveIntegerOrNull(
    ...
    if (canBeCastAsPositiveIntegerOrNull(probablePositiveNumberOrNull) === false) {
