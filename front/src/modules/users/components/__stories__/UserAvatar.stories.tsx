...
export const Size40: Story = {
  render: getRenderWrapperForComponent(
    <Avatar avatarUrl={avatarUrl} size={40} placeholderLetter="L" />,
  ),
};

export const Size32: Story = {
  render: getRenderWrapperForComponent(
    <Avatar avatarUrl={avatarUrl} size={32} placeholderLetter="L" />,
  ),
};

export const Size16: Story = {
  render: getRenderWrapperForComponent(
    <Avatar avatarUrl={avatarUrl} size={16} placeholderLetter="L" />,
  ),
};

export const NoAvatarPicture: Story = {
  render: getRenderWrapperForComponent(
    <Avatar avatarUrl={''} size={16} placeholderLetter="L" />,
  ),
};
