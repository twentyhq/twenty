...
import { UserUpdateOneRequiredWithoutRefreshTokensNestedInput } from "../inputs/UserUpdateOneRequiredWithoutRefreshTokensNestedInput";
...
export class RefreshTokenUpdateInput {
  ...
  @TypeGraphQL.Field(_type => UserUpdateOneRequiredWithoutRefreshTokensNestedInput, {
    nullable: true
  })
