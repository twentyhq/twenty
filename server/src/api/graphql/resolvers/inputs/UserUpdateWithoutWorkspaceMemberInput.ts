...
import { CompanyUpdateManyWithoutAccountOwnerNestedInput } from "../inputs/CompanyUpdateManyWithoutAccountOwnerNestedInput";
...
@TypeGraphQL.InputType("UserUpdateWithoutWorkspaceMemberInput", {
  isAbstract: true
})
export class UserUpdateWithoutWorkspaceMemberInput {
  ...
  @TypeGraphQL.Field(_type => CompanyUpdateManyWithoutAccountOwnerNestedInput, {
    nullable: true
  })
