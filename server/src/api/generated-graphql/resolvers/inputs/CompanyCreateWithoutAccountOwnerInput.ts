...
import { PersonCreateNestedManyWithoutCompanyInput } from './PersonCreateNestedManyWithoutCompanyInput';
import { WorkspaceCreateNestedOneWithoutCompaniesInput } from './WorkspaceCreateNestedOneWithoutCompaniesInput';

@TypeGraphQL.InputType('CompanyCreateWithoutAccountOwnerInput', {
  isAbstract: true,
})
