...
Don't forget to update the database connection string with the correct credentials (see step 3).
...
```bash
PG_DATABASE_URL=postgres://postgres:twenty@postgres:5432/default?connection_limit=1
```
