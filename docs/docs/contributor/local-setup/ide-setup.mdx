...
You can use any IDE you prefer, but Visual Studio Code is the choice of Twenty's internal team, and has lots of extensions and settings to share with you.
