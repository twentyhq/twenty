...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>onClick</td>
      <td>function</td>
      <td>A callback function that triggers when someone clicks on the button</td>
      <td></td>
    </tr>
...
<SandpackEditor
  availableComponentPaths={['@/ui/input/button/components/FloatingButton', '@/ui/display/icon/types/IconComponent', '@/ui/input/button/components/FloatingButtonGroup']}
...
<SandpackEditor
  availableComponentPaths={['@/ui/input/button/components/FloatingIconButton','@/ui/input/button/components/FloatingIconButtonGroup']}
