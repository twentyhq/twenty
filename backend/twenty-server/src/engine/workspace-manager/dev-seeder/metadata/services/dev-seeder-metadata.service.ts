...
import { COMPETITOR_CUSTOM_OBJECT_SEED } from 'src/engine/workspace-manager/dev-seeder/metadata/custom-objects/constants/competitor-custom-object-seed.constant';
import { PLAYBOOK_CUSTOM_OBJECT_SEED } from 'src/engine/workspace-manager/dev-seeder/metadata/custom-objects/constants/playbook-custom-object-seed.constant';
  ...
  private readonly workspaceConfigs: Record<string, WorkspaceSeedConfig> = {
    [SEED_APPLE_WORKSPACE_ID]: {
      objects: [
        ...
        { seed: COMPETITOR_CUSTOM_OBJECT_SEED },
        { seed: PLAYBOOK_CUSTOM_OBJECT_SEED },
