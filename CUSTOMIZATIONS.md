...
| `packages/twenty-front/src/modules/object-record/record-table/hooks/useCreateNewIndexRecord.ts`                                                                                           | Replaced with `openDraftInSidePanel` — creates draft in local Jotai store, opens side panel, record NOT persisted until user clicks Create     | Insurance agents leave required fields blank; draft approach prevents empty records in DB                                                                       |
...
| `packages/twenty-front/src/modules/object-record/record-field/ui/meta-types/input/hooks/useAddNewRecordAndOpenSidePanel.ts`                                                               | Creates draft in store with FK prefills instead of immediately creating related record                                                         | Routes relation "+" button through draft creation                                                                                                              |
