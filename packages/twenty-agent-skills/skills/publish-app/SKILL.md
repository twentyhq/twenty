...
Pick this skill when the user wants to make an existing Twenty app _presentable_ — listing copy, branding, public assets, and publication. Representative triggers:
...
If the needed publishing detail is unclear, search the official Twenty docs at `https://docs.twenty.com` before guessing. When a Twenty docs MCP server is configured (`https://docs.twenty.com/mcp`), prefer searching through it; it is optional and not required for this skill.
