...
| Settings menu item | Configuration the app's admins or members set up, under Settings — persisted but not rendered yet, see `layout.md` | `defineFrontComponent` plus `defineSettingsMenuItem` |
