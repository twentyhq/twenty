...
import { CalendarEventIndicator } from '@ui/data-display/CalendarDayLabel/CalendarEventIndicator';
import { IconButton } from '@ui/input/IconButton/IconButton';
import { Button } from '@ui/input/Button/Button';
import { MenuItem } from '@ui/navigation/MenuItem/MenuItem';
import { DropdownMenuItemsContainer } from '@ui/navigation/DropdownMenu/DropdownMenuItemsContainer';
import { OverlayContainer } from '@ui/surfaces/OverlayContainer/OverlayContainer';
import {
  IconCalendarEvent,
  IconCalendarX,
  IconDotsVertical,
      ...
      {autoJoin && meeting.url && Date.parse(meeting.startsAt) > now && (
        <Menu.Root>
          ...
          <Menu.Portal>
            ...
            >
              <Menu.Popup render={<OverlayContainer />}>
                <DropdownMenuItemsContainer role="presentation">
                  <Menu.Item
