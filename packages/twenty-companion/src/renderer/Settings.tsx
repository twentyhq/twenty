...
export const Settings = ({ state, isPending, command }: ActionProps) => (
  <section className="settings-page">
    ...
    >
      ...
      <SettingsCardContent
        icon={<IconSettings size={ICON.size.md} stroke={ICON.stroke.sm} />}
      ...
      <SettingsToggle
        ...
        icon={<IconLogin2 size={ICON.size.md} stroke={ICON.stroke.sm} />}
      ...
      <SettingsToggle
        ...
        icon={<IconClock size={ICON.size.md} stroke={ICON.stroke.sm} />}
    ...
    >
      {(
        ...
        <SettingsToggle
          ...
          command={command}
          setting={key}
          icon={<Icon size={ICON.size.md} stroke={ICON.stroke.sm} />}
          label={label}
      ...
      >
        <SettingsCardContent
          icon={<IconMicrophone size={ICON.size.md} stroke={ICON.stroke.sm} />}
          title={i18n._('Recording permissions')}
          description={i18n._(
            'Manage microphone, system audio, and call detection access.',
          )}
        >
          <IconChevronRight size={ICON.size.md} stroke={ICON.stroke.sm} />
        </SettingsCardContent>
      </button>
    </Card>
    ...
    >
      ...
      >
        ...
        >
          <IconArrowUpRight size={ICON.size.md} stroke={ICON.stroke.sm} />
        </SettingsCardContent>
      </button>
      <SettingsCardContent
