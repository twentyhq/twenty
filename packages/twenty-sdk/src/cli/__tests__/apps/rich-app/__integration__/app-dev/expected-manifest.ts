...
export const EXPECTED_MANIFEST: Manifest = {
  ...
  frontComponents: [
    ...
    {
      builtComponentPath: 'src/components/billing-settings.front-component.mjs',
      builtComponentChecksum: '[checksum]',
      componentName: 'BillingSettings',
      description: 'A settings tab rendered after the sync settings tab',
      name: 'billing-settings',
      sourceComponentPath:
        'src/components/billing-settings.front-component.tsx',
    ...
    {
      builtComponentPath: 'src/components/sync-settings.front-component.mjs',
      builtComponentChecksum: '[checksum]',
      componentName: 'SyncSettings',
      description: 'A settings tab rendered before the billing settings tab',
      name: 'sync-settings',
      sourceComponentPath: 'src/components/sync-settings.front-component.tsx',
