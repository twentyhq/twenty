  ...
  describe('logicFunctions', () => {
    it('should have built logicFunctions preserving source path structure', async () => {
      ...
      expect(sortedFiles).toEqual([
        ...
        'src/components/card.front-component.tsx',
