  ...
  describe('logicFunctions', () => {
    it('should have built logicFunctions preserving source path structure', async () => {
      ...
      expect(sortedFiles).toEqual([
        ...
        'src',
        'src/components',
        'src/components/billing-settings.front-component.mjs',
        'src/components/billing-settings.front-component.mjs.map',
        ...
        'src/components/sync-settings.front-component.mjs',
        'src/components/sync-settings.front-component.mjs.map',
