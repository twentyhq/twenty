...
export interface ObjectFilter {
  ...
  universalIdentifier?: UUIDFilterComparison | null;
...
export interface QueryGenqlSelection {
  ...
  getCoreViewFields?: CoreViewFieldGenqlSelection & {
    __args: { viewId: Scalars['String'] };
  };
  getCoreViewField?: CoreViewFieldGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  getCoreViews?: CoreViewGenqlSelection & {
    __args?: {
      objectMetadataId?: Scalars['String'] | null;
  ...
  getCoreViewSorts?: CoreViewSortGenqlSelection & {
    __args?: { viewId?: Scalars['String'] | null };
  };
  getCoreViewSort?: CoreViewSortGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  getCoreViewGroups?: CoreViewGroupGenqlSelection & {
    __args?: { viewId?: Scalars['String'] | null };
  };
  getCoreViewGroup?: CoreViewGroupGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  getCoreViewFilterGroups?: CoreViewFilterGroupGenqlSelection & {
    __args?: { viewId?: Scalars['String'] | null };
  };
  getCoreViewFilterGroup?: CoreViewFilterGroupGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  getCoreViewFilters?: CoreViewFilterGenqlSelection & {
    __args?: { viewId?: Scalars['String'] | null };
  };
  getCoreViewFilter?: CoreViewFilterGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  getCoreViewFieldGroups?: CoreViewFieldGroupGenqlSelection & {
    __args: { viewId: Scalars['String'] };
  };
  getCoreViewFieldGroup?: CoreViewFieldGroupGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
...
export interface MutationGenqlSelection {
  ...
  createCoreViewGroup?: CoreViewGroupGenqlSelection & {
    __args: { input: CreateViewGroupInput };
  };
  createManyCoreViewGroups?: CoreViewGroupGenqlSelection & {
    __args: { inputs: CreateViewGroupInput[] };
  };
  updateCoreViewGroup?: CoreViewGroupGenqlSelection & {
    __args: { input: UpdateViewGroupInput };
  };
  deleteCoreViewGroup?: CoreViewGroupGenqlSelection & {
    __args: { input: DeleteViewGroupInput };
  };
  destroyCoreViewGroup?: CoreViewGroupGenqlSelection & {
    __args: { input: DestroyViewGroupInput };
  };
  createCoreViewFilterGroup?: CoreViewFilterGroupGenqlSelection & {
    __args: { input: CreateViewFilterGroupInput };
  };
  updateCoreViewFilterGroup?: CoreViewFilterGroupGenqlSelection & {
  ...
  updateCoreViewFilter?: CoreViewFilterGenqlSelection & {
    __args: { input: UpdateViewFilterInput };
  };
  deleteCoreViewFilter?: CoreViewFilterGenqlSelection & {
    __args: { input: DeleteViewFilterInput };
  };
  destroyCoreViewFilter?: CoreViewFilterGenqlSelection & {
  ...
  registerNpmPackage?: ApplicationRegistrationGenqlSelection & {
    __args: { packageName: Scalars['String'] };
  };
...
export interface UpdateWorkspaceInput {
  ...
  autoEnableNewAiModels?: Scalars['Boolean'] | null;
  disabledAiModelIds?: Scalars['String'][] | null;
...
export interface OnDbEventInput {
  action?: DatabaseEventAction | null;
  objectNameSingular?: Scalars['String'] | null;
...
export const isCoreViewField = (
  obj?: { __typename?: any } | null,
): obj is CoreViewField => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCoreViewField"');
...
export const isCoreViewFilterGroup = (
  obj?: { __typename?: any } | null,
): obj is CoreViewFilterGroup => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCoreViewFilterGroup"');
  return CoreViewFilterGroup_possibleTypes.includes(obj.__typename);
};

const CoreViewFilter_possibleTypes: string[] = ['CoreViewFilter'];
export const isCoreViewFilter = (
  obj?: { __typename?: any } | null,
): obj is CoreViewFilter => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCoreViewFilter"');
  return CoreViewFilter_possibleTypes.includes(obj.__typename);
};

const CoreViewGroup_possibleTypes: string[] = ['CoreViewGroup'];
export const isCoreViewGroup = (
  obj?: { __typename?: any } | null,
): obj is CoreViewGroup => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCoreViewGroup"');
  return CoreViewGroup_possibleTypes.includes(obj.__typename);
};

const CoreViewSort_possibleTypes: string[] = ['CoreViewSort'];
export const isCoreViewSort = (
  obj?: { __typename?: any } | null,
): obj is CoreViewSort => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCoreViewSort"');
...
export const isCoreViewFieldGroup = (
  obj?: { __typename?: any } | null,
): obj is CoreViewFieldGroup => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCoreViewFieldGroup"');
  return CoreViewFieldGroup_possibleTypes.includes(obj.__typename);
};

const CoreView_possibleTypes: string[] = ['CoreView'];
export const isCoreView = (
  obj?: { __typename?: any } | null,
): obj is CoreView => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCoreView"');
...
const NewFieldDefaultConfiguration_possibleTypes: string[] = [
  'NewFieldDefaultConfiguration',
];
export const isNewFieldDefaultConfiguration = (
  obj?: { __typename?: any } | null,
): obj is NewFieldDefaultConfiguration => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isNewFieldDefaultConfiguration"',
    );
...
export const isRichTextV2Body = (
  obj?: { __typename?: any } | null,
): obj is RichTextV2Body => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRichTextV2Body"');
...
const MetadataEventWithQueryIds_possibleTypes: string[] = [
  'MetadataEventWithQueryIds',
];
export const isMetadataEventWithQueryIds = (
  obj?: { __typename?: any } | null,
): obj is MetadataEventWithQueryIds => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMetadataEventWithQueryIds"');
...
export const isOnDbEvent = (
  obj?: { __typename?: any } | null,
): obj is OnDbEvent => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isOnDbEvent"');
...
export const enumFeatureFlagKey = {
  ...
  IS_APPLICATION_INSTALLATION_FROM_TARBALL_ENABLED:
    'IS_APPLICATION_INSTALLATION_FROM_TARBALL_ENABLED' as const,
