...
export type ImageFootprintScaleArgs = {
...
export type ProjectedBoundsArgs = {
...
export type MeshFootprintScaleArgs = ProjectedBoundsArgs & {
...
export const HALFTONE_FOOTPRINT = {
  virtualRenderHeight: VIRTUAL_RENDER_HEIGHT,
  referencePreviewDistance: REFERENCE_PREVIEW_DISTANCE,
  minFootprintScale: MIN_FOOTPRINT_SCALE,
  getImagePreviewZoom,
  getContainedImageRect,
  getFootprintScaleFromRects,
  getImageFootprintScale,
  projectBox3ToViewport,
