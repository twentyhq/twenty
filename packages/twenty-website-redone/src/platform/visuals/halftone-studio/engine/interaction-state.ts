...
function createHalftoneInteractionState(
...
function resetHalftoneInteractionState(
...
export const HALFTONE_INTERACTION = {
  create: createHalftoneInteractionState,
  springStep: applySpringStep,
  reset: resetHalftoneInteractionState,
};
