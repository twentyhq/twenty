...
import { DRACO_DECODER_PATH } from './draco-decoder-path';
import { mergeGeometries } from './merge-geometries';
import { type HalftoneModelLoader } from './studio-settings-types';
...
export const HALFTONE_GEOMETRY_LOADERS = {
  loadFromFile: loadImportedGeometry,
  loadFromUrl: loadImportedGeometryFromUrl,
};
