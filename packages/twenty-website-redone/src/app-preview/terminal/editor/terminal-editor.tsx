...
import { TerminalEditorCodeView } from './terminal-editor-code-view';
import { TerminalEditorExplorer } from './terminal-editor-explorer';
import { TerminalEditorTabs } from './terminal-editor-tabs';
