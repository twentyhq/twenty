...
// STORAGE_FILE, RECORD_WRITE, SUBSCRIPTION and MESSAGE_CAMPAIGN_SEND are left
// out on purpose: the platform raises all five itself, and API_REQUEST rows
// feed the workspace's API rate limit.
