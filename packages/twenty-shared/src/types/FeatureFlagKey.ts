export enum FeatureFlagKey {
  ...
  // Inert since the core read/dispatch cutover: nothing reads these two
  // anymore. Kept so the metadata GraphQL enum stays backward compatible;
  // removed at workflow-projection teardown.
