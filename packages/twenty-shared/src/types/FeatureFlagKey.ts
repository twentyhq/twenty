export enum FeatureFlagKey {
  ...
  // IS_WORKFLOW_VERSION_IN_CORE_ENABLED and IS_WORKFLOW_DISPATCH_FROM_CORE_ENABLED
  // are inert since the core read/dispatch cutover: nothing reads them. Kept so the
  // metadata GraphQL enum stays backward compatible; removed at workflow-projection
  // teardown. IS_WORKFLOW_CORE_INDEX_PAGE_ENABLED is still live.
