...
export type { ObjectPermissionsByRoleId } from './ObjectPermissionsByRoleId';
export type { ObjectPermissionsByRoleIdDeprecated } from './ObjectPermissionsByRoleIdDeprecated';
