...
export { GOOGLE_EMAIL_FORWARDING_OAUTH_SCOPES } from './GoogleEmailForwardingOauthScopes';
...
export { MICROSOFT_EMAIL_FORWARDING_OAUTH_SCOPES } from './MicrosoftEmailForwardingOauthScopes';
