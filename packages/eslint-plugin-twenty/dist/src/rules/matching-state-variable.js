...
const matchingStateVariableRule = createRule({
        ...
        return {
            VariableDeclarator: (node) => {
                ...
                if (((_a = node === null || node === void 0 ? void 0 : node.init) === null || _a === void 0 ? void 0 : _a.type) === utils_1.AST_NODE_TYPES.CallExpression &&
                    ...
                    const expectedVariableNameBase = stateNameBase.replace(/(State|FamilyState|Selector|ScopedState|ScopedFamilyState|ScopedSelector)$/, "");
    ...
    meta: {
        ...
        schema: [],
        messages: {
            invalidVariableName: "Invalid usage of {{ hookName }}: the variable should be named '{{ expectedName }}' but found '{{ actualName }}'.",
