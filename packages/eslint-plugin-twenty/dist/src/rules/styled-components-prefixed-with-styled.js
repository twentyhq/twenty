    ...
    create: (context) => {
        return {
            VariableDeclarator: (node) => {
                ...
                const tagged = tag.type === utils_1.AST_NODE_TYPES.MemberExpression
                    ? tag.object
                    : tag.type === utils_1.AST_NODE_TYPES.CallExpression
                        ? tag.callee
                        : null;
                if ((tagged === null || tagged === void 0 ? void 0 : tagged.type) === utils_1.AST_NODE_TYPES.Identifier &&
                    tagged.name === "styled") {
