...
ruleTester.run("matching-state-variable", matching_state_variable_1.default, {
    ...
    invalid: [
        ...
        },
        {
            ...
            output: "const [variable, setVariable] = useRecoilScopedState(variableState);",
        },
        {
        ...
        },
        {
            ...
            output: "const [variable, setVariable] = useRecoilFamilyState(variableState);",
        },
        {
        ...
        },
        {
            ...
            output: "const [variable, setVariable] = useRecoilScopedFamilyState(variableState);",
        },
        {
        ...
        },
        {
            ...
            output: "const [, setVariable] = useRecoilScopedFamilyState(variableState);",
        },
    ],
});
