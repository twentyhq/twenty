...
const settings = {
  sourceMode: 'shape',
  shapeKey: 'userUpload_1776601895865',
  lighting: {
    intensity: 1.5,
    fillIntensity: 0.15,
...
type WhyTwentyHeroHalftoneProps = {
  modelUrl?: string;
  style?: CSSProperties;
};

export function WhyTwentyHeroHalftone({
  modelUrl = '/illustrations/why-twenty/hero/hero.glb',
  style,
}: WhyTwentyHeroHalftoneProps) {
