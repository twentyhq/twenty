 ...
 *
 * Originally autogenerated by the in-app halftone studio
 * (src/app/halftone) and then locally edited for site-wide concerns
 * (shared glass-environment texture, centralized DRACO decoder path).
 *
 * If you need to refresh the visual or runtime behaviour, regenerate from
 * the studio AND re-apply those local edits — re-exporting blindly will
 * silently lose them. See src/app/halftone/_lib/exporters.ts.
 *
 * Type checking is disabled at the file level because the serialized
 * Three.js runtime contains thousands of lines of legacy implicitly-typed
 * code that the generator does not annotate.
 */
// @ts-nocheck
'use client';
...
// Halftone renderer for the /why-twenty hero 3D "20" model.
// Exported from the halftone studio; settings match the requested effect.
