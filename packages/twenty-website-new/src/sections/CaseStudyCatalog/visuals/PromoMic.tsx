...
async function mountHalftoneCanvas(options) {
  const { container, imageUrl, onError } = options;
  ...
  const renderFrame = (timestamp) => {
    ...
    halftoneMaterial.uniforms.hoverHalftoneActive.value = settings.animation
      .hoverHalftoneEnabled
      ? interaction.hoverStrength
      : 0;
    halftoneMaterial.uniforms.hoverHalftonePowerShift.value = settings.animation
      .hoverHalftoneEnabled
    ...
    halftoneMaterial.uniforms.hoverHalftoneWidthShift.value = settings.animation
      .hoverHalftoneEnabled
      ? settings.animation.hoverHalftoneWidthShift
      : 0;
    halftoneMaterial.uniforms.hoverLightStrength.value = settings.animation
      .hoverLightEnabled
