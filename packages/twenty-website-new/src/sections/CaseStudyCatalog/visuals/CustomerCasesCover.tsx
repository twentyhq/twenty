 ...
 *
 * Autogenerated by the in-app halftone studio (src/app/halftone). Do NOT
 * hand-edit; if the visual or runtime behaviour needs to change,
 * regenerate the export from the studio. See
