...
const GLB_URL = '/illustrations/home/three-cards-illustration/one.glb';
...
function applyHalftoneDashMaterials(
  ...
  modelRoot.traverse((sceneObject) => {
    ...
    mesh.userData.diamondMeshRest = rest;
  });
}
...
export function Diamond(_properties: IllustrationProps) {
      ...
      (gltf) => {
        ...
        const renderFrame = () => {
          ...
          modelRoot.traverse((sceneObject) => {
            ...
            const rest = sceneObject.userData.diamondMeshRest as
              | MeshRestPose
              | undefined;
            if (!rest) {
              return;
