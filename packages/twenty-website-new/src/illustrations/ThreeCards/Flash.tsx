...
const GLB_URL = '/illustrations/home/three-cards-illustration/two.glb';
...
function applyHalftoneDashMaterials(
  ...
  modelRoot.traverse((sceneObject) => {
    ...
    mesh.userData.flashMeshRest = rest;
  });
}
...
export function Flash(_properties: IllustrationProps) {
      ...
      (gltf) => {
        ...
        const renderFrame = () => {
          ...
          modelRoot.traverse((sceneObject) => {
            ...
            const rest = sceneObject.userData.flashMeshRest as
              | MeshRestPose
              | undefined;
            if (!rest) {
              return;
