...
function StaticGlbModel({ src }: LazyGlbIllustrationProps) {
...
export function LazyGlbIllustration({ src }: LazyGlbIllustrationProps) {
  return (
    <Canvas
      dpr={[1, 1.25]}
      frameloop="demand"
      ...
      camera={{ fov: 30, near: 0.1, far: 100, position: [0, 0, 6] }}
      onCreated={({ gl, scene }) => {
