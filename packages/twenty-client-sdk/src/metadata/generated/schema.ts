...
export type AgentChatThreadSortFields = 'id' | 'updatedAt' | 'deletedAt' | 'lastMessageAt'
...
export interface AgentChatThreadFilter {and?: (AgentChatThreadFilter[] | null),or?: (AgentChatThreadFilter[] | null),id?: (UUIDFilterComparison | null),updatedAt?: (DateFieldComparison | null),deletedAt?: (DateFieldComparison | null),lastMessageAt?: (DateFieldComparison | null)}
...
export const enumAgentChatThreadSortFields = {
   ...
   lastMessageAt: 'lastMessageAt' as const
}
