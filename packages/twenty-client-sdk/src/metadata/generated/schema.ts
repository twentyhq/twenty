...
export const enumFeatureFlagKey = {
   ...
   IS_TIMELINE_RULES_ENABLED: 'IS_TIMELINE_RULES_ENABLED' as const
}
...
export const enumAllMetadataName = {
   ...
   timelineActivityRule: 'timelineActivityRule' as const
}
