...
export type FeatureFlagKey =
	...
	| "IS_NATIVE_CALL_RECORDING_TABS_ENABLED"
...
export interface MutationGenqlSelection {
	...
	uploadEmailAttachmentFile?: FileWithSignedUrlGenqlSelection & {
	...
	syncApplication?: WorkspaceMigrationGenqlSelection & {
		__args: { manifest: Scalars["JSON"]; dryRun?: Scalars["Boolean"] | null };
	};
...
export interface UpdateApplicationRegistrationPayload {
	...
	isPreInstalled?: Scalars["Boolean"] | null;
	isVetted?: Scalars["Boolean"] | null;
}
...
const CampaignSkippedRecipientsDTO_possibleTypes: string[] = [
	"CampaignSkippedRecipientsDTO",
];
export const isCampaignSkippedRecipientsDTO = (
	obj?: { __typename?: any } | null,
): obj is CampaignSkippedRecipientsDTO => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isCampaignSkippedRecipientsDTO"',
		);
...
export const enumFeatureFlagKey = {
	...
	IS_WORKFLOW_VERSION_IN_CORE_ENABLED:
		"IS_WORKFLOW_VERSION_IN_CORE_ENABLED" as const,
	IS_WORKFLOW_CORE_INDEX_PAGE_ENABLED:
		"IS_WORKFLOW_CORE_INDEX_PAGE_ENABLED" as const,
	IS_WORKFLOW_DISPATCH_FROM_CORE_ENABLED:
		"IS_WORKFLOW_DISPATCH_FROM_CORE_ENABLED" as const,
	IS_NATIVE_CALL_RECORDING_TABS_ENABLED:
		"IS_NATIVE_CALL_RECORDING_TABS_ENABLED" as const,
