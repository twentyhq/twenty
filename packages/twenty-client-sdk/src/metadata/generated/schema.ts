...
export interface BackfillSharingRuleInput {granteePrincipalType: RecordSharePrincipalType,granteeRoleId?: (Scalars['UUID'] | null),accessLevel: SharingRuleAccessLevel,name?: (Scalars['String'] | null)}
