...
export interface Query {
    ...
    applicationConnectedAccounts: ConnectedAccountPublicDTO[]
...
export interface QueryGenqlSelection{
    ...
    applicationConnectedAccounts?: (ConnectedAccountPublicDTOGenqlSelection & { __args: {applicationId: Scalars['UUID']} })
