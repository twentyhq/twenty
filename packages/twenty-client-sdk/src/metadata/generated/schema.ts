...
export interface QueryGenqlSelection {
  ...
  findApplicationRegistrationVariables?: ApplicationRegistrationVariableDTOGenqlSelection & {
...
export interface MutationGenqlSelection {
  ...
  updatePublicDomain?: PublicDomainGenqlSelection & {
    __args: {
      domain: Scalars['String'];
      applicationId?: Scalars['String'] | null;
    };
...
const ApplicationRegistrationVariableDTO_possibleTypes: string[] = [
  'ApplicationRegistrationVariableDTO',
];
export const isApplicationRegistrationVariableDTO = (
  obj?: { __typename?: any } | null,
): obj is ApplicationRegistrationVariableDTO => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationRegistrationVariableDTO"',
    );
  return ApplicationRegistrationVariableDTO_possibleTypes.includes(
    obj.__typename,
  );
};
...
export const enumFeatureFlagKey = {
  ...
  IS_SETTINGS_DISCOVERY_HERO_ENABLED:
    'IS_SETTINGS_DISCOVERY_HERO_ENABLED' as const,
