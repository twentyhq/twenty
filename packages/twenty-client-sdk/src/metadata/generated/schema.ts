...
export type MetadataReadability =
  | 'OPEN'
  | 'PRIVATE'
  | 'INHERITED'
  | 'APPLICATION'
...
export type WorkspaceDiscoverability =
  | 'PUBLIC'
...
export type PageLayoutWidgetVerticalListHeightBehavior =
  | 'FIT_CONTENT'
  | 'TAB_VIEWPORT';
...
export type WorkspaceCompanyEnrichmentOutcome =
  | 'matched'
  | 'unavailable'
  | 'transientError';

export type WorkspacePersonEnrichmentOutcome =
  | 'matched'
  | 'unavailable'
  | 'transientError';
...
export type WorkspaceSetupChatOutcome =
  | 'STARTED'
  | 'ALREADY_STARTED'
  | 'UNAVAILABLE';
...
export type MessageFolderPendingSyncAction =
  | 'FOLDER_DELETION'
  | 'FOLDER_IMPORT'
  | 'NONE';
...
export type MetadataTranslationProvenance =
  | 'WORKSPACE'
  | 'SHIPPED'
  | 'INHERITED';
...
export interface FieldFilter {
  ...
  isUIEditable?: BooleanFieldComparison | null;
...
export interface QueryGenqlSelection {
  recordSharing?: RecordSharingDTOGenqlSelection & {
    __args: { target: RecordSharingTargetInput };
  };
  ...
  applicationSdkClientChecksums?: SdkClientChecksumsGenqlSelection & {
    __args: { applicationId: Scalars['UUID'] };
  };
  isApplicationStopped?: {
    __args: { applicationUniversalIdentifier: Scalars['String'] };
  };
  ...
  usageQuotaScopeConsumption?: UsageQuotaScopeConsumptionGenqlSelection & {
    __args: { input: UsageQuotaScopeInput };
  };
  ...
  billingPortalSession?: BillingSessionGenqlSelection & {
    __args?: {
      returnUrlPath?: Scalars['String'] | null;
      forPaymentMethodUpdate?: Scalars['Boolean'] | null;
    };
  };
  listPlans?: BillingPlanGenqlSelection;
  getResourceCreditUsage?: BillingResourceCreditUsageGenqlSelection;
  myConnectedAccounts?: ConnectedAccountPublicDTOGenqlSelection;
  applicationConnectedAccounts?: ApplicationConnectedAccountDTOGenqlSelection & {
    __args: { applicationId: Scalars['UUID'] };
  };
  applicationConnectionProviders?: ApplicationConnectionProviderGenqlSelection & {
    __args: { applicationId: Scalars['UUID'] };
  };
  ...
  mostlyEmptyFieldMetadataIds?: {
    __args: { objectMetadataId: Scalars['UUID'] };
  };
  ...
  getPublicWorkspaceDataById?: PublicWorkspaceDataSummaryGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  ...
  findClaimableApplicationRegistration?: ClaimableApplicationRegistrationGenqlSelection & {
    __args?: {
      sourcePackage?: Scalars['String'] | null;
  ...
  findInstallApplicationJobStatus?: JobStatusGenqlSelection & {
    __args: { universalIdentifier: Scalars['String'] };
  };
  findUninstallApplicationJobStatus?: JobStatusGenqlSelection & {
    __args: { universalIdentifier: Scalars['String'] };
  };
  findManyMarketplaceApps?: MarketplaceAppGenqlSelection & {
    __args?: { universalIdentifiers?: Scalars['String'][] | null };
  };
  findMarketplaceAppDetail?: MarketplaceAppDetailGenqlSelection & {
    __args: { universalIdentifier: Scalars['String'] };
  };
  publicMarketplaceApps?: MarketplaceAppGenqlSelection & {
    __args: { isVetted: Scalars['Boolean'] };
  };
  publicMarketplaceAppDetail?: MarketplaceAppDetailGenqlSelection & {
    __args: { universalIdentifier: Scalars['String'] };
  };
  ...
  previewMessageCampaignAudience?: CampaignAudiencePreviewDTOGenqlSelection & {
    __args: { input: PreviewMessageCampaignAudienceInput };
  };
  messageSuppressions?: MessageSuppressionListGenqlSelection & {
    __args: { input: FindMessageSuppressionsInput };
  };
  ...
  appMessageChannels?: MessageChannelGenqlSelection & {
    __args?: { filter?: ListAppMessageChannelsInput | null };
  };
  ...
  appKeyValue?: AppKeyValueGenqlSelection & {
    __args: { key: Scalars['String']; scope?: AppKeyValueScope | null };
  };
  getJobs?: JobStatusGenqlSelection & {
    __args: { jobIds: Scalars['String'][] };
  };
  appConnections?: AppConnectionGenqlSelection & {
    __args?: { filter?: ListAppConnectionsInput | null };
  };
  appConnection?: AppConnectionGenqlSelection & {
    __args: { id: Scalars['ID'] };
  };
  ...
  metadataTranslations?: MetadataTranslationGenqlSelection & {
    __args: { input: MetadataTranslationsInput };
  };
  recordPermissions?: RecordPermissionsResultGenqlSelection & {
    __args: { targets: RecordPermissionsTargetInput[] };
  };
  ...
  checkWorkspaceSubdomainAvailability?: SubdomainAvailabilityDTOGenqlSelection & {
    __args: { subdomain: Scalars['String'] };
  };
  ...
  callRecordingIdForCalendarEvent?: {
    __args: { calendarEventId: Scalars['UUID'] };
  };
  ...
  exportApplication?: ApplicationExportGenqlSelection & {
    __args: { universalIdentifier: Scalars['UUID'] };
  };
...
export interface RecordSharingTargetInput {
  objectMetadataId: Scalars['UUID'];
  recordId: Scalars['UUID'];
}

export interface UsageQuotaScopeInput {
  resourceType: UsageResourceType;
  operationType: UsageOperationType;
  spenderType: Scalars['String'];
  spenderId?: Scalars['String'] | null;
  periodUnit: Scalars['String'];
  meter: Scalars['String'];
}
...
export interface ObjectFilter {
  ...
  isSystem?: BooleanFieldComparison | null;
  isUICreatable?: BooleanFieldComparison | null;
  isUIEditable?: BooleanFieldComparison | null;
  isUIReadOnly?: BooleanFieldComparison | null;
}
...
export interface PreviewMessageCampaignAudienceInput {
  listId: Scalars['String'];
  unsubscribeTopicId?: Scalars['String'] | null;
}

export interface FindMessageSuppressionsInput {
  reason?: MessageSuppressionReason | null;
  searchTerm?: Scalars['String'] | null;
  unsubscribeTopicId?: Scalars['UUID'] | null;
  limit: Scalars['Int'];
  offset: Scalars['Int'];
}

export interface ListAppMessageChannelsInput {
  connectedAccountId?: Scalars['UUID'] | null;
}

export interface ListAppConnectionsInput {
  providerName?: Scalars['String'] | null;
  userWorkspaceId?: Scalars['String'] | null;
  visibility?: Scalars['String'] | null;
}

export interface MetadataTranslationsInput {
  objectMetadataId?: Scalars['UUID'] | null;
  fieldMetadataId?: Scalars['UUID'] | null;
  locale?: Scalars['String'] | null;
}

export interface RecordPermissionsTargetInput {
  objectMetadataId: Scalars['UUID'];
  recordId: Scalars['UUID'];
}
...
export interface MutationGenqlSelection {
  ...
  setRecordShare?: RecordSharingDTOGenqlSelection & {
    __args: {
  ...
  createFileUpload?: FileUploadTargetGenqlSelection & {
    __args: {
      filename: Scalars['String'];
      size: Scalars['Float'];
      fileFolder: FileFolder;
      fieldMetadataId?: Scalars['String'] | null;
      fieldMetadataUniversalIdentifier?: Scalars['String'] | null;
    };
  };
  completeFileUpload?: FileWithSignedUrlGenqlSelection & {
    __args: { fileId: Scalars['String'] };
  };
  ...
  completeWorkspaceLogoUpload?: FileWithSignedUrlGenqlSelection & {
    __args: { fileId: Scalars['String'] };
  };
  completeWorkspaceMemberProfilePictureUpload?: FileWithSignedUrlGenqlSelection & {
    __args: { fileId: Scalars['String'] };
  };
  /** @deprecated Use createFileUpload with the FilesField folder and the fieldMetadataUniversalIdentifier, then completeFileUpload, which send the file straight to file storage. */
  ...
  createUsageLimit?: UsageLimitGenqlSelection & {
    __args: { input: CreateUsageLimitInput };
  };
  updateUsageLimit?: UsageLimitGenqlSelection & {
    __args: { input: UpdateUsageLimitInput };
  };
  ...
  upsertViewWidget?: ViewGenqlSelection & {
    __args: { input: UpsertViewWidgetInput };
  };
  ...
  createSubscriptionPaymentIntent?: BillingPaymentIntentGenqlSelection & {
    __args: {
      recurringInterval: SubscriptionInterval;
      plan: BillingPlanKey;
      requirePaymentMethod: Scalars['Boolean'];
  ...
  setResourceCreditSubscriptionPrice?: BillingUpdateGenqlSelection & {
  ...
  deleteConnectedAccount?: ConnectedAccountPublicDTOGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  disconnectConnectedAccount?: ConnectedAccountPublicDTOGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  ...
  skipSyncEmailOnboardingStep?: OnboardingStepSuccessGenqlSelection & {
    __args: { isAutoSkipped: Scalars['Boolean'] };
  };
  completeBookCallOnboardingStep?: OnboardingStepSuccessGenqlSelection & {
    __args: {
      hasBookedCall: Scalars['Boolean'];
      isAutoSkipped: Scalars['Boolean'];
    };
  };
  triggerInstallAppsOnboardingStep?: OnboardingStepSuccessGenqlSelection & {
    __args: {
      universalIdentifiers: Scalars['String'][];
      isAutoSkipped: Scalars['Boolean'];
    };
  };
  ...
  resetPageLayoutToDefault?: PageLayoutGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  ...
  updateManyObjects?: ObjectGenqlSelection & {
    __args: { inputs: UpdateOneObjectInput[] };
  };
  createOneIndex?: IndexGenqlSelection & {
    __args: { input: CreateOneIndexInput };
  };
  deleteOneIndex?: IndexGenqlSelection & {
    __args: { input: DeleteOneIndexInput };
  };
  ...
  resetCommandMenuItem?: CommandMenuItemGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  ...
  updateWorkspaceAllowedIframeOrigins?: WorkspaceGenqlSelection & {
    __args: { data: UpdateWorkspaceAllowedIframeOriginsInput };
  };
  ...
  completeAppTarballUpload?: ApplicationRegistrationGenqlSelection & {
    __args: { fileId: Scalars['UUID'] };
  };
  /** @deprecated Use createFileUpload with the AppTarball folder and completeAppTarballUpload, which send the tarball straight to file storage. */
  ...
  claimApplicationRegistrationOwnership?: ApplicationRegistrationGenqlSelection & {
    __args: { applicationRegistrationId: Scalars['String'] };
  };
  ...
  grantApplicationCapabilities?: ApplicationCapabilityGrantGenqlSelection & {
    __args: { input: GrantApplicationCapabilitiesInput };
  };
  /** @deprecated Use installApplication instead */
  ...
  installApplication?: ApplicationGenqlSelection & {
    __args: {
      universalIdentifier: Scalars['String'];
      version?: Scalars['String'] | null;
    };
  };
  triggerInstallApplicationJob?: TriggerInstallApplicationJobResultGenqlSelection & {
    __args: { input: TriggerInstallApplicationJobInput };
  };
  triggerUninstallApplicationJob?: TriggerUninstallApplicationJobResultGenqlSelection & {
    __args: { input: TriggerUninstallApplicationJobInput };
  };
  updateApplication?: ApplicationGenqlSelection & {
    __args: { id: Scalars['UUID']; input: UpdateApplicationInput };
  };
  uninstallApplication?: { __args: { universalIdentifier: Scalars['String'] } };
  syncMarketplaceCatalog?: boolean | number;
  runApplicationHealthCheck?: ApplicationHealthCheckResultGenqlSelection & {
    __args: { applicationId: Scalars['UUID'] };
  };
  ...
  upsertPermissionFlags?: RolePermissionFlagGenqlSelection & {
  ...
  sendEmailViaEmailingDomain?: SendEmailViaDomainOutputGenqlSelection & {
    __args: { input: SendEmailViaDomainInput };
  };
  sendMessageCampaign?: SendMessageCampaignOutputDTOGenqlSelection & {
    __args: { input: SendMessageCampaignInput };
  };
  cancelMessageCampaign?: CancelMessageCampaignOutputDTOGenqlSelection & {
    __args: { input: CancelMessageCampaignInput };
  };
  sendMessageCampaignTest?: SendEmailViaDomainOutputGenqlSelection & {
    __args: { input: SendMessageCampaignTestInput };
  };
  duplicateMessageList?: DuplicatedMessageListGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  createMessageSuppression?: MessageSuppressionGenqlSelection & {
    __args: { input: CreateMessageSuppressionInput };
  };
  deleteMessageSuppression?: { __args: { id: Scalars['UUID'] } };
  createUnsubscribeTopic?: UnsubscribeTopicGenqlSelection & {
    __args: { input: CreateUnsubscribeTopicInput };
  };
  updateUnsubscribeTopic?: UnsubscribeTopicGenqlSelection & {
  ...
  createEmailGroupChannel?: CreateEmailGroupChannelOutputGenqlSelection & {
    __args: { input: CreateEmailGroupChannelInput };
  };
  updateEmailGroupChannel?: MessageChannelGenqlSelection & {
    __args: { input: UpdateEmailGroupChannelInput };
  };
  deleteEmailGroupChannel?: MessageChannelGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  createAppMessageChannel?: MessageChannelGenqlSelection & {
    __args: { input: CreateAppMessageChannelInput };
  };
  updateAppMessageChannel?: MessageChannelGenqlSelection & {
    __args: { input: UpdateAppMessageChannelInput };
  };
  deleteAppMessageChannel?: MessageChannelGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  ingestAppMessages?: IngestAppMessagesOutputGenqlSelection & {
    __args: { input: IngestAppMessagesInput };
  };
  createEmailingDomain?: EmailingDomainGenqlSelection & {
    __args: { input: CreateEmailingDomainInput };
  };
  deleteEmailingDomain?: { __args: { id: Scalars['String'] } };
  verifyEmailingDomain?: EmailingDomainGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  runAgent?: RunAgentResultGenqlSelection & {
    __args: { input: RunAgentInput };
  };
  ...
  setAppKeyValue?: AppKeyValueGenqlSelection & {
    __args: { input: SetAppKeyValueInput };
  };
  deleteAppKeyValue?: {
    __args: { key: Scalars['String']; scope?: AppKeyValueScope | null };
  };
  /** @deprecated Use enqueueJobs instead. */
  enqueueJob?: EnqueueJobResultGenqlSelection & {
    __args: { input: EnqueueJobInput };
  };
  enqueueJobs?: EnqueueJobsResultGenqlSelection & {
    __args: { input: EnqueueJobsInput };
  };
  reportAppConnectionAuthFailure?: {
    __args: { input: ReportAppConnectionAuthFailureInput };
  };
  ...
  retryChatMessage?: SendChatMessageResultGenqlSelection & {
    __args: { threadId: Scalars['UUID']; modelId?: Scalars['String'] | null };
  };
  answerAgentChatQuestion?: SendChatMessageResultGenqlSelection & {
    __args: {
      threadId: Scalars['UUID'];
      messageId: Scalars['UUID'];
  ...
  renameChatThread?: AgentChatThreadGenqlSelection & {
    __args: { id: Scalars['UUID']; title: Scalars['String'] };
  };
  archiveChatThread?: AgentChatThreadGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  unarchiveChatThread?: AgentChatThreadGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  deleteChatThread?: { __args: { id: Scalars['UUID'] } };
  deleteQueuedChatMessage?: { __args: { messageId: Scalars['UUID'] } };
  startWorkspaceSetupChat?: StartWorkspaceSetupChatResultGenqlSelection & {
    __args?: {
      companyContext?: Scalars['JSON'] | null;
      personContext?: Scalars['JSON'] | null;
    };
  };
  ...
  updateTimelineActivityType?: TimelineActivityTypeGenqlSelection & {
    __args: { input: UpdateTimelineActivityTypeInput };
  };
  resetTimelineActivityType?: TimelineActivityTypeGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  ...
  signUpInNewWorkspace?: SignUpGenqlSelection & {
    __args?: { input?: SignUpInNewWorkspaceInput | null };
  };
  /** @deprecated Use createNewWorkspaceLogoUpload and completeNewWorkspaceLogoUpload, which send the logo straight to file storage. */
  uploadNewWorkspaceLogo?: FileWithSignedUrlGenqlSelection & {
    __args: { workspaceId: Scalars['String']; file: Scalars['Upload'] };
  };
  createNewWorkspaceLogoUpload?: FileUploadTargetGenqlSelection & {
    __args: {
  ...
  completeNewWorkspaceLogoUpload?: FileWithSignedUrlGenqlSelection & {
    __args: { workspaceId: Scalars['String']; fileId: Scalars['String'] };
  };
  ...
  getAuthTokensFromSSOExchangeToken?: AuthTokensGenqlSelection & {
    __args: { ssoExchangeToken: Scalars['String'] };
  };
  ...
  updateWorkspaceMemberSettings?: {
    __args: { input: UpdateWorkspaceMemberSettingsInput };
  };
  updateUserEmail?: {
    __args: {
  ...
  createCalendarEvent?: CreateCalendarEventOutputGenqlSelection & {
    __args: { input: CreateCalendarEventInput };
  };
  ...
  createPublicDomain?: PublicDomainGenqlSelection & {
    __args: { domain: Scalars['String']; applicationId: Scalars['String'] };
  };
  ...
  syncApplication?: WorkspaceMigrationGenqlSelection & {
    __args: {
      ...
      inferDeletionFromMissingEntities?: Scalars['Boolean'] | null;
    };
  };
  /** @deprecated Use createApplicationFileUploads and completeApplicationFileUploads, which send the files straight to file storage. */
  ...
  createApplicationFileUploads?: CreateApplicationFileUploadsResultGenqlSelection & {
    __args: {
      applicationUniversalIdentifier: Scalars['String'];
      files: ApplicationFileUploadRequestInput[];
    };
  };
  completeApplicationFileUploads?: CompleteApplicationFileUploadsResultGenqlSelection & {
    __args: {
      applicationUniversalIdentifier: Scalars['String'];
      fileIds: Scalars['UUID'][];
    };
  };
  revokeApplicationAuthorization?: {
    __args: { applicationAuthorizationId: Scalars['UUID'] };
  };
...
export interface RecordSharePrincipalInput {
  workspaceMemberId?: Scalars['UUID'] | null;
  roleId?: Scalars['UUID'] | null;
  everyone?: Scalars['Boolean'] | null;
}
...
export interface CreateUsageLimitInput {
  ...
  meter: Scalars['String'];
  limitValue: Scalars['BigInt'];
  burstValue?: Scalars['BigInt'] | null;
}
...
export interface CreateViewFilterInput {
  ...
  relationTargetFieldMetadataId?: Scalars['UUID'] | null;
  viewId: Scalars['UUID'];
}
...
export interface CreateViewInput {
  ...
  kanbanColumnWidth?: Scalars['Int'] | null;
  groupLoadLimit?: Scalars['Int'] | null;
  /** Deprecated: Superseded by objectMetadata.openRecordIn and the workspace member preference; kept one release for API compatibility, no longer read by the frontend. */
  ...
  calendarEndFieldMetadataId?: Scalars['UUID'] | null;
...
export interface UpsertViewWidgetViewFilterGroupInput {
  id?: Scalars['UUID'] | null;
  parentViewFilterGroupId?: Scalars['UUID'] | null;
  logicalOperator?: ViewFilterGroupLogicalOperator | null;
  positionInViewFilterGroup?: Scalars['Float'] | null;
...
export interface UpsertViewWidgetViewSortInput {
  id?: Scalars['UUID'] | null;
  fieldMetadataId: Scalars['UUID'];
...
export interface UpdatePageLayoutWithTabsInput {
  ...
  type: PageLayoutType;
  objectMetadataId?: Scalars['UUID'] | null;
  isFirstTabPinned?: Scalars['Boolean'] | null;
...
export interface UpdateObjectPayload {
  ...
  openRecordIn?: ObjectOpenRecordIn | null;
  readability?: MetadataReadability | null;
  translations?: MetadataTranslationOverrideInput[] | null;
}

export interface MetadataTranslationOverrideInput {
  locale: Scalars['String'];
  property: Scalars['String'];
...
export interface CreateIndexFieldInput {
  fieldMetadataId: Scalars['UUID'];
  subFieldName?: Scalars['String'] | null;
}
...
export interface CreateLogicFunctionFromSourceInput {
  ...
  serverRouteTriggerSettings?: Scalars['JSON'] | null;
  toolTriggerSettings?: Scalars['JSON'] | null;
  workflowActionTriggerSettings?: Scalars['JSON'] | null;
}
...
export interface CreateCommandMenuItemInput {
  ...
  coreWorkflowVersionId?: Scalars['UUID'] | null;
  ...
  conditionalAvailabilityExpression?: Scalars['String'] | null;
  conditionalPinnedExpression?: Scalars['String'] | null;
  availabilityObjectMetadataId?: Scalars['UUID'] | null;
  payload?: Scalars['JSON'] | null;
  navigationTargetObjectMetadataId?: Scalars['UUID'] | null;
  pageLayoutId?: Scalars['UUID'] | null;
}
...
export interface UpdateWorkspaceInput {
  ...
  workspaceDiscoverability?: WorkspaceDiscoverability | null;
  ...
  aiChatModelTier?: AiModelTier | null;
  aiAgentModelTier?: AiModelTier | null;
  isAutoModelSelectionEnabled?: Scalars['Boolean'] | null;
  aiModelIdByTier?: Scalars['JSON'] | null;
  aiEvaluationModelId?: Scalars['String'] | null;
  aiAdditionalInstructions?: Scalars['String'] | null;
  editableProfileFields?: Scalars['String'][] | null;
  isInternalMessagesImportEnabled?: Scalars['Boolean'] | null;
}

export interface UpdateWorkspaceAllowedIframeOriginsInput {
...
export interface UpdateApplicationRegistrationVariablePayload {
  value?: Scalars['String'] | null;
  resetValue?: Scalars['Boolean'] | null;
  description?: Scalars['String'] | null;
}

export interface GrantApplicationCapabilitiesInput {
  applicationId: Scalars['UUID'];
  capabilities: Scalars['String'][];
}

export interface TriggerInstallApplicationJobInput {
  universalIdentifier: Scalars['String'];
}

export interface TriggerUninstallApplicationJobInput {
  universalIdentifier: Scalars['String'];
}

export interface UpdateApplicationInput {
  autoUpgrade?: Scalars['Boolean'] | null;
}
...
export interface UpsertPermissionFlagsInput {
  roleId: Scalars['UUID'];
  permissionFlagKeys: Scalars['String'][];
}
...
export interface SendEmailViaDomainInput {
...
export interface SendMessageCampaignInput {
  campaignId: Scalars['String'];
  scheduledAt?: Scalars['DateTime'] | null;
}

export interface CancelMessageCampaignInput {
  campaignId: Scalars['String'];
}

export interface SendMessageCampaignTestInput {
...
export interface CreateMessageSuppressionInput {
  emailAddress: Scalars['String'];
  unsubscribeTopicId?: Scalars['UUID'] | null;
}

export interface CreateUnsubscribeTopicInput {
  name: Scalars['String'];
  description?: Scalars['String'] | null;
  visibility?: UnsubscribeTopicVisibility | null;
}

export interface UpdateUnsubscribeTopicInput {
  id: Scalars['String'];
  name?: Scalars['String'] | null;
  description?: Scalars['String'] | null;
  visibility?: UnsubscribeTopicVisibility | null;
...
export interface CreateEmailGroupChannelInput {
  handle: Scalars['String'];
  displayName?: Scalars['String'] | null;
}

export interface UpdateEmailGroupChannelInput {
  id: Scalars['UUID'];
  displayName?: Scalars['String'] | null;
}

export interface CreateAppMessageChannelInput {
  connectedAccountId: Scalars['UUID'];
  handle: Scalars['String'];
  displayName?: Scalars['String'] | null;
  visibility: MessageChannelVisibility;
...
export interface UpdateAppMessageChannelInput {
  id: Scalars['UUID'];
  displayName?: Scalars['String'] | null;
  visibility?: MessageChannelVisibility | null;
  isSyncEnabled?: Scalars['Boolean'] | null;
...
export interface IngestAppMessagesInput {
  messageChannelId: Scalars['UUID'];
...
export interface AppMessageInput {
  externalId: Scalars['String'];
  threadExternalId: Scalars['String'];
...
export interface AppMessageParticipantInput {
...
export interface CreateEmailingDomainInput {
  domain: Scalars['String'];
}
...
export interface RunAgentInput {
  ...
  prompt?: Scalars['String'] | null;
  runAsWorkspaceMemberId?: Scalars['UUID'] | null;
  messages?: RunAgentMessageInput[] | null;
}

export interface RunAgentMessageInput {
  role: RunAgentMessageRole;
  content: Scalars['String'];
  attachments?: RunAgentMessageAttachmentInput[] | null;
}

export interface RunAgentMessageAttachmentInput {
  fileId: Scalars['UUID'];
...
export interface SetAppKeyValueInput {
  key: Scalars['String'];
  value?: Scalars['JSON'] | null;
  scope?: AppKeyValueScope | null;
}
...
export interface EnqueueJobInput {
  ...
  retryLimit?: Scalars['Int'] | null;
  delayMs?: Scalars['Int'] | null;
}

export interface EnqueueJobsInput {
  logicFunctionUniversalIdentifier: Scalars['String'];
  payloads?: Scalars['JSON'][] | null;
  jobs?: EnqueueJobItemInput[] | null;
  retryLimit?: Scalars['Int'] | null;
  delayMs?: Scalars['Int'] | null;
}

export interface EnqueueJobItemInput {
  payload?: Scalars['JSON'] | null;
  jobId?: Scalars['String'] | null;
}

export interface ReportAppConnectionAuthFailureInput {
  id: Scalars['ID'];
...
export interface AgentChatQuestionAnswerInput {
  questionIndex: Scalars['Int'];
  selectedOptionIndices: Scalars['Int'][];
  freeText?: Scalars['String'] | null;
}
...
export interface UpdateTimelineActivityTypeInput {
  id: Scalars['UUID'];
  label?: Scalars['String'] | null;
  icon?: Scalars['String'] | null;
  isActive?: Scalars['Boolean'] | null;
...
export interface SignUpInNewWorkspaceInput {
  displayName?: Scalars['String'] | null;
  subdomain?: Scalars['String'] | null;
}

export interface UpdateWorkspaceMemberSettingsInput {
...
export interface CreateCalendarEventInput {
  ...
  attendees?: Scalars['String'] | null;
  sendInvitations?: Scalars['Boolean'] | null;
  addConferencing?: Scalars['Boolean'] | null;
}

export interface SendEmailInput {
  connectedAccountId: Scalars['String'];
  fromHandle?: Scalars['String'] | null;
  to: Scalars['String'];
  cc?: Scalars['String'] | null;
  bcc?: Scalars['String'] | null;
  subject: Scalars['String'];
  ...
  draftMessageId?: Scalars['String'] | null;
  files?: SendEmailAttachmentInput[] | null;
}
...
export interface EmailAccountConnectionParameters {
  name?: Scalars['String'] | null;
  IMAP?: ConnectionParametersInput | null;
  SMTP?: ConnectionParametersInput | null;
  CALDAV?: ConnectionParametersInput | null;
}

export interface ConnectionParametersInput {
  host: Scalars['String'];
  port: Scalars['Float'];
  username?: Scalars['String'] | null;
  password?: Scalars['String'] | null;
  connectionSecurity?: EmailConnectionSecurity | null;
}
...
export interface ApplicationFileUploadRequestInput {
  fileFolder: FileFolder;
  filePath: Scalars['String'];
  size: Scalars['Int'];
}
...
export interface SubscriptionGenqlSelection {
  ...
  eventLogsLive?: EventLogRecordGenqlSelection & {
    __args: { table: EventLogTable };
  };
  exportRecords?: RecordExportGenqlSelection & {
    __args: { input: CreateRecordExportInput };
  };
  __typename?: boolean | number;
  __scalar?: boolean | number;
}
...
export interface CreateRecordExportInput {
  objectMetadataId: Scalars['UUID'];
  fieldMetadataIds: Scalars['UUID'][];
  filter?: Scalars['JSON'] | null;
  orderBy?: Scalars['JSON'] | null;
}
...
export const isSettingsMenuItem = (
  obj?: { __typename?: any } | null,
): obj is SettingsMenuItem => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSettingsMenuItem"');
...
export const isRolePermissionFlag = (
  obj?: { __typename?: any } | null,
): obj is RolePermissionFlag => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRolePermissionFlag"');
...
export const isBillingCustomer = (
  obj?: { __typename?: any } | null,
): obj is BillingCustomer => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingCustomer"');
...
export const isSdkClientChecksums = (
  obj?: { __typename?: any } | null,
): obj is SdkClientChecksums => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSdkClientChecksums"');
...
const CallRecordingSummaryConfiguration_possibleTypes: string[] = [
  'CallRecordingSummaryConfiguration',
];
export const isCallRecordingSummaryConfiguration = (
  obj?: { __typename?: any } | null,
): obj is CallRecordingSummaryConfiguration => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isCallRecordingSummaryConfiguration"',
    );
  return CallRecordingSummaryConfiguration_possibleTypes.includes(
    obj.__typename,
  );
};

const CallRecordingTranscriptConfiguration_possibleTypes: string[] = [
  'CallRecordingTranscriptConfiguration',
];
export const isCallRecordingTranscriptConfiguration = (
  obj?: { __typename?: any } | null,
): obj is CallRecordingTranscriptConfiguration => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isCallRecordingTranscriptConfiguration"',
    );
  return CallRecordingTranscriptConfiguration_possibleTypes.includes(
    obj.__typename,
  );
};

const MessageCampaignBodyConfiguration_possibleTypes: string[] = [
  'MessageCampaignBodyConfiguration',
];
export const isMessageCampaignBodyConfiguration = (
  obj?: { __typename?: any } | null,
): obj is MessageCampaignBodyConfiguration => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isMessageCampaignBodyConfiguration"',
    );
  return MessageCampaignBodyConfiguration_possibleTypes.includes(
    obj.__typename,
  );
};

const MessageCampaignDetailsConfiguration_possibleTypes: string[] = [
  'MessageCampaignDetailsConfiguration',
];
export const isMessageCampaignDetailsConfiguration = (
  obj?: { __typename?: any } | null,
): obj is MessageCampaignDetailsConfiguration => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isMessageCampaignDetailsConfiguration"',
    );
  return MessageCampaignDetailsConfiguration_possibleTypes.includes(
    obj.__typename,
  );
};
...
const FormFieldConfiguration_possibleTypes: string[] = [
  'FormFieldConfiguration',
];
export const isFormFieldConfiguration = (
  obj?: { __typename?: any } | null,
): obj is FormFieldConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFormFieldConfiguration"');
...
const ApplicationConnectionProviderOAuthConfig_possibleTypes: string[] = [
  'ApplicationConnectionProviderOAuthConfig',
];
export const isApplicationConnectionProviderOAuthConfig = (
  obj?: { __typename?: any } | null,
): obj is ApplicationConnectionProviderOAuthConfig => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationConnectionProviderOAuthConfig"',
    );
  return ApplicationConnectionProviderOAuthConfig_possibleTypes.includes(
    obj.__typename,
  );
};

const ApplicationConnectionProvider_possibleTypes: string[] = [
  'ApplicationConnectionProvider',
];
export const isApplicationConnectionProvider = (
  obj?: { __typename?: any } | null,
): obj is ApplicationConnectionProvider => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationConnectionProvider"',
    );
...
export const isUsageQuotaDefinition = (
  obj?: { __typename?: any } | null,
): obj is UsageQuotaDefinition => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUsageQuotaDefinition"');
...
export const isUsageQuotaDefinitions = (
  obj?: { __typename?: any } | null,
): obj is UsageQuotaDefinitions => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUsageQuotaDefinitions"');
  return UsageQuotaDefinitions_possibleTypes.includes(obj.__typename);
};

const UsageQuotaWithConsumption_possibleTypes: string[] = [
  'UsageQuotaWithConsumption',
];
export const isUsageQuotaWithConsumption = (
  obj?: { __typename?: any } | null,
): obj is UsageQuotaWithConsumption => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUsageQuotaWithConsumption"');
  return UsageQuotaWithConsumption_possibleTypes.includes(obj.__typename);
};

const UsageQuotaScopeConsumption_possibleTypes: string[] = [
  'UsageQuotaScopeConsumption',
];
export const isUsageQuotaScopeConsumption = (
  obj?: { __typename?: any } | null,
): obj is UsageQuotaScopeConsumption => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUsageQuotaScopeConsumption"');
...
export const isFileUploadTarget = (
  obj?: { __typename?: any } | null,
): obj is FileUploadTarget => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isFileUploadTarget"');
...
export const isRecordPermissionsDTO = (
  obj?: { __typename?: any } | null,
): obj is RecordPermissionsDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRecordPermissionsDTO"');
...
export const isRecordSharingGrantDTO = (
  obj?: { __typename?: any } | null,
): obj is RecordSharingGrantDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRecordSharingGrantDTO"');
...
export const isRecordSharingRoleDTO = (
  obj?: { __typename?: any } | null,
): obj is RecordSharingRoleDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRecordSharingRoleDTO"');
...
export const isRecordSharingDTO = (
  obj?: { __typename?: any } | null,
): obj is RecordSharingDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRecordSharingDTO"');
...
export const isJobStatus = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isJobStatus"');
...
export const isUserSession = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUserSession"');
...
const BillingResourceCreditUsage_possibleTypes: string[] = [
  'BillingResourceCreditUsage',
];
export const isBillingResourceCreditUsage = (
  obj?: { __typename?: any } | null,
): obj is BillingResourceCreditUsage => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingResourceCreditUsage"');
...
export const isBillingPaymentIntent = (
  obj?: { __typename?: any } | null,
): obj is BillingPaymentIntent => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBillingPaymentIntent"');
...
export const isInviteSuggestion = (
  obj?: { __typename?: any } | null,
): obj is InviteSuggestion => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isInviteSuggestion"');
  return InviteSuggestion_possibleTypes.includes(obj.__typename);
};

const OnboardingStepNavigation_possibleTypes: string[] = [
  'OnboardingStepNavigation',
];
export const isOnboardingStepNavigation = (
  obj?: { __typename?: any } | null,
): obj is OnboardingStepNavigation => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isOnboardingStepNavigation"');
...
const ApplicationConnectedAccountDTO_possibleTypes: string[] = [
  'ApplicationConnectedAccountDTO',
];
export const isApplicationConnectedAccountDTO = (
  obj?: { __typename?: any } | null,
): obj is ApplicationConnectedAccountDTO => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationConnectedAccountDTO"',
    );
...
const PublicWorkspaceDataSummary_possibleTypes: string[] = [
  'PublicWorkspaceDataSummary',
];
export const isPublicWorkspaceDataSummary = (
  obj?: { __typename?: any } | null,
): obj is PublicWorkspaceDataSummary => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPublicWorkspaceDataSummary"');
...
const ClientAiEvaluationModelConfig_possibleTypes: string[] = [
  'ClientAiEvaluationModelConfig',
];
export const isClientAiEvaluationModelConfig = (
  obj?: { __typename?: any } | null,
): obj is ClientAiEvaluationModelConfig => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isClientAiEvaluationModelConfig"',
    );
  return ClientAiEvaluationModelConfig_possibleTypes.includes(obj.__typename);
};

const ClientAiModelTierConfig_possibleTypes: string[] = [
  'ClientAiModelTierConfig',
];
export const isClientAiModelTierConfig = (
  obj?: { __typename?: any } | null,
): obj is ClientAiModelTierConfig => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isClientAiModelTierConfig"');
...
const ClaimableApplicationRegistration_possibleTypes: string[] = [
  'ClaimableApplicationRegistration',
];
export const isClaimableApplicationRegistration = (
  obj?: { __typename?: any } | null,
): obj is ClaimableApplicationRegistration => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isClaimableApplicationRegistration"',
    );
  return ClaimableApplicationRegistration_possibleTypes.includes(
    obj.__typename,
  );
};
...
export const isAppConnection = (
  obj?: { __typename?: any } | null,
): obj is AppConnection => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAppConnection"');
...
const ApplicationHealthCheckAction_possibleTypes: string[] = [
  'ApplicationHealthCheckAction',
];
export const isApplicationHealthCheckAction = (
  obj?: { __typename?: any } | null,
): obj is ApplicationHealthCheckAction => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationHealthCheckAction"',
    );
  return ApplicationHealthCheckAction_possibleTypes.includes(obj.__typename);
};

const ApplicationHealthCheckResult_possibleTypes: string[] = [
  'ApplicationHealthCheckResult',
];
export const isApplicationHealthCheckResult = (
  obj?: { __typename?: any } | null,
): obj is ApplicationHealthCheckResult => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationHealthCheckResult"',
    );
...
export const isMarketplaceAppRole = (
  obj?: { __typename?: any } | null,
): obj is MarketplaceAppRole => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMarketplaceAppRole"');
...
const TriggerInstallApplicationJobResult_possibleTypes: string[] = [
  'TriggerInstallApplicationJobResult',
];
export const isTriggerInstallApplicationJobResult = (
  obj?: { __typename?: any } | null,
): obj is TriggerInstallApplicationJobResult => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isTriggerInstallApplicationJobResult"',
    );
  return TriggerInstallApplicationJobResult_possibleTypes.includes(
    obj.__typename,
  );
};

const TriggerUninstallApplicationJobResult_possibleTypes: string[] = [
  'TriggerUninstallApplicationJobResult',
];
export const isTriggerUninstallApplicationJobResult = (
  obj?: { __typename?: any } | null,
): obj is TriggerUninstallApplicationJobResult => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isTriggerUninstallApplicationJobResult"',
    );
  return TriggerUninstallApplicationJobResult_possibleTypes.includes(
    obj.__typename,
  );
};

const ApplicationCapabilityGrant_possibleTypes: string[] = [
  'ApplicationCapabilityGrant',
];
export const isApplicationCapabilityGrant = (
  obj?: { __typename?: any } | null,
): obj is ApplicationCapabilityGrant => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApplicationCapabilityGrant"');
  return ApplicationCapabilityGrant_possibleTypes.includes(obj.__typename);
};

const WorkspaceCompanyEnrichmentResult_possibleTypes: string[] = [
  'WorkspaceCompanyEnrichmentResult',
];
export const isWorkspaceCompanyEnrichmentResult = (
  obj?: { __typename?: any } | null,
): obj is WorkspaceCompanyEnrichmentResult => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isWorkspaceCompanyEnrichmentResult"',
    );
  return WorkspaceCompanyEnrichmentResult_possibleTypes.includes(
    obj.__typename,
  );
};
...
export const isSearchField = (
  obj?: { __typename?: any } | null,
): obj is SearchField => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSearchField"');
...
const SubdomainAvailabilityDTO_possibleTypes: string[] = [
  'SubdomainAvailabilityDTO',
];
export const isSubdomainAvailabilityDTO = (
  obj?: { __typename?: any } | null,
): obj is SubdomainAvailabilityDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSubdomainAvailabilityDTO"');
  return SubdomainAvailabilityDTO_possibleTypes.includes(obj.__typename);
};

const WorkspaceCreationDefaultsDTO_possibleTypes: string[] = [
  'WorkspaceCreationDefaultsDTO',
];
export const isWorkspaceCreationDefaultsDTO = (
  obj?: { __typename?: any } | null,
): obj is WorkspaceCreationDefaultsDTO => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isWorkspaceCreationDefaultsDTO"',
    );
...
export const isStopImpersonation = (
  obj?: { __typename?: any } | null,
): obj is StopImpersonation => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isStopImpersonation"');
  return StopImpersonation_possibleTypes.includes(obj.__typename);
};

const ApplicationAuthorization_possibleTypes: string[] = [
  'ApplicationAuthorization',
];
export const isApplicationAuthorization = (
  obj?: { __typename?: any } | null,
): obj is ApplicationAuthorization => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApplicationAuthorization"');
  return ApplicationAuthorization_possibleTypes.includes(obj.__typename);
};

const ApplicationExportApplication_possibleTypes: string[] = [
  'ApplicationExportApplication',
];
export const isApplicationExportApplication = (
  obj?: { __typename?: any } | null,
): obj is ApplicationExportApplication => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationExportApplication"',
    );
  return ApplicationExportApplication_possibleTypes.includes(obj.__typename);
};

const ApplicationExportCoverageEntry_possibleTypes: string[] = [
  'ApplicationExportCoverageEntry',
];
export const isApplicationExportCoverageEntry = (
  obj?: { __typename?: any } | null,
): obj is ApplicationExportCoverageEntry => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationExportCoverageEntry"',
    );
...
export const isApplicationExportFile = (
  obj?: { __typename?: any } | null,
): obj is ApplicationExportFile => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApplicationExportFile"');
...
export const isApplicationExport = (
  obj?: { __typename?: any } | null,
): obj is ApplicationExport => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApplicationExport"');
...
const ApplicationFileCompletionError_possibleTypes: string[] = [
  'ApplicationFileCompletionError',
];
export const isApplicationFileCompletionError = (
  obj?: { __typename?: any } | null,
): obj is ApplicationFileCompletionError => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isApplicationFileCompletionError"',
    );
  return ApplicationFileCompletionError_possibleTypes.includes(obj.__typename);
};

const CompleteApplicationFileUploadsResult_possibleTypes: string[] = [
  'CompleteApplicationFileUploadsResult',
];
export const isCompleteApplicationFileUploadsResult = (
  obj?: { __typename?: any } | null,
): obj is CompleteApplicationFileUploadsResult => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isCompleteApplicationFileUploadsResult"',
    );
  return CompleteApplicationFileUploadsResult_possibleTypes.includes(
    obj.__typename,
  );
};

const ApplicationFileUploadTarget_possibleTypes: string[] = [
  'ApplicationFileUploadTarget',
];
export const isApplicationFileUploadTarget = (
  obj?: { __typename?: any } | null,
): obj is ApplicationFileUploadTarget => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApplicationFileUploadTarget"');
  return ApplicationFileUploadTarget_possibleTypes.includes(obj.__typename);
};

const ApplicationFileUploadError_possibleTypes: string[] = [
  'ApplicationFileUploadError',
];
export const isApplicationFileUploadError = (
  obj?: { __typename?: any } | null,
): obj is ApplicationFileUploadError => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isApplicationFileUploadError"');
  return ApplicationFileUploadError_possibleTypes.includes(obj.__typename);
};

const CreateApplicationFileUploadsResult_possibleTypes: string[] = [
  'CreateApplicationFileUploadsResult',
];
export const isCreateApplicationFileUploadsResult = (
  obj?: { __typename?: any } | null,
): obj is CreateApplicationFileUploadsResult => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isCreateApplicationFileUploadsResult"',
    );
  return CreateApplicationFileUploadsResult_possibleTypes.includes(
    obj.__typename,
  );
};
...
export const isIngestedAppMessage = (
  obj?: { __typename?: any } | null,
): obj is IngestedAppMessage => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isIngestedAppMessage"');
  return IngestedAppMessage_possibleTypes.includes(obj.__typename);
};

const IngestAppMessagesOutput_possibleTypes: string[] = [
  'IngestAppMessagesOutput',
];
export const isIngestAppMessagesOutput = (
  obj?: { __typename?: any } | null,
): obj is IngestAppMessagesOutput => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isIngestAppMessagesOutput"');
  return IngestAppMessagesOutput_possibleTypes.includes(obj.__typename);
};

const CreateEmailGroupChannelOutput_possibleTypes: string[] = [
  'CreateEmailGroupChannelOutput',
];
export const isCreateEmailGroupChannelOutput = (
  obj?: { __typename?: any } | null,
): obj is CreateEmailGroupChannelOutput => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isCreateEmailGroupChannelOutput"',
    );
  return CreateEmailGroupChannelOutput_possibleTypes.includes(obj.__typename);
};

const CampaignAudiencePreviewDTO_possibleTypes: string[] = [
  'CampaignAudiencePreviewDTO',
];
export const isCampaignAudiencePreviewDTO = (
  obj?: { __typename?: any } | null,
): obj is CampaignAudiencePreviewDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCampaignAudiencePreviewDTO"');
  return CampaignAudiencePreviewDTO_possibleTypes.includes(obj.__typename);
};

const CancelMessageCampaignOutputDTO_possibleTypes: string[] = [
  'CancelMessageCampaignOutputDTO',
];
export const isCancelMessageCampaignOutputDTO = (
  obj?: { __typename?: any } | null,
): obj is CancelMessageCampaignOutputDTO => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isCancelMessageCampaignOutputDTO"',
    );
  return CancelMessageCampaignOutputDTO_possibleTypes.includes(obj.__typename);
};

const SendEmailViaDomainOutput_possibleTypes: string[] = [
  'SendEmailViaDomainOutput',
];
export const isSendEmailViaDomainOutput = (
  obj?: { __typename?: any } | null,
): obj is SendEmailViaDomainOutput => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSendEmailViaDomainOutput"');
  return SendEmailViaDomainOutput_possibleTypes.includes(obj.__typename);
};

const SendMessageCampaignOutputDTO_possibleTypes: string[] = [
  'SendMessageCampaignOutputDTO',
];
export const isSendMessageCampaignOutputDTO = (
  obj?: { __typename?: any } | null,
): obj is SendMessageCampaignOutputDTO => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isSendMessageCampaignOutputDTO"',
    );
...
export const isDuplicatedMessageList = (
  obj?: { __typename?: any } | null,
): obj is DuplicatedMessageList => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isDuplicatedMessageList"');
...
export const isMessageSuppression = (
  obj?: { __typename?: any } | null,
): obj is MessageSuppression => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMessageSuppression"');
  return MessageSuppression_possibleTypes.includes(obj.__typename);
};

const MessageSuppressionList_possibleTypes: string[] = [
  'MessageSuppressionList',
];
export const isMessageSuppressionList = (
  obj?: { __typename?: any } | null,
): obj is MessageSuppressionList => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMessageSuppressionList"');
...
export const isUnsubscribeTopic = (
  obj?: { __typename?: any } | null,
): obj is UnsubscribeTopic => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUnsubscribeTopic"');
...
const ImapSmtpCaldavPublicConnectionParams_possibleTypes: string[] = [
  'ImapSmtpCaldavPublicConnectionParams',
];
export const isImapSmtpCaldavPublicConnectionParams = (
  obj?: { __typename?: any } | null,
): obj is ImapSmtpCaldavPublicConnectionParams => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isImapSmtpCaldavPublicConnectionParams"',
    );
  return ImapSmtpCaldavPublicConnectionParams_possibleTypes.includes(
    obj.__typename,
  );
};

const ImapSmtpCaldavPublicConnectionParameters_possibleTypes: string[] = [
  'ImapSmtpCaldavPublicConnectionParameters',
];
export const isImapSmtpCaldavPublicConnectionParameters = (
  obj?: { __typename?: any } | null,
): obj is ImapSmtpCaldavPublicConnectionParameters => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isImapSmtpCaldavPublicConnectionParameters"',
    );
  return ImapSmtpCaldavPublicConnectionParameters_possibleTypes.includes(
    obj.__typename,
  );
};
...
export const isRunAgentResult = (
  obj?: { __typename?: any } | null,
): obj is RunAgentResult => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRunAgentResult"');
...
const CreateCalendarEventOutput_possibleTypes: string[] = [
  'CreateCalendarEventOutput',
];
export const isCreateCalendarEventOutput = (
  obj?: { __typename?: any } | null,
): obj is CreateCalendarEventOutput => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCreateCalendarEventOutput"');
...
export const isRecordExport = (
  obj?: { __typename?: any } | null,
): obj is RecordExport => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRecordExport"');
  return RecordExport_possibleTypes.includes(obj.__typename);
};

const AiChatUsage_possibleTypes: string[] = ['AiChatUsage'];
export const isAiChatUsage = (
  obj?: { __typename?: any } | null,
): obj is AiChatUsage => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAiChatUsage"');
...
export const isChatStreamError = (
  obj?: { __typename?: any } | null,
): obj is ChatStreamError => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isChatStreamError"');
...
const StartWorkspaceSetupChatResult_possibleTypes: string[] = [
  'StartWorkspaceSetupChatResult',
];
export const isStartWorkspaceSetupChatResult = (
  obj?: { __typename?: any } | null,
): obj is StartWorkspaceSetupChatResult => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isStartWorkspaceSetupChatResult"',
    );
  return StartWorkspaceSetupChatResult_possibleTypes.includes(obj.__typename);
};

const RecordPermissionsResult_possibleTypes: string[] = [
  'RecordPermissionsResult',
];
export const isRecordPermissionsResult = (
  obj?: { __typename?: any } | null,
): obj is RecordPermissionsResult => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRecordPermissionsResult"');
...
export const isWorkspaceAiStats = (
  obj?: { __typename?: any } | null,
): obj is WorkspaceAiStats => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isWorkspaceAiStats"');
...
export const isEnqueueJobResult = (
  obj?: { __typename?: any } | null,
): obj is EnqueueJobResult => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEnqueueJobResult"');
...
export const isEnqueueJobsResult = (
  obj?: { __typename?: any } | null,
): obj is EnqueueJobsResult => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEnqueueJobsResult"');
  return EnqueueJobsResult_possibleTypes.includes(obj.__typename);
};

const AppKeyValue_possibleTypes: string[] = ['AppKeyValue'];
export const isAppKeyValue = (
  obj?: { __typename?: any } | null,
): obj is AppKeyValue => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAppKeyValue"');
...
export const isMetadataTranslation = (
  obj?: { __typename?: any } | null,
): obj is MetadataTranslation => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMetadataTranslation"');
  return MetadataTranslation_possibleTypes.includes(obj.__typename);
};

const TimelineActivityTypeEmitThrough_possibleTypes: string[] = [
  'TimelineActivityTypeEmitThrough',
];
export const isTimelineActivityTypeEmitThrough = (
  obj?: { __typename?: any } | null,
): obj is TimelineActivityTypeEmitThrough => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isTimelineActivityTypeEmitThrough"',
    );
  return TimelineActivityTypeEmitThrough_possibleTypes.includes(obj.__typename);
};

const TimelineActivityTypeEmit_possibleTypes: string[] = [
  'TimelineActivityTypeEmit',
];
export const isTimelineActivityTypeEmit = (
  obj?: { __typename?: any } | null,
): obj is TimelineActivityTypeEmit => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTimelineActivityTypeEmit"');
...
export const isTimelineActivityType = (
  obj?: { __typename?: any } | null,
): obj is TimelineActivityType => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTimelineActivityType"');
...
export const enumFeatureFlagKey = {
  ...
  IS_CONFIGURABLE_SEARCH_FIELDS_ENABLED:
    'IS_CONFIGURABLE_SEARCH_FIELDS_ENABLED' as const,
  IS_JSON_FILTER_ENABLED: 'IS_JSON_FILTER_ENABLED' as const,
  IS_MESSAGE_CAMPAIGN_ENABLED: 'IS_MESSAGE_CAMPAIGN_ENABLED' as const,
  IS_JUNCTION_RELATIONS_ENABLED: 'IS_JUNCTION_RELATIONS_ENABLED' as const,
  IS_REST_METADATA_API_NEW_FORMAT_DIRECT:
    'IS_REST_METADATA_API_NEW_FORMAT_DIRECT' as const,
  IS_LOGIC_FUNCTION_PREBUILT_MODE_ENABLED:
    'IS_LOGIC_FUNCTION_PREBUILT_MODE_ENABLED' as const,
  IS_WORKFLOW_CORE_INDEX_PAGE_ENABLED:
    'IS_WORKFLOW_CORE_INDEX_PAGE_ENABLED' as const,
  IS_MESSAGE_CALENDAR_TARGET_READ_ENABLED:
    'IS_MESSAGE_CALENDAR_TARGET_READ_ENABLED' as const,
  ...
  IS_DEFERRED_WORKSPACE_MIGRATION_ACTIONS_ENABLED:
    'IS_DEFERRED_WORKSPACE_MIGRATION_ACTIONS_ENABLED' as const,
