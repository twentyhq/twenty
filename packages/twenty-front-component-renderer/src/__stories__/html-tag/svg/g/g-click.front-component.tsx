...
const GClickFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="g:click">
...
export default defineFrontComponent({
  universalIdentifier: 'fc-g-c-click-00000000-0000-0000-0000-000000000020',
  name: 'g-click-front-component',
  description: 'Front component covering click on <g>',
  component: GClickFrontComponent,
});
