...
const PropertyReflectionFrontComponent = () => {
  ...
  return (
    <FrontComponentCard scenarioId={scenarioId}>{render()}</FrontComponentCard>
  );
};

export default defineFrontComponent({
  universalIdentifier: 'fc-prop-00000000-0000-0000-0000-000000000020',
  name: 'property-reflection-front-component',
  description: 'Front component covering property reflection per HTML element',
  component: PropertyReflectionFrontComponent,
});
