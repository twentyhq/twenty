...
import { BUTTON_STYLE } from './shared/probe-styles';
...
export default defineFrontComponent({
  universalIdentifier: 'probe-host-00000000-0000-0000-0000-000000000020',
  name: 'host-api-probe',
  description: 'Probe component covering host communication APIs',
  component: HostApiProbe,
});
