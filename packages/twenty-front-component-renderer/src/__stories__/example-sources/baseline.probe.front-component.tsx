...
import { type BaselineElementName } from './shared/baseline-element-names';
...
const ELEMENT_REGISTRY: Record<BaselineElementName, ElementSpec> = {
...
const BaselineScenario = ({ spec, eventName }: ScenarioProps) => {
  ...
  return (
    <>
      {wrapped}
      <span data-testid="subject-state">{interactionCount}</span>
...
export default defineFrontComponent({
  universalIdentifier: 'probe-bsln-00000000-0000-0000-0000-000000000020',
  name: 'baseline-probe',
  description: 'Probe component covering baseline click/focus per element',
  component: BaselineProbe,
});
