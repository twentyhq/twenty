...
export { frontComponentLocalStorageService } from './host/utils/frontComponentLocalStorageService';
export { FrontComponentStorageError } from './utils/FrontComponentStorageError';
export type { FrontComponentLocalStorageNamespace } from './types/FrontComponentLocalStorageNamespace';
