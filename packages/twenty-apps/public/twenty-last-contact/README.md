...
| **Last heard from** | The last time **they reached out or responded** — an inbound email, or a meeting they organized (inbound). | Spot who's gone silent. |
...
_Dates are bidirectional unless noted: **Last contacted** is outbound only, **Last heard from** is inbound only, and **Last interaction** is simply the more recent of the two._
...
- **Direction is inferred** — from the email's sender and the meeting's organizer. A meeting your team set up counts as _contacted_; one they set up counts as _heard from_. A meeting counts for both.
