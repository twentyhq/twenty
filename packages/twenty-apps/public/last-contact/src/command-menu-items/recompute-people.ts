...
export default defineCommandMenuItem({
  universalIdentifier:
    RECOMPUTE_COMMAND_MENU_ITEM_UNIVERSAL_IDENTIFIERS.person,
  availabilityObjectUniversalIdentifier:
    RECOMPUTE_TARGETS.person.objectUniversalIdentifier,
  frontComponentUniversalIdentifier:
    RECOMPUTE_FRONT_COMPONENT_UNIVERSAL_IDENTIFIERS.person,
