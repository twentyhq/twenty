...
// Recall caches idempotent responses for exactly 1 hour
// (docs.recall.ai/reference/idempotency); a re-send past that window creates
// a twin bot instead of deduping, so re-sends are only trusted inside it.
