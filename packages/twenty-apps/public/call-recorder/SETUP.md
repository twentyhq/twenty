...
3. A **Gladia API key** added in the Recall.ai dashboard
   (**Transcription → Gladia**) for each region you use — post-call transcripts
   are generated by Gladia and fail without it.
