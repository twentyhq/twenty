...
describe('buildSlackAssistantAnswerText', () => {
  // This text is what every body fallback renders, so losing the footer here
  // means workspaces that reject Block Kit see no duration at all.
  ...
  it('should keep the response body untouched', () => {
    ...
    expect(
      buildSlackAssistantAnswerText({ responseText, durationMilliseconds: 1000 }),
