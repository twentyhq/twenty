...
import { SLACK_INSTALL_REVOKED_UNIVERSAL_IDENTIFIER } from 'src/constants/universal-identifiers';
import { slackInstallRevokedHandler } from 'src/logic-functions/handlers/slack-install-revoked-handler';

export default defineLogicFunction({
  universalIdentifier: SLACK_INSTALL_REVOKED_UNIVERSAL_IDENTIFIER,
