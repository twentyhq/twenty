...
export const SLACK_USER_MAPPING_OBJECT_UNIVERSAL_IDENTIFIER =
  'ebb881f5-7ce9-4f24-be1d-499323d3c292';

export const SLACK_USER_MAPPING_NAME_FIELD_UNIVERSAL_IDENTIFIER =
  'b75993d1-f96a-402d-a46c-2c928043fc58';

export const SLACK_USER_MAPPING_TEAM_ID_FIELD_UNIVERSAL_IDENTIFIER =
  '69ec7ead-80f3-43f5-8a6f-c71880a6588c';

export const SLACK_USER_MAPPING_USER_ID_FIELD_UNIVERSAL_IDENTIFIER =
  '0b7c2fb7-6b5d-4a6d-abbc-6f3ceddd7fc8';

export const SLACK_USER_MAPPING_SOURCE_FIELD_UNIVERSAL_IDENTIFIER =
  '28ea1176-1a5a-4f7f-82d9-56927a6e4af0';

export const SLACK_USER_MAPPING_WORKSPACE_MEMBER_FIELD_UNIVERSAL_IDENTIFIER =
  'a46fa5a5-bb6f-4474-9ba4-b816ab743d0d';

export const SLACK_USER_MAPPINGS_ON_WORKSPACE_MEMBER_FIELD_UNIVERSAL_IDENTIFIER =
  'dbccb29b-a50f-47b0-9232-852a12d874cb';

export const SLACK_USER_MAPPING_SLACK_USER_INDEX_UNIVERSAL_IDENTIFIER =
  '88085b27-6176-4196-9445-646d3fafac9b';

export const SLACK_USER_MAPPING_SLACK_USER_INDEX_TEAM_ID_FIELD_UNIVERSAL_IDENTIFIER =
  '0d0b3215-9ec1-4761-b615-50f818567441';

export const SLACK_USER_MAPPING_SLACK_USER_INDEX_USER_ID_FIELD_UNIVERSAL_IDENTIFIER =
