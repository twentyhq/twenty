...
export const SLACK_TEAM_RELEASE_UNIVERSAL_IDENTIFIER =
  '4470aba8-5ff5-4800-88db-2a427cd8677c';

export const SLACK_APP_UNINSTALL_UNIVERSAL_IDENTIFIER =
  '0c89ed56-7e69-40e4-b15a-919a4912ed9b';

export const SLACK_CONNECTION_TEAM_BACKFILL_UNIVERSAL_IDENTIFIER =
  'f098323e-a280-4471-8928-47741da019db';
