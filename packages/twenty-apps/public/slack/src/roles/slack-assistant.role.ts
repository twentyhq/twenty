...
const WRITABLE_CRM_OBJECT_UNIVERSAL_IDENTIFIERS = [
...
export default defineRole({
  ...
  description:
    'CRM access for the Slack conversational assistant. Lets the slack-assistant agent read, create, update, and soft-delete people, companies, opportunities, notes, and tasks. Workspace members stay read-only. Bound to the agent via roleUniversalIdentifier on install; tighten this role if you need a narrower bot.',
  ...
  objectPermissions: [
    ...WRITABLE_CRM_OBJECT_UNIVERSAL_IDENTIFIERS.map(
