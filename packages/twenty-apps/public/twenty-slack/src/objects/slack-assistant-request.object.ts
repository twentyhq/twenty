...
// Technical object: acts as the durable queue between the Slack events webhook
// (which must answer Slack within 3 seconds) and the assistant worker, and as
// an audit log of every assistant interaction.
