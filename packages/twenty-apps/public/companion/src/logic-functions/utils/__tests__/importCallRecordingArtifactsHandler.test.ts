...
import importCallRecordingArtifactsLogicFunction from 'src/logic-functions/importCallRecordingArtifacts';

const importCallRecordingArtifactsMock = vi.hoisted(() => vi.fn());
const coreApiClientMock = vi.hoisted(() => vi.fn());

vi.mock('src/logic-functions/flows/utils/importCallRecordingArtifacts', () => ({
