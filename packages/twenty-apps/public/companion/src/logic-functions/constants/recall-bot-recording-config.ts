import { COMPANION_RECORDING_RETENTION_HOURS_ENV_VAR_NAME } from 'src/logic-functions/constants/companion-recording-retention-hours-env-var-name';
import { DEFAULT_COMPANION_RECORDING_RETENTION_HOURS } from 'src/logic-functions/constants/default-companion-recording-retention-hours';
