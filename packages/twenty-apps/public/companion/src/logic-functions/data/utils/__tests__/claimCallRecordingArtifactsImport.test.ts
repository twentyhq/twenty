...
import { claimCallRecordingArtifactsImport } from 'src/logic-functions/data/utils/claimCallRecordingArtifactsImport';
import { releaseCallRecordingArtifactsImportClaim } from 'src/logic-functions/data/utils/releaseCallRecordingArtifactsImportClaim';
...
describe('claimCallRecordingArtifactsImport', () => {
      ...
      updateCallRecordings: {
        __args: {
          filter: {
            ...
            or: [
              { companionImportClaimedAt: { is: 'NULL' } },
              { companionImportClaimedAt: { lte: '2026-01-01T13:56:00.000Z' } },
            ],
          },
          data: { companionImportClaimedAt: '2026-01-01T14:06:00.000Z' },
        },
        id: true,
      },
    });
  ...
  it('reclaims a lease older than the TTL', async () => {
    ...
    mutationMock.mockImplementation(async (mutation: any) => {
      ...
      const staleBefore = filter.or[1].companionImportClaimedAt.lte;
    ...
    ).toEqual({ companionImportClaimedAt: '2026-01-01T14:06:00.000Z' });
  });
