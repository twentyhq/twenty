...
import { DEFAULT_ROLE_UNIVERSAL_IDENTIFIER } from 'src/constants/DEFAULT_ROLE_UNIVERSAL_IDENTIFIER';

export default defineApplicationRole({
  universalIdentifier: DEFAULT_ROLE_UNIVERSAL_IDENTIFIER,
  label: `${APP_DISPLAY_NAME} default role`,
  description:
    'Reads personal meeting context and processes desktop recordings, audio, transcripts, and summaries.',
