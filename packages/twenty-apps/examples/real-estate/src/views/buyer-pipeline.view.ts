...
export default defineView({
  ...
  fields: [
    ...
    { universalIdentifier: 'e0e095be-1f73-424c-95d6-e0e01e2fc608', fieldMetadataUniversalIdentifier: opportunityFields.pointOfContact.universalIdentifier, position: 2, isVisible: true, size: 180 },
