...
// Errors surface as plain Error messages built from the HTTP status text and raw
// response body (axios error / GraphQL error wrapping), so retryability has to be
// detected from the message text. Covers rate limiting (429, Cloudflare 1015),
// transient gateway errors (502/503/504) and network-level failures.
