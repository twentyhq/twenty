...
export default defineView({
	...
	fields: [
		{
			universalIdentifier: "0a80e4b4-f52b-420a-9372-8143ea9d726a",
		...
		{
			universalIdentifier: "f53d191c-c9e2-47c1-8e89-b600f77e667e",
			fieldMetadataUniversalIdentifier:
				PROPERTY_PRICE_FIELD_UNIVERSAL_IDENTIFIER,
			position: 1,
			isVisible: true,
		...
		{
			universalIdentifier: "3d5d31a7-016a-4d39-8b39-8d850e4c8d90",
			fieldMetadataUniversalIdentifier:
				PROPERTY_STATUS_FIELD_UNIVERSAL_IDENTIFIER,
			position: 2,
			isVisible: true,
		...
		{
			universalIdentifier: "0987e9ff-6210-468b-8639-7af8c64f23f6",
