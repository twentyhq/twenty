...
export interface AuthorizeAppOutput {
    redirectUrl: Scalars['String']
    __typename: 'AuthorizeAppOutput'
}

export interface EmailPasswordResetLinkOutput {
    /** Boolean that confirms query was dispatched */
    success: Scalars['Boolean']
    __typename: 'EmailPasswordResetLinkOutput'
}

export interface InvalidatePasswordOutput {
    /** Boolean that confirms query was dispatched */
    success: Scalars['Boolean']
...
export interface TransientTokenOutput {
...
export interface VerifyEmailAndGetLoginTokenOutput {
    loginToken: AuthToken
    workspaceUrls: WorkspaceUrls
...
export interface WorkspaceInviteHashValidOutput {
...
export type CommandMenuItemAvailabilityType = 'GLOBAL' | 'SINGLE_RECORD' | 'BULK_RECORDS'
...
export interface AdminAIModelsOutput {
...
export interface BarChartDataOutput {
    data: Scalars['JSON'][]
...
export interface LineChartDataOutput {
...
export interface PieChartDataOutput {
...
export type FileFolder = 'ProfilePicture' | 'WorkspaceLogo' | 'Attachment' | 'PersonPicture' | 'CorePicture' | 'File' | 'AgentChat' | 'BuiltLogicFunction' | 'BuiltFrontComponent' | 'PublicAsset' | 'Source' | 'FilesField' | 'Dependencies' | 'Workflow'

export type WorkspaceMigrationActionType = 'delete' | 'create' | 'update'

export type AllMetadataName = 'fieldMetadata' | 'objectMetadata' | 'view' | 'viewField' | 'viewFieldGroup' | 'viewGroup' | 'rowLevelPermissionPredicate' | 'rowLevelPermissionPredicateGroup' | 'viewFilterGroup' | 'index' | 'logicFunction' | 'viewFilter' | 'role' | 'roleTarget' | 'agent' | 'skill' | 'pageLayout' | 'pageLayoutWidget' | 'pageLayoutTab' | 'commandMenuItem' | 'navigationMenuItem' | 'frontComponent' | 'webhook'
...
export interface SignedFileGenqlSelection{
    path?: boolean | number
...
export interface AuthorizeAppOutputGenqlSelection{
    redirectUrl?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}

export interface EmailPasswordResetLinkOutputGenqlSelection{
    /** Boolean that confirms query was dispatched */
    success?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
export interface InvalidatePasswordOutputGenqlSelection{
    /** Boolean that confirms query was dispatched */
    success?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
export interface TransientTokenOutputGenqlSelection{
    transientToken?: AuthTokenGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}

export interface ValidatePasswordResetTokenOutputGenqlSelection{
    id?: boolean | number
    email?: boolean | number
    hasPassword?: boolean | number
    __typename?: boolean | number
...
export interface VerifyEmailAndGetLoginTokenOutputGenqlSelection{
    loginToken?: AuthTokenGenqlSelection
    workspaceUrls?: WorkspaceUrlsGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
...
export interface LoginTokenOutputGenqlSelection{
    loginToken?: AuthTokenGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface WorkspaceInviteHashValidOutputGenqlSelection{
...
export interface AdminAIModelsOutputGenqlSelection{
...
export interface WorkspaceMigrationDTOGenqlSelection{
...
export interface BarChartDataOutputGenqlSelection{
    data?: boolean | number
...
export interface LineChartDataOutputGenqlSelection{
...
export interface PieChartDataOutputGenqlSelection{
...
export interface QueryGenqlSelection{
    ...
    checkWorkspaceInviteHashIsValid?: (WorkspaceInviteHashValidOutputGenqlSelection & { __args: {inviteHash: Scalars['String']} })
    findWorkspaceFromInviteHash?: (WorkspaceGenqlSelection & { __args: {inviteHash: Scalars['String']} })
    validatePasswordResetToken?: (ValidatePasswordResetTokenOutputGenqlSelection & { __args: {passwordResetToken: Scalars['String']} })
    ...
    pieChartData?: (PieChartDataOutputGenqlSelection & { __args: {input: PieChartDataInput} })
    lineChartData?: (LineChartDataOutputGenqlSelection & { __args: {input: LineChartDataInput} })
    barChartData?: (BarChartDataOutputGenqlSelection & { __args: {input: BarChartDataInput} })
    ...
    getAdminAiModels?: AdminAIModelsOutputGenqlSelection
...
export interface MutationGenqlSelection{
    ...
    /** @deprecated Use uploadFilesFieldFile instead */
    uploadFile?: (SignedFileGenqlSelection & { __args: {file: Scalars['Upload'], fileFolder?: (FileFolder | null)} })
    uploadImage?: (SignedFileGenqlSelection & { __args: {file: Scalars['Upload'], fileFolder?: (FileFolder | null)} })
    /** @deprecated Use specific file service instead */
    ...
    uploadWorkspaceMemberProfilePictureLegacy?: (SignedFileGenqlSelection & { __args: {file: Scalars['Upload']} })
    ...
    uploadWorkspaceLogoLegacy?: (SignedFileGenqlSelection & { __args: {file: Scalars['Upload']} })
    ...
    getLoginTokenFromCredentials?: (LoginTokenOutputGenqlSelection & { __args: {email: Scalars['String'], password: Scalars['String'], captchaToken?: (Scalars['String'] | null), locale?: (Scalars['String'] | null), verifyEmailRedirectPath?: (Scalars['String'] | null), origin: Scalars['String']} })
    ...
    verifyEmailAndGetLoginToken?: (VerifyEmailAndGetLoginTokenOutputGenqlSelection & { __args: {emailVerificationToken: Scalars['String'], email: Scalars['String'], captchaToken?: (Scalars['String'] | null), origin: Scalars['String']} })
    verifyEmailAndGetWorkspaceAgnosticToken?: (AvailableWorkspacesAndAccessTokensOutputGenqlSelection & { __args: {emailVerificationToken: Scalars['String'], email: Scalars['String'], captchaToken?: (Scalars['String'] | null)} })
    ...
    generateTransientToken?: TransientTokenOutputGenqlSelection
    getAuthTokensFromLoginToken?: (AuthTokensGenqlSelection & { __args: {loginToken: Scalars['String'], origin: Scalars['String']} })
    authorizeApp?: (AuthorizeAppOutputGenqlSelection & { __args: {clientId: Scalars['String'], codeChallenge?: (Scalars['String'] | null), redirectUrl: Scalars['String']} })
    ...
    emailPasswordResetLink?: (EmailPasswordResetLinkOutputGenqlSelection & { __args: {email: Scalars['String'], workspaceId: Scalars['UUID']} })
    updatePasswordViaResetToken?: (InvalidatePasswordOutputGenqlSelection & { __args: {passwordResetToken: Scalars['String'], newPassword: Scalars['String']} })
    ...
    syncApplication?: (WorkspaceMigrationDTOGenqlSelection & { __args: {manifest: Scalars['JSON']} })
    ...
    installMarketplaceApp?: boolean | number
...
export interface CreateCommandMenuItemInput {workflowVersionId?: (Scalars['UUID'] | null),frontComponentId?: (Scalars['UUID'] | null),label: Scalars['String'],icon?: (Scalars['String'] | null),isPinned?: (Scalars['Boolean'] | null),availabilityType?: (CommandMenuItemAvailabilityType | null),availabilityObjectMetadataId?: (Scalars['UUID'] | null)}

export interface UpdateCommandMenuItemInput {id: Scalars['UUID'],label?: (Scalars['String'] | null),icon?: (Scalars['String'] | null),isPinned?: (Scalars['Boolean'] | null),availabilityType?: (CommandMenuItemAvailabilityType | null),availabilityObjectMetadataId?: (Scalars['UUID'] | null)}
...
export interface CreateNavigationMenuItemInput {userWorkspaceId?: (Scalars['UUID'] | null),targetRecordId?: (Scalars['UUID'] | null),targetObjectMetadataId?: (Scalars['UUID'] | null),viewId?: (Scalars['UUID'] | null),name?: (Scalars['String'] | null),link?: (Scalars['String'] | null),icon?: (Scalars['String'] | null),folderId?: (Scalars['UUID'] | null),position?: (Scalars['Float'] | null)}
...
export interface UpdateNavigationMenuItemInput {folderId?: (Scalars['UUID'] | null),position?: (Scalars['Float'] | null),name?: (Scalars['String'] | null),link?: (Scalars['String'] | null),icon?: (Scalars['String'] | null)}
...
export interface CreateApplicationInput {universalIdentifier: Scalars['String'],name: Scalars['String'],description?: (Scalars['String'] | null),version: Scalars['String'],sourcePath: Scalars['String']}
...
export interface LogicFunctionLogsInput {applicationId?: (Scalars['UUID'] | null),applicationUniversalIdentifier?: (Scalars['UUID'] | null),name?: (Scalars['String'] | null),id?: (Scalars['UUID'] | null),universalIdentifier?: (Scalars['UUID'] | null)}
    ...
    const SignedFile_possibleTypes: string[] = ['SignedFile']
    export const isSignedFile = (obj?: { __typename?: any } | null): obj is SignedFile => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSignedFile"')
      return SignedFile_possibleTypes.includes(obj.__typename)
    }
    ...
    const AuthorizeAppOutput_possibleTypes: string[] = ['AuthorizeAppOutput']
    export const isAuthorizeAppOutput = (obj?: { __typename?: any } | null): obj is AuthorizeAppOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isAuthorizeAppOutput"')
      return AuthorizeAppOutput_possibleTypes.includes(obj.__typename)
    }
    


    const EmailPasswordResetLinkOutput_possibleTypes: string[] = ['EmailPasswordResetLinkOutput']
    export const isEmailPasswordResetLinkOutput = (obj?: { __typename?: any } | null): obj is EmailPasswordResetLinkOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isEmailPasswordResetLinkOutput"')
      return EmailPasswordResetLinkOutput_possibleTypes.includes(obj.__typename)
    }
    


    const InvalidatePasswordOutput_possibleTypes: string[] = ['InvalidatePasswordOutput']
    export const isInvalidatePasswordOutput = (obj?: { __typename?: any } | null): obj is InvalidatePasswordOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isInvalidatePasswordOutput"')
      return InvalidatePasswordOutput_possibleTypes.includes(obj.__typename)
    }
    ...
    const TransientTokenOutput_possibleTypes: string[] = ['TransientTokenOutput']
    export const isTransientTokenOutput = (obj?: { __typename?: any } | null): obj is TransientTokenOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTransientTokenOutput"')
      return TransientTokenOutput_possibleTypes.includes(obj.__typename)
    }
    


    const ValidatePasswordResetTokenOutput_possibleTypes: string[] = ['ValidatePasswordResetTokenOutput']
    export const isValidatePasswordResetTokenOutput = (obj?: { __typename?: any } | null): obj is ValidatePasswordResetTokenOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isValidatePasswordResetTokenOutput"')
      return ValidatePasswordResetTokenOutput_possibleTypes.includes(obj.__typename)
    }
    ...
    const VerifyEmailAndGetLoginTokenOutput_possibleTypes: string[] = ['VerifyEmailAndGetLoginTokenOutput']
    export const isVerifyEmailAndGetLoginTokenOutput = (obj?: { __typename?: any } | null): obj is VerifyEmailAndGetLoginTokenOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isVerifyEmailAndGetLoginTokenOutput"')
      return VerifyEmailAndGetLoginTokenOutput_possibleTypes.includes(obj.__typename)
    }
    ...
    const LoginTokenOutput_possibleTypes: string[] = ['LoginTokenOutput']
    export const isLoginTokenOutput = (obj?: { __typename?: any } | null): obj is LoginTokenOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isLoginTokenOutput"')
      return LoginTokenOutput_possibleTypes.includes(obj.__typename)
    }
    ...
    const WorkspaceInviteHashValidOutput_possibleTypes: string[] = ['WorkspaceInviteHashValidOutput']
    export const isWorkspaceInviteHashValidOutput = (obj?: { __typename?: any } | null): obj is WorkspaceInviteHashValidOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isWorkspaceInviteHashValidOutput"')
      return WorkspaceInviteHashValidOutput_possibleTypes.includes(obj.__typename)
    }
    ...
    const AdminAIModelsOutput_possibleTypes: string[] = ['AdminAIModelsOutput']
    export const isAdminAIModelsOutput = (obj?: { __typename?: any } | null): obj is AdminAIModelsOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isAdminAIModelsOutput"')
      return AdminAIModelsOutput_possibleTypes.includes(obj.__typename)
    }
    ...
    const WorkspaceMigrationDTO_possibleTypes: string[] = ['WorkspaceMigrationDTO']
    export const isWorkspaceMigrationDTO = (obj?: { __typename?: any } | null): obj is WorkspaceMigrationDTO => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isWorkspaceMigrationDTO"')
      return WorkspaceMigrationDTO_possibleTypes.includes(obj.__typename)
    }
    ...
    const BarChartDataOutput_possibleTypes: string[] = ['BarChartDataOutput']
    export const isBarChartDataOutput = (obj?: { __typename?: any } | null): obj is BarChartDataOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isBarChartDataOutput"')
      return BarChartDataOutput_possibleTypes.includes(obj.__typename)
    }
    ...
    const LineChartDataOutput_possibleTypes: string[] = ['LineChartDataOutput']
    export const isLineChartDataOutput = (obj?: { __typename?: any } | null): obj is LineChartDataOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isLineChartDataOutput"')
      return LineChartDataOutput_possibleTypes.includes(obj.__typename)
    }
    ...
    const PieChartDataOutput_possibleTypes: string[] = ['PieChartDataOutput']
    export const isPieChartDataOutput = (obj?: { __typename?: any } | null): obj is PieChartDataOutput => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPieChartDataOutput"')
      return PieChartDataOutput_possibleTypes.includes(obj.__typename)
    }
...
export const enumFeatureFlagKey = {
   ...
   IS_FILES_FIELD_MIGRATED: 'IS_FILES_FIELD_MIGRATED' as const,
   IS_CORE_PICTURE_MIGRATED: 'IS_CORE_PICTURE_MIGRATED' as const,
   IS_OTHER_FILE_MIGRATED: 'IS_OTHER_FILE_MIGRATED' as const,
...
export const enumCommandMenuItemAvailabilityType = {
   ...
   SINGLE_RECORD: 'SINGLE_RECORD' as const,
   BULK_RECORDS: 'BULK_RECORDS' as const
}
