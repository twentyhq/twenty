...
export const importOpportunityFromTftSchema = z.preprocess(
	dropNulls,
	z.object({
...
export function mapToOpportunityCreateInput(
	...
	if (tftOpportunityId !== undefined)
		opportunityData.tftOpportunityId = tftOpportunityId;
	...
	if (isNonEmptyString(input.closeDate))
		opportunityData.closeDate = input.closeDate;
