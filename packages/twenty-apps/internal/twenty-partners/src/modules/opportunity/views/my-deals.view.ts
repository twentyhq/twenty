...
export default defineView({
	...
	fields: [
		{
			universalIdentifier: "5c936e54-687a-4bf4-a995-1d90c71b337e",
		...
		{
			universalIdentifier: "c7d850e1-5d95-4097-93a3-02142654a470",
			fieldMetadataUniversalIdentifier:
				OPPORTUNITY_STAGE_FIELD_UNIVERSAL_IDENTIFIER,
			position: 1,
			isVisible: true,
			size: 160,
		},
		{
			universalIdentifier: "fee39824-5859-433e-8f08-c4b9edecca0a",
