...
export default defineObject({
	...
	description:
		"Marketing content involving a partner: quotes, case studies, logos",
	icon: "IconQuote",
	isSearchable: true,
	...
	fields: [
		...
		},
		{
			...
			options: [
				{
					id: "07f85e5b-0d70-416b-9884-256e469ed532",
				...
				{
					id: "108b2358-d04d-4fdc-83df-a5978d39f66f",
					value: "CASE_STUDY",
					label: "Case study",
					position: 1,
					color: "green",
				...
				{
					id: "eb45f371-f93c-4c45-9c8a-f29e1a58b7e4",
					value: "PARTNER_QUOTE",
					label: "Partner quote",
					position: 2,
					color: "orange",
				...
				{
					id: "3356c8a0-41cd-47c3-a293-5862138abc1a",
					value: "LOGO",
					label: "Logo",
					position: 3,
					color: "purple",
		...
		},
		{
			...
			options: [
				{
					id: "5d41450b-8efb-41e8-81b7-b534429ec1b4",
					value: "WIP",
					label: "WIP",
					position: 0,
					color: "gray",
				...
				{
					id: "6611ae9a-4253-4638-9c47-d8bf2ec54368",
				...
				{
					id: "ae3d91e4-96ea-4687-b71f-d2d80088f28a",
					value: "UNDER_CUSTOMER_PARTNER_REVIEW",
					label: "Under review",
					position: 2,
					color: "orange",
				},
				{
					id: "91fe48a3-7950-4cdd-8c52-8d9b2cc03f0b",
					value: "APPROVED",
					label: "Approved",
					position: 3,
					color: "green",
				...
				{
					id: "fa640b71-862e-4c64-80fa-37ab8b50d254",
					value: "REJECTED",
					label: "Rejected",
					position: 4,
					color: "red",
