...
const chipPublished: CSSProperties = {
	...chipBase,
	...
	<div style={cardStyle}>
		...
		>
			<div style={{ minWidth: 0 }}>
				...
				{row.clientName.trim() !== "" ? (
					<div style={clientStyle}>{row.clientName}</div>
				) : null}
			</div>
			<div style={{ display: "flex", alignItems: "center", gap: 10 }}>
				<span style={row.published ? chipPublished : chipDraft}>
			...
			<div style={bodyStyle}>
				...
				<Field label="Story">
					<MarkdownEditor
						...
						onChange={(v) => onChange({ bodyMarkdown: v })}
						placeholder="Tell the story of this project…"
						ariaLabel="Case study story"
					/>
				</Field>
				<Field label="Case study link">
					<UrlInput
						value={row.caseStudyLink}
						onChange={(v) => onChange({ caseStudyLink: v })}
						placeholder="https://…"
					/>
				</Field>
