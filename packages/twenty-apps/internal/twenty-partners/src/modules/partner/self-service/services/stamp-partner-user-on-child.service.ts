...
const CHILD_ACCESSORS = {
	partnerLink: {
		read: getPartnerLinkPartnerUser,
		write: updatePartnerLinkPartnerUser,
	},
	partnerService: {
		read: getPartnerServicePartnerUser,
		write: updatePartnerServicePartnerUser,
	},
	partnerContent: {
		read: getPartnerContentPartnerUser,
		write: updatePartnerContentPartnerUser,
	},
	application: {
		read: getApplicationPartnerUser,
		write: updateApplicationPartnerUser,
	},
} as const;
