...
import { healCallRecordingsMissingRecallBot } from 'src/logic-functions/utils/heal-call-recordings-missing-recall-bot.util';
...
describe('healCallRecordingsMissingRecallBot', () => {
  ...
  it('schedules a bot and writes the id for an upcoming botless recording', async () => {
    ...
    const result = await healCallRecordingsMissingRecallBot({
