...
Two-way sync between Twenty and the [Resend](https://resend.com) email platform. The app syncs contacts, segments, templates, broadcasts, and emails.
...
In Twenty, go to **Settings > Applications > Resend** and set:
