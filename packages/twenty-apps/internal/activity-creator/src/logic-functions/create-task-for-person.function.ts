...
import { CREATE_TASK_FOR_PERSON_LOGIC_FUNCTION_UNIVERSAL_IDENTIFIER } from 'src/constants/universal-identifiers';
import { buildCreateTaskConfig } from 'src/logic-functions/utils/build-create-task-config';

export default defineLogicFunction(
  buildCreateTaskConfig({
    universalIdentifier:
      CREATE_TASK_FOR_PERSON_LOGIC_FUNCTION_UNIVERSAL_IDENTIFIER,
