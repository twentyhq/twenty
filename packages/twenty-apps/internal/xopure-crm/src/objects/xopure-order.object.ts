  ...
  fields: [
    ...
    { universalIdentifier: 'a115cfd0-b655-4070-bc39-eacb67f6a2ce', type: FieldType.TEXT, name: 'buyerType', label: 'Buyer type', icon: 'IconUser' },
    {
      ...
      options: [
        ...
        { id: 'c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', value: 'SYNCED', label: 'Synced', position: 2, color: 'turquoise' },
        { id: 'd4e5f6a7-b8c9-4d0e-1f2a-3b4c5d6e7f80', value: 'SHIPPED', label: 'Shipped', position: 3, color: 'green' },
      ],
    },
    { universalIdentifier: 'e5f6a7b8-c9d0-4e1f-2a3b-4c5d6e7f8091', type: FieldType.TEXT, name: 'paymentMethodCode', label: 'Payment method code', icon: 'IconCreditCard' },
    { universalIdentifier: 'f6a7b8c9-d0e1-4f2a-3b4c-5d6e7f80912a', type: FieldType.BOOLEAN, name: 'manualReviewRequired', label: 'Manual review required', icon: 'IconAlertCircle', defaultValue: false },
    { universalIdentifier: 'a7b8c9d0-e1f2-4a3b-4c5d-6e7f80912a3b', type: FieldType.TEXT, name: 'trackingNumber', label: 'Tracking number', icon: 'IconTruck' },
