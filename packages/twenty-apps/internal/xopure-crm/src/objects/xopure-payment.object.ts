...
export default defineObject({
  ...
  fields: [
    ...
    { universalIdentifier: '4ac9fe75-07d4-49df-9357-0a88838b0ba0', type: FieldType.TEXT, name: 'provider', label: 'Provider', icon: 'IconBuilding' },
    { universalIdentifier: '69158b5f-67b6-4af6-a598-4bbe567c423d', type: FieldType.TEXT, name: 'rail', label: 'Rail', icon: 'IconRoute' },
    { universalIdentifier: '4a6aa409-faa7-4d36-bf8e-d6ee9b8f266b', type: FieldType.TEXT, name: 'methodCode', label: 'Method code', icon: 'IconBarcode' },
    { universalIdentifier: 'cf73a32c-47aa-402f-bd29-05130cf88e3d', type: FieldType.NUMBER, name: 'amountCents', label: 'Amount cents', icon: 'IconCurrencyDollar', defaultValue: 0 },
    { universalIdentifier: '763d7589-6d0f-46b0-be37-a6d5d42b90ba', type: FieldType.TEXT, name: 'currencyCode', label: 'Currency code', icon: 'IconCoin' },
    {
    ...
    { universalIdentifier: '46fbb9a7-b609-4f16-974c-2e00f8101acb', type: FieldType.TEXT, name: 'providerPaymentId', label: 'Provider payment ID', icon: 'IconHash' },
    { universalIdentifier: '0abd4d2b-f57b-485a-b46b-4363f7b489c0', type: FieldType.NUMBER, name: 'refundCents', label: 'Refund cents', icon: 'IconCurrencyDollar', defaultValue: 0 },
    { universalIdentifier: '04b53871-1ca6-4d7e-a36c-4dc98f3a873e', type: FieldType.TEXT, name: 'description', label: 'Description', icon: 'IconNotes' },
