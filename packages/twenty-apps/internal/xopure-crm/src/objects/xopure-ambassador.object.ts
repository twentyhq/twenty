...
export default defineObject({
  ...
  fields: [
    ...
    { universalIdentifier: 'db64cf04-0e15-4be2-a6dd-7e2d38af2c19', type: FieldType.NUMBER, name: 'personalVolume', label: 'Personal volume', icon: 'IconChartBar', defaultValue: 0 },
    ...
    { universalIdentifier: 'aa16f6fc-6cb5-4bd1-98b3-57d0343ac891', type: FieldType.NUMBER, name: 'teamVolume', label: 'Team volume', icon: 'IconChartBar', defaultValue: 0 },
    ...
    { universalIdentifier: '4ef453e7-3cb0-4be4-9d0f-e328e6c447ee', type: FieldType.NUMBER, name: 'heldCommission', label: 'Held commission', icon: 'IconCurrencyDollar', defaultValue: 0 },
    ...
    { universalIdentifier: '4ca9ee14-bc1d-4ff2-bcf2-e2885ce8f539', type: FieldType.NUMBER, name: 'payableCommission', label: 'Payable commission', icon: 'IconCurrencyDollar', defaultValue: 0 },
    ...
    { universalIdentifier: '6ef74ce7-5573-40d1-b3a9-2b8aaec4e659', type: FieldType.NUMBER, name: 'paidCommission', label: 'Paid commission', icon: 'IconCurrencyDollar', defaultValue: 0 },
    ...
    { universalIdentifier: '0b7415a9-9616-45a0-9604-948e2ad7cbaa', type: FieldType.NUMBER, name: 'lifetimeCommission', label: 'Lifetime commission', icon: 'IconCurrencyDollar', defaultValue: 0 },
