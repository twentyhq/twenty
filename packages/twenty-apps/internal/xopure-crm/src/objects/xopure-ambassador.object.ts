...
export default defineObject({
  ...
  fields: [
    ...
    { universalIdentifier: 'c1706b1f-2e0e-4d6c-975a-c68efd8241fe', type: FieldType.TEXT, name: 'customSlug', label: 'Custom slug', icon: 'IconLink', isNullable: true, defaultValue: null },
    { universalIdentifier: '644807d8-13a9-428d-8471-aa40fdee14e3', type: FieldType.TEXT, name: 'referralUrl', label: 'Referral URL', icon: 'IconExternalLink', isNullable: true, defaultValue: null },
    { universalIdentifier: '2a29804d-9e6a-4185-9d3f-06e9403ad286', type: FieldType.TEXT, name: 'accountType', label: 'Account type', icon: 'IconTag', isNullable: true, defaultValue: null },
