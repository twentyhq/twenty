...
export const SendEmailVerificationLinkEmail = ({
  ...
  return (
    <BaseEmail width={333} locale={locale}>
      ...
      <MainText>
        <Trans id="Thanks for registering for an account on InsurOS! Before we get started, we just need to confirm that this is you. Click below to verify your email address." />
      </MainText>
      <br />
...
SendEmailVerificationLinkEmail.PreviewProps = {
  link: 'https://app.insuros.ca/verify-email/123',
  locale: 'en',
};
