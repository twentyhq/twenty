...
// A position/normal/uv buffer merge that tolerates indexed and non-indexed
// inputs (the builtin coins/arrow merge many primitives; imported models merge
// their meshes). Standalone so it doesn't depend on three's BufferGeometryUtils.
