// The four GLSL programs the live canvas renders with: a full-screen pass, a
// separable gaussian blur (glow), an image passthrough with contain/cover fit,
// and the halftone dash field itself. The exporters re-use these verbatim when
// baking a standalone component, so they live in the engine, not the exporter.
