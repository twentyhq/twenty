...
// footprint.test.ts which evals this string and compares results.
export const HALFTONE_FOOTPRINT_RUNTIME_SOURCE = `
const REFERENCE_PREVIEW_DISTANCE = ${HALFTONE_FOOTPRINT.referencePreviewDistance};
const MIN_FOOTPRINT_SCALE = ${HALFTONE_FOOTPRINT.minFootprintScale};
