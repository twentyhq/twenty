...
export function generateImageHalftoneSvg({
  ...
  const imageRect = HALFTONE_FOOTPRINT.getContainedImageRect({
    imageHeight: image.naturalHeight,
    imageWidth: image.naturalWidth,
    viewportHeight: height,
    viewportWidth: width,
    zoom: HALFTONE_FOOTPRINT.getImagePreviewZoom(previewDistance),
  });
  ...
  const footprintScale = HALFTONE_FOOTPRINT.getImageFootprintScale({
    imageHeight: image.naturalHeight,
    imageWidth: image.naturalWidth,
    previewDistance,
    viewportHeight: height,
