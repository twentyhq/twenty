...
// The mockup's rounded five-point rating star (authored glyph, ported).
export function RatingStar({ fillColor, size = 12 }: RatingStarProps) {
  return (
    <svg
      aria-hidden
      width={size}
