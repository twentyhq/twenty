...
describe('conversation-scroll', () => {
  it('should use smooth scrolling and auto when reduced motion is preferred', () => {
    const smoothElement = {
      scrollHeight: 100,
      scrollTo: jest.fn(),
      scrollTop: 0,
  ...
  it('should scroll to the bottom with native scrollTo when available', () => {
    const element = {
      scrollHeight: 240,
      scrollTo: jest.fn(),
      scrollTop: 0,
  ...
  it('should fall back to scrollTop when scrollTo is missing or unsupported', () => {
