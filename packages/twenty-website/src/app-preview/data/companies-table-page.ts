// The Companies table the mockup opens on — extracted verbatim from the
// old app-preview data (the battery A/B verifies the rendered output).
...
export const COMPANIES_TABLE_PAGE: TablePageDefinition = {
  type: 'table',
  header: {
    title: 'All Companies',
    count: 9,
  ...
  rows: [
    ...
    },
    {
      ...
      cells: {
        ...
        opportunities: {
          type: 'relation',
          items: [{ name: 'Fundraising', shortLabel: 'F', tone: 'gray' }],
        },
