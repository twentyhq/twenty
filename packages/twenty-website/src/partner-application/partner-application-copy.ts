...
export const PARTNER_APPLICATION_COPY = {
  ...
  fields: {
    ...
    twentyExperienceProofLinkHint: msg`Best proof first: a live Twenty instance URL, a public repo, or a YouTube link — we can check those directly. Loom, Drive and file links are accepted but slower to review.`,
