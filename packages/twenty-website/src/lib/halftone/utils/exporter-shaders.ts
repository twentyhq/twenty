import { GLASS_ENVIRONMENT_DATA_URL } from '@/lib/halftone/utils/glass-environment-data';
...
import type { ExportedShapeDescriptor } from '../types/exporter-types';
...
export const imagePassthroughFragmentShader = `
  precision highp float;
...
export const GEOMETRY_RUNTIME_SOURCE = String.raw`
...
export function getExportedShapeLoader(
...
export const GLASS_MATERIAL_RUNTIME_SOURCE = String.raw`
