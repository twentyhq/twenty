...
export const DATA_MODEL_ICONS = {
  ChevronExpand: IconChevronExpand,
  fields: {
    apps: IconApps,
  ...
  headers: {
    ...
    userSmall: IconUserSmall,
    usersSmall: IconUsersSmall,
  },
};
