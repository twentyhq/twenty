...
type TerminalSendButtonFingerHintProps = {
  position: TerminalSendButtonHintPosition | null;
  ready: boolean;
  visible: boolean;
};

export const TerminalSendButtonFingerHint = ({
  position,
  ready,
  visible,
}: TerminalSendButtonFingerHintProps) => {
  if (!visible || position === null || typeof document === 'undefined') {
    return null;
  }
