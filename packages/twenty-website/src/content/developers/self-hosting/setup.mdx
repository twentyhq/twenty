...
4. (Optional) If your Entra app registration [account type](https://learn.microsoft.com/en-us/entra/identity-platform/single-and-multi-tenant-apps) is single-tenant, set this variable:
