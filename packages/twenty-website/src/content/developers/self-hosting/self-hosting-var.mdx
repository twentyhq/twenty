...
<ArticleTable options={[
    ...
    ['LLM_PROMPT_TEMPLATE_DRIVER', 'langfuse', "Sets where LLM prompt templates are loaded from. Can be 'langfuse', defaults to 'file'."],
    ['LANGFUSE_SECRET_KEY', 'sk-lf-abcdabcd-abcd...', "Langfuse secret key"],
    ['LANGFUSE_PUBLIC_KEY', 'pk-lf-abcdabcd-abcd...', "Langfuse public key"],
    ['PROMPT_TEMPLATE_NAME_ASK_AI', 'ask-ai-development', "The name of the Langfuse prompt for the Ask AI feature"]
]}></ArticleTable>
