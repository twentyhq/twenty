...
<ArticleTable options={[
  ['CODE_EXECUTOR_TYPE', 'local', "Custom code engine driver: 'local' or 'lambda'"],
  ['CODE_EXECUTOR_LAMBDA_REGION', '', 'Lambda Region'],
  ['CODE_EXECUTOR_LAMBDA_ROLE', '', 'Lambda Role'],
  ['CODE_EXECUTOR_LAMBDA_ACCESS_KEY_ID', '', 'Optional depending on the authentication method'],
  ['CODE_EXECUTOR_LAMBDA_SECRET_ACCESS_KEY', '', 'Optional depending on the authentication method'],
]}></ArticleTable>
