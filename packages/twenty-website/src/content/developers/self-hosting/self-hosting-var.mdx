...
<ArticleTable options={[
    ...
    ['AUTH_GOOGLE_CALLBACK_URL', 'https://[domain]/auth/google/redirect', 'Google auth callback URL'],
    ...
    ['AUTH_MICROSOFT_CALLBACK_URL', 'https://[domain]/auth/microsoft/redirect', 'Microsoft auth callback URL'],
