...
<ArticleTable options={[
    ...
    ['AUTH_OIDC_ENABLED', 'false', 'Enable OIDC SSO login'],
    ['AUTH_OIDC_ISSUER', '', 'OIDC issuer url'],
    ['AUTH_OIDC_CLIENT_ID', '', 'OIDC client ID'],
    ['AUTH_OIDC_CLIENT_SECRET', '', 'OIDC client secret'],
    ['AUTH_OIDC_TOKEN_URL', '', 'OIDC token url'],
    ['AUTH_OIDC_USERINFO_URL', '', 'OIDC userinfo url'],
    ['AUTH_OIDC_SCOPE', '', 'OIDC scopes'],
    ['AUTH_OIDC_CALLBACK_URL', '', 'OIDC auth callback'],
