...
While installing twenty for the first time you might wanna change the default database password.
...
⚠️ WARNING Following steps will remove all your database data ! ⚠️
