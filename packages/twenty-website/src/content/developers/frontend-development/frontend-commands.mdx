...
```bash
yarn nx graphql:generate twenty-front
```
...
```bash
yarn nx test twenty-front# run jest tests
yarn nx storybook:serve:dev twenty-front# run storybook
yarn nx storybook:test twenty-front# run tests # (needs yarn storybook:serve:dev to be running)
yarn nx storybook:coverage twenty-front # (needs yarn storybook:serve:dev to be running)
```
