...
Sync Twenty with 3000+ apps using <UserGuideLink href="https://zapier.com/apps/twenty/integrations">Zapier</UserGuideLink>, and automate your work. Here's how you can connect Twenty to Zapier:
...
4. Select Twenty as the action. An action is the event performed whenever an application triggers an automation. <UserGuideLink href="https://zapier.com/how-it-works">Learn more about triggers and actions in Zapier.</UserGuideLink>
...
<UserGuideEditContent articleTitle="integrations.mdx"></UserGuideEditContent>