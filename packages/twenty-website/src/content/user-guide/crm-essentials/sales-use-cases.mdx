...
Visit our [Workflows section](/user-guide/section/workflows/getting-started-workflows) to learn how to build these automations step by step. For detailed examples, see our [Workflow Use Cases](/user-guide/section/workflows/workflow-use-cases) and [External Tool Integration](/user-guide/section/workflows/external-tool-integration) guides.
