...
Encounter an issue? <UserGuideLink href="https://github.com/twentyhq/twenty/issues/new">Create an issue</UserGuideLink> on GitHub, providing as much detail as possible.

<img src="/images/user-guide/github/new-issue.png" style={{width:'100%'}}/>

### Suggesting Features

What improvements would you like to see on Twenty? No matter your technical know-how, you can join <UserGuideLink href="https://github.com/twentyhq/twenty/discussions">the conversation here</UserGuideLink>.
...
Remember to adhere to Twenty's <UserGuideLink href="https://github.com/twentyhq/twenty/blob/main/.github/CODE_OF_CONDUCT.md">Code of Conduct</UserGuideLink> throughout your contribution process.
...
<UserGuideEditContent articleTitle="github.mdx"></UserGuideEditContent>