...
There is rarely one only way to build a data model. Below are a few tips to help you build yours.
...
- Why can't I see the Data Model under the Settings?
  - Reach out to your workspace admin, data model is usually only accessible by admins.
