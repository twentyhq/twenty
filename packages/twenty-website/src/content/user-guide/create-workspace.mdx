...
## Step 1: Registration
1. Navigate to <UserGuideLink href="https://app.twenty.com/sign-up">Twenty Sign Up</UserGuideLink>.
...
## Support
For queries or help, connect with the dedicated support team at [contact@twenty.com](mailto:contact@twenty.com) or send a message on <UserGuideLink href="https://discord.gg/cx5n4Jzs57">Discord</UserGuideLink>

<UserGuideEditContent articleTitle="create-workspace.mdx"></UserGuideEditContent>