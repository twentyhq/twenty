...
You'll see a search bar at the top of your sidebar to quickly find records across your workspace. You can also bring up the command bar with the ```Cmd/Ctrl + K``` shortcut to navigate through your workspace and find people, companies, notes, and more.

The command bar also supports shortcuts for navigation and quick actions.
...
If you're new to Views, read <ArticleLink href="https://twenty.com/user-guide/section/core-crm-features/views-sort-filter">this article</ArticleLink> to learn how to create and customize them.
