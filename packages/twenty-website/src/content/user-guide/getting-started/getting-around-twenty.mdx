...
- Switch between your several workspaces using the dropdown menu on the very top
- Chose between the light and dark themes
- Use the search bar (press / to open it instantly)
- Open the Settings section
- Have a direct access to your Favourites views. Favorites are unique for each user.
...
## The command menu
The command menu gives you quick access to most actions in Twenty.
Open it via the three dots in the top right, or press Cmd + K (Mac) / Ctrl + K (Windows).
...
## Views
Every object (like Opportunities or People) supports multiple views.

Use the dropdown in the top left of the main layout to switch between them. For example:
- Use a Kanban view to track deals by stage
- Use Group By view to 
