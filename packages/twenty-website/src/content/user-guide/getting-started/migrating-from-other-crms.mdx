...
Use CSV import via Command Menu (Cmd+K). See our [data import guide](/user-guide/section/integrations/import-export-data) for detailed instructions.
...
Read our [import-export data guide](/user-guide/section/integrations/import-export-data) for detailed instructions on creating relationships during CSV import.
