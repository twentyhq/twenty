...
Twenty now supports multiple email addresses for each contact, including a primary email and additional emails.
When syncing emails, calendar events, they are linked even if they are from additional emails.
