...
2. Click “Untitled” and enter your name workflow on the upper left 
...
Runs are saved executions of active workflows. They provide details like status, output, author, and last updates. View past runs from the **Runs** field or open the **Workflow Runs** view for ore specific insights that’ll be useful for monitoring and troubleshooting.
...
Workflows has three statuses: **Draft**, **Activated**, and **Deactivated**.
