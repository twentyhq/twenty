...
3. Go to the **Settings** tab, then cick **Delete Role**
...
You can customize what each role can see or do across objects, settings, and general application acitons.
...
- Granting full editng rights to all workspace settings by toggling **Settings All Access**, or 
