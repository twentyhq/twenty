...
yarn twenty remote add --api-url http://localhost:2020 --as local  # Authenticate via OAuth
...
- Use `yarn twenty remote add` to authenticate with your Twenty workspace via OAuth.
...
- Auth not working: make sure you're logged in to Twenty in the browser first, then run `yarn twenty remote add`.
