...
describe('ThemeProvider', () => {
  ...
  it('should write the scale onto the root element and recompute', () => {
    setIconSizeMd(DESKTOP_ICON_SIZE_MD);
    stubMatchMedia();
    ...
    setIconSizeMd(MOBILE_ICON_SIZE_MD);
    rerender(
      <ThemeProvider colorScheme="light" scale={1.25}>
        <IconSizeProbe />
      </ThemeProvider>,
    );
  ...
  it('should leave the scale alone when no scale is passed', () => {
    setIconSizeMd(DESKTOP_ICON_SIZE_MD);
    stubMatchMedia();
