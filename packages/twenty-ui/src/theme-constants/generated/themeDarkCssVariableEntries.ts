...
export const THEME_DARK_CSS_VARIABLE_ENTRIES: [string, string][] = [
  ...
  [
    '--t-background-primary-inverted-hover',
    'color(display-p3 0.702 0.702 0.702)',
  ],
  [
    '--t-blur-light',
    'blur(6px) saturate(200%) contrast(100%) brightness(130%)',
  ],
  [
    '--t-blur-medium',
    'blur(12px) saturate(200%) contrast(100%) brightness(130%)',
  ],
  [
    '--t-blur-strong',
    'blur(20px) saturate(200%) contrast(100%) brightness(130%)',
  ],
  ...
  [
    '--t-border-color-secondary-inverted',
    'color(display-p3 0.702 0.702 0.702)',
  ],
