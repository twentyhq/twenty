      ...
      case 'primary':
        switch (accent) {
          ...
          case 'blue':
            return `
              background: ${
                !inverted ? theme.color.blue : theme.background.primary
              };
              border-color: ${
                !inverted
                  ? focus
          ...
          case 'danger':
            return `
              background: ${
                !inverted ? theme.color.red : theme.background.primary
              };
              border-color: ${
                !inverted
                  ? focus
        ...
        switch (accent) {
          ...
          case 'danger':
            return `
              ...
              color: ${
                !inverted ? theme.font.color.danger : theme.font.color.inverted
              };
              &:hover {
                background: ${
                  !inverted
