...
import { MenuItemAvatar } from '@ui/components/navigation/MenuItemAvatar/MenuItemAvatar';
import { MenuItemDraggable } from '@ui/components/navigation/MenuItemDraggable/MenuItemDraggable';
