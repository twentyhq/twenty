import { type ColorLabels } from '@ui/components/MenuItem/types/ColorLabels';
import {
...
import { DEFAULT_COLOR_LABELS } from '@ui/components/MenuItem/constants/DefaultColorLabels';
