import { TINTED_ICON_TILE_COLOR_SHADES } from '@ui/components/TintedIconTile/internal/constants/tintedIconTileColorShades.constant';
import { getColorFromTheme } from '@ui/components/TintedIconTile/internal/utils/getColorFromTheme';
