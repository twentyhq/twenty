...
import { FloatingButton } from '@ui/components/FloatingButton/FloatingButton';
import { type FloatingButtonSize } from '@ui/components/FloatingButton/types/FloatingButtonSize';
