...
import { JsonTree } from '@ui/components/JsonTree/JsonTree';
import { isTwoFirstDepths } from '@ui/components/JsonTree/internal/utils/isTwoFirstDepths';
...
export const GroupedRoots: Story = {
  parameters: { a11y: A11Y_DEFER_COLOR_CONTRAST },
  args: {
    entries: [
      { id: 'first-step', label: 'Find company', value: { name: 'Acme' } },
