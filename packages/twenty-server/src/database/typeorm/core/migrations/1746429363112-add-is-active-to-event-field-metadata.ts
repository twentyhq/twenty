...
export class AddIsActiveToEventFieldMetadata1746429363112
  implements MigrationInterface
{
  name = 'AddIsActiveToEventFieldMetadata1746429363112';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "core"."eventFieldMetadata_fieldtype_enum" AS ENUM('string', 'number', 'boolean', 'object')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "core"."eventFieldMetadata" DROP CONSTRAINT "FK_d4bdc96669d719468943da6331d"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "core"."eventFieldMetadata_fieldtype_enum"`,
    );
