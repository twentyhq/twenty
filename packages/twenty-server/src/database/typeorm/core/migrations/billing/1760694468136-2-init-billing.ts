...
export class InitBilling1760694468136 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    const billingCustomerTableExists = await queryRunner.hasTable(
      'core.billingCustomer',
    );

    if (billingCustomerTableExists) {
    ...
    await queryRunner.query(
      `CREATE TYPE "core"."billingPrice_interval_enum" AS ENUM('month', 'year')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "core"."billingSubscription_interval_enum" AS ENUM('month', 'year')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "core"."billingSubscriptionItem" ADD CONSTRAINT "FK_e576e45ea2b21aef8271826622e" FOREIGN KEY ("stripeProductId") REFERENCES "core"."billingProduct"("stripeProductId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "core"."billingSubscriptionItem" DROP CONSTRAINT "FK_e576e45ea2b21aef8271826622e"`,
    );
    await queryRunner.query(
