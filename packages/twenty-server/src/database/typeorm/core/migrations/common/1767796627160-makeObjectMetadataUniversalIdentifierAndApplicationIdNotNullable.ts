...
export class MakeObjectMetadataUniversalIdentifierAndApplicationIdNotNullable1767796627160
  implements MigrationInterface
{
  name =
    'MakeObjectMetadataUniversalIdentifierAndApplicationIdNotNullable1767796627160';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      ...
      try {
        ...
        console.error(
          'Failed to rollback to savepoint in MakeObjectMetadataUniversalIdentifierAndApplicationIdNotNullable1767796627160',
          rollbackError,
        );
        throw rollbackError;
      }
      ...
      // eslint-disable-next-line no-console
      console.error(
        'Swallowing MakeObjectMetadataUniversalIdentifierAndApplicationIdNotNullable1767796627160 error',
        e,
      );
    }
  }
