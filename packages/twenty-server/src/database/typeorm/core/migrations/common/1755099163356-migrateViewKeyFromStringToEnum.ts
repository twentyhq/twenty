...
export class MigrateViewKeyFromStringToEnum1755099163356
  implements MigrationInterface
{
  name = 'MigrateViewKeyFromStringToEnum1755099163356';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "core"."view" ADD "key" "core"."view_key_enum" DEFAULT 'INDEX'`,
    );
  }
