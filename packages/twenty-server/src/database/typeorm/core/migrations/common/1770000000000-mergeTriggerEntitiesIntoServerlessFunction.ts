...
export class MergeTriggerEntitiesIntoServerlessFunction1770000000000
  implements MigrationInterface
{
  name = 'MergeTriggerEntitiesIntoServerlessFunction1770000000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Add new trigger settings columns to serverlessFunction table
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Remove trigger settings columns from serverlessFunction table
    await queryRunner.query(
    ...
    // Recreate old trigger tables (simplified structure for rollback)
    await queryRunner.query(`
