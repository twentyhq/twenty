...
export class AddWorkspaceIdToIndirectEntities1775755334136
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "core"."twoFactorAuthenticationMethod" ADD "workspaceId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."applicationVariable" ADD "workspaceId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."indexFieldMetadata" ADD "workspaceId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."agentMessagePart" ADD "workspaceId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."agentChatThread" ADD "workspaceId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."agentMessage" ADD "workspaceId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."agentTurnEvaluation" ADD "workspaceId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."agentTurn" ADD "workspaceId" uuid`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "core"."agentTurn" DROP COLUMN "workspaceId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."agentTurnEvaluation" DROP COLUMN "workspaceId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."agentMessage" DROP COLUMN "workspaceId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."agentChatThread" DROP COLUMN "workspaceId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."agentMessagePart" DROP COLUMN "workspaceId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."indexFieldMetadata" DROP COLUMN "workspaceId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."applicationVariable" DROP COLUMN "workspaceId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."twoFactorAuthenticationMethod" DROP COLUMN "workspaceId"`,
    );
  }
}
