...
export class AddWorkspaceTrustedDomain1739955345446
  implements MigrationInterface
{
  name = 'AddWorkspaceTrustedDomain1739955345446';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "core"."workspaceTrustedDomain" ADD CONSTRAINT "FK_130f179c3608a3d8cde9d355d2e" FOREIGN KEY ("workspaceId") REFERENCES "core"."workspace"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "core"."workspaceTrustedDomain" DROP CONSTRAINT "FK_130f179c3608a3d8cde9d355d2e"`,
    );
