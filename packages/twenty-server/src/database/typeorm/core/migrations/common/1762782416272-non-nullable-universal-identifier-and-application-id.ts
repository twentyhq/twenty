  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    try {
      ...
      console.error(
        `Swallowing NonNullableUniversalIdentifierAndApplicationId1762782416272 error: ${error.message}.  upgrade command will handle fallback`,
      );
    }
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_b86af4ea24cae518dee8eae996" ON "core"."viewField" ("universalIdentifier", "workspaceId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "core"."view" ALTER COLUMN "universalIdentifier" DROP NOT NULL`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_552aa6908966e980099b3e5ebf" ON "core"."view" ("universalIdentifier", "workspaceId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_a44e3b03f0eca32d0504d5ef73" ON "core"."viewGroup" ("universalIdentifier", "workspaceId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_cd4588bfc9ad73345b3953a039" ON "core"."viewFilter" ("universalIdentifier", "workspaceId") `,
    );
    await queryRunner.query(
