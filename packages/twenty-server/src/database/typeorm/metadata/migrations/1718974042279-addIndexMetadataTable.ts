...
export class AddIndexMetadataTable1718974042279 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "metadata"."indexMetadata" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "expression" character varying, "workspaceId" character varying, "objectMetadataId" uuid NOT NULL, CONSTRAINT "PK_f73bb3c3678aee204e341f0ca4e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "metadata"."indexFieldMetadata" DROP CONSTRAINT "FK_be0950612a54b58c72bd62d629e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "metadata"."indexFieldMetadata" DROP CONSTRAINT "FK_b20192c432612eb710801dd5664"`,
    );
    await queryRunner.query(
      `ALTER TABLE "metadata"."indexMetadata" DROP CONSTRAINT "FK_051487e9b745cb175950130b63f"`,
    );
