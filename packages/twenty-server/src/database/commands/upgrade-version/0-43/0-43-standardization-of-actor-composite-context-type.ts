...
/**
 * Important note: This command is duplicated with the `upgrade-0.42:standardization-of-actor-composite-context-type`
 * Because we needed to release a command along a patch in 0.42.7
 * As we've already published the 0.42 minor, self hosting users might never ran the added in 0.42.7 command
 * Explaining why it's duplicated here
 */
@Command({
  name: 'upgrade-0.43:standardization-of-actor-composite-context-type',
  description: 'Add context to actor composite type.',
})
export class StandardizationOfActorCompositeContextTypeCommand_043 extends ActiveWorkspacesCommandRunner {
