...
import { MigrateCanvasRecordPageTabsToVerticalListCommand } from 'src/database/commands/upgrade-version-command/2-23/2-23-workspace-command-1784600000000-migrate-canvas-record-page-tabs-to-vertical-list.command';
