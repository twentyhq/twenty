...
@RegisteredInstanceCommand('2.20.0', 1783515520392)
export class AddMessagingSettingsAndAppMessageChannelTypeFastInstanceCommand implements FastInstanceCommand {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE "core"."connectionProvider" ADD "messagingSettings" jsonb',
    );
    await queryRunner.query(
      'ALTER TYPE "core"."messageChannel_type_enum" RENAME TO "messageChannel_type_enum_old"',
    );
    await queryRunner.query(
      "CREATE TYPE \"core\".\"messageChannel_type_enum\" AS ENUM('EMAIL', 'SMS', 'EMAIL_GROUP', 'APP')",
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "core"."connectionProvider" DROP COLUMN "messagingSettings"',
    );
  }
}
