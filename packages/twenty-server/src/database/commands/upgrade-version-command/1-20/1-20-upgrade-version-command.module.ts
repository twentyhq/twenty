...
import { MigrateStandardViewNamesCommand } from 'src/database/commands/upgrade-version-command/1-20/1-20-migrate-standard-view-names.command';
...
@Module({
  ...
  providers: [
    ...
    MigrateStandardViewNamesCommand,
