...
import { SyncShortLinkObjectCommand } from 'src/database/commands/upgrade-version-command/2-43/2-43-workspace-command-1790333284553-sync-short-link-object.command';
