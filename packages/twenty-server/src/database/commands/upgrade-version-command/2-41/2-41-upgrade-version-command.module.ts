...
import { MigrateStandardChildObjectsToInheritedAccessCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-workspace-command-1789343528002-migrate-standard-child-objects-to-inherited-access.command';
