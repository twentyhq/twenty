...
import { NormalizeCompositeFieldDefaultsCommand } from 'src/database/commands/upgrade-version-command/2-4/2-4-workspace-command-1778000001000-normalize-composite-field-defaults.command';
