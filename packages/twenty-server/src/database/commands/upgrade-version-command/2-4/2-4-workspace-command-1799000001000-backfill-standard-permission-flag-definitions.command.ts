...
@Command({
  name: 'upgrade:2-4:backfill-standard-permission-flag-definitions',
  description:
    'Backfill standard permission flag definitions for existing workspaces created before flag definitions were syncable',
})
export class BackfillStandardPermissionFlagDefinitionsCommand extends ActiveOrSuspendedWorkspaceCommandRunner {
  constructor(
  ...
  override async runOnWorkspace({
    ...
    const standardDefinitions = Object.values(
      standardAllFlatEntityMaps.flatPermissionFlagDefinitionMaps
