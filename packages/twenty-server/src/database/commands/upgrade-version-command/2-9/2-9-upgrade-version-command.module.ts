...
import { FixDefaultRelationFieldLabelsIconsCommand } from 'src/database/commands/upgrade-version-command/2-9/2-9-workspace-command-1799000040000-fix-default-relation-field-labels-icons.command';
...
@Module({
  ...
  providers: [
    ...
    FixDefaultRelationFieldLabelsIconsCommand,
  ],
})
