...
export class UniqueEmailingDomainGloballyFastInstanceCommand
  implements FastInstanceCommand
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "core"."emailingDomain" ADD CONSTRAINT "UQ_c08c841c3a94aecaa58f5c9ce0d" UNIQUE ("domain")',
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE "core"."emailingDomain" DROP CONSTRAINT "UQ_c08c841c3a94aecaa58f5c9ce0d"',
    );
    await queryRunner.query(
