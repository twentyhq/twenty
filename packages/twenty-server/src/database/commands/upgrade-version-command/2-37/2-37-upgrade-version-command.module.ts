...
import { NormalizeWorkflowRecordCrudRichTextFieldsCommand } from 'src/database/commands/upgrade-version-command/2-37/2-37-workspace-command-1787905762209-normalize-workflow-record-crud-rich-text-fields.command';
