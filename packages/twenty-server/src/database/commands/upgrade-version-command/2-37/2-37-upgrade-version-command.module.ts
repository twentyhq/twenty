...
import { NormalizeWorkflowRecordCrudRichTextFieldsCommand } from 'src/database/commands/upgrade-version-command/2-37/2-37-workspace-command-1787840070507-normalize-workflow-record-crud-rich-text-fields.command';
