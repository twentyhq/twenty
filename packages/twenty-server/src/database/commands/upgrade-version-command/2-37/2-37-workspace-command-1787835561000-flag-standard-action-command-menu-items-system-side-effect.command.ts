...
import { invalidateCommandMenuItemReownCache } from 'src/database/commands/upgrade-version-command/2-37/utils/invalidate-command-menu-item-reown-cache.util';
...
@RegisteredWorkspaceCommand('2.37.0', 1787835561000)
@Command({
  name: 'upgrade:2-37:flag-standard-action-command-menu-items-system-side-effect',
  description:
