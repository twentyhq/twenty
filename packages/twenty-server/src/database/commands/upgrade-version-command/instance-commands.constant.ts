...
import { AddAgentChatThreadParticipantsFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789750766488-add-agent-chat-thread-participants';
import { BackfillAgentChatThreadParticipantsSlowInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-slow-1789750766489-backfill-agent-chat-thread-participants';
import { AddAgentChatChannelsFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789750766490-add-agent-chat-channels';
import { AddAgentChatChannelRolesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789750766491-add-agent-chat-channel-roles';
import { AddAgentChatThreadWorkflowRunFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789750766492-add-agent-chat-thread-workflow-run';
import { AddAgentChatThreadInboxStateFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789750766493-add-agent-chat-thread-inbox-state';
import { AddAgentChatThreadReadsFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789750766494-add-agent-chat-thread-reads';
...
export const INSTANCE_COMMANDS = [
  ...
  AddAgentChatThreadInboxStateFastInstanceCommand,
  AddAgentChatThreadReadsFastInstanceCommand,
];
