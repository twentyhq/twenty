...
import { RenamePeopleDataLabsAppApiKeyVariableSlowInstanceCommand } from 'src/database/commands/upgrade-version-command/2-28/2-28-instance-command-slow-1785836761026-rename-people-data-labs-app-api-key-variable';
...
export const INSTANCE_COMMANDS = [
  ...
  RenamePeopleDataLabsAppApiKeyVariableSlowInstanceCommand,
];
