...
import { AddManifestFileIdToApplicationRegistrationFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-20/2-20-instance-command-fast-1783412175009-add-manifest-file-id-to-application-registration';
import { BackfillManifestFileIdOnApplicationRegistrationSlowInstanceCommand } from 'src/database/commands/upgrade-version-command/2-20/2-20-instance-command-slow-1783412175010-backfill-manifest-file-id-on-application-registration';
