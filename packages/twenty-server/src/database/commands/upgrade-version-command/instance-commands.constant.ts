...
import { CreateInboxTablesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789344039566-create-inbox-tables';
