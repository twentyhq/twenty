...
import { CreateInboxTablesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789565100000-create-inbox-tables';
import { AddMessageChannelDefaultInboxQueueFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789565160000-add-message-channel-default-inbox-queue';
