...
import { CreateJwtPublicKeyTableFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-5/2-5-instance-command-fast-1778550000000-create-jwt-public-key-table';
...
export const INSTANCE_COMMANDS = [
  ...
  CreateJwtPublicKeyTableFastInstanceCommand,
