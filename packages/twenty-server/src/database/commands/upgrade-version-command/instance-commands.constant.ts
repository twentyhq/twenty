...
import { AddReadabilityParentFieldsToObjectMetadataFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789140100000-add-readability-parent-fields-to-object-metadata';
import { AddOwnerFieldToObjectMetadataFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789140400000-add-owner-field-to-object-metadata';
import { AddSharingRuleTableFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789140600000-add-sharing-rule-table';
import { AddSharingRuleParentToRowLevelPermissionPredicateFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789140600001-add-sharing-rule-parent-to-row-level-permission-predicate';
