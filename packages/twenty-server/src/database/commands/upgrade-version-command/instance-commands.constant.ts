...
import { AddIsVettedToApplicationRegistrationFastInstanceCommand } from './2-20/2-20-instance-command-fast-1783520000000-add-is-vetted-to-application-registration';
import { BackfillIsVettedOnApplicationRegistrationSlowInstanceCommand } from './2-20/2-20-instance-command-slow-1783520000001-backfill-is-vetted-on-application-registration';
...
export const INSTANCE_COMMANDS = [
  ...
  AddIsVettedToApplicationRegistrationFastInstanceCommand,
  BackfillIsVettedOnApplicationRegistrationSlowInstanceCommand,
];
