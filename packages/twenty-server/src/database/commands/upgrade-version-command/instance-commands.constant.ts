...
import { AddConnectedAccountWebhookSubscriptionFastInstanceCommand } from './2-15/2-15-instance-command-fast-1782000000000-add-connected-account-webhook-subscription';
...
export const INSTANCE_COMMANDS = [
  ...
  AddConnectedAccountWebhookSubscriptionFastInstanceCommand,
];
