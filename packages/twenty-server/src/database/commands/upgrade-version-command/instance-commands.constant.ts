...
import { AddPayloadToCommandMenuItemSlowInstanceCommand } from 'src/database/commands/upgrade-version-command/1-21/1-21-instance-command-slow-1775129635528-add-payload-to-command-menu-item';
...
export const INSTANCE_COMMANDS = [
  ...
  AddPayloadToCommandMenuItemSlowInstanceCommand,
