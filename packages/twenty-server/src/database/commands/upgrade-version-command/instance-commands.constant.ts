...
import { AddCategoryAndPositionToApplicationVariablesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-21/2-21-instance-command-fast-1783946877150-add-category-and-position-to-application-variables';
