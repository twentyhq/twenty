...
import { CreateApplicationRegistrationLogicFunctionCoreTableFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-15/2-15-instance-command-fast-1782143375974-create-application-registration-logic-function-core-table';
