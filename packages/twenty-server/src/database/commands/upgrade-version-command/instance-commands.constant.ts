...
import { CreateUserSessionCoreTableSlowInstanceCommand } from 'src/database/commands/upgrade-version-command/2-27/2-27-instance-command-slow-1785518325511-create-user-session-core-table';
...
export const INSTANCE_COMMANDS = [
  ...
  CreateUserSessionCoreTableSlowInstanceCommand,
];
