...
import { AddDeletedAtAndLastMessageAtToAgentChatThreadSlowInstanceCommand } from 'src/database/commands/upgrade-version-command/2-2/2-2-instance-command-slow-1777681000000-add-deleted-at-and-last-message-at-to-agent-chat-thread';
...
export const INSTANCE_COMMANDS = [
  ...
  AddDeletedAtAndLastMessageAtToAgentChatThreadSlowInstanceCommand,
];
