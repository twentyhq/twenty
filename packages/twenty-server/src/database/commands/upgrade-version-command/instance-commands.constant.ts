...
import { CreateInboxTablesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789562400000-create-inbox-tables';
import { AddMessageChannelDefaultInboxQueueFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789562460000-add-message-channel-default-inbox-queue';
