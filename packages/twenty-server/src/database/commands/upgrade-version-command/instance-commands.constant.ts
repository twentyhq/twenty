...
import { AddIsRequiredToApplicationVariableFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789300000000-add-is-required-to-application-variable';
