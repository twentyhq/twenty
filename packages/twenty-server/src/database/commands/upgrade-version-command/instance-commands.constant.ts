...
import { AddIsSystemSideEffectFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-12/2-12-instance-command-fast-1781020106371-add-is-system-side-effect';
import { BackfillIsSystemSideEffectSlowInstanceCommand } from 'src/database/commands/upgrade-version-command/2-12/2-12-instance-command-slow-1781020130204-backfill-is-system-side-effect';
...
export const INSTANCE_COMMANDS = [
  ...
  BackfillIsSystemSideEffectSlowInstanceCommand,
];
