...
import { AllowServerScopedFileFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-19/2-19-instance-command-fast-1783344513157-allow-server-scoped-file';
