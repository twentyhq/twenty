...
import { AddSyncedCategoriesToCalendarChannelFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-13/2-13-instance-command-fast-1781209671012-add-synced-categories-to-calendar-channel';
