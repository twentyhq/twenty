...
import { AddObjectMetadataValidationRulesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-43/2-43-instance-command-fast-1790372510566-add-object-metadata-validation-rules';
...
export const INSTANCE_COMMANDS = [
  ...
  AddObjectMetadataValidationRulesFastInstanceCommand,
];
