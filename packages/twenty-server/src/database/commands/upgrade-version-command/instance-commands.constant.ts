...
import { AddSharingRuleTableFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-39/2-39-instance-command-fast-1788563190094-add-sharing-rule-table';
import { AddSharingRuleParentToRowLevelPermissionPredicateFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-39/2-39-instance-command-fast-1788563190107-add-sharing-rule-parent-to-row-level-permission-predicate';
