...
import { CreateTimelineActivityRuleCoreTableFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-33/2-33-instance-command-fast-1787125000000-create-timeline-activity-rule-core-table';
...
export const INSTANCE_COMMANDS = [
  ...
  CreateTimelineActivityRuleCoreTableFastInstanceCommand,
];
