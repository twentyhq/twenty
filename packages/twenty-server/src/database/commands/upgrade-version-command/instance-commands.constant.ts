...
import { DropIsCustomFromObjectAndFieldMetadataFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-10/2-10-instance-command-fast-1780579070012-drop-is-custom-from-object-and-field-metadata';
