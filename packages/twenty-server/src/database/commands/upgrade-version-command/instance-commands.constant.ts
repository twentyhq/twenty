...
import { AddDeferredSchemaOperationTableFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789818559333-add-deferred-schema-operation-table';
...
export const INSTANCE_COMMANDS = [
  ...
  AddDeferredSchemaOperationTableFastInstanceCommand,
];
