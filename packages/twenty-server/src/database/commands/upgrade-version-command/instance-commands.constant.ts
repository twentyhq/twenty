...
import { AddCanAutoUpgradeToApplicationFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-23/2-23-instance-command-fast-1784297307235-add-can-auto-upgrade-to-application';
...
export const INSTANCE_COMMANDS = [
  ...
  AddCanAutoUpgradeToApplicationFastInstanceCommand,
];
