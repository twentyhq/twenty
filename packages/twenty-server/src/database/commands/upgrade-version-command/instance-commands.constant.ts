...
import { RenameDeferredWorkspaceMigrationActionNameFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1790252400000-rename-deferred-workspace-migration-action-name';
