...
import { AddFrontComponentSettingsTabFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789656830373-add-front-component-settings-tab';
import { BackfillFrontComponentSettingsTabSlowInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-slow-1789656830374-backfill-front-component-settings-tab';
