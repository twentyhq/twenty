...
import { AddServerCronTriggerSettingsToLogicFunctionFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-43/2-43-instance-command-fast-1790246492978-add-server-cron-trigger-settings-to-logic-function';
...
export const INSTANCE_COMMANDS = [
  ...
  AddServerCronTriggerSettingsToLogicFunctionFastInstanceCommand,
];
