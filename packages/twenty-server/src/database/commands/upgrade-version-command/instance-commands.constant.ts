...
import { AllowInstanceScopedFileFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-19/2-19-instance-command-fast-1783344513157-allow-instance-scoped-file';
...
export const INSTANCE_COMMANDS = [
  ...
  AllowInstanceScopedFileFastInstanceCommand,
];
