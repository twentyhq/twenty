...
import { AddStatusesToBillingSubscriptionIndexFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-23/2-23-instance-command-fast-1784650048045-AddStatusesToBillingSubscriptionIndex';
...
export const INSTANCE_COMMANDS = [
  ...
  AddStatusesToBillingSubscriptionIndexFastInstanceCommand,
];
