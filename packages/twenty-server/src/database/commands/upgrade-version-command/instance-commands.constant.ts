...
import { AddIsLockedToViewFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-19/2-19-instance-command-fast-1802000000000-add-is-locked-to-view';
