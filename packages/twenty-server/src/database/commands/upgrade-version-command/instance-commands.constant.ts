...
import { BackfillNonUiCreatableStandardSystemObjectsFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-13/2-13-instance-command-fast-1781277480000-backfill-non-ui-creatable-standard-system-objects';
...
export const INSTANCE_COMMANDS = [
  ...
  BackfillNonUiCreatableStandardSystemObjectsFastInstanceCommand,
];
