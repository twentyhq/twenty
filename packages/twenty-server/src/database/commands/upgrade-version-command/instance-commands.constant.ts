...
import { AddWorkspaceSchemaMigrationLockFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1790160278812-add-workspace-schema-migration-lock';
...
export const INSTANCE_COMMANDS = [
  ...
  AddWorkspaceSchemaMigrationLockFastInstanceCommand,
];
