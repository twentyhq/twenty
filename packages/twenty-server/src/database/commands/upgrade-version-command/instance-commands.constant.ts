...
import { AddIsBetweenOperandFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-13/2-13-instance-command-fast-1799000040000-add-is-between-operand';
...
export const INSTANCE_COMMANDS = [
  ...
  AddIsBetweenOperandFastInstanceCommand,
