...
import { AddStatusToFileFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-19/2-19-instance-command-fast-1782000000000-add-status-to-file';
