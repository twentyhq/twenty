...
import { AddEmailSignatureToConnectedAccountFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-8/2-8-instance-command-fast-1779499101802-add-email-signature-to-connected-account';
...
export const INSTANCE_COMMANDS = [
  ...
  AddEmailSignatureToConnectedAccountFastInstanceCommand,
];
