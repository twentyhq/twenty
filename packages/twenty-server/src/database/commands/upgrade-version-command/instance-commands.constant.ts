...
import { AddIsRequiredToApplicationVariableFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-39/2-39-instance-command-fast-1788620000000-add-is-required-to-application-variable';
...
export const INSTANCE_COMMANDS = [
  ...
  AddIsRequiredToApplicationVariableFastInstanceCommand,
];
