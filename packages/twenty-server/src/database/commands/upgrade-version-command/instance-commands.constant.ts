...
import { AddSystemNavigationMenuItemTypeFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-33/2-33-instance-command-fast-1787313900000-add-system-navigation-menu-item-type';
