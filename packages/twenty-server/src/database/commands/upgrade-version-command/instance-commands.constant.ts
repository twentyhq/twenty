...
import { AddAgentChatThreadInboxStateFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789723890000-add-agent-chat-thread-inbox-state';
