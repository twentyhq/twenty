...
import { RenameIsFeaturedToIsVettedOnApplicationRegistrationFastInstanceCommand } from './2-20/2-20-instance-command-fast-1783520000000-rename-is-featured-to-is-vetted-on-application-registration';
