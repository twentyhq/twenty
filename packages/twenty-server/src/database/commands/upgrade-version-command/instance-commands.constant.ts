...
import { AddIsDirectoryListingEnabledToWorkspaceFastInstanceCommand } from './2-19/2-19-instance-command-fast-1820000001000-add-is-directory-listing-enabled-to-workspace';
...
export const INSTANCE_COMMANDS = [
  ...
  AddIsDirectoryListingEnabledToWorkspaceFastInstanceCommand,
];
