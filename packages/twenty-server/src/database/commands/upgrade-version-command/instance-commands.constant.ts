...
import { RelinkWorkflowVersionsToCoreWorkflowsFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789566000000-relink-workflow-versions-to-core-workflows';
...
export const INSTANCE_COMMANDS = [
  ...
  RelinkWorkflowVersionsToCoreWorkflowsFastInstanceCommand,
