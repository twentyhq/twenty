...
import { AddCategoryAndPositionToApplicationVariablesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-20/2-20-instance-command-fast-1783669319208-add-category-and-position-to-application-variables';
