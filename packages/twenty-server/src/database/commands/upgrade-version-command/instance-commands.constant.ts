...
import { CreateInboxCoreTablesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-30/2-30-instance-command-fast-1786360664857-create-inbox-core-tables';
