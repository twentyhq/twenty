...
import { AllowNullPayloadOnObjectNavigationCommandMenuItemFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-35/2-35-instance-command-fast-1787649282029-allow-null-payload-on-object-navigation-command-menu-item';
...
export const INSTANCE_COMMANDS = [
  ...
  AllowNullPayloadOnObjectNavigationCommandMenuItemFastInstanceCommand,
];
