...
import { AddCampaignClickTrackingFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-40/2-40-instance-command-fast-1788885873413-add-campaign-click-tracking';
...
export const INSTANCE_COMMANDS = [
  ...
  AddCampaignClickTrackingFastInstanceCommand,
