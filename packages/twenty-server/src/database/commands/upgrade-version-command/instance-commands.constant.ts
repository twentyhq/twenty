...
import { CreateInboxTablesFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789579200000-create-inbox-tables';
import { AddMessageChannelDefaultInboxQueueFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789579260000-add-message-channel-default-inbox-queue';
