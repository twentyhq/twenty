...
import { AddDefaultViewKeyFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-40/2-40-instance-command-fast-1789026815000-add-default-view-key';
...
export const INSTANCE_COMMANDS = [
  ...
  AddDefaultViewKeyFastInstanceCommand,
];
