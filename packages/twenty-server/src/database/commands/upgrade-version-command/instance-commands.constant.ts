...
import { AddSaasAuthBusinessIdToWorkspaceFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-16/2-16-instance-command-fast-1782300000000-add-saas-auth-business-id-to-workspace';
...
export const INSTANCE_COMMANDS = [
  ...
  AddSaasAuthBusinessIdToWorkspaceFastInstanceCommand,
];
