...
import { AddSetupStatusToApplicationFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-16/2-16-instance-command-fast-1800000000000-add-setup-status-to-application';
...
export const INSTANCE_COMMANDS = [
  ...
  AddSetupStatusToApplicationFastInstanceCommand,
];
