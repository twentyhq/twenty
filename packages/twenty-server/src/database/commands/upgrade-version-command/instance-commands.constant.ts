...
import { AddWorkspaceSchemaMigrationLockTableFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1790161900000-add-workspace-schema-migration-lock-table';
...
export const INSTANCE_COMMANDS = [
  ...
  AddWorkspaceSchemaMigrationLockTableFastInstanceCommand,
