...
import { CreateViewKanbanFieldMetadataIdForeignKeyHackyMigrationCommand } from 'src/database/commands/upgrade-version-command/1-10/1-10-create-view-kanban-field-metadata-id-foreign-key-hacky-migration.command';
