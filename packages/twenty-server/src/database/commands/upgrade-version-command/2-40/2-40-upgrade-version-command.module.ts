...
import { AddPersonEmailTrackingConsentCommand } from 'src/database/commands/upgrade-version-command/2-40/2-40-workspace-command-1789311770162-add-person-email-tracking-consent.command';
