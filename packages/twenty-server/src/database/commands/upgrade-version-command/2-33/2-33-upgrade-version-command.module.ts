...
import { AddCanceledMessageCampaignStatusCommand } from 'src/database/commands/upgrade-version-command/2-33/2-33-workspace-command-1787200060000-add-canceled-message-campaign-status.command';
import { AddMessageCampaignSkippedCountFieldCommand } from 'src/database/commands/upgrade-version-command/2-33/2-33-workspace-command-1787200000000-add-message-campaign-skipped-count-field.command';
...
@Module({
  ...
  providers: [
    ...
    AddMessageCampaignSkippedCountFieldCommand,
    AddCanceledMessageCampaignStatusCommand,
  ],
})
