...
import { AddSystemWorkflowsNavigationMenuItemCommand } from 'src/database/commands/upgrade-version-command/2-33/2-33-workspace-command-1787313901000-add-system-workflows-navigation-menu-item.command';
