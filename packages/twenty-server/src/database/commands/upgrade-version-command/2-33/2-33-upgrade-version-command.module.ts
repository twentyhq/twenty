...
import { SyncMessageDeliveryMetadataCommand } from 'src/database/commands/upgrade-version-command/2-33/2-33-workspace-command-1787200120000-sync-message-delivery-metadata.command';
...
@Module({
  ...
  providers: [
    ...
    SyncMessageDeliveryMetadataCommand,
  ],
})
