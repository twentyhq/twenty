...
import { V1_4_UpgradeVersionCommandModule } from 'src/database/commands/upgrade-version-command/1-4/1-4-upgrade-version-command.module';
import {
...
@Module({
  imports: [
    ...
    V1_4_UpgradeVersionCommandModule,
