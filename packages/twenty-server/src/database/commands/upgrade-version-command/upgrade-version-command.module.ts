...
import { UpgradeVersion1_8CommandModule } from 'src/database/commands/upgrade-version-command/1-8/1-8-upgrade-version-command.module';
...
@Module({
  imports: [
    ...
    UpgradeVersion1_8CommandModule,
