...
import { NormalizeCompanyDomainNamesCommand } from 'src/database/commands/upgrade-version-command/2-36/2-36-workspace-command-1787785121000-normalize-company-domain-names.command';
