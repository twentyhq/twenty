...
import { NormalizeWorkflowRecordCrudRichTextFieldsCommand } from 'src/database/commands/upgrade-version-command/2-36/2-36-workspace-command-1787827154863-normalize-workflow-record-crud-rich-text-fields.command';
