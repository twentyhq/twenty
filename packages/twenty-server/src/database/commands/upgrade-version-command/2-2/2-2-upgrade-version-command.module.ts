...
import { AddOpportunityNoStageSelectOptionCommand } from 'src/database/commands/upgrade-version-command/2-2/2-2-workspace-command-1786000001100-add-opportunity-no-stage-select-option.command';
...
@Module({
  ...
  providers: [
    ...
    AddOpportunityNoStageSelectOptionCommand,
  ],
})
