...
export class UpgradeCommand extends UpgradeCommandRunner {
  ...
  constructor(
    ...
    protected readonly removeIsWorkspaceMigrationV2EnabledFeatureFlagCommand: RemoveIsWorkspaceMigrationV2EnabledFeatureFlagCommand,
  ) {
    super(
      workspaceRepository,
      twentyConfigService,
    ...
    const commands_1130: VersionCommands = {
      beforeSyncMetadata: [
        ...
        this.removeIsWorkspaceMigrationV2EnabledFeatureFlagCommand,
      ],
      afterSyncMetadata: [],
    };
