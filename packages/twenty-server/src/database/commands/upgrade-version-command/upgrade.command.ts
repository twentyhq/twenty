...
export class UpgradeCommand extends UpgradeCommandRunner {
  ...
  constructor(
    ...
    protected readonly migrateNewFieldDefaultConfigurationToVisibilityCommand: MigrateNewFieldDefaultConfigurationToVisibilityCommand,
    ...
    const commands_1190: VersionCommands = [
      ...
      this.migrateNewFieldDefaultConfigurationToVisibilityCommand,
