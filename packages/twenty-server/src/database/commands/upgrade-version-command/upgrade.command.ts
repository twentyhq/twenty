...
import { MigratePageLayoutTabSyncableEntityCommand } from 'src/database/commands/upgrade-version-command/1-13/1-13-migrate-page-layout-tab-syncable-entity.command';
...
export class UpgradeCommand extends UpgradeCommandRunner {
  ...
  constructor(
    ...
    protected readonly migratePageLayoutTabSyncableEntityCommand: MigratePageLayoutTabSyncableEntityCommand,
  ) {
    super(
      workspaceRepository,
      twentyConfigService,
