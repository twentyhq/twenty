...
export class UpgradeCommand extends UpgradeCommandRunner {
  ...
  constructor(
    ...
    protected readonly createViewKanbanFieldMetadataIdForeignKeyHackyMigrationCommand: CreateViewKanbanFieldMetadataIdForeignKeyHackyMigrationCommand,
  ) {
    super(
      workspaceRepository,
      twentyConfigService,
    ...
    const commands_1100: VersionCommands = {
      beforeSyncMetadata: [
        ...
        this.createViewKanbanFieldMetadataIdForeignKeyHackyMigrationCommand,
