...
// The relation's other leg lives on agentChatThread, an object that already
// exists in every workspace, so selecting additions by owning object alone
// would provision half a relation and fail validation.
