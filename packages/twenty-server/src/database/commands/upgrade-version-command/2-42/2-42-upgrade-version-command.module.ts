...
import { ProvisionAgentChatThreadTargetCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-workspace-command-1790166480000-provision-agent-chat-thread-target.command';
