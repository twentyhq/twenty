import { BackfillWorkspaceWorkflowVersionIdCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-workspace-command-1789642900001-backfill-workspace-workflow-version-id.command';
...
@Module({
  ...
  providers: [
    BackfillWorkspaceWorkflowVersionIdCommand,UnpinCreationCommandsOnRecordSelectionCommand],
})
