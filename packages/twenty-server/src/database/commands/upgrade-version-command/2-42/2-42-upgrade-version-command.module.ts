...
import { SyncInputAskObjectCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-workspace-command-1789900600000-sync-input-ask-object.command';
