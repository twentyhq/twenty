...
import { UpgradePeopleDataLabsApplicationToCoreWorkflowsCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-workspace-command-1789977103904-upgrade-people-data-labs-application.command';
