...
import { RetypeInitialObjectViewsCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-workspace-command-1790081579000-retype-initial-object-views.command';
...
@Module({
  ...
  providers: [
    ...
    RetypeInitialObjectViewsCommand,
  ],
