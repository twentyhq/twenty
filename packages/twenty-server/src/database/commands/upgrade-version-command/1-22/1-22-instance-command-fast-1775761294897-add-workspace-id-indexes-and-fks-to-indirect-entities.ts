  ...
  implements FastInstanceCommand
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE INDEX IF NOT EXISTS "IDX_d8cf7f15cf6466ac0e3b443b3d" ON "core"."indexFieldMetadata" ("workspaceId") ',
    );
    await queryRunner.query(
      'CREATE INDEX IF NOT EXISTS "IDX_b8282d1e10fbb7856950f86c61" ON "core"."twoFactorAuthenticationMethod" ("workspaceId") ',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "core"."applicationVariable" DROP CONSTRAINT IF EXISTS "FK_78ae6cfe5f49a76c4bf842ad58b"',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "core"."indexFieldMetadata" DROP CONSTRAINT IF EXISTS "FK_d8cf7f15cf6466ac0e3b443b3d2"',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "core"."twoFactorAuthenticationMethod" DROP CONSTRAINT IF EXISTS "FK_b8282d1e10fbb7856950f86c616"',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "core"."agentMessagePart" DROP CONSTRAINT IF EXISTS "FK_70b398dc45219db8f3e36b3a078"',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "core"."agentTurnEvaluation" DROP CONSTRAINT IF EXISTS "FK_c81d8fabdda94b7fa86fb6f1e70"',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "core"."agentChatThread" DROP CONSTRAINT IF EXISTS "FK_3d097ed53841d80904ed02c8373"',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "core"."agentTurn" DROP CONSTRAINT IF EXISTS "FK_a4bb3c6176c2607693a6756ff6c"',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "core"."agentMessage" DROP CONSTRAINT IF EXISTS "FK_75db4f2e80922078e8171ae130a"',
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'DROP INDEX IF EXISTS "core"."IDX_75db4f2e80922078e8171ae130"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "core"."IDX_a4bb3c6176c2607693a6756ff6"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "core"."IDX_3d097ed53841d80904ed02c837"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "core"."IDX_c81d8fabdda94b7fa86fb6f1e7"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "core"."IDX_70b398dc45219db8f3e36b3a07"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "core"."IDX_b8282d1e10fbb7856950f86c61"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "core"."IDX_d8cf7f15cf6466ac0e3b443b3d"',
    );
    await queryRunner.query(
      'DROP INDEX IF EXISTS "core"."IDX_78ae6cfe5f49a76c4bf842ad58"',
    );
  }
}
