...
import { MakeStandardChildObjectsInheritedCommand } from 'src/database/commands/upgrade-version-command/2-39/2-39-workspace-command-1788593235048-make-standard-child-objects-inherited.command';
