...
import { SyncMessageCampaignSchemaCommand } from 'src/database/commands/upgrade-version-command/2-35/2-35-workspace-command-1787578823597-sync-message-campaign-schema.command';
