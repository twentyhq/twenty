...
// An object navigation command drops its payload once the 2-35 rewrite has run,
// but the target backfill runs first and leaves both set, so the NAVIGATION
// branch only requires one of the two
...
@RegisteredInstanceCommand('2.35.0', 1787649282029)
export class AllowNullPayloadOnObjectNavigationCommandMenuItemFastInstanceCommand
