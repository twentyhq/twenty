...
// The pre-2.28 pinned universal identifiers of the 20 curated standard
// record-page layouts, keyed by their object. The 2-28 record-page re-own
...
export const PRE_2_28_STANDARD_RECORD_PAGE_LAYOUT_UNIVERSAL_IDENTIFIER_BY_OBJECT_UNIVERSAL_IDENTIFIER: Record<
  string,
  string
> = {
