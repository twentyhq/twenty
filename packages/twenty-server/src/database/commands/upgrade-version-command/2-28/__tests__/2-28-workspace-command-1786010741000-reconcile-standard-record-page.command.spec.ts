...
const COMPANY_PRE_2_28_LAYOUT_UNIVERSAL_IDENTIFIER =
...
// The curated company stack, still on its pre-2.28 pinned literal.
const CURATED_STACK = (() => {
  ...
  return {
    ...
    pageLayout: {
      ...stack.pageLayout,
      universalIdentifier: COMPANY_PRE_2_28_LAYOUT_UNIVERSAL_IDENTIFIER,
    },
  };
})();
...
describe('ReconcileStandardRecordPageCommand', () => {
  ...
  it('re-owns the curated stack located by its pre-2.28 literal', async () => {
    mockWorkspaceCache();
