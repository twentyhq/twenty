...
import { V2_6_UpgradeVersionCommandModule } from 'src/database/commands/upgrade-version-command/2-6/2-6-upgrade-version-command.module';
...
@Module({
  imports: [
    ...
    V2_6_UpgradeVersionCommandModule,
  ],
})
