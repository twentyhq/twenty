...
import { V2_30_UpgradeVersionCommandModule } from 'src/database/commands/upgrade-version-command/2-30/2-30-upgrade-version-command.module';
...
@Module({
  imports: [
    ...
    V2_30_UpgradeVersionCommandModule,
  ],
})
