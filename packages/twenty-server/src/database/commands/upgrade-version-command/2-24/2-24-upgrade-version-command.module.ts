...
import { ConfigureMessageCampaignCommandMenuCommand } from 'src/database/commands/upgrade-version-command/2-24/2-24-workspace-command-1784900000000-configure-message-campaign-command-menu.command';
