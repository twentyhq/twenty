...
import { AddWorkflowVersionStickyNotesFieldCommand } from 'src/database/commands/upgrade-version-command/2-15/2-15-workspace-command-1800000003000-add-workflow-version-sticky-notes-field.command';
...
@Module({
  ...
  providers: [
    ...
    AddWorkflowVersionStickyNotesFieldCommand,
  ],
})
