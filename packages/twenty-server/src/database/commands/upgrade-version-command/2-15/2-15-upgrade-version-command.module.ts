...
import { AddTimelineActivityKindFieldCommand } from 'src/database/commands/upgrade-version-command/2-15/2-15-workspace-command-1800000003000-add-timeline-activity-kind-field.command';
...
@Module({
  ...
  providers: [
    ...
    AddTimelineActivityKindFieldCommand,
  ],
})
