...
import { MigratePersonAvatarUrlToAvatarFileCommand } from 'src/database/commands/upgrade-version-command/2-21/2-21-workspace-command-1783933872000-migrate-person-avatar-url-to-avatar-file.command';
