...
export class AllowServerScopedFileFastInstanceCommand implements FastInstanceCommand {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE UNIQUE INDEX "IDX_FILE_SERVER_PATH_UNIQUE" ON "core"."file" ("path") WHERE "workspaceId" IS NULL');
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('DROP INDEX "core"."IDX_FILE_SERVER_PATH_UNIQUE"');
