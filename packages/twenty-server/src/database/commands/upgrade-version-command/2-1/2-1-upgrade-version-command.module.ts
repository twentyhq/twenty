...
import { SyncTwentyStandardApplicationSpvCommand } from 'src/database/commands/upgrade-version-command/2-1/2-1-workspace-command-1795000003000-sync-twenty-standard-application-spv.command';
import { ResyncTwentyStandardApplicationSpvCommand } from 'src/database/commands/upgrade-version-command/2-1/2-1-workspace-command-1795000004000-resync-twenty-standard-application-spv.command';
...
@Module({
  ...
  providers: [
    ...
    SyncTwentyStandardApplicationSpvCommand,
    ResyncTwentyStandardApplicationSpvCommand,
  ],
})
