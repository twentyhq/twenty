...
export type BuildRowLevelPermissionRecordFilterForParentArgs = {
...
export const buildRowLevelPermissionRecordFilterForParent = ({
  ...
  parent,
  workspaceMember,
}: BuildRowLevelPermissionRecordFilterForParentArgs): RecordGqlOperationFilter | null => {
  ...
  const recordFilterGroups: RecordFilterGroup[] = [...relevantGroupIds]
    ...
    .filter(
      (predicateGroup) =>
        isRowLevelPermissionPredicateOfParent(predicateGroup, parent) &&
