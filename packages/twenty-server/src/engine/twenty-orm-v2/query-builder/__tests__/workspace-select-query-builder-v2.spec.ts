...
describe('WorkspaceSelectQueryBuilderV2', () => {
  ...
  it('should hydrate a partial relation column selected without an output alias', async () => {
    ...
    // The selection may precede the join that introduces the alias.
    queryBuilder.setFindOptions({ select: { id: true } });
...
// The timeline messaging service is the reference consumer of the TypeORM parity
// surface: these specs mirror its three query shapes end to end.
