...
export enum WorkspaceTrustedDomainExceptionCode {
  ...
  WORKSPACE_TRUSTED_DOMAIN_DOES_NOT_MATCH_DOMAIN_EMAIL = 'WORKSPACE_TRUSTED_DOMAIN_DOES_NOT_MATCH_DOMAIN_EMAIL',
  WORKSPACE_TRUSTED_DOMAIN_VALIDATION_TOKEN_INVALID = 'WORKSPACE_TRUSTED_DOMAIN_VALIDATION_TOKEN_INVALID',
  WORKSPACE_TRUSTED_DOMAIN_ALREADY_VALIDATED = 'WORKSPACE_TRUSTED_DOMAIN_ALREADY_VALIDATED',
}
