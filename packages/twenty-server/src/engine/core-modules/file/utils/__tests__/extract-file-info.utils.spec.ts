...
describe('extractFileInfo', () => {
  ...
  it.each([
    { name: 'PNG', buffer: pngBuffer, filename: 'image.png', ext: 'png', mime: 'image/png' },
    { name: 'PDF', buffer: pdfBuffer, filename: 'document.pdf', ext: 'pdf', mime: 'application/pdf' },
    { name: 'ZIP', buffer: zipBuffer, filename: 'archive.zip', ext: 'zip', mime: 'application/zip' },
    { name: 'PNG (mismatched extension)', buffer: pngBuffer, filename: 'image.txt', ext: 'png', mime: 'image/png' },
  ...
  it.each([
    ...
    { name: 'JSON', filename: 'config.json', ext: 'json', mime: 'application/json' },
    { name: 'markdown', filename: 'README.md', ext: 'md', mime: 'text/markdown' },
    { name: 'HTML', filename: 'index.html', ext: 'html', mime: 'text/html' },
    { name: 'unknown extension', filename: 'file.unknown', ext: 'unknown', mime: 'application/octet-stream' },
    { name: 'no extension', filename: 'file-without-extension', ext: '', mime: 'application/octet-stream' },
  ...
  it.each([
    ...
    { ext: 'pdf', filename: 'fake-document.pdf', expectedMime: 'application/pdf' },
