...
describe('ApplicationRegistrationEncryptionService', () => {
  let service: ApplicationRegistrationEncryptionService;
  ...
  beforeEach(async () => {
    ...
    service = module.get(ApplicationRegistrationEncryptionService);
  });
