...
import { CREATE_INBOX_TABLES_UPGRADE_COMMAND_NAME } from 'src/database/commands/upgrade-version-command/2-40/create-inbox-tables-upgrade-command-name.constant';
