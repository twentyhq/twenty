...
export const DPA_TEMPLATE_BLOCKS: DpaTemplateBlock[] = [
  ...
  {
    kind: 'paragraph',
    text: '13.1 Governing Law: This DPA is governed by the same law and jurisdiction as the Agreement ({{GOVERNING_LAW}}; default: France for the EU deployment), unless otherwise required by the SCCs or other transfer addenda for specific international transfer matters (as noted in Section 7.2). In any case, no change in governing law is intended by this DPA except as necessary to incorporate the required international data transfer terms.',
  },
  {
    kind: 'paragraph',
  ...
  {
    kind: 'paragraph',
    text: 'Data Importer (Processor): {{PROCESSOR_ENTITY}} — {{PROCESSOR_LEGAL_FORM}} (default: Twenty.com SAS, a société par actions simplifiée under the laws of France; for US deployments: Twenty, Inc., a public benefit corporation under the laws of Delaware, USA). Registered office: {{PROCESSOR_ADDRESS}}. {{PROCESSOR_ENTITY}} provides cloud-based CRM software and related services and Processes Customer Personal Data in the {{HOSTING_REGION}} (default: the EU, Frankfurt, Germany). Contact for privacy inquiries: privacy@twenty.com. {{PROCESSOR_ENTITY}} acts as Processor (and, where applicable, Service Provider under the CCPA and data importer under the SCCs). The applicable Processor entity, hosting region, and governing law are those specified in the Order Form or Customer’s workspace configuration.',
  },
  {
    kind: 'paragraph',
