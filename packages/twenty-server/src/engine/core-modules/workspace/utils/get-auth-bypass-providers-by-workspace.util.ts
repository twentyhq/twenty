import { AuthBypassProvidersDTO } from 'src/engine/core-modules/workspace/dtos/public-workspace-data-output';
...
export const getAuthBypassProvidersByWorkspace = ({
  ...
  return {
    ...
    microsoft:
      workspace.isMicrosoftAuthBypassEnabled && systemEnabledProviders.microsoft,
  };
};
