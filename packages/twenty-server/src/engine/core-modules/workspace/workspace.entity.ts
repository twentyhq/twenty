...
import { ADD_CAMPAIGN_TRACKING_FLAGS_UPGRADE_COMMAND_NAME } from 'src/database/commands/upgrade-version-command/2-42/add-campaign-tracking-flags-upgrade-command-name.constant';
