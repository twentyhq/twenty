...
export class WorkspaceEntity {
	...
	@OneToMany(
		() => FeatureFlagEntity,
		(featureFlag) => featureFlag.workspace,
	)
	...
	@OneToMany(
		() => PublicDomainEntity,
		(publicDomain) => publicDomain.workspace,
	)
	...
	@OneToMany(
		() => ViewFilterEntity,
		(viewFilter) => viewFilter.workspace,
	)
