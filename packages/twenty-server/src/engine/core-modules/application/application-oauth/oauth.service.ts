...
export class OAuthService {
  ...
  async introspectToken(params: {
    ...
    // A confidential client (one with a secret) must present it; without a
    // valid secret we disclose nothing about the token.
    if (
      isConfidentialClient(clientValidation) &&
