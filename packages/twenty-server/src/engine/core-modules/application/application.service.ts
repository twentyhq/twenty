...
const WORKSPACE_CUSTOM_APPLICATION_DESCRIPTION = `The built-in home for your workspace's custom objects, views, layouts, logic functions, front components, and agents.
...
export class ApplicationService {
  ...
  async createWorkspaceCustomApplication(
    ...
    const workspaceCustomApplication = await this.create(
      {
        description: WORKSPACE_CUSTOM_APPLICATION_DESCRIPTION,
        name: 'Custom',
