...
import { ADD_CATEGORY_AND_POSITION_TO_APPLICATION_VARIABLES_UPGRADE_COMMAND_NAME } from 'src/database/commands/upgrade-version-command/2-21/add-category-and-position-to-application-variables-upgrade-command-name.constant';
