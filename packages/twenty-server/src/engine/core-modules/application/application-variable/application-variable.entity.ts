...
import { ADD_IS_DEPRECATED_TO_APPLICATION_VARIABLES_UPGRADE_COMMAND_NAME } from 'src/database/commands/upgrade-version-command/2-29/add-is-deprecated-to-application-variables-upgrade-command-name.constant';
