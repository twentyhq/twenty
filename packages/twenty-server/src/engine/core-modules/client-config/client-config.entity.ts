...
import { AuthBypassProvidersDTO, AuthProvidersDTO } from 'src/engine/core-modules/workspace/dtos/public-workspace-data-output';
...
export class ClientConfig {
  ...
  @Field(() => AuthBypassProvidersDTO, { nullable: false })
