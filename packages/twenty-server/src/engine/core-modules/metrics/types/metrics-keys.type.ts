export enum MetricsKeys {
  ...
  ServerCronTickSkipped = 'server-cron/tick-skipped',
  ServerCronStepFailed = 'server-cron/step-failed',
  ServerCronDispatchEnqueued = 'server-cron/dispatch-enqueued',
  ServerCronDispatchDropped = 'server-cron/dispatch-dropped',
