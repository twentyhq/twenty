...
type BuildUnsubscribePreferencesPageArgs = {
  ...
  isTrackingOptedOut: boolean | undefined;
  updatePath: string;
...
const buildTrackingSection = (isTrackingOptedOut: boolean): string => {
...
export const buildUnsubscribePreferencesPage = ({
  ...
  const preferenceSections = [
    ...
    isDefined(isTrackingOptedOut)
      ? buildTrackingSection(isTrackingOptedOut)
      : '',
