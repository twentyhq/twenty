...
import { NoUsageLimitEntitlementProvider } from 'src/engine/core-modules/usage-limit/services/no-usage-limit-entitlement-provider.service';
...
export const findUsageLimitEntitlementProvider = (
  ...
  }) ?? new NoUsageLimitEntitlementProvider();
