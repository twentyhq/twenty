...
import {
  DateScalarMode,
  NumberScalarMode,
} from 'src/engine/graphql/workspace-schema-builder/interfaces/workspace-build-schema-optionts.interface';
...
import {
  ...
  BooleanFilterType,
  BigFloatFilterType,
} from 'src/engine/graphql/workspace-schema-builder/graphql-types/input';
import { OrderByDirectionType } from 'src/engine/graphql/workspace-schema-builder/graphql-types/enum';
import { BigFloatScalarType } from 'src/engine/graphql/workspace-schema-builder/graphql-types/scalars';
import { PositionScalarType } from 'src/engine/graphql/workspace-schema-builder/graphql-types/scalars/position.scalar';
