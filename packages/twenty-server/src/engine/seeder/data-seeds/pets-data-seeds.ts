export const PETS_DATA_SEEDS = [
  {
    ...
    pictures: {
      primaryLinkUrl: 'https://images.unsplash.com/photo-1507146426996-ef05306b995a?q=80&w=3270&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      primaryLinkLabel: 'Picture 1',
      secondaryLinks: [{ "url": 'https://images.unsplash.com/photo-1447684808650-354ae64db5b8?q=80&w=3267&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', "label": 'Picture 2' }],
    },
    ...
    extraData: "{\n      settingsOnVetSoftware: {\n        vetSoftware: 'VetLink',\n        settings: [\n          { key: 'Vet name', value: 'Dr. John Doe' },\n          { key: 'Vet phone', value: '234-567-890' },\n          { key: 'Vet email', value: ''},\n          { key: 'Vet address', value: '513 Batz Fork, 7344 Haley Loop, Jacksonstad, North Dakota, 32048-5208, United States' },\n        ]\n      },\n      additionalData: [\n        { key: 'Weight', value: '5kg' },\n        { key: 'Height', value: '30cm' },\n        { key: 'Length', value: '50cm' },\n        { key: 'Breed', value: 'Golden Retriever' },\n        { key: 'Color', value: 'Golden' },\n        { key: 'Eye color', value: 'Brown' },\n        { key: 'Fur', value: 'Long' },\n        { key: 'Tail', value: 'Long' },\n        { key: 'Ears', value: 'Long' },\n        { key: 'Paws', value: 'Small' },\n        { key: 'Nose', value: 'Wet' },\n        { key: 'Teeth', value: 'White' },\n        { key: 'Habits', value: 'Barks when someone is at the door' },\n        { key: 'Likes', value: 'Belly rubs' },\n        { key: 'Dislikes', value: 'Being alone' },\n      ]\n    }"
  },
