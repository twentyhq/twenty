...
import {
  FieldMetadataEntity,
  FieldMetadataType,
} from 'src/engine/api/metadata/field-metadata/field-metadata.entity';
import { isCompositeFieldMetadataType } from 'src/engine/api/metadata/field-metadata/utils/is-composite-field-metadata-type.util';
...
import { compositeDefinitions } from 'src/engine/api/metadata/field-metadata/composite-types';
import { validateDefaultValueForType } from 'src/engine/api/metadata/field-metadata/utils/validate-default-value-for-type.util';
import {
  EnumFieldMetadataUnionType,
  isEnumFieldMetadataType,
} from 'src/engine/api/metadata/field-metadata/utils/is-enum-field-metadata-type.util';
import { validateOptionsForType } from 'src/engine/api/metadata/field-metadata/utils/validate-options-for-type.util';
import { serializeDefaultValue } from 'src/engine/api/metadata/field-metadata/utils/serialize-default-value';
...
import { generateTargetColumnMap } from 'src/engine/api/metadata/field-metadata/utils/generate-target-column-map.util';
import { customNamePrefix } from 'src/engine/workspace/manager/utils/compute-custom-name.util';
import { isRelationFieldMetadataType } from 'src/engine/workspace/manager/utils/is-relation-field-metadata-type.util';
