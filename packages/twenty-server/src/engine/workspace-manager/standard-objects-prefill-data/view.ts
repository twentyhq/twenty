...
import { viewChartFields } from 'src/engine/workspace-manager/standard-objects-prefill-data/view-chart-fields';
...
export const viewPrefillData = async (
  ...
  await entityManager
    ...
    .values([
      ...
      ...viewChartFields(viewIdMap['All Charts'], objectMetadataMap),
    ])
    .execute();
};
