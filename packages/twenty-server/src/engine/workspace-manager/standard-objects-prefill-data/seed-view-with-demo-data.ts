...
import { policyAllView } from 'src/engine/workspace-manager/standard-objects-prefill-data/views/policy-all.view';
...
export const seedViewWithDemoData = async (
  ...
  const viewDefinitions = [
    ...
    mgasAllView(objectMetadataStandardIdToIdMap),
    policyAllView(objectMetadataStandardIdToIdMap),
  ];
