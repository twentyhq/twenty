...
import { seedEnterpriseValidityToken } from 'src/engine/workspace-manager/dev-seeder/core/utils/seed-enterprise-validity-token.util';
...
export const seedCoreSchema = async ({
  ...
  try {
    ...
    await seedEnterpriseValidityToken({ queryRunner, schemaName });
