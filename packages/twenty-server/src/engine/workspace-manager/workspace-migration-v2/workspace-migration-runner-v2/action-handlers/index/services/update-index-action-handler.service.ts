...
export class UpdateIndexActionHandlerService extends WorkspaceMigrationRunnerActionHandler(
  ...
  optimisticallyApplyActionOnAllFlatEntityMaps({
  ...
  }: OptimisticallyApplyActionOnAllFlatEntityMapsArgs<UpdateIndexAction>) {
    // Delete old index then add the updated one
    const mapsAfterDelete = deleteFlatEntityFromFlatEntityMapsOrThrow({
    ...
    return {
      flatIndexMaps: addFlatEntityToFlatEntityMapsOrThrow({
        ...
        flatEntityMaps: mapsAfterDelete,
      }),
    };
  }
