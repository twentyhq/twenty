...
export const STANDARD_COMMAND_MENU_ITEMS = {
  ...
  deleteRecords: {
    ...
    isPinned: false,
    position: 4,
    shortLabel: i18nLabel(msg`Delete`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  restoreRecords: {
    ...
    isPinned: true,
    position: 5,
    shortLabel: i18nLabel(msg`Restore`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  destroyRecords: {
    ...
    isPinned: false,
    position: 6,
    shortLabel: i18nLabel(msg`Destroy`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  addToFavorites: {
    ...
    label: i18nLabel(msg`Add to Favorites`),
    icon: 'IconHeart',
    isPinned: true,
    position: 7,
    shortLabel: null,
  ...
  removeFromFavorites: {
    ...
    label: i18nLabel(msg`Remove from Favorites`),
    icon: 'IconHeartOff',
    isPinned: true,
    position: 8,
    shortLabel: null,
  ...
  exportNoteToPdf: {
    ...
    label: i18nLabel(msg`Export to PDF`),
    icon: 'IconFileExport',
    isPinned: false,
    position: 9,
    shortLabel: i18nLabel(msg`Export`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  updateMultipleRecords: {
    ...
    isPinned: true,
    position: 11,
    shortLabel: i18nLabel(msg`Update`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  mergeMultipleRecords: {
    ...
    isPinned: false,
    position: 12,
    shortLabel: i18nLabel(msg`Merge`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  importRecords: {
    ...
    isPinned: false,
    position: 13,
    shortLabel: i18nLabel(msg`Import`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL_OBJECT_CONTEXT,
    conditionalAvailabilityExpression:
  ...
  exportView: {
    ...
    label: i18nLabel(msg`Export View`),
    icon: 'IconFileExport',
    isPinned: false,
    position: 14,
    shortLabel: i18nLabel(msg`Export`),
  ...
  createNewView: {
    ...
    label: i18nLabel(msg`Create View`),
    icon: 'IconLayout',
    isPinned: false,
    position: 16,
    shortLabel: i18nLabel(msg`Create View`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL_OBJECT_CONTEXT,
    conditionalAvailabilityExpression:
      'pageType == "INDEX_PAGE" and not hasAnySoftDeleteFilterOnView',
    availabilityObjectMetadataUniversalIdentifier: null,
  ...
  hideDeletedRecords: {
    ...
    isPinned: false,
    position: 17,
    shortLabel: i18nLabel(msg`Hide deleted`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL_OBJECT_CONTEXT,
    conditionalAvailabilityExpression:
  ...
  editRecordPageLayout: {
    ...
    label: i18nLabel(msg`Edit Layout`),
    icon: 'IconPencil',
    isPinned: false,
    position: 18,
    shortLabel: i18nLabel(msg`Edit Layout`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  editDashboardLayout: {
    ...
    label: i18nLabel(msg`Edit Dashboard`),
    icon: 'IconPencil',
    isPinned: true,
    position: 19,
    shortLabel: i18nLabel(msg`Edit`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  saveDashboardLayout: {
    ...
    label: i18nLabel(msg`Save Dashboard`),
    icon: 'IconDeviceFloppy',
    isPinned: true,
    position: 20,
    shortLabel: i18nLabel(msg`Save`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  cancelDashboardLayout: {
    ...
    label: i18nLabel(msg`Cancel Edition`),
    icon: 'IconCancel',
    isPinned: true,
    position: 21,
    shortLabel: i18nLabel(msg`Cancel`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
      'pageType == "RECORD_PAGE" and isDashboardPageLayoutInEditMode and noneDefined(selectedRecords, "deletedAt") and everyDefined(selectedRecords, "pageLayoutId") and objectPermissions.canUpdateObjectRecords',
    availabilityObjectMetadataUniversalIdentifier:
  ...
  duplicateDashboard: {
    ...
    label: i18nLabel(msg`Duplicate Dashboard`),
    icon: 'IconCopyPlus',
    isPinned: false,
    position: 22,
    shortLabel: i18nLabel(msg`Duplicate`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  activateWorkflow: {
    ...
    label: i18nLabel(msg`Activate Workflow`),
    icon: 'IconPower',
    isPinned: true,
    position: 23,
    shortLabel: i18nLabel(msg`Activate`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  deactivateWorkflow: {
    ...
    label: i18nLabel(msg`Deactivate Workflow`),
    icon: 'IconPlayerPause',
    isPinned: true,
    position: 24,
    shortLabel: i18nLabel(msg`Deactivate`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  discardDraftWorkflow: {
    ...
    label: i18nLabel(msg`Discard Draft`),
    icon: 'IconNoteOff',
    isPinned: true,
    position: 25,
    shortLabel: i18nLabel(msg`Discard Draft`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  testWorkflow: {
    ...
    label: i18nLabel(msg`Test Workflow`),
    icon: 'IconPlayerPlay',
    isPinned: true,
    position: 26,
    shortLabel: i18nLabel(msg`Test`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  seeActiveVersionWorkflow: {
    ...
    label: i18nLabel(msg`See Active Version`),
    icon: 'IconVersions',
    isPinned: false,
    position: 27,
    shortLabel: i18nLabel(msg`See Active Version`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  seeRunsWorkflow: {
    ...
    label: i18nLabel(msg`See Runs`),
    icon: 'IconHistoryToggle',
    isPinned: true,
    position: 28,
    shortLabel: i18nLabel(msg`See Runs`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  seeVersionsWorkflow: {
    ...
    label: i18nLabel(msg`See Versions History`),
    icon: 'IconVersions',
    isPinned: false,
    position: 29,
    shortLabel: i18nLabel(msg`See Versions`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
      'noneDefined(selectedRecords, "deletedAt")',
    availabilityObjectMetadataUniversalIdentifier:
  ...
  addNodeWorkflow: {
    ...
    label: i18nLabel(msg`Add a Node`),
    icon: 'IconPlus',
    isPinned: true,
    position: 30,
    shortLabel: i18nLabel(msg`Add a Node`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  tidyUpWorkflow: {
    ...
    label: i18nLabel(msg`Tidy up Workflow`),
    icon: 'IconReorder',
    isPinned: false,
    position: 31,
    shortLabel: i18nLabel(msg`Tidy up`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
      'pageType == "RECORD_PAGE" and everyDefined(selectedRecords, "currentVersion.trigger") and everyDefined(selectedRecords, "currentVersion.steps") and every(selectedRecords, "currentVersion.steps.length") and noneDefined(selectedRecords, "deletedAt")',
    availabilityObjectMetadataUniversalIdentifier:
  ...
  duplicateWorkflow: {
    ...
    label: i18nLabel(msg`Duplicate Workflow`),
    icon: 'IconCopy',
    isPinned: false,
    position: 32,
    shortLabel: i18nLabel(msg`Duplicate`),
  ...
  seeVersionWorkflowRun: {
    ...
    label: i18nLabel(msg`See Version`),
    icon: 'IconVersions',
    isPinned: true,
    position: 33,
    shortLabel: i18nLabel(msg`See Version`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
  ...
  seeWorkflowWorkflowRun: {
    ...
    label: i18nLabel(msg`See Workflow`),
    icon: 'IconSettingsAutomation',
    isPinned: true,
    position: 34,
    shortLabel: i18nLabel(msg`See Workflow`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression: null,
    availabilityObjectMetadataUniversalIdentifier:
      STANDARD_OBJECTS.workflowRun.universalIdentifier,
  ...
  stopWorkflowRun: {
    ...
    label: i18nLabel(msg`Stop`),
    icon: 'IconPlayerStop',
    isPinned: true,
    position: 35,
    shortLabel: i18nLabel(msg`Stop`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  retryWorkflowRun: {
    ...
    label: i18nLabel(msg`Retry`),
    icon: 'IconRefresh',
    isPinned: true,
    position: 36,
    shortLabel: i18nLabel(msg`Retry`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  useAsDraftWorkflowVersion: {
    ...
    label: i18nLabel(msg`Use as Draft`),
    icon: 'IconPencil',
    isPinned: true,
    position: 39,
    shortLabel: i18nLabel(msg`Use as Draft`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  searchRecords: {
    ...
    label: i18nLabel(msg`Search`),
    icon: 'IconSearch',
    isPinned: false,
    position: 41,
    shortLabel: i18nLabel(msg`Search`),
  ...
  askAi: {
    ...
    label: i18nLabel(msg`Ask AI`),
    icon: 'IconSparkles',
    isPinned: false,
    position: 43,
    shortLabel: i18nLabel(msg`Ask AI`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
  ...
  viewPreviousAiChats: {
    ...
    label: i18nLabel(msg`View Previous AI Chats`),
    icon: 'IconHistory',
    isPinned: false,
    position: 44,
    shortLabel: i18nLabel(msg`Previous AI Chats`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: 'permissionFlags.AI',
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
  ...
  replyToEmailThread: {
    ...
    label: i18nLabel(msg`Reply`),
    icon: 'IconArrowBackUp',
    isPinned: true,
    position: 45,
    shortLabel: i18nLabel(msg`Reply`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
  ...
  composeEmail: {
    ...
    label: i18nLabel(msg`Compose Email`),
    icon: 'IconMail',
    isPinned: false,
    position: 46,
    shortLabel: i18nLabel(msg`Compose`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
  ...
  composeCampaign: {
    ...
    label: i18nLabel(msg`Compose Campaign`),
    icon: 'IconSend',
    isPinned: false,
    position: 66,
    shortLabel: i18nLabel(msg`Campaign`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
  ...
  composeCampaignPinned: {
    ...
    label: i18nLabel(msg`Create new Campaign`),
    icon: 'IconPlus',
    isPinned: true,
    position: 67,
    shortLabel: i18nLabel(msg`New Campaign`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL_OBJECT_CONTEXT,
    conditionalAvailabilityExpression:
  ...
  sendMessageCampaign: {
    ...
    label: i18nLabel(msg`Send Campaign`),
    icon: 'IconSend',
    isPinned: true,
    position: 68,
    shortLabel: i18nLabel(msg`Send`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  sendMessageCampaignTest: {
    ...
    label: i18nLabel(msg`Send Test Email`),
    icon: 'IconMail',
    isPinned: true,
    position: 69,
    shortLabel: i18nLabel(msg`Test`),
  ...
  emailBlockSettings: {
    ...
    label: i18nLabel(msg`Block Settings`),
    icon: 'IconAdjustments',
    isPinned: true,
    position: 70,
    shortLabel: i18nLabel(msg`Design`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
  ...
  goToSettings: {
    ...
    label: i18nLabel(msg`Go to Settings`),
    icon: 'IconSettings',
    isPinned: false,
    position: 47,
    shortLabel: i18nLabel(msg`Settings`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: null,
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
  ...
  goToSettingsExperience: {
    ...
    label: i18nLabel(msg`Go to Experience Settings`),
    icon: 'IconColorSwatch',
    isPinned: false,
    position: 48,
    shortLabel: i18nLabel(msg`Experience`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: null,
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
  ...
  goToSettingsAccounts: {
    ...
    label: i18nLabel(msg`Go to Accounts Settings`),
    icon: 'IconAt',
    isPinned: false,
    position: 49,
    shortLabel: i18nLabel(msg`Accounts`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
  ...
  goToSettingsAccountsEmails: {
    ...
    label: i18nLabel(msg`Go to Emails Settings`),
    icon: 'IconMail',
    isPinned: false,
    position: 50,
    shortLabel: i18nLabel(msg`Emails`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: 'permissionFlags.CONNECTED_ACCOUNTS',
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
  ...
  goToSettingsAccountsCalendars: {
    ...
    label: i18nLabel(msg`Go to Calendars Settings`),
    icon: 'IconCalendarEvent',
    isPinned: false,
    position: 51,
    shortLabel: i18nLabel(msg`Calendars`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: 'permissionFlags.CONNECTED_ACCOUNTS',
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
  ...
  goToSettingsGeneral: {
    ...
    label: i18nLabel(msg`Go to General Settings`),
    icon: 'IconSettings',
    isPinned: false,
    position: 52,
    shortLabel: i18nLabel(msg`General`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
  ...
  goToSettingsObjects: {
    ...
    label: i18nLabel(msg`Go to Data Model Settings`),
    icon: 'IconHierarchy2',
    isPinned: false,
    position: 53,
    shortLabel: i18nLabel(msg`Data Model`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
  ...
  goToSettingsMembers: {
    ...
    label: i18nLabel(msg`Go to Members Settings`),
    icon: 'IconUsers',
    isPinned: false,
    position: 54,
    shortLabel: i18nLabel(msg`Members`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
  ...
  goToSettingsRoles: {
    ...
    label: i18nLabel(msg`Go to Roles Settings`),
    icon: 'IconLock',
    isPinned: false,
    position: 55,
    shortLabel: i18nLabel(msg`Roles`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: 'permissionFlags.WORKSPACE_MEMBERS',
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
  ...
  goToSettingsDomains: {
    ...
    label: i18nLabel(msg`Go to Domains Settings`),
    icon: 'IconWorld',
    isPinned: false,
    position: 56,
    shortLabel: i18nLabel(msg`Domains`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: 'permissionFlags.WORKSPACE',
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
  ...
  goToSettingsBilling: {
    ...
    label: i18nLabel(msg`Go to Billing Settings`),
    icon: 'IconCurrencyDollar',
    isPinned: false,
    position: 57,
    shortLabel: i18nLabel(msg`Billing`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: 'permissionFlags.WORKSPACE',
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
  ...
  goToSettingsApiWebhooks: {
    ...
    label: i18nLabel(msg`Go to MCP & APIs Settings`),
    icon: 'IconPlug',
    isPinned: false,
    position: 58,
    shortLabel: i18nLabel(msg`MCP & APIs`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
  ...
  goToSettingsApplications: {
    ...
    label: i18nLabel(msg`Go to Apps Settings`),
    icon: 'IconApps',
    isPinned: false,
    position: 59,
    shortLabel: i18nLabel(msg`Apps`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
  ...
  goToSettingsAI: {
    ...
    label: i18nLabel(msg`Go to AI Settings`),
    icon: 'IconSparkles',
    isPinned: false,
    position: 60,
    shortLabel: i18nLabel(msg`AI`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: 'permissionFlags.WORKSPACE',
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
  ...
  goToSettingsSecurity: {
    ...
    label: i18nLabel(msg`Go to Security Settings`),
    icon: 'IconKey',
    isPinned: false,
    position: 61,
    shortLabel: i18nLabel(msg`Security`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
  ...
  goToSettingsAdminPanel: {
    ...
    label: i18nLabel(msg`Go to Admin Panel Settings`),
    icon: 'IconServer',
    isPinned: false,
    position: 62,
    shortLabel: i18nLabel(msg`Admin Panel`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression:
  ...
  goToSettingsUpdates: {
    ...
    label: i18nLabel(msg`Go to Community Settings`),
    icon: 'IconUsers',
    isPinned: false,
    position: 63,
    shortLabel: i18nLabel(msg`Community`),
    availabilityType: CommandMenuItemAvailabilityType.GLOBAL,
    conditionalAvailabilityExpression: null,
    availabilityObjectMetadataUniversalIdentifier: null,
    frontComponentUniversalIdentifier: null,
  ...
  composeEmailToPerson: {
    ...
    isPinned: true,
    position: 64,
    shortLabel: i18nLabel(msg`Send Email`),
    availabilityType: CommandMenuItemAvailabilityType.RECORD_SELECTION,
    conditionalAvailabilityExpression:
