...
import {
    ...
    MESSAGE_CHANNEL_SUBSCRIPTION_STANDARD_FIELD_IDS,
...
export const STANDARD_OBJECTS = {
  ...
  messageChannel: {
    ...
    fields: {
      ...
      subscriptions: {
        universalIdentifier: MESSAGE_CHANNEL_STANDARD_FIELD_IDS.subscriptions,
      },
    },
    indexes: {
      connectedAccountIdIndex: {
  ...
  messageChannelSubscription: {
    universalIdentifier: STANDARD_OBJECT_IDS.messageChannelSubscription,
    fields: {
      id: { universalIdentifier: '20202020-c01a-4f1a-9a1a-1a2b3c4d5e6f' },
      createdAt: {
        universalIdentifier: '20202020-c01b-4f1b-9b1b-2b3c4d5e6f7a',
      },
      updatedAt: {
        universalIdentifier: '20202020-c01c-4f1c-9c1c-3c4d5e6f7a8b',
      },
      deletedAt: {
        universalIdentifier: '20202020-c01d-4f1d-9d1d-4d5e6f7a8b9c',
      },
      provider: {
        universalIdentifier:
          MESSAGE_CHANNEL_SUBSCRIPTION_STANDARD_FIELD_IDS.provider,
      },
      status: {
        universalIdentifier:
          MESSAGE_CHANNEL_SUBSCRIPTION_STANDARD_FIELD_IDS.status,
      },
      expiresAt: {
        universalIdentifier:
          MESSAGE_CHANNEL_SUBSCRIPTION_STANDARD_FIELD_IDS.expiresAt,
      },
      providerSubscriptionId: {
        universalIdentifier:
          MESSAGE_CHANNEL_SUBSCRIPTION_STANDARD_FIELD_IDS.providerSubscriptionId,
      },
      lastNotificationAt: {
        universalIdentifier:
          MESSAGE_CHANNEL_SUBSCRIPTION_STANDARD_FIELD_IDS.lastNotificationAt,
      },
      failureCount: {
        universalIdentifier:
          MESSAGE_CHANNEL_SUBSCRIPTION_STANDARD_FIELD_IDS.failureCount,
      },
      lastError: {
        universalIdentifier:
          MESSAGE_CHANNEL_SUBSCRIPTION_STANDARD_FIELD_IDS.lastError,
      },
      messageChannel: {
        universalIdentifier:
          MESSAGE_CHANNEL_SUBSCRIPTION_STANDARD_FIELD_IDS.messageChannel,
      },
    },
    indexes: {
      messageChannelIdIndex: {
        universalIdentifier: '4d49e4f8-5770-4d2a-4e1f-78c9d70c1d79',
      },
    },
  },
  messageFolder: {
