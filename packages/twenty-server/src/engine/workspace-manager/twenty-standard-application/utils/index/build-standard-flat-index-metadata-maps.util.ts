...
import { buildCallRecordingCalendarEventAssociationStandardFlatIndexMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/index/compute-call-recording-calendar-event-association-standard-flat-index-metadata.util';
...
const STANDARD_FLAT_INDEX_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  callRecordingCalendarEventAssociation:
    buildCallRecordingCalendarEventAssociationStandardFlatIndexMetadatas,
