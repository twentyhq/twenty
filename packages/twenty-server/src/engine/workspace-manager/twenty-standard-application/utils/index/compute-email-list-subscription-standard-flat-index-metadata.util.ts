...
export const buildEmailListSubscriptionStandardFlatIndexMetadatas = ({
  now,
  objectName,
  workspaceId,
...
}: Omit<CreateStandardIndexArgs<'emailListSubscription'>, 'context'>): Record<
  AllStandardObjectIndexName<'emailListSubscription'>,
  FlatIndexMetadata
> => ({
