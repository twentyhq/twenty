...
export const computeStandardMessageListMemberViews = (
  args: Omit<CreateStandardViewArgs<'messageListMember'>, 'context'>,
): Record<string, FlatView> => {
  return {
    allMessageListMembers: createStandardViewFlatMetadata({
      ...args,
