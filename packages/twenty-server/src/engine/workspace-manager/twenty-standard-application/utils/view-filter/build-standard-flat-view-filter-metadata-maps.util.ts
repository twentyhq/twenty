...
import { computeStandardMessageListMemberViewFilters } from 'src/engine/workspace-manager/twenty-standard-application/utils/view-filter/compute-standard-message-list-member-view-filters.util';
...
const STANDARD_FLAT_VIEW_FILTER_METADATA_BUILDERS_BY_OBJECT_NAME = {
  messageListMember: computeStandardMessageListMemberViewFilters,
