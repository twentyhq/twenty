...
export const buildMessageStandardFlatSearchFieldMetadatas = ({
  now,
  objectName,
  workspaceId,
  ...
  CreateStandardSearchFieldArgs<'message'>,
  'context'
>): FlatSearchFieldMetadata[] =>
  SEARCH_FIELDS_FOR_MESSAGE.map((searchField, position) =>
    createStandardSearchFieldFlatMetadata({
      objectName,
      workspaceId,
      context: {
        fieldName: searchField.name as AllStandardObjectFieldName<'message'>,
        position,
      },
      standardObjectMetadataRelatedEntityIds,
      dependencyFlatEntityMaps,
