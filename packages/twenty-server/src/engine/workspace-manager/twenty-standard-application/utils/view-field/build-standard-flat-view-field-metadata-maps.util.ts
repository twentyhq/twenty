...
import { computeStandardCallRecordingCalendarEventAssociationViewFields } from 'src/engine/workspace-manager/twenty-standard-application/utils/view-field/compute-standard-call-recording-calendar-event-association-view-fields.util';
...
const STANDARD_FLAT_VIEW_FIELD_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  callRecordingCalendarEventAssociation:
    computeStandardCallRecordingCalendarEventAssociationViewFields,
