...
import { computeStandardMessageThreadViewFieldGroups } from 'src/engine/workspace-manager/twenty-standard-application/utils/view-field-group/compute-standard-message-thread-view-field-groups.util';
...
const STANDARD_FLAT_VIEW_FIELD_GROUP_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  messageThread: computeStandardMessageThreadViewFieldGroups,
