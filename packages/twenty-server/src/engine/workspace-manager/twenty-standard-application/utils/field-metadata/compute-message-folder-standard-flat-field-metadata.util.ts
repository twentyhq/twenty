...
>): Record<AllStandardObjectFieldName<'messageFolder'>, FlatFieldMetadata> => ({
  ...
  highestUid: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
  ...
  uidValidity: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
  ...
  modSeq: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'modSeq',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Mod Seq`),
      description: i18nLabel(msg`IMAP Mod Sequence`),
      icon: 'IconHash',
      isNullable: true,
      isUIReadOnly: true,
    },
  ...
  firstSyncedUid: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
