...
> => ({
  ...
  ledProjects: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'ledProjects',
      label: i18nLabel(msg`Led projects`),
      description: i18nLabel(msg`Projects led by the workspace member`),
  ...
  appAccesses: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`App access grants for the workspace member`),
      icon: 'IconLock',
      isNullable: false,
      isUIEditable: false,
  ...
  assignedIssues: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'assignedIssues',
      label: i18nLabel(msg`Assigned issues`),
      description: i18nLabel(msg`Issues assigned to the workspace member`),
  ...
  reportedIssues: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'reportedIssues',
      label: i18nLabel(msg`Reported issues`),
      description: i18nLabel(msg`Issues reported by the workspace member`),
      icon: 'IconLayoutKanban',
      isNullable: false,
      isUIEditable: false,
      targetObjectName: 'issue',
      targetFieldName: 'reporter',
      settings: {
        relationType: RelationType.ONE_TO_MANY,
      },
    },
  ...
  assignedEpics: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'assignedEpics',
      label: i18nLabel(msg`Assigned epics`),
      description: i18nLabel(msg`Epics assigned to the workspace member`),
      icon: 'IconStack2',
      isNullable: false,
      isUIEditable: false,
  ...
  ownedSprints: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'ownedSprints',
      label: i18nLabel(msg`Owned sprints`),
      description: i18nLabel(msg`Sprints owned by the workspace member`),
      icon: 'IconRun',
      isNullable: false,
      isUIEditable: false,
  ...
  issueComments: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(msg`Issue comments`),
      description: i18nLabel(
        msg`Issue comments authored by the workspace member`,
      ),
      icon: 'IconMessage',
      isNullable: false,
      isUIEditable: false,
  ...
  worklogs: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Worklogs logged by the workspace member`),
      icon: 'IconClock',
      isNullable: false,
      isUIEditable: false,
  ...
  shifts: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Shifts worked by the workspace member`),
      icon: 'IconCalendarClock',
      isNullable: false,
      isUIEditable: false,
