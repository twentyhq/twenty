...
> => ({
  ...
  notifications: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      ...
      label: i18nLabel(msg`Notifications`),
      description: i18nLabel(msg`Notifications for the workspace member`),
      icon: 'IconBell',
      isNullable: false,
      isUIEditable: false,
