      ...
      options: [
        {
          ...
          value: 'NEW',
          label: i18nLabel(msg`Application Received`),
          position: 0,
          color: 'red',
        },
        {
          ...
          value: 'SCREENING',
          label: i18nLabel(msg`Eligibility Review`),
          position: 1,
          color: 'purple',
        },
        {
          ...
          value: 'MEETING',
          label: i18nLabel(msg`Farm Assessment`),
          position: 2,
          color: 'sky',
        },
        {
          ...
          value: 'PROPOSAL',
          label: i18nLabel(msg`Forecast Submitted`),
          position: 3,
          color: 'turquoise',
        },
        {
          ...
          value: 'CUSTOMER',
          label: i18nLabel(msg`Loan Approved`),
          position: 4,
          color: 'yellow',
        },
        {
          id: '20202020-df76-40c4-a3cc-498f0d2a2ad5',
          value: 'LOAN_FUNDED',
          label: i18nLabel(msg`Loan Funded`),
          position: 5,
          color: 'green',
        },
        {
          id: '20202020-adde-479b-a29d-8752f8061014',
          value: 'APPLICATION_REJECTED',
          label: i18nLabel(msg`Application Rejected`),
          position: 6,
          color: 'gray',
        },
      ],
