...
>): Record<AllStandardObjectFieldName<'opportunity'>, FlatFieldMetadata> => ({
  ...
  type: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Opportunity type`),
      icon: 'IconTag',
      isNullable: true,
      options: [
        {
          id: '20202020-7a1e-4b2f-9c3d-4e5f6a7b8c9d',
          value: 'CLOSE_RATE',
          label: i18nLabel(msg`Close-Rate`),
          position: 0,
          color: 'blue',
        },
        {
          id: '20202020-8b2f-4c3a-9d4e-5f6a7b8c9d0e',
          value: 'CLOSE_RATE_PILOT',
          label: i18nLabel(msg`Close-Rate Pilot`),
          position: 1,
          color: 'sky',
        },
        {
          id: '20202020-9c3a-4d4b-8e5f-6a7b8c9d0e1f',
          value: 'FRAC_COO',
          label: i18nLabel(msg`FracCOO`),
          position: 2,
          color: 'turquoise',
        },
        {
          id: '20202020-0d4b-4e5c-9f6a-7b8c9d0e1f2a',
          value: 'OTHER',
