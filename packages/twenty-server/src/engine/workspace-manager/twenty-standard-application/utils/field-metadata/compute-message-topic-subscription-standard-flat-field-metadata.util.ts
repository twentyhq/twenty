...
> => ({
  ...
  status: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      options: [
        {
          id: '41a79333-a789-4783-9283-58b52ea82c3c',
          value: 'PENDING',
  ...
  confirmedAt: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'confirmedAt',
      type: FieldMetadataType.DATE_TIME,
      label: i18nLabel(msg`Confirmed at`),
      description: i18nLabel(
        msg`When the person confirmed a double opt-in subscription`,
      ),
