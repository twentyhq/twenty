...
export type FlatCreateWorkflowAction =
  BaseFlatCreateWorkspaceMigrationAction<'workflow'>;

export type UniversalCreateWorkflowAction =
  BaseUniversalCreateWorkspaceMigrationAction<'workflow'>;

export type FlatUpdateWorkflowAction =
  BaseFlatUpdateWorkspaceMigrationAction<'workflow'>;

export type UniversalUpdateWorkflowAction =
  BaseUniversalUpdateWorkspaceMigrationAction<'workflow'>;

export type UniversalDeleteWorkflowAction =
  BaseUniversalDeleteWorkspaceMigrationAction<'workflow'>;

export type FlatDeleteWorkflowAction =
  BaseFlatDeleteWorkspaceMigrationAction<'workflow'>;
