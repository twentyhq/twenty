...
export type FlatCreateSettingsMenuItemAction =
  BaseFlatCreateWorkspaceMigrationAction<'settingsMenuItem'>;

export type UniversalCreateSettingsMenuItemAction =
  BaseUniversalCreateWorkspaceMigrationAction<'settingsMenuItem'>;

export type FlatUpdateSettingsMenuItemAction =
  BaseFlatUpdateWorkspaceMigrationAction<'settingsMenuItem'>;

export type UniversalUpdateSettingsMenuItemAction =
  BaseUniversalUpdateWorkspaceMigrationAction<'settingsMenuItem'>;

export type UniversalDeleteSettingsMenuItemAction =
  BaseUniversalDeleteWorkspaceMigrationAction<'settingsMenuItem'>;

export type FlatDeleteSettingsMenuItemAction =
  BaseFlatDeleteWorkspaceMigrationAction<'settingsMenuItem'>;
