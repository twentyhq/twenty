...
export type FlatCreateTimelineActivityTypeAction =
  BaseFlatCreateWorkspaceMigrationAction<'timelineActivityType'>;

export type UniversalCreateTimelineActivityTypeAction =
  BaseUniversalCreateWorkspaceMigrationAction<'timelineActivityType'>;

export type FlatUpdateTimelineActivityTypeAction =
  BaseFlatUpdateWorkspaceMigrationAction<'timelineActivityType'>;

export type UniversalUpdateTimelineActivityTypeAction =
  BaseUniversalUpdateWorkspaceMigrationAction<'timelineActivityType'>;

export type UniversalDeleteTimelineActivityTypeAction =
  BaseUniversalDeleteWorkspaceMigrationAction<'timelineActivityType'>;

export type FlatDeleteTimelineActivityTypeAction =
  BaseFlatDeleteWorkspaceMigrationAction<'timelineActivityType'>;
