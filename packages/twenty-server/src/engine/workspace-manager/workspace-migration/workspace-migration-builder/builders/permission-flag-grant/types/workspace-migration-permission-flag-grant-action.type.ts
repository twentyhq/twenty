...
export type FlatCreatePermissionFlagGrantAction =
  BaseFlatCreateWorkspaceMigrationAction<'permissionFlagGrant'>;

export type FlatUpdatePermissionFlagGrantAction =
  BaseFlatUpdateWorkspaceMigrationAction<'permissionFlagGrant'>;

export type FlatDeletePermissionFlagGrantAction =
  BaseFlatDeleteWorkspaceMigrationAction<'permissionFlagGrant'>;

export type UniversalCreatePermissionFlagGrantAction =
  BaseUniversalCreateWorkspaceMigrationAction<'permissionFlagGrant'>;

export type UniversalUpdatePermissionFlagGrantAction =
  BaseUniversalUpdateWorkspaceMigrationAction<'permissionFlagGrant'>;

export type UniversalDeletePermissionFlagGrantAction =
  BaseUniversalDeleteWorkspaceMigrationAction<'permissionFlagGrant'>;
