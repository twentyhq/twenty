...
export type CreateViewSortAction =
  BaseCreateWorkspaceMigrationAction<'viewSort'>;

export type UpdateViewSortAction =
  BaseUpdateWorkspaceMigrationAction<'viewSort'>;

export type DeleteViewSortAction =
  BaseDeleteWorkspaceMigrationAction<'viewSort'>;
