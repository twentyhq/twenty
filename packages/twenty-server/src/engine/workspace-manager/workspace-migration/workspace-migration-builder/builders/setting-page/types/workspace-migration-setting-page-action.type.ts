...
export type FlatCreateSettingPageAction =
  BaseFlatCreateWorkspaceMigrationAction<'settingPage'>;

export type UniversalCreateSettingPageAction =
  BaseUniversalCreateWorkspaceMigrationAction<'settingPage'>;

export type FlatUpdateSettingPageAction =
  BaseFlatUpdateWorkspaceMigrationAction<'settingPage'>;

export type UniversalUpdateSettingPageAction =
  BaseUniversalUpdateWorkspaceMigrationAction<'settingPage'>;

export type UniversalDeleteSettingPageAction =
  BaseUniversalDeleteWorkspaceMigrationAction<'settingPage'>;

export type FlatDeleteSettingPageAction =
  BaseFlatDeleteWorkspaceMigrationAction<'settingPage'>;
