...
export type FlatCreateSharingRuleAction =
  BaseFlatCreateWorkspaceMigrationAction<'sharingRule'>;

export type UniversalCreateSharingRuleAction =
  BaseUniversalCreateWorkspaceMigrationAction<'sharingRule'>;

export type FlatUpdateSharingRuleAction =
  BaseFlatUpdateWorkspaceMigrationAction<'sharingRule'>;

export type UniversalUpdateSharingRuleAction =
  BaseUniversalUpdateWorkspaceMigrationAction<'sharingRule'>;

export type UniversalDeleteSharingRuleAction =
  BaseUniversalDeleteWorkspaceMigrationAction<'sharingRule'>;

export type FlatDeleteSharingRuleAction =
  BaseFlatDeleteWorkspaceMigrationAction<'sharingRule'>;
