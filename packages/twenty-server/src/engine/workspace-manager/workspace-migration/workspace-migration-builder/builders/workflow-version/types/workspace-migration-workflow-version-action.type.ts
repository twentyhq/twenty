...
export type FlatCreateWorkflowVersionAction =
  BaseFlatCreateWorkspaceMigrationAction<'workflowVersion'>;

export type UniversalCreateWorkflowVersionAction =
  BaseUniversalCreateWorkspaceMigrationAction<'workflowVersion'>;

export type FlatUpdateWorkflowVersionAction =
  BaseFlatUpdateWorkspaceMigrationAction<'workflowVersion'>;

export type UniversalUpdateWorkflowVersionAction =
  BaseUniversalUpdateWorkspaceMigrationAction<'workflowVersion'>;

export type UniversalDeleteWorkflowVersionAction =
  BaseUniversalDeleteWorkspaceMigrationAction<'workflowVersion'>;

export type FlatDeleteWorkflowVersionAction =
  BaseFlatDeleteWorkspaceMigrationAction<'workflowVersion'>;
