...
export const MESSAGE_CHANNEL_STANDARD_FIELD_IDS = {
  ...
  syncAllFolders: '20202020-a1b2-4c3d-9e8f-1234567890ab',
  pendingGroupEmailsAction: '20202020-b2c3-4d5e-9f1a-2345678901bc',
...
export const MESSAGE_FOLDER_STANDARD_FIELD_IDS = {
  ...
  pendingSyncAction: '20202020-c4d5-4e6f-9a1b-3456789012cd',
} as const;
