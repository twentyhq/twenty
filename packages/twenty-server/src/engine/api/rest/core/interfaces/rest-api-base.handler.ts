...
import { GroupByOutputItem } from 'src/engine/api/common/common-query-runners/common-group-by-query-runner.service';
...
export abstract class RestApiBaseHandler {
  ...
  ): Promise<FormatResult | { data: FormatResult[] } | GroupByOutputItem[]>;
