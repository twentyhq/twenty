...
export class WorkspaceGraphqlSchemaSDLService {
  ...
  async getOrComputeSchemaSDL(
    ...
    const {
      data: {
        flatObjectMetadataMaps: cachedFlatObjectMetadataMaps,
        flatFieldMetadataMaps: cachedFlatFieldMetadataMaps,
        flatIndexMaps: cachedFlatIndexMaps,
        flatApplicationMaps,
      },
      hashes,
    } =
    ...
    let sdl = shouldUseStoredSdl
      ...
      : undefined;
    let usedScalarNames = shouldUseStoredSdl
