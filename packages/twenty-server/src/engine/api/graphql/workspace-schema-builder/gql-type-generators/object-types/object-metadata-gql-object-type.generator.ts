...
import { GraphQLObjectType, GraphQLOutputType, isInputType } from 'graphql';
    ...
    for (const field of objectMetadata.fields) {
      ...
      if (isCompositeFieldMetadataType(field.type)) {
        ...
        if (
          ...
          isInputType(compositeFieldObjectType)
        ) {
        ...
        if (!isDefined(enumFieldEnumType) || isInputType(enumFieldEnumType)) {
