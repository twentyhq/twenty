...
import { ObjectMetadataInterface } from 'src/engine/api/metadata/field-metadata/interfaces/object-metadata.interface';
...
import { fullNameObjectDefinition } from 'src/engine/api/metadata/field-metadata/composite-types/full-name.composite-type';
import { currencyObjectDefinition } from 'src/engine/api/metadata/field-metadata/composite-types/currency.composite-type';
import { linkObjectDefinition } from 'src/engine/api/metadata/field-metadata/composite-types/link.composite-type';
