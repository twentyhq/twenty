...
describe('buildColumnsToSelect', () => {
  ...
  it('should handle non-existent field in relations', () => {
    const select = {
      nameFirstName: true,
    };
  ...
  it('should handle field metadata not found in fieldsById', () => {
    const mockObjectMetadataWithMissingField: any = {
      ...mockObjectMetadataItemWithFieldMaps,
      fieldIdByName: {
        ...mockObjectMetadataItemWithFieldMaps.fieldIdByName,
        company: 'non-existent-field-id',
      },
    };
    ...
    const result = buildColumnsToSelect({
      select,
      relations,
      objectMetadataItemWithFieldMaps: mockObjectMetadataWithMissingField,
    });
