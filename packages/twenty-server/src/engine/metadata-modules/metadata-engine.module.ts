...
import { ApplicationRegistrationWebhookModule } from 'src/engine/core-modules/application-registration-webhook/application-registration-webhook.module';
...
@Module({
  imports: [
    ...
    RouteTriggerModule,
    ApplicationRegistrationWebhookModule,
    WebhookModule,
