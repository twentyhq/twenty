...
import { ApplicationInvokingUserPermissionModule } from 'src/engine/core-modules/application/application-invoking-user-permission/application-invoking-user-permission.module';
...
@Module({
  imports: [
    ...
    ApplicationInvokingUserPermissionModule,
