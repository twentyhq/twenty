...
import { PermissionFlagDefinitionModule } from 'src/engine/metadata-modules/permission-flag-definition/permission-flag-definition.module';
...
@Module({
  imports: [
    ...
    RoleModule,
    PermissionsModule,
    PermissionFlagDefinitionModule,
    RouteTriggerModule,
    WebhookModule,
