...
import { type FlatPageLayoutWidgetTypeValidator } from 'src/engine/metadata-modules/flat-page-layout-widget/types/flat-page-layout-widget-type-validator.type';
...
import { validateGraphFlatPageLayoutWidget } from 'src/engine/metadata-modules/flat-page-layout-widget/validators/utils/validate-graph-flat-page-layout-widget.util';
import { validateIframeFlatPageLayoutWidget } from 'src/engine/metadata-modules/flat-page-layout-widget/validators/utils/validate-iframe-flat-page-layout-widget.util';
import { validateStandaloneRichTextFlatPageLayoutWidget } from 'src/engine/metadata-modules/flat-page-layout-widget/validators/utils/validate-standalone-rich-text-flat-page-layout-widget.util';
...
export class FlatPageLayoutWidgetTypeValidatorService {
  ...
  private readonly PAGE_LAYOUT_WIDGET_TYPE_VALIDATOR_HASHMAP: FlatPageLayoutWidgetTypeValidator =
    {
      ...
      IFRAME: validateIframeFlatPageLayoutWidget,
      ...
      GRAPH: validateGraphFlatPageLayoutWidget,
      STANDALONE_RICH_TEXT: validateStandaloneRichTextFlatPageLayoutWidget,
  ...
  public validateFlatPageLayoutWidgetTypeSpecificities(
    ...
    const pageLayoutWidgetTypeValidator =
      this.PAGE_LAYOUT_WIDGET_TYPE_VALIDATOR_HASHMAP[widgetType];
