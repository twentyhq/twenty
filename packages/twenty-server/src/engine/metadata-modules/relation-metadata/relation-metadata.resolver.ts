...
import { relationMetadataExceptionHandler } from 'src/engine/metadata-modules/relation-metadata/relation-metadata.exception';
...
export class RelationMetadataResolver {
  ...
  deleteOneRelation(
    ...
    return this.relationMetadataService
      .deleteOneRelation(input.id, workspaceId)
      .catch(relationMetadataExceptionHandler);
  }
}
