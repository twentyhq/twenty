...
import { ADD_SHARING_RULE_TABLE_UPGRADE_COMMAND_NAME } from 'src/database/commands/upgrade-version-command/2-41/add-sharing-rule-table-upgrade-command-name.constant';
