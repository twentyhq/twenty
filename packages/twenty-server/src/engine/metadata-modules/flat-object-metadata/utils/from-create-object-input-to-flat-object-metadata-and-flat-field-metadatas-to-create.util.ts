...
export const fromCreateObjectInputToFlatObjectMetadataAndFlatFieldMetadatasToCreate =
  ({
    ...
    flatFieldMetadataToCreate: FlatFieldMetadataSecond[];
    ...
    const objectFlatFieldMetadatas: FlatFieldMetadataSecond[] = [
    ...
    return {
      ...
      flatFieldMetadataToCreate: objectFlatFieldMetadatas,
    };
  };
