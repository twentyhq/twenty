...
import { WorkspaceFlatSharingRuleMapCacheService } from 'src/engine/metadata-modules/flat-sharing-rule/services/workspace-flat-sharing-rule-map-cache.service';
...
@Module({
  ...
  providers: [
    ...
    WorkspaceFlatSharingRuleMapCacheService,
    ...
    provideWorkspaceScopedRepository(SharingRuleEntity),
