import {
  AllFlatEntitiesByMetadataEngineNameV2
...
export type AllFlatEntityMaps = {
  [P in keyof AllFlatEntitiesByMetadataEngineNameV2 as FromMetadataEngineNameToFlatEntityMapsKey<P>]: FlatEntityMaps<
    AllFlatEntitiesByMetadataEngineNameV2[P]['flatEntity']
  >;
};
