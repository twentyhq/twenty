...
import { type WorkspaceMigrationIndexActionType } from 'src/engine/metadata-modules/workspace-migration/workspace-migration.entity';
...
type ExpectedGenericFlatEntityInformation = {
  actions: {
    [P in WorkspaceMigrationIndexActionType]:
