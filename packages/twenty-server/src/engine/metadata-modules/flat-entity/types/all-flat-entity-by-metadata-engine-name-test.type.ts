...
import { WorkspaceMigrationIndexActionType } from 'src/engine/metadata-modules/workspace-migration/workspace-migration.entity';
...
type ExpectedGenericFlatEntityInformation = {
  actions: {
    [P in WorkspaceMigrationIndexActionType]: WorkspaceMigrationActionV2 | WorkspaceMigrationActionV2[];
  };
