...
export type ReplaceFlatEntityInFlatEntityMapsOrThrowArgs<T extends SyncableFlatEntity> =
  {
    flatEntity: T;
    flatEntityMaps: FlatEntityMaps<T>;
  };

export const replaceFlatEntityInFlatEntityMapsOrThrow = <T extends SyncableFlatEntity>({
  flatEntity,
  flatEntityMaps,
