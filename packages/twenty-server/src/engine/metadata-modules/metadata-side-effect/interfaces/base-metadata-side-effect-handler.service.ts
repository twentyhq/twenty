...
import { type MetadataSideEffectAdditionalCacheDataMaps } from 'src/engine/metadata-modules/flat-entity/types/metadata-side-effect-additional-cache-data-maps.type';
...
export type BuildSideEffectsArgs<P extends AllMetadataName> = {
  ...
  relatedFlatEntityMaps: MetadataFlatEntityAndRelatedFlatEntityMapsForSideEffect<P> &
    MetadataSideEffectAdditionalCacheDataMaps<P> & {
