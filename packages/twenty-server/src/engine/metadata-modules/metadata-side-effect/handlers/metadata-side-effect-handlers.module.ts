...
import { ObjectDefaultRelationsOnCreateSideEffectHandlerService } from 'src/engine/metadata-modules/metadata-side-effect/handlers/object-metadata/services/object-default-relations-on-create-side-effect-handler.service';
...
@Module({
  providers: [
    ...
    ObjectDefaultRelationsOnCreateSideEffectHandlerService,
