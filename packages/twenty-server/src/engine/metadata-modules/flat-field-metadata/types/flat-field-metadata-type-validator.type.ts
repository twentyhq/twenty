...
import { GenericValidateFlatFieldMetadataTypeSpecificitiesArgs } from 'src/engine/metadata-modules/flat-field-metadata/services/flat-field-metadata-type-validator.service';
...
export type FlatFieldMetadataTypeValidationArgs<T extends FieldMetadataType> =
  Omit<GenericValidateFlatFieldMetadataTypeSpecificitiesArgs, 'flatEntityToValidate'> & {
