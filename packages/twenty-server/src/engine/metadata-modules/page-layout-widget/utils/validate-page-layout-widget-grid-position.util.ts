  ...
  if (row < 0) {
    errors.push({
      ...
      message: generatePageLayoutWidgetExceptionMessage(
        ...
        widgetTitle,
        undefined,
        `row ${row} must be greater than or equal to 0`,
      ),
      userFriendlyMessage: msg`Widget row must be positive`,
    });
  }
  ...
  if (column < 0) {
    errors.push({
      ...
      message: generatePageLayoutWidgetExceptionMessage(
        ...
        widgetTitle,
        undefined,
        `column ${column} must be greater than or equal to 0`,
      ),
      userFriendlyMessage: msg`Widget column must be positive`,
    });
  }
  ...
  if (rowSpan < 1) {
    errors.push({
      ...
      message: generatePageLayoutWidgetExceptionMessage(
        ...
        widgetTitle,
        undefined,
        `rowSpan ${rowSpan} must be greater than or equal to 1`,
      ),
  ...
  if (columnSpan < 1) {
    errors.push({
      ...
      message: generatePageLayoutWidgetExceptionMessage(
        ...
        widgetTitle,
        undefined,
        `columnSpan ${columnSpan} must be greater than or equal to 1`,
      ),
