...
import { DROP_GRID_POSITION_FROM_PAGE_LAYOUT_WIDGET_UPGRADE_COMMAND_NAME } from 'src/database/commands/upgrade-version-command/2-38/drop-grid-position-from-page-layout-widget-upgrade-command-name.constant';
  ...
  implements Required<PageLayoutWidgetEntity>
{
  ...
  @WasRemovedInUpgrade({
    upgradeCommandName:
      DROP_GRID_POSITION_FROM_PAGE_LAYOUT_WIDGET_UPGRADE_COMMAND_NAME,
  })
