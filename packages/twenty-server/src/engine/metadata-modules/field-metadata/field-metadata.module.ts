...
import { CalculatedFieldService } from 'src/engine/metadata-modules/field-metadata/services/calculated-field.service';
...
@Module({
  ...
  exports: [FieldMetadataService, CalculatedFieldService, FieldMetadataToolsFactory],
})
