...
import { TokenService } from 'src/engine/features/auth/services/token.service';
import { ObjectMetadataService } from 'src/engine/api/metadata/object-metadata/object-metadata.service';
import { baseSchema } from 'src/engine/features/open-api/utils/base-schema.utils';
import {
  computeManyResultPath,
  computeSingleResultPath,
} from 'src/engine/features/open-api/utils/path.utils';
import { getErrorResponses } from 'src/engine/features/open-api/utils/get-error-responses.utils';
import {
  computeMetadataSchemaComponents,
  computeParameterComponents,
  computeSchemaComponents,
} from 'src/engine/features/open-api/utils/components.utils';
import { computeSchemaTags } from 'src/engine/features/open-api/utils/compute-schema-tags.utils';
import { computeWebhooks } from 'src/engine/features/open-api/utils/computeWebhooks.utils';
import { capitalize } from 'src/utils/capitalize';
import {
  getDeleteResponse200,
  getManyResultResponse200,
  getSingleResultSuccessResponse,
} from 'src/engine/features/open-api/utils/responses.utils';
import { getRequestBody } from 'src/engine/features/open-api/utils/request-body.utils';
