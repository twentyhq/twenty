...
import { ChallengeInput } from 'src/engine/features/auth/dto/challenge.input';
import { assert } from 'src/utils/assert';
import {
  PASSWORD_REGEX,
  compareHash,
  hashPassword,
} from 'src/engine/features/auth/auth.util';
import { Verify } from 'src/engine/features/auth/dto/verify.entity';
import { UserExists } from 'src/engine/features/auth/dto/user-exists.entity';
import { WorkspaceInviteHashValid } from 'src/engine/features/auth/dto/workspace-invite-hash-valid.entity';
...
import { UserService } from 'src/engine/features/user/services/user.service';
import { EnvironmentService } from 'src/integrations/environment/environment.service';
import { EmailService } from 'src/integrations/email/email.service';
import { UpdatePassword } from 'src/engine/features/auth/dto/update-password.entity';
import { SignUpService } from 'src/engine/features/auth/services/sign-up.service';
