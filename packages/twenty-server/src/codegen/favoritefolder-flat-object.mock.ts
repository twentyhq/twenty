...
import { FAVORITEFOLDER_FLAT_FIELDS_MOCK } from './favoritefolder-flat-fields.mock';

export const FAVORITEFOLDER_FLAT_OBJECT_MOCK = getFlatObjectMetadataMock({
  ...
  flatIndexMetadatas: [],
  flatFieldMetadatas: Object.values(FAVORITEFOLDER_FLAT_FIELDS_MOCK),
});
