...
import { MKT_STAFF_DATA_SEEDS_IDS } from './mkt-staff-data-seeds.constants';
...
export const MKT_STAFF_STATUS_HISTORY_DATA_SEEDS: MktStaffStatusHistoryDataSeed[] =
  [
    // Initial hiring records - all staff starting with their first status
    {
      ...
      staffId: MKT_STAFF_DATA_SEEDS_IDS.SALES_MANAGER,
    ...
    },
    {
      ...
      staffId: MKT_STAFF_DATA_SEEDS_IDS.SALES_REP_1,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.PERMANENT,
      changeDate: '2024-01-15T09:00:00Z',
      changeReason: 'Initial hiring as permanent employee',
      approvedBy: MKT_STAFF_DATA_SEEDS_IDS.SALES_MANAGER,
      notes:
    ...
    },
    {
      ...
      staffId: MKT_STAFF_DATA_SEEDS_IDS.SALES_REP_2,
      fromStatusId: null,
    ...
    {
      id: MKT_STAFF_STATUS_HISTORY_DATA_SEEDS_IDS.SUPPORT_MANAGER_HIRE,
      staffId: MKT_STAFF_DATA_SEEDS_IDS.SUPPORT_MANAGER,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.PERMANENT,
      changeDate: '2024-01-01T09:00:00Z',
      changeReason: 'Initial hiring as permanent employee',
      approvedBy: null,
      notes: 'Hired as Support Manager with customer service background',
      expectedEndDate: null,
      actualEndDate: null,
      createdBySource: 'MANUAL',
      createdByWorkspaceMemberId: null,
    ...
    {
      id: MKT_STAFF_STATUS_HISTORY_DATA_SEEDS_IDS.SUPPORT_AGENT_1_HIRE,
      staffId: MKT_STAFF_DATA_SEEDS_IDS.SUPPORT_AGENT_1,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.PERMANENT,
      changeDate: '2024-01-10T09:00:00Z',
      changeReason: 'Initial hiring as permanent employee',
      approvedBy: MKT_STAFF_DATA_SEEDS_IDS.SUPPORT_MANAGER,
      notes: 'Experienced support agent hired directly as permanent staff',
      expectedEndDate: null,
      actualEndDate: null,
      createdBySource: 'MANUAL',
      createdByWorkspaceMemberId: null,
    ...
    {
      id: MKT_STAFF_STATUS_HISTORY_DATA_SEEDS_IDS.SUPPORT_AGENT_2_HIRE,
      staffId: MKT_STAFF_DATA_SEEDS_IDS.SUPPORT_AGENT_2,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.CONTRACT,
      changeDate: '2024-02-01T09:00:00Z',
      changeReason: 'Initial hiring on contract basis',
      approvedBy: MKT_STAFF_DATA_SEEDS_IDS.SUPPORT_MANAGER,
      notes: 'Hired on 1-year contract to handle increased workload',
    ...
    {
      id: MKT_STAFF_STATUS_HISTORY_DATA_SEEDS_IDS.FINANCE_MANAGER_HIRE,
      staffId: MKT_STAFF_DATA_SEEDS_IDS.FINANCE_MANAGER,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.PERMANENT,
      changeDate: '2024-01-01T09:00:00Z',
      changeReason: 'Initial hiring as permanent employee',
      approvedBy: null,
      notes: 'Hired as Finance Manager with CPA certification',
      expectedEndDate: null,
      actualEndDate: null,
      createdBySource: 'MANUAL',
      createdByWorkspaceMemberId: null,
    ...
    {
      id: MKT_STAFF_STATUS_HISTORY_DATA_SEEDS_IDS.ACCOUNTANT_HIRE,
      staffId: MKT_STAFF_DATA_SEEDS_IDS.ACCOUNTANT,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.PERMANENT,
      changeDate: '2024-01-15T09:00:00Z',
      changeReason: 'Initial hiring as permanent employee',
      approvedBy: MKT_STAFF_DATA_SEEDS_IDS.FINANCE_MANAGER,
      notes: 'Experienced accountant hired to support finance operations',
      expectedEndDate: null,
      actualEndDate: null,
      createdBySource: 'MANUAL',
      createdByWorkspaceMemberId: null,
    ...
    {
      id: MKT_STAFF_STATUS_HISTORY_DATA_SEEDS_IDS.HR_MANAGER_HIRE,
      staffId: MKT_STAFF_DATA_SEEDS_IDS.HR_MANAGER,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.PERMANENT,
      changeDate: '2024-01-01T09:00:00Z',
      changeReason: 'Initial hiring as permanent employee',
      approvedBy: null,
      notes: 'Hired as HR Manager to establish HR processes',
      expectedEndDate: null,
      actualEndDate: null,
      createdBySource: 'MANUAL',
      createdByWorkspaceMemberId: null,
    ...
    {
      id: MKT_STAFF_STATUS_HISTORY_DATA_SEEDS_IDS.HR_SPECIALIST_HIRE,
      staffId: MKT_STAFF_DATA_SEEDS_IDS.HR_SPECIALIST,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.PERMANENT,
      changeDate: '2024-01-20T09:00:00Z',
      changeReason: 'Initial hiring as permanent employee',
      approvedBy: MKT_STAFF_DATA_SEEDS_IDS.HR_MANAGER,
      notes:
        'HR specialist hired to support recruitment and employee relations',
      expectedEndDate: null,
      actualEndDate: null,
      createdBySource: 'MANUAL',
      createdByWorkspaceMemberId: null,
    ...
    {
      id: MKT_STAFF_STATUS_HISTORY_DATA_SEEDS_IDS.TECH_LEAD_HIRE,
      staffId: MKT_STAFF_DATA_SEEDS_IDS.TECH_LEAD,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.PERMANENT,
      changeDate: '2024-01-01T09:00:00Z',
      changeReason: 'Initial hiring as permanent employee',
      approvedBy: null,
      notes: 'Senior tech lead hired to establish development team',
      expectedEndDate: null,
      actualEndDate: null,
      createdBySource: 'MANUAL',
      createdByWorkspaceMemberId: null,
    ...
    {
      id: MKT_STAFF_STATUS_HISTORY_DATA_SEEDS_IDS.DEVELOPER_HIRE,
      staffId: MKT_STAFF_DATA_SEEDS_IDS.DEVELOPER,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.PERMANENT,
      changeDate: '2024-02-01T09:00:00Z',
      changeReason: 'Initial hiring as permanent employee',
      approvedBy: MKT_STAFF_DATA_SEEDS_IDS.TECH_LEAD,
      notes: 'Full-stack developer hired to work on CRM system',
      expectedEndDate: null,
      actualEndDate: null,
      createdBySource: 'MANUAL',
      createdByWorkspaceMemberId: null,
    ...
    {
      id: MKT_STAFF_STATUS_HISTORY_DATA_SEEDS_IDS.ADMIN_MANAGER_HIRE,
      staffId: MKT_STAFF_DATA_SEEDS_IDS.ADMIN_MANAGER,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.PERMANENT,
      changeDate: '2024-01-01T09:00:00Z',
      changeReason: 'Initial hiring as permanent employee',
      approvedBy: null,
      notes: 'Admin manager hired to oversee administrative operations',
      expectedEndDate: null,
      actualEndDate: null,
      createdBySource: 'MANUAL',
      createdByWorkspaceMemberId: null,
    ...
    {
      id: MKT_STAFF_STATUS_HISTORY_DATA_SEEDS_IDS.ADMIN_STAFF_HIRE,
      staffId: MKT_STAFF_DATA_SEEDS_IDS.ADMIN_STAFF,
      fromStatusId: null,
      toStatusId: MKT_EMPLOYMENT_STATUS_DATA_SEEDS_IDS.PERMANENT,
      changeDate: '2024-01-25T09:00:00Z',
      changeReason: 'Initial hiring as permanent employee',
      approvedBy: MKT_STAFF_DATA_SEEDS_IDS.ADMIN_MANAGER,
      notes: 'Administrative staff hired to support daily operations',
      expectedEndDate: null,
      actualEndDate: null,
      createdBySource: 'MANUAL',
      createdByWorkspaceMemberId: null,
