...
import { WorkflowVersionNonActivableGateModule } from 'src/modules/workflow/workflow-builder/workflow-validation/workflow-version-non-activable-gate.module';
...
@Module({
  imports: [
    ...
    WorkflowVersionNonActivableGateModule,
