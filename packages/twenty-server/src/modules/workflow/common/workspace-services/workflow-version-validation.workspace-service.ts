  ...
  async validateWorkflowVersionForCreateOne(
    ...
    if (
      ...
      throw new WorkflowQueryValidationException(
        ...
        {
          displayedErrorMessage: t`Cannot create workflow version with status other than draft`,
        },
      );
    }
    ...
    if (workflowAlreadyHasDraftVersion) {
      throw new WorkflowQueryValidationException(
        ...
        WorkflowQueryValidationExceptionCode.FORBIDDEN,
        {
          displayedErrorMessage: t`Cannot create multiple draft versions for the same workflow`,
        },
      );
    }
  }
  ...
  async validateWorkflowVersionForUpdateOne({
    ...
    if (payload.data.status && payload.data.status !== workflowVersion.status) {
      throw new WorkflowQueryValidationException(
        ...
        WorkflowQueryValidationExceptionCode.FORBIDDEN,
        {
          displayedErrorMessage: t`Cannot update workflow version status manually`,
        },
      );
    }
  ...
  async validateWorkflowVersionForDeleteOne(
    ...
    if (!otherWorkflowVersionsExist) {
      throw new WorkflowQueryValidationException(
        ...
        WorkflowQueryValidationExceptionCode.FORBIDDEN,
        {
          displayedErrorMessage: t`The initial version of a workflow can not be deleted`,
        },
      );
    }
  }
