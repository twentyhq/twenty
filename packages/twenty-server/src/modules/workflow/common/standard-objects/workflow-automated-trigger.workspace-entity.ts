...
export class WorkflowAutomatedTriggerWorkspaceEntity extends createBaseWorkspaceEntity(
  {
    id: STANDARD_OBJECTS.workflowAutomatedTrigger.fields.id.universalIdentifier,
    createdAt:
      STANDARD_OBJECTS.workflowAutomatedTrigger.fields.createdAt
        .universalIdentifier,
    updatedAt:
      STANDARD_OBJECTS.workflowAutomatedTrigger.fields.updatedAt
        .universalIdentifier,
    deletedAt:
      STANDARD_OBJECTS.workflowAutomatedTrigger.fields.deletedAt
        .universalIdentifier,
  },
) {
  @WorkspaceField({
  ...
  @WorkspaceRelation({
    universalIdentifier: WORKFLOW_AUTOMATED_TRIGGER_STANDARD_FIELD_IDS.workflow,
