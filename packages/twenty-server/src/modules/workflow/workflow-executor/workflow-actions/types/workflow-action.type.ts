...
import { type WorkflowLogicFunctionActionSettings } from 'src/modules/workflow/workflow-executor/workflow-actions/logic-function/types/workflow-function-action-settings.type';
...
export type WorkflowLogicFunctionAction = BaseWorkflowAction & {
  type: WorkflowActionType.FUNCTION;
