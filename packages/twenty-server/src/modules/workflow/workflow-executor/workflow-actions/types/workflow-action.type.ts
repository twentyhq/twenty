...
export type WorkflowCreateOrUpdateRecordAction = BaseWorkflowAction & {
  type: WorkflowActionType.CREATE_OR_UPDATE_RECORD;
  settings: WorkflowCreateOrUpdateRecordActionSettings;
};
