...
// Propel clean-room RLS — offPlanOpportunity (lane ②). Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`offPlanOpportunity.findMany`)
export class OffPlanOpportunityRlsPreQueryHook implements WorkspacePreQueryHookInstance {
