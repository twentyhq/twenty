...
// Propel clean-room RLS — sellOpportunity.groupBy. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`sellOpportunity.groupBy`)
export class SellOpportunityGroupByRlsPreQueryHook implements WorkspacePreQueryHookInstance {
