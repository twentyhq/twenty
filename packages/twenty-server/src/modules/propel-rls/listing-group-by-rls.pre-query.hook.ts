...
// Propel clean-room RLS — listing.groupBy. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`listing.groupBy`)
export class ListingGroupByRlsPreQueryHook implements WorkspacePreQueryHookInstance {
