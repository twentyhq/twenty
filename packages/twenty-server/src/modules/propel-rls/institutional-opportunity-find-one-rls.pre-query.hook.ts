...
// Propel clean-room RLS — institutionalOpportunity.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`institutionalOpportunity.findOne`)
export class InstitutionalOpportunityFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
