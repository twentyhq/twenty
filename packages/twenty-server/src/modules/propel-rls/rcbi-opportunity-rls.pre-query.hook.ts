...
// Propel clean-room RLS — rcbiOpportunity (lane ⑦). Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`rcbiOpportunity.findMany`)
export class RcbiOpportunityRlsPreQueryHook implements WorkspacePreQueryHookInstance {
