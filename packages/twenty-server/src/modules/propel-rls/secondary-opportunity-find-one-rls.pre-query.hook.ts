...
// Propel clean-room RLS — secondaryOpportunity.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`secondaryOpportunity.findOne`)
export class SecondaryOpportunityFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
