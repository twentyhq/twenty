...
// Propel clean-room RLS — chainLink.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`chainLink.findOne`)
export class ChainLinkFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
