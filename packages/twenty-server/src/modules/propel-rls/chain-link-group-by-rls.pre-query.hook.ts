...
// Propel clean-room RLS — chainLink.groupBy. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`chainLink.groupBy`)
export class ChainLinkGroupByRlsPreQueryHook implements WorkspacePreQueryHookInstance {
