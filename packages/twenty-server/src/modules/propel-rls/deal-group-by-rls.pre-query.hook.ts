...
// Propel clean-room RLS — deal.groupBy. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`deal.groupBy`)
export class DealGroupByRlsPreQueryHook implements WorkspacePreQueryHookInstance {
