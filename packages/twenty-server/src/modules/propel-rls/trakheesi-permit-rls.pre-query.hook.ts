...
// Propel clean-room RLS — trakheesiPermit (child). Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`trakheesiPermit.findMany`)
export class TrakheesiPermitRlsPreQueryHook implements WorkspacePreQueryHookInstance {
