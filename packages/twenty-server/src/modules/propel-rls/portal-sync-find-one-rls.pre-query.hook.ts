...
// Propel clean-room RLS — portalSync.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`portalSync.findOne`)
export class PortalSyncFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
