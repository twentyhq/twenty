...
// Propel clean-room RLS — institutionalOpportunity.groupBy. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`institutionalOpportunity.groupBy`)
export class InstitutionalOpportunityGroupByRlsPreQueryHook implements WorkspacePreQueryHookInstance {
