...
// Propel clean-room RLS — offer (§8.4). Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`offer.findMany`)
export class OfferRlsPreQueryHook implements WorkspacePreQueryHookInstance {
