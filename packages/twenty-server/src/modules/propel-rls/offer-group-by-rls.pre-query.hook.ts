...
// Propel clean-room RLS — offer.groupBy. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`offer.groupBy`)
export class OfferGroupByRlsPreQueryHook implements WorkspacePreQueryHookInstance {
