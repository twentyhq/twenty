...
// Propel clean-room RLS — offPlanOpportunity.groupBy. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`offPlanOpportunity.groupBy`)
export class OffPlanOpportunityGroupByRlsPreQueryHook implements WorkspacePreQueryHookInstance {
