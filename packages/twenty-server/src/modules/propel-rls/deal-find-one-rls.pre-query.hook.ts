...
// Propel clean-room RLS — deal.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`deal.findOne`)
export class DealFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
