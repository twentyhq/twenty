...
// Propel clean-room RLS — sellOpportunity.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`sellOpportunity.findOne`)
export class SellOpportunityFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
