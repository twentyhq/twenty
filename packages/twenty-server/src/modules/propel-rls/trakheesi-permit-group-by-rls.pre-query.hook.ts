...
// Propel clean-room RLS — trakheesiPermit.groupBy. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`trakheesiPermit.groupBy`)
export class TrakheesiPermitGroupByRlsPreQueryHook implements WorkspacePreQueryHookInstance {
