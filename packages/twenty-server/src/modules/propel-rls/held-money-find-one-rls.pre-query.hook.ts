...
// Propel clean-room RLS — heldMoney.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`heldMoney.findOne`)
export class HeldMoneyFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
