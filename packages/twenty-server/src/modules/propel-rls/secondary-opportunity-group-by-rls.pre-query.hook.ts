...
// Propel clean-room RLS — secondaryOpportunity.groupBy. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`secondaryOpportunity.groupBy`)
export class SecondaryOpportunityGroupByRlsPreQueryHook implements WorkspacePreQueryHookInstance {
