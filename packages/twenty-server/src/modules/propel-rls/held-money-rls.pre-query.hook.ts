...
// Propel clean-room RLS — heldMoney (§8.5). Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`heldMoney.findMany`)
export class HeldMoneyRlsPreQueryHook implements WorkspacePreQueryHookInstance {
