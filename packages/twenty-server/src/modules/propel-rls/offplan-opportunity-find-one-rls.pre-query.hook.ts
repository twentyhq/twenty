...
// Propel clean-room RLS — offPlanOpportunity.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`offPlanOpportunity.findOne`)
export class OffPlanOpportunityFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
