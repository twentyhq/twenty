...
// Propel clean-room RLS — institutionalOpportunity (lane ③). Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`institutionalOpportunity.findMany`)
export class InstitutionalOpportunityRlsPreQueryHook implements WorkspacePreQueryHookInstance {
