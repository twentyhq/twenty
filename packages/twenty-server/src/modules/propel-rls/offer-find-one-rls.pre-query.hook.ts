...
// Propel clean-room RLS — offer.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`offer.findOne`)
export class OfferFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
