...
// Propel clean-room RLS — listing.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`listing.findOne`)
export class ListingFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
