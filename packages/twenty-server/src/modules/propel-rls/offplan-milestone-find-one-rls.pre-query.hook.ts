...
// Propel clean-room RLS — offPlanMilestone.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`offPlanMilestone.findOne`)
export class OffPlanMilestoneFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
