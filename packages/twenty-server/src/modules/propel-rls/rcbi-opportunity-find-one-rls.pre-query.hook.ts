...
// Propel clean-room RLS — rcbiOpportunity.findOne. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`rcbiOpportunity.findOne`)
export class RcbiOpportunityFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
