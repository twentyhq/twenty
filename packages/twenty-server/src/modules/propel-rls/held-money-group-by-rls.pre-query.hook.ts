...
// Propel clean-room RLS — heldMoney.groupBy. Tier resolved from Twenty role in propel-tier.service.ts.
@WorkspaceQueryHook(`heldMoney.groupBy`)
export class HeldMoneyGroupByRlsPreQueryHook implements WorkspacePreQueryHookInstance {
