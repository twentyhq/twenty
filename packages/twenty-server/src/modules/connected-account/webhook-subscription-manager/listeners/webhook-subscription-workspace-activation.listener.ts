...
import {
  ...
  type SyncWorkspaceWebhookSubscriptionsJobData,
} from 'src/modules/connected-account/webhook-subscription-manager/jobs/sync-workspace-webhook-subscriptions.job';
