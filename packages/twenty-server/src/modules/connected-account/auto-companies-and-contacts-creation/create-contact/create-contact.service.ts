...
import { getFirstNameAndLastNameFromHandleAndDisplayName } from 'src/modules/calendar-messaging-participant-manager/utils/get-first-name-and-last-name-from-handle-and-display-name.util';
