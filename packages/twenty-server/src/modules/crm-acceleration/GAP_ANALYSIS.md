...
| Estado | Count |
|--------|-------|
| ✅ Implementado real (crm-acceleration services) | 12 |
| 🔶 Stub / entidad mínima (módulos separados) | 9 |
| ❌ Fase 2 — pendiente código | 55 |
| ❌ Fase 3 — pendiente código | 28 |
| ❌ Fase 4 — backlog | 12 |
| **Total faltante** | **87** |
...
## 🔶 Stubs — módulos separados (entidades mínimas, sin lógica completa)

| # | Feature | Módulo | Gap |
|---|---------|--------|-----|
| 1 | Predictive Lead Scoring | lead-scoring/ | Solo stub, sin modelo ML |
...
| 56 | Gamification | gamification/ | Entidades badge/goal, sin lógica puntos |
