...
export class WorkspaceMemberWorkspaceEntity extends BaseWorkspaceEntity {
  ...
  @WorkspaceRelation({
    standardId: WORKSPACE_MEMBER_STANDARD_FIELD_IDS.managedPolicies,
    type: RelationType.ONE_TO_MANY,
    label: msg`Managed Policies`,
    description: msg`Policies managed by the workspace member`,
    icon: 'IconFileText',
    inverseSideTarget: () => PolicyWorkspaceEntity,
    inverseSideFieldKey: 'accountManager',
    onDelete: RelationOnDeleteAction.SET_NULL,
  })
  @WorkspaceIsNullable()
  managedPolicies: Relation<PolicyWorkspaceEntity[]>;

  @WorkspaceJoinColumn('managedPolicies')
  managedPoliciesIds: string[];
  ...
  @WorkspaceRelation({
    standardId: WORKSPACE_MEMBER_STANDARD_FIELD_IDS.rabbitSignSignatures,
    type: RelationType.ONE_TO_MANY,
    label: msg`RabbitSign Signatures`,
    description: msg`RabbitSign signatures owned by the workspace member`,
    icon: 'IconSignature',
    inverseSideTarget: () => RabbitSignSignatureWorkspaceEntity,
    inverseSideFieldKey: 'workspaceMember',
    onDelete: RelationOnDeleteAction.CASCADE,
  })
  rabbitSignSignatures: Relation<RabbitSignSignatureWorkspaceEntity[]>;
}
