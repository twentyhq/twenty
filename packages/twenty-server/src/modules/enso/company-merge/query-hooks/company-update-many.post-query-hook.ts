...
// Batch company update — re-check each affected row (worker no-ops unless ≥2 live
// companies share an identity).
@Injectable()
@WorkspaceQueryHook({
  key: `company.updateMany`,
  type: WorkspaceQueryHookType.POST_HOOK,
})
export class CompanyMergeCompanyUpdateManyPostQueryHook implements WorkspacePostQueryHookInstance {
  constructor(
