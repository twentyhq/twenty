...
export class CalendarEventParticipantWorkspaceEntity extends createBaseWorkspaceEntity(
  ...
  @WorkspaceRelation({
    universalIdentifier: CALENDAR_EVENT_PARTICIPANT_STANDARD_FIELD_IDS.calendarEvent,
  ...
  @WorkspaceRelation({
    universalIdentifier: CALENDAR_EVENT_PARTICIPANT_STANDARD_FIELD_IDS.person,
    type: RelationType.MANY_TO_ONE,
    label: msg`Person`,
  ...
  @WorkspaceRelation({
    universalIdentifier: CALENDAR_EVENT_PARTICIPANT_STANDARD_FIELD_IDS.workspaceMember,
    type: RelationType.MANY_TO_ONE,
