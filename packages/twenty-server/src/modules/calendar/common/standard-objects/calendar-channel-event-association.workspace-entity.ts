...
export class CalendarChannelEventAssociationWorkspaceEntity extends createBaseWorkspaceEntity(
  {
    id: STANDARD_OBJECTS.calendarChannelEventAssociation.fields.id
      .universalIdentifier,
    createdAt:
      STANDARD_OBJECTS.calendarChannelEventAssociation.fields.createdAt
        .universalIdentifier,
    updatedAt:
      STANDARD_OBJECTS.calendarChannelEventAssociation.fields.updatedAt
        .universalIdentifier,
    deletedAt:
      STANDARD_OBJECTS.calendarChannelEventAssociation.fields.deletedAt
        .universalIdentifier,
  },
) {
  /**
