      ...
      try {
        ...
        const [calendarChannels] = isMigrated
          ? await this.coreDataSource.query(
              ...
              [CalendarChannelSyncStage.CALENDAR_EVENT_LIST_FETCH_SCHEDULED, now, activeWorkspace.id, CalendarChannelSyncStage.CALENDAR_EVENT_LIST_FETCH_PENDING],
            )
          : await this.coreDataSource.query(
              ...
              [CalendarChannelSyncStage.CALENDAR_EVENT_LIST_FETCH_SCHEDULED, now, CalendarChannelSyncStage.CALENDAR_EVENT_LIST_FETCH_PENDING],
            );
