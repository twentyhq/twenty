...
export class NoteTargetWorkspaceEntity extends createBaseWorkspaceEntity({
  id: STANDARD_OBJECTS.noteTarget.fields.id.universalIdentifier,
  createdAt: STANDARD_OBJECTS.noteTarget.fields.createdAt.universalIdentifier,
  updatedAt: STANDARD_OBJECTS.noteTarget.fields.updatedAt.universalIdentifier,
  deletedAt: STANDARD_OBJECTS.noteTarget.fields.deletedAt.universalIdentifier,
}) {
  @WorkspaceRelation({
    universalIdentifier: NOTE_TARGET_STANDARD_FIELD_IDS.note,
  ...
  @WorkspaceRelation({
    universalIdentifier: NOTE_TARGET_STANDARD_FIELD_IDS.person,
    type: RelationType.MANY_TO_ONE,
    label: msg`Person`,
  ...
  @WorkspaceRelation({
    universalIdentifier: NOTE_TARGET_STANDARD_FIELD_IDS.company,
    type: RelationType.MANY_TO_ONE,
    label: msg`Company`,
