...
import { GmailGetEmailIdsToFilterService } from 'src/modules/messaging/services/gmail-partial-message-list-fetch/gmail-fetch-messages-ids-to-exclude.service';
...
@Module({
  ...
  providers: [
    ...
    GmailGetEmailIdsToFilterService,
  ],
  exports: [
    GmailPartialMessageListFetchService,
    GmailPartialMessageListFetchV2Service,
