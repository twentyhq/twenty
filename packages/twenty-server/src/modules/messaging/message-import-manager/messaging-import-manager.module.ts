...
import { ImportMessagesResolver } from 'src/modules/messaging/message-import-manager/resolvers/import-messages.resolver';
...
@Module({
  ...
  providers: [
    ...
    MessagingImportMessagesService,
    ImportMessagesResolver,
