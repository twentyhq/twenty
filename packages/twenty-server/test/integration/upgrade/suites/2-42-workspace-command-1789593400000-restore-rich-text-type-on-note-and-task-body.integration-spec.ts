...
import { type RestoreRichTextTypeOnNoteAndTaskBodyCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-workspace-command-1789593400000-restore-rich-text-type-on-note-and-task-body.command';
...
describe('2-42 workspace command 1789593400000 - RestoreRichTextTypeOnNoteAndTaskBodyCommand (integration)', () => {
