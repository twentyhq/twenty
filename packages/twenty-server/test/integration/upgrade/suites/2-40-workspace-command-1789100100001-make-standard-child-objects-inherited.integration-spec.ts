...
import { type MakeStandardChildObjectsInheritedCommand } from 'src/database/commands/upgrade-version-command/2-40/2-40-workspace-command-1789100100001-make-standard-child-objects-inherited.command';
...
describe('2-40 workspace command 1789100100001 - MakeStandardChildObjectsInheritedCommand (integration)', () => {
