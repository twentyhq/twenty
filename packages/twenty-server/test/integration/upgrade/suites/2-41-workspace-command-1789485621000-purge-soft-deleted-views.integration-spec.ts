...
import { type PurgeSoftDeletedViewsCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-workspace-command-1789485621000-purge-soft-deleted-views.command';
...
describe('2-41 workspace command 1789485621000 - PurgeSoftDeletedViewsCommand (integration)', () => {
