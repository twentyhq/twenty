...
import { updateCoreViewFieldQueryFactory } from 'test/integration/metadata/suites/view-field/utils/update-core-view-field-query-factory.util';
...
export const updateOneCoreViewField = async ({
  ...
  updateCoreViewField: ViewFieldEntity;
}> => {
  const graphqlOperation = updateCoreViewFieldQueryFactory({
    input,
    gqlFields,
  });
