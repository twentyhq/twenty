...
// Test function 1: Simple greeting function
const SIMPLE_FUNCTION_CODE = {
  'src/index.ts': `export const main = async (params: { name: string }): Promise<object> => {
...
// Test function 2: Function using lodash (external package)
...
// Test function 3: Function that throws an error
...
describe('Serverless Function Execution', () => {
  ...
  it('should execute a simple serverless function', async () => {
    // Create the function
    ...
    expect(result?.logs).toContain('Greeting generated:');
  });
