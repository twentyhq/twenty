...
4. For each translated locale pulled from Crowdin, ensure a `packages/twenty-docs/<language>/navigation.json` file exists. These files contain **labels only**; page slugs always come from the base structure.
