...
<Note>
10,000개 이상의 회사를 가져와야 하나요? 여러 파일로 분할하거나 [API 가져오기](/ko/user-guide/data-migration/how-tos/import-data-via-api)를 사용하세요.
</Note>
...
1. **[연락처 가져오기](/ko/user-guide/data-migration/how-tos/import-contacts-via-csv)** — 도메인을 사용하여 회사에 연결하세요
2. **기회 가져오기** — 회사에 연결하세요
...
* [고유성 제약 조건](/ko/user-guide/data-migration/capabilities/uniqueness-constraints)
