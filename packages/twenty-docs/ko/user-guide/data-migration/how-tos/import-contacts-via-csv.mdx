...
자세한 내용은 [기존 레코드를 업데이트하는 방법](/ko/user-guide/data-migration/how-tos/update-existing-records-via-import)을 참조하세요.
...
* [가져오기 오류 수정](/ko/user-guide/data-migration/how-tos/fix-import-errors)
* [관계 가져오기 방법](/ko/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv)
* [필드 매핑 레퍼런스](/ko/user-guide/data-migration/capabilities/field-mapping)
