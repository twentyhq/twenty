...
<Tip>
파이프라인 단계에서 시간을 추적하는 전체 예시는 [각 단계에서 기회가 머무는 기간 추적하기](/ko/user-guide/views-pipelines/how-tos/track-time-in-stage)를 참조하세요.
</Tip>
...
전체 워크플로우는 [파이프라인에서 예상 금액 표시하기](/ko/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline)를 참조하세요.
...
* [파이프라인에서 예상 금액 표시하기](/ko/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline)
* [단계에서 시간 추적하기](/ko/user-guide/views-pipelines/how-tos/track-time-in-stage)
