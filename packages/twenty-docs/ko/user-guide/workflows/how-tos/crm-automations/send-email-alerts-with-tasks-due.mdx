...
* [워크플로우에서 이메일 보내기](/ko/user-guide/workflows/capabilities/send-emails-from-workflows)
* [Code 액션에서 배열 처리하기](/ko/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions)
