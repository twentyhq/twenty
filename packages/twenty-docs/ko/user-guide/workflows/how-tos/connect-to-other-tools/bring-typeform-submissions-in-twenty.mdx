...
표준 Webhook 설정은 [Webhook 트리거 설정](/ko/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger)을 참조하세요. 이 문서는 Typeform의 맞춤형 페이로드 구조에 필요한 특정 처리 방법을 다룹니다.
...
* [Webhook 트리거 설정](/ko/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger)
