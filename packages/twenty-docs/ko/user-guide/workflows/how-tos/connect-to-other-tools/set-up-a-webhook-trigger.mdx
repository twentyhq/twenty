...
<Tip>
배열 처리에 대한 자세한 내용은 [Code 액션에서 배열 처리하기](/ko/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions)를 참조하세요.
</Tip>

## 관련 항목

* [워크플로우 트리거](/ko/user-guide/workflows/capabilities/workflow-triggers)
