...
* [Twenty에서 PDF 생성](/ko/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — 생성된 PDF를 레코드에 첨부
...
* [Closed Won 자동화](/ko/user-guide/workflows/how-tos/crm-automations/closed-won-automations)
