...
* [관계 필드](/ko/user-guide/data-model/capabilities/relation-fields) — 관계 유형 설명
* [사용자 정의 오브젝트 만들기](/ko/user-guide/data-model/how-tos/create-custom-objects) — 오브젝트 생성 방법
* [관계 필드 만들기](/ko/user-guide/data-model/how-tos/create-relation-fields) — 기본 관계 설정
