...
API 키를 생성하려면 **Settings → MCP & APIs → API → + Create key**로 이동하세요. 자세한 내용은 [API](/ko/developers/extend/api#create-an-api-key)를 참조하세요.
...
* **API Key**: **Settings → Members → Roles**에서 API 키에 역할을 할당하세요. 자세한 내용은 [권한](/ko/user-guide/permissions-access/capabilities/permissions)을 참조하세요.
