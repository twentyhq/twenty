...
<Tip>
이는 워크플로를 사용하여 [수식 필드](/ko/user-guide/workflows/how-tos/crm-automations/formula-fields)를 만드는 예시입니다.
</Tip>
...
* [수식 필드](/ko/user-guide/workflows/how-tos/crm-automations/formula-fields) — 워크플로를 사용하여 계산된 필드를 생성
* [칸반 보기](/ko/user-guide/views-pipelines/capabilities/kanban-views) — 열 집계
* [사용자 정의 필드 만드는 방법](/ko/user-guide/data-model/how-tos/create-custom-fields) — 필드 구성
