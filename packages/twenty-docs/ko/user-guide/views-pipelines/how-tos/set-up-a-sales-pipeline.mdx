...
* [칸반 보기](/ko/user-guide/views-pipelines/capabilities/kanban-views) — 집계 및 컴팩트 보기
* [필터 및 정렬](/ko/user-guide/views-pipelines/capabilities/filters-and-sorting) — 필터된 보기 만들기
