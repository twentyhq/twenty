...
* [칸반 보기](/ko/user-guide/views-pipelines/capabilities/kanban-views) — 집계, 컴팩트 보기, 단계
* [영업 파이프라인 설정 방법](/ko/user-guide/views-pipelines/how-tos/set-up-a-sales-pipeline) — 기회용 칸반
