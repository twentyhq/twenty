...
<Tip>
이는 워크플로를 사용해 [수식 필드](/ko/user-guide/workflows/how-tos/crm-automations/formula-fields)를 만드는 예시로, 특히 날짜 계산에 관한 내용입니다.
</Tip>
...
* [워크플로](/ko/user-guide/workflows/overview) — 자동화 기본
* [사용자 정의 필드 생성 방법](/ko/user-guide/data-model/how-tos/create-custom-fields) — 필드 구성
* [칸반 보기](/ko/user-guide/views-pipelines/capabilities/kanban-views) — 집계
