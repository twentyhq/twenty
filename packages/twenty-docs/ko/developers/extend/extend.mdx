...
<CardGroup cols={2}>
  <Card title="API" icon="code" href="/ko/developers/extend/api">
    프로그래밍 방식으로 Twenty에 연결하세요
  </Card>
  <Card title="웹훅" icon="bell" href="/ko/developers/extend/webhooks">
    이벤트에 대한 실시간 알림을 받으세요
  </Card>
  <Card title="앱" icon="puzzle-piece" href="/ko/developers/extend/apps/getting-started/quick-start">
    코드로 사용자 지정을 구축하세요
  </Card>
</CardGroup>
