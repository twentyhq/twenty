...
| 시나리오                | 인증 방식                                                                        |
| ------------------- | ---------------------------------------------------------------------------- |
| 내부 스크립트, 자동화        | [API 키](/ko/developers/extend/api#authentication)                               |
| 사용자를 대신하여 동작하는 외부 앱 | **OAuth — 권한 부여 코드**                                                         |
| 서버 간, 사용자 컨텍스트 없음   | **OAuth — 클라이언트 자격 증명**                                                      |
| UI 확장이 포함된 Twenty 앱 | [앱](/ko/developers/extend/apps/getting-started/quick-start) (OAuth는 자동으로 처리됩니다) |
