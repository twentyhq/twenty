...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/ko/developers/extend/apps/operations/cli">
    `yarn twenty` 참고 — exec, logs, uninstall, remotes.
  </Card>
  <Card title="동기화 및 복구" icon="compass" href="/ko/developers/extend/apps/operations/sync-and-recovery">
    동기화 차분을 읽을 때 어떤 명령을 사용할지와 복구 단계에 대해 다룹니다.
  </Card>
  <Card title="테스트" icon="flask" href="/ko/developers/extend/apps/operations/testing">
    Vitest 설정, 통합 테스트, 타입 체크, CI 워크플로.
  </Card>
  <Card title="게시" icon="upload" href="/ko/developers/extend/apps/operations/publishing">
