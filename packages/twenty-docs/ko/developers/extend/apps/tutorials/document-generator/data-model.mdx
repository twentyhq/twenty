...
전체 패턴은 [Relations](/ko/developers/extend/apps/data/relations)를 참조하세요.
...
<Card title="다음: 문서 생성 →" icon="bolt" href="/ko/developers/extend/apps/tutorials/document-generator/generating-documents">
