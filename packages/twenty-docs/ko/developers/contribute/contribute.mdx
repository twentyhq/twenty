...
<CardGroup cols={2}>
  <Card title="버그 보고 및 요청" icon="bug" href="/ko/developers/contribute/capabilities/bug-and-requests">
    문제를 보고하거나 기능을 요청하세요
  </Card>
  <Card title="프론트엔드 개발" icon="browser" href="/ko/developers/contribute/capabilities/frontend-development/folder-architecture-front">
    UI에 기여하세요
  </Card>
</CardGroup>
