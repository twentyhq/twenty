...
After understanding objects:
- [Learn about Fields](/user-guide/Features & Configuration/fields/field-types-reference) to add properties to your objects
- [Explore Custom Objects](/user-guide/Features & Configuration/objects/custom-objects) for advanced use cases
- [Set up Object Permissions](/user-guide/Features & Configuration/objects/object-permissions-and-access-control) to control access
