...
For email and calendar setup, visit [Connect Your Mailbox and Calendar](/user-guide/Getting Started with Twenty/first-configuration/connect-your-mailbox-and-calendar).
