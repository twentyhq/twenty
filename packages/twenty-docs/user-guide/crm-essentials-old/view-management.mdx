...
For more advanced data organization, see our [Data Model section](/user-guide/How-To Tutorials/admins/data-model/create-custom-objects) to learn about customizing fields and objects.
