---
<<<<<<< Updated upstream:packages/twenty-docs/user-guide/Getting Started/learn-the-interface/navigation-overview.mdx
...
If you're new to Views, read our [View Management](/user-guide/How-To Tutorials/end-users/views-daily-crm-usage/how-to-create-a-new-view) article to learn how to create and customize them.
...
description: Navigate the Twenty interface and understand the main areas.
---

# Getting Around Twenty

*Content to be added*
>>>>>>> Stashed changes:packages/twenty-docs/user-guide/getting-started/getting-around-twenty.mdx

Now that you understand the basic navigation:
- [Learn about the Sidebar](/user-guide/Getting Started/learn-the-interface/using-the-sidebar)
- [Discover the Command Palette](/user-guide/Getting Started/learn-the-interface/using-the-command-palette)
- [Master Keyboard Shortcuts](/user-guide/Getting Started/learn-the-interface/keyboard-shortcuts)
