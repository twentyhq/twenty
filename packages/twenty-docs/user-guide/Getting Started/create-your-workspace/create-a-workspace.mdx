---
<<<<<<< Updated upstream:packages/twenty-docs/user-guide/Getting Started/create-your-workspace/create-a-workspace.mdx
...
description: How to create your Twenty workspace.
---

# Create Workspace

*Content to be added*
>>>>>>> Stashed changes:packages/twenty-docs/user-guide/getting-started/create-workspace.mdx

After creating your workspace, you'll want to:
- [Learn the Interface](/user-guide/Getting Started/learn-the-interface/navigation-overview)
- [Configure Your First Settings](/user-guide/Getting Started/first-configuration/connect-your-mailbox-and-calendar)
