...
Follow our [data model guide](/user-guide/How-To Tutorials/admins/data-model/how-to-create-custom-objects) to:
...
Use the CSV import via the Command Menu  `Cmd + K` (Mac) or `Ctrl + K` (Windows). See our [data import guide](/user-guide/Getting Started/import-export/import-data-from-csv) for detailed instructions.
...
Read our [import-export data guide](/user-guide/Getting Started/import-export/import-data-from-csv) for detailed instructions on creating relationships during CSV import.
...
Discover our [implementation services](/user-guide/Resources/professional-services/implementation-services).
