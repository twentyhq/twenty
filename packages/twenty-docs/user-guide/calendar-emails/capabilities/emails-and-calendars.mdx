...
<Frame>
  <img src="/images/user-guide/emails/emails_header.png" alt="Emails and Calendars" />
</Frame>

**Note**: To connect your email accounts and configure sync settings, visit [Email & Calendar Setup](/user-guide/calendar-emails/getting-started/email-calendar-setup).
