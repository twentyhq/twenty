...
Read [this article](https://twenty.com/user-guide/data-model/customize-your-data-model) to learn how to design your data model.
...
## What's next?
Start creating automations using [workflows](https://twenty.com/user-guide/workflows/getting-started-workflows).
