...
<AccordionGroup>
  ...
  <Accordion title="Can I use my own AI models?">
    On cloud, you can use only AI models provided by Twenty. On your self-hosted instance, you can use your own AI models after obtaining Organization license.
  </Accordion>
