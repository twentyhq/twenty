...
<AccordionGroup>
  ...
  <Accordion title="Can I use my own AI models?">
    On cloud, you can use only AI models provided by Twenty, on self-hosted, you can use your own AI models after obtaining Organization license.
  </Accordion>

  <Accordion title="I don't see a role I assigned to AI agent, where is it?">
    By default, Roles assignable to workspace members, if a role is assignable only to AI agents, you need to change filter to see them as well.
  </Accordion>
