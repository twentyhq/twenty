...
<AccordionGroup>
  ...
  <Accordion title="Can I use my own AI models?">
    ...
    Custom providers (custom endpoints, private gateways, OpenAI-compatible or local models, extra regions), added under **Settings → Admin Panel → AI → Custom Providers**, are complimentary up to 25 seats. Above that, an Organization plan is required.
  </Accordion>
