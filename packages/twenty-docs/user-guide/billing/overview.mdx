...
<CardGroup cols={2}>
  <Card title="Pricing Plans" icon="tags" href="/user-guide/billing/getting-started/understanding-your-plan">
    Learn about Twenty's pricing plans and what's included.
  </Card>
  <Card title="FAQ" icon="circle-question" href="/user-guide/billing/capabilities/billing-and-pricing-faq">
...
| **Pro (Cloud)** | Everything apart the Premium features (SSO and row-level permissions), standard support |
...
For more questions, see the [Billing FAQ](/user-guide/billing/capabilities/billing-and-pricing-faq).
