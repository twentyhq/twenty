...
<Accordion title="Is Organization plan on cloud and Organization plan on self-hosted the same?">
  They offer the same premium features but e.g. if you buy Organization plan on cloud, you cannot transfer this to self-hosted as you need an Enterprise key.
</Accordion>
