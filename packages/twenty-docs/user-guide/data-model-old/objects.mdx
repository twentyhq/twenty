...
- [Learn about Fields](/user-guide/Features/fields/field-types-reference) to add properties to your objects
- [Explore Custom Objects](/user-guide/Features/objects/custom-objects) for advanced use cases
- [Set up Object Permissions](/user-guide/Features/objects/object-permissions-and-access-control) to control access
