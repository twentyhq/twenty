...
description: Understand how to effectively manage tasks in Twenty.
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

<Frame>
  <img src="/images/user-guide/tasks/tasks_header.png" alt="Tasks" />
</Frame>
...
Use [Workflows](/user-guide/workflows/overview) to automatically create tasks:
