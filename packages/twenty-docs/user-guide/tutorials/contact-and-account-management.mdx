...
description: Create and manage People and Company records to build your customer database.
---

<Frame>
  <img src="/images/user-guide/home/contact-and-account-management.png" alt="Contact Management" />
</Frame>
...
When you have existing data from spreadsheets or other systems, CSV import is your fastest option. You can prepare your data in Excel or Google Sheets, then upload it all at once. This is particularly useful when migrating from another CRM or when someone has been tracking contacts in spreadsheets. Our [Import/Export Data](/user-guide/data-migration/getting-started/import-export-data) guide walks you through the process.
...
To learn more about setting up these automated data flows, check out our [Workflows](/user-guide/workflows/overview) section.
...
If your business needs other fields to be unique (like phone numbers, or reference codes), you can configure this in your data model. Head to our [Data Model](/user-guide/data-model/how-tos/customize-your-data-model) section to learn how to set up additional uniqueness constraints for your specific needs.
...
The standard fields might not capture everything important for your business. If you need additional information: like customer segments, referral sources, or industry-specific data: you can add custom fields or modify existing ones. Head to our [Data Model](/user-guide/data-model/how-tos/customize-your-data-model) section to learn how to customize your setup.
