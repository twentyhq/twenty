...
description: Explore how to efficiently manage notes within record pages in Twenty.
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

<Frame>
  <img src="/images/user-guide/notes/notes_header.png" alt="Notes" />
</Frame>
...
Use [Workflows](/user-guide/workflows/overview) to automatically create notes:
