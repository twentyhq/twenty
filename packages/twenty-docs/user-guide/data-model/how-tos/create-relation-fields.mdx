...
<Note>
  **Relation names cannot be changed after creation** (they affect the API).
  Plan your names carefully.
</Note>
...
<Note>
  **Deleting a relation doesn't delete records.** Only the link between them is
  removed.
</Note>
