...
| I want to... | Guide |
|--------------|-------|
| Create a new object | [How to Create Custom Objects](/user-guide/data-model/how-tos/how-to-create-custom-objects) |
| Add fields to an object | [How to Create Custom Fields](/user-guide/data-model/how-tos/how-to-create-custom-fields) |
| Connect objects together | [How to Create Relation Fields](/user-guide/data-model/how-tos/how-to-create-relation-fields) |

## Learn More

- [Understanding Your Data Model](/user-guide/data-model/getting-started/understanding-your-data-model) — key concepts and planning tips
