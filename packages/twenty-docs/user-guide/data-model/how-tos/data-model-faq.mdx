...
Yes, you can import CSV data into any object, including custom objects. The import process supports field mapping for custom fields. See [How to Prepare Your CSV Files](/user-guide/data-migration/how-tos/how-to-prepare-your-csv-files).
</Accordion>
...
Check our [Implementation Services](/user-guide/getting-started/implementation-services) for help with complex data model design.
