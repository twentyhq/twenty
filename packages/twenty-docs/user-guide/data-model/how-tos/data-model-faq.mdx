...
Yes. Drag and drop items in the sidebar to change their order. Each user can arrange their own sidebar. See the [Sidebar guide](/user-guide/layout/capabilities/navigation).
</Accordion>
