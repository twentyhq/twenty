...
See [How to Create Custom Fields](/user-guide/data-model/how-tos/how-to-create-custom-fields) for details on field types and configuration.

## Connecting to Other Objects

To link your object to People, Companies, or other objects, create a relation field. See [How to Create Relation Fields](/user-guide/data-model/how-tos/how-to-create-relation-fields).
