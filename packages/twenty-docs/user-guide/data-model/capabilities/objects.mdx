...
<Frame>
  <img src="/images/user-guide/objects/objects_orange.png" alt="Objects" />
</Frame>
...
<Warning>
**Important note:** Once you create a custom object, you cannot delete it. You can only deactivate it. This is to prevent accidental data loss. If you deactivate an object, all its data will be hidden but preserved.
</Warning>
