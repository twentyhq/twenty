...
<CardGroup cols={2}>
  <Card
    title="Permissions"
    icon="lock"
    href="/user-guide/permissions-access/capabilities/permissions"
  >
  ...
  <Card
    ...
    icon="key"
    href="/user-guide/permissions-access/capabilities/sso-configuration"
  >
  ...
  <Card
    ...
    href="/user-guide/permissions-access/how-tos/permissions-faq"
  >
