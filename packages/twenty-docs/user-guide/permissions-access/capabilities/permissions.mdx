...
<Frame>
  <img src="/images/user-guide/permissions/permissions.png" alt="Permissions" />
</Frame>
...
**Note**: You can only assign roles to existing workspace members. To invite new members, use [Member Management](/user-guide/permissions-access/getting-started/member-management).
