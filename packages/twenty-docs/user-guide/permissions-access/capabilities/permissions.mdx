...
Roles can also be assigned to:
- **API Keys**: Control what actions API integrations can perform
- **AI Agents**: Define permissions for AI-powered automations

{/* TODO: Detail how to assign roles to API keys under Settings → API and Webhooks */}
{/* TODO: Detail how to assign roles to AI agents once AI features are released */}
