...
4. Debug issues by examining step outputs
...
<Note>
Large numbers of workflow runs can slow down page loading. If you notice performance issues, consider hiding the runs panel when not actively debugging.
</Note>
