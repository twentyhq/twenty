...
<Note>
  5 monthly credits are generous for standard automations. Most teams won't
  exceed this limit with typical workflow usage. Additional credits are
  primarily needed for advanced Code actions and AI-powered workflows.
</Note>
