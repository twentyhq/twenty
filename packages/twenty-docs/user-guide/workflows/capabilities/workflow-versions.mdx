...
2. Click **Activate** to publish your draft
3. The draft becomes the new active version
4. The previous active version is archived

### Draft Conflicts
If you try to edit while another draft exists:
- **Override**: Replace the existing draft with your changes
- **Return**: Go back and edit the existing draft instead
...
- [Getting Started with Workflows](/user-guide/workflows/getting-started/getting-started-workflows)
