...
<Note>
  Each branch is independent. Adding a branch doesn't affect other existing
...
<Note>
  While you can use a
  [Delay](/user-guide/workflows/capabilities/workflow-actions#delay) node to
  pause execution, it's not currently configurable to wait "until another branch
  ends."
</Note>
