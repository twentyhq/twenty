...
description: Automate repetitive tasks to reduce manual work and keep your data accurate.
image: /images/user-guide/workflows/internal-automations.png
---

<Frame>
  <img src="/images/user-guide/workflows/internal-automations.png" alt="Internal Automations" />
</Frame>

Below are workflow examples you can implement to automate repetitive tasks and keep your data up-to-date.
