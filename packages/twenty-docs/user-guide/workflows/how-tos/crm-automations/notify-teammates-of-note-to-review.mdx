...
<Note>
  **Tagging teammates directly in notes is not yet supported.** This feature is
  planned for the second half of 2026. In the meantime, this workflow provides a
...
<Warning>
  **Limitation**: This approach allows assigning one reviewer per field. If you
  need to notify multiple people, create additional relation fields (e.g.,
  Reviewer 1, Reviewer 2). This won't scale well if you need to tag many
