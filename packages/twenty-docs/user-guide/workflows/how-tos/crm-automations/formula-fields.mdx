...
<Tip>
  For a complete example of tracking time in pipeline stages, see [Track How
  Long Opportunities Stay in Each
  Stage](/user-guide/views-pipelines/how-tos/track-time-in-stage).
</Tip>
...
<Note>
  Negative values indicate overdue tasks. You can use this field to filter or
