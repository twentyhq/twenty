...
![Workflow overview showing trigger, Find Sender, AI Triage, Should Reply branch, and Send Threaded Reply steps](/images/user-guide/workflows/auto-reply/workflow-overview.png)
...
![Find Sender config filtering Message Participants by message and role](/images/user-guide/workflows/auto-reply/find-sender.png)
...
![AI Agent prompt with email subject, body, and sender variables](/images/user-guide/workflows/auto-reply/ai-triage.png)
...
![If/Else branch checking AI response does not contain SKIP](/images/user-guide/workflows/auto-reply/should-reply.png)
...
![Send Email config with In-Reply-To, subject with Re: prefix, and AI-drafted body](/images/user-guide/workflows/auto-reply/send-email.png)
