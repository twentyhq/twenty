...
<Tip>
  For more details on handling arrays, see [Handle Arrays in Code
  Actions](/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
