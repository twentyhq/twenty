---
title: Bring Form Submissions into Twenty
description: Connect web forms like Typeform to automatically create leads in your CRM.
---

This guide covers connecting form tools to Twenty using webhook-triggered workflows. For general webhook setup, see [Set Up a Webhook Trigger](/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger).

## Typeform Integration

Typeform can send form submissions directly to Twenty via webhooks.
