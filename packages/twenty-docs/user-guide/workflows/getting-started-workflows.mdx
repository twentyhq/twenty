...
For detailed examples and step-by-step guidance, see our [Internal Automations](/user-guide/How-To Tutorials/admins/automations-workflows/how-to-create-a-trigger-based-workflow) guide.
...
For detailed integration patterns and implementation guidance, see our [External Tool Integration](/user-guide/How-To Tutorials/admins/automations-workflows/how-to-integrate-external-services-in-workflows) guide.

### What if I don't want to build those connections?
We offer [Professional Services](/user-guide/Twenty Resources/professional-services/implementation-services) to help you create the automations you need.
