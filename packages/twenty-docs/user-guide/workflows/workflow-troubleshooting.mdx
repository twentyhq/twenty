...
- Review [Workflow Features](/user-guide/Features & Configuration/automations-workflows/workflow-triggers) for technical details
- Check [Workflow Credits](/user-guide/Features & Configuration/billing/usage-tracking) for optimization tips
- Explore [Internal Automations](/user-guide/How-To Tutorials/admins/automations-workflows/how-to-create-a-trigger-based-workflow) and [External Tool Integration](/user-guide/How-To Tutorials/admins/automations-workflows/how-to-integrate-external-services-in-workflows) for examples

### Professional Support
- Contact our [Professional Services](/user-guide/Twenty Resources/professional-services/implementation-services) for complex troubleshooting
