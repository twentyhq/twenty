...
<Accordion title="Are Twenty applications AGPL or MIT licensed?">
Twenty SDK is MIT licensed meaning applications can have whichever license the creator chooses.
</Accordion>
</AccordionGroup>
