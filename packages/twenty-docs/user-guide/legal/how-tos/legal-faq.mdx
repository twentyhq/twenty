...
No, since those features are used only by your team, you don't have to publish your changes publicly. However, under AGPLv3, you must make changes source code available within your company (e.g. via an internal git repository).
</Accordion>
