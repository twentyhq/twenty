...
CRM content can be used to train AI model depending on sub-processor's Terms and Conditions. Twenty does not have its own AI model — all AI models available on Twenty Cloud are provided by our sub-processors.
</Accordion>
...
Backups are created continuously with snapshots taken daily and retention period is 30 days.
</Accordion>
