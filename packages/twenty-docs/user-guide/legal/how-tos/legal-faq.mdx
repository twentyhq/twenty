...
Hosting region can be contractually fixed starting 2027, alternatively you can reach out to [our Partners](https://twenty.com/partners/list?categories=HOSTING) to help you set up your instance.
</Accordion>
...
## Compliance
<AccordionGroup>
<Accordion title="Is Twenty GDRP compliant?">
Yes, Twenty is [GDRP compliant](https://trust.twenty.com/?tab=securityControls&frameworks=gdpr_v1).
</Accordion>
...
No, Twenty is in process of becoming HIPAA compliant.
</Accordion>
</AccordionGroup>
