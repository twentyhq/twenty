...
<Tip>
  This is an example of creating [Formula
  Fields](/user-guide/workflows/how-tos/crm-automations/formula-fields) using
  workflows.
</Tip>
...
<Note>
  To create a new branch, right click on the workflow canvas and click **New
  action**. Then, link this action to the previous node by dragging the arrow
  from the previous node to this new action.
</Note>
