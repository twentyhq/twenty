...
Use the CSV import via the Command Menu  `Cmd + K` (Mac) or `Ctrl + K` (Windows). See our [data import guide](/user-guide/Getting Started with Twenty/import-export/import-data-from-csv) for detailed instructions.
...
Read our [import-export data guide](/user-guide/Getting Started with Twenty/import-export/import-data-from-csv) for detailed instructions on creating relationships during CSV import.
...
Discover our [implementation services](/user-guide/Twenty Resources/professional-services/implementation-services).
