...
- [Learn about the Sidebar](/user-guide/Getting Started with Twenty/learn-the-interface/using-the-sidebar)
- [Discover the Command Palette](/user-guide/Getting Started with Twenty/learn-the-interface/using-the-command-palette)
- [Master Keyboard Shortcuts](/user-guide/Getting Started with Twenty/learn-the-interface/keyboard-shortcuts)
