...
**Note**: You can only assign roles to existing workspace members. To invite new members, use [Member Management](/user-guide/How-To Tutorials/admins/user-management-permissions/how-to-add-or-remove-users).
