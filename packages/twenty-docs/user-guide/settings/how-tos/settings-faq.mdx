...
Yes, go to **Settings → Profile** and update your email. You'll need to verify the new email address before the change takes effect.
</Accordion>
...
Note: This removes your access to all workspaces.
</Accordion>
</AccordionGroup>
