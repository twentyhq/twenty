...
Configure under **Settings → Apps → your app → General → App URL**. The **App URL** section only appears with **Advanced mode** on (toggle at the bottom left of the Settings sidebar).
