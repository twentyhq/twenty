...
Configure under **Settings → Apps → your app → Settings → Public URL**.

Apps that expose routes on the web are served from a dedicated URL, shown in the **Public URL** section. You can serve an app from a domain you own instead.
