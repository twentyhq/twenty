...
<Warning>
  Deleting your workspace permanently removes all data and cannot be undone. All
  workspace data will be lost forever, all members will lose access immediately,
