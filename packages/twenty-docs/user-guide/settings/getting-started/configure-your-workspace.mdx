...
3. This will be used for all currency fields

## Essential Configurations

### Data Model
Configure your objects and fields:
1. Go to **Settings → Data Model**
2. Review standard objects (People, Companies, Opportunities)
3. Create custom objects if needed
4. Add custom fields to capture your unique data
...
- [ ] Data model reviewed and customized
