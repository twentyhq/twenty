...
See [How to Import Relations](/user-guide/data-migration/how-tos/how-to-import-relations-between-objects-via-csv) for details on maintaining relationships.
...
For complex migrations or large datasets, contact us at [contact@twenty.com](mailto:contact@twenty.com) or explore our [Implementation Services](/user-guide/getting-started/implementation-services).
