...
<Note>For larger exports (20,000+ records), use filters to export in batches or use the [API](/developers/api-and-webhooks/apis-overview).</Note>
...
See: [API Documentation](/developers/api-and-webhooks/apis-overview)
...
- [API Documentation](/developers/api-and-webhooks/apis-overview) — build custom export workflows
