...
<Note>For datasets larger than 10,000 records, split into multiple files or use the [API import](/user-guide/data-migration/how-tos/how-to-import-data-via-api).</Note>
...
See [How to Import Relations](/user-guide/data-migration/how-tos/how-to-import-relations-between-objects-via-csv) for detailed instructions.
...
- [Import Companies](/user-guide/data-migration/how-tos/how-to-import-companies-via-csv) (import these first)
- [Import Contacts](/user-guide/data-migration/how-tos/how-to-import-contacts-via-csv)
- [Fix any import errors](/user-guide/data-migration/how-tos/how-to-fix-import-errors)
