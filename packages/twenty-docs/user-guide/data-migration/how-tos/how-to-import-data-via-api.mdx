---
title: How to Import Data via API
...
|-----|----------|---------------|
| **GraphQL** | Flexible queries, fetching related data, complex operations | [GraphQL API Docs](/developers/api-and-webhooks/core-api/overview) |
| **REST** | Simple CRUD operations, familiar REST patterns | [REST API Docs](/developers/api-and-webhooks/rest-api/overview) |
...
Contact us at [contact@twenty.com](mailto:contact@twenty.com) or explore our [Implementation Services](/user-guide/getting-started/implementation-services).
...
- [GraphQL API Documentation](/developers/api-and-webhooks/core-api/overview)
- [REST API Documentation](/developers/api-and-webhooks/rest-api/overview)
- [API Authentication](/developers/api-and-webhooks/api-keys)
