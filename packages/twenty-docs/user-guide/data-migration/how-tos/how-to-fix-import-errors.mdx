...
|---------------|---------------|
| "Duplicate value" | Value already exists in Twenty or your file |
| "Invalid format" | Data doesn't match expected format |
| "Required field missing" | A required field is empty |
| "Relation not found" | Referenced record doesn't exist |
| "File too large" | More than 10,000 records |
...
**Solution:** Use `https://domain.com` format
