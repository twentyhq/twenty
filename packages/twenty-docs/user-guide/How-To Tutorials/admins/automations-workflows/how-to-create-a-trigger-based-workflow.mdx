...
After mastering internal automations:
- [Learn External Tool Integration](/user-guide/How-To Tutorials/admins/automations-workflows/how-to-integrate-external-services-in-workflows)
