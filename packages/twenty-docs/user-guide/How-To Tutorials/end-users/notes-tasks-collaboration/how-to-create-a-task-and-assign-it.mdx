---
title: How to Create a Task and Assign It
...
Use [Workflows](/user-guide/How-To Tutorials/admins/automations-workflows/how-to-build-your-first-workflow) to automatically create tasks:
...
After mastering task management:
- [Learn about Notes](/user-guide/How-To Tutorials/end-users/notes-tasks-collaboration/how-to-create-a-note-on-a-record) for documentation
- [Use @Mentions](/user-guide/How-To Tutorials/end-users/notes-tasks-collaboration/how-to-use-mentions-for-team-collaboration) for team communication
- [Set up Workflows](/user-guide/How-To Tutorials/admins/automations-workflows/how-to-build-your-first-workflow) to automate task creation
