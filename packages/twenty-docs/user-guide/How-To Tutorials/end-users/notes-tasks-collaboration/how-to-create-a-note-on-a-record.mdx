---
title: How to Create a Note on a Record
...
Use [Workflows](/user-guide/How-To Tutorials/admins/automations-workflows/how-to-build-your-first-workflow) to automatically create notes:
...
After mastering notes:
- [Learn to Create Tasks](/user-guide/How-To Tutorials/end-users/notes-tasks-collaboration/how-to-create-a-task-and-assign-it)
- [Use @Mentions for Collaboration](/user-guide/How-To Tutorials/end-users/notes-tasks-collaboration/how-to-use-mentions-for-team-collaboration)
- [Set up Notifications](/user-guide/How-To Tutorials/end-users/notes-tasks-collaboration/how-to-set-up-notifications)
