...
**Note**: To connect your email accounts and configure sync settings, visit [Connect Your Mailbox and Calendar](/user-guide/Getting Started/first-configuration/connect-your-mailbox-and-calendar).
