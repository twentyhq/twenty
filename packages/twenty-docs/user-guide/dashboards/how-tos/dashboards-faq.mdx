...
<AccordionGroup>
  ...
  <Accordion title="Why do I see 'Undisplayed data' warning on my bar chart?">
    Bar charts have display limits: maximum 100 bars, and 50 groups per bar when using Group By. If your data exceeds this, add filters to narrow down the results or change the grouping (e.g., group by week instead of day).
  </Accordion>
