...
<Note>
  Dashboards are currently in beta. Activate them under **Settings → Updates →
  Early Access**.
</Note>
...
<Note>
  **Current limitations**: - Exporting dashboards and sharing with external
  users (non-Twenty users) are not available at the moment. - Gauge charts and
