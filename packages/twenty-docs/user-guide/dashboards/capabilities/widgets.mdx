...
Dashboard table and kanban widgets are read-only by default. To let users edit records from a widget:

1. Edit the dashboard
2. Select the widget
3. Turn on **Allow editing** in the widget settings

For tables, this enables cell editing. For kanban boards, it enables editing cards, moving them between columns, and creating records. Role permissions still apply.
