...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="database"  />Source </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="filter"  />Filter </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="axis-x" />Data on display </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="arrows-sort" />Sort by </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="eye-off" />Omit zero values </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="axis-y" />Data on display </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="filters" />Group by </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="calendar" />Date granularity </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="chart-bar-popular" />Cumulative </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="math-min" />Min range / <ChartIcon icon="math-max" />Max range </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="color-swatch" />Colors </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="gizmo" />Axis name </div>

Choose which axis labels to show: **None**, **X axis**, **Y axis**, or **Both** (bar and line charts only).

### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="stack-2" />Stacked bars / Stacked lines </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="badge-2k" />Data labels </div>
...
### <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}> <ChartIcon icon="text-caption" />Legend </div>
