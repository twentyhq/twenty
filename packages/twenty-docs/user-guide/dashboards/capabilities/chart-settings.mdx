...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="database"  /> Source </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="filter"  /> Filter </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="axis-x" /> Data on display </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="calendar" /> Date granularity </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="arrows-sort" /> Sort by </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="eye-off" /> Omit zero values </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="axis-y" /> Data on display </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="filters" /> Group by </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="chart-bar-popular" /> Cumulative </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="math-min" /> Min range / <ChartIcon icon="math-max" /> Max range </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="color-swatch" /> Colors </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="gizmo" /> Axis name </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="stack-2" /> Stacked bars / Stacked lines </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="badge-2k" /> Data labels </div>
...
### <div style={{ display: 'flex', alignItems: 'center' }}> <ChartIcon icon="text-caption" /> Legend </div>
...
- <span style={{ display: 'inline-flex', verticalAlign: 'middle' }}><ChartIcon icon="number-123" size={16} /></span> **Show value in center** – Display the total
