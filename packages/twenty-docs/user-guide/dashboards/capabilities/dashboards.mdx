...
<Note>
  **Coming soon**: We will add the ability to set a specific timezone for a
  dashboard, so all users see consistent data regardless of their location.
</Note>

<Note>
  **Coming soon**: Dashboard-level filters will allow you to apply filters
  across all widgets at once, making it faster to explore your data.
</Note>
