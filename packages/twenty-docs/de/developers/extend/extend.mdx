...
<CardGroup cols={2}>
  <Card title="APIs" icon="code" href="/de/developers/extend/api">
    Verbinden Sie sich programmgesteuert mit Twenty
  </Card>
  <Card title="Webhooks" icon="bell" href="/de/developers/extend/webhooks">
    Erhalten Sie Benachrichtigungen über Ereignisse in Echtzeit
  </Card>
  <Card title="Apps" icon="puzzle-piece" href="/de/developers/extend/apps/getting-started/quick-start">
