...
Erstellen Sie explizite Ereignisse mit [`createTimelineActivity()`](/de/developers/extend/apps/logic/logic-functions#create-a-timeline-activity). App-Code verwendet stabile universelle Bezeichner; Twenty löst die installationsspezifischen Metadaten-IDs auf.
