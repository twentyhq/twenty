...
Alle Modi benötigen ein authentifiziertes Remote-Repository. Weitere Informationen zu `plan` finden Sie unter [Synchronisierung & Wiederherstellung](/de/developers/extend/apps/operations/sync-and-recovery#previewing-changes-plan).
...
Vollständige Referenz: [Konzepte](/de/developers/extend/apps/getting-started/concepts).
