...
Die [Anwendung config](/de/developers/extend/apps/config/application) trägt die
...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.twenty.com/de/developers/extend/apps',
...
[Testing](/de/developers/extend/apps/operations/testing) und
[Synchronisieren & Wiederherstellen](/de/developers/extend/apps/operations/sync-and-recovery).
...
[Publishing](/de/developers/extend/apps/operations/publishing).
...
<CardGroup cols={2}>
  <Card title="Datenreferenz" icon="database" href="/de/developers/extend/apps/data/overview">
    Jeder Feldtyp, Relation und Index-Option.
  </Card>
  <Card title="Logische Referenz" icon="bolt" href="/de/developers/extend/apps/logic/overview">
    Cron- und Datenbankereignis-Trigger, der Schlüsselwert-Store, OAuth Verbindungen.
  </Card>
  <Card title="Layout-Referenz" icon="table-columns" href="/de/developers/extend/apps/layout/overview">
