...
Siehe [Relations](/de/developers/extend/apps/data/relations) für das vollständige Muster.
...
<Card title="Weiter: Dokumente generieren →" icon="bolt" href="/de/developers/extend/apps/tutorials/document-generator/generating-documents">
