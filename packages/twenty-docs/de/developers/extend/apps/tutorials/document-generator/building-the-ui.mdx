...
Eine [view](/de/developers/extend/apps/layout/views) ist eine gespeicherte Liste eines bestimmten Objekts.
Ein [Navigationsmenüeintrag](/de/developers/extend/apps/layout/navigation-menu-items)
bringt diese Ansicht in die Sidebar. Der Server stellt für jedes Objekt bereits automatisch die Standardansicht "Alle ..." bereit, daher sind die von einer App definierten Ansichten zusätzliche, kuratierte Ansichten.
...
Eine [Frontkomponent](/de/developers/extend/apps/layout/front-components) ist eine Reaktions-
...
Ein [Commandmenu item](/de/developers/extend/apps/layout/command-menu-items) mit
...
Mounten Sie es mit einem [page layout](/de/developers/extend/apps/layout/page-layouts). Ein
...
`FIELD`-Widgets unterstützen auch andere Darstellungsmodi und Optionen, darunter
das Auflisten von Datensätzen einer verschachtelten Beziehung, die zwei Ebenen entfernt ist — siehe die
[Field-Widget-Referenz](/de/developers/extend/apps/layout/page-layouts#field-widgets).
...
<Card title="Weiter: ein KI-Agent →" icon="robot" href="/de/developers/extend/apps/tutorials/document-generator/ai-agent">
