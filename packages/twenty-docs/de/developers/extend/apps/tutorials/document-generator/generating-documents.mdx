...
Jetzt der Kern: eine [Logikfunktion](/de/developers/extend/apps/logic/logic-functions)
...
(`Garn test:unit`) bedecken. Siehe [Testing](/de/developers/extend/apps/operations/testing).
</Tip>

## Der Handler

Der Handler verwendet die generierte [`CoreApiClient`](/de/developers/extend/apps/logic/logic-functions)
...
Siehe [Roles](/de/developers/extend/apps/config/roles) für feinkörnige Berechtigungen.
...
<Card title="Weiter: HTTP-Routen →" icon="globe" href="/de/developers/extend/apps/tutorials/document-generator/http-routes">
