...
Eine [skill](/de/developers/extend/apps/logic/skills-and-agents) ist wiederverwendbare
...
Ein [agent](/de/developers/extend/apps/logic/skills-and-agents) paßt einen Prompt mit einem
...
[Chapter 2](/de/developers/extend/apps/tutorials/document-generator/generating-documents#grant-it-access).
</Note>
...
<Card title="Weiter: Publizieren →" icon="rocket" href="/de/developers/extend/apps/tutorials/document-generator/publishing">
