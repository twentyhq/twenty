...
| ------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| Interne Skripte, Automatisierung                  | [API-Schlüssel](/de/developers/extend/api#authentication)                                          |
...
| Twenty-App mit UI-Erweiterungen                   | [Apps](/de/developers/extend/apps/getting-started/quick-start) (OAuth wird automatisch gehandhabt) |
