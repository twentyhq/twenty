...
* [Berechtigungen](/de/user-guide/permissions-access/capabilities/permissions) — ausführliche Informationen zum Erstellen und Verwalten von Rollen
* [KI-Agenten](/de/user-guide/ai/capabilities/ai-agents) — KI-Funktionen in Workflows
