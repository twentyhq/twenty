...
* [Ein PDF aus Twenty generieren](/de/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — generierte PDFs an Datensätze anhängen
...
* [Automatisierungen für Closed Won](/de/user-guide/workflows/how-tos/crm-automations/closed-won-automations)
