...
<AccordionGroup>
  ...
  <Accordion title="Was ist der Unterschied zwischen manuellen Single-, Global- und Bulk-Triggern?">
    ...
    \| **Single** | Ein oder mehrere ausgewählte Datensätze | Einmal pro ausgewähltem Datensatz |
    \| **Bulk** | Ein oder mehrere ausgewählte Datensätze | Einmal, mit allen Datensätzen als Array |
    ...
    * **Bulk**: Verwenden Sie dies, wenn Sie Datensätze gemeinsam verarbeiten oder den Credit-Verbrauch optimieren möchten (erfordert die Iterator-Aktion)
    ...
    Siehe [Workflow-Trigger](/de/user-guide/workflows/capabilities/workflow-triggers) für Details.
  </Accordion>
  ...
  <Accordion title="Ich sehe keinen If/Else-Knoten. Was sollte ich tun?">
    ...
    **Aktuelle Problemumgehung**: Erstellen Sie mehrere Verzweigungen von Ihrem Schritt aus, die jeweils mit einer **Filter**-Aktion beginnen:
    ...
    Siehe [Verzweigungen verwenden](/de/user-guide/workflows/capabilities/workflow-branches) für eine Schritt-für-Schritt-Anleitung.
  </Accordion>
  ...
  <Accordion title="Wie lese ich Workflow-Ausführungen?">
    ...
    * **Daten**: Betrachten Sie Eingabe-/Ausgabedaten in jedem Schritt
    ...
    Siehe [Workflow-Ausführungen](/de/user-guide/workflows/capabilities/workflow-runs) für Details.
  </Accordion>
