...
<Tip>
Ein vollständiges Beispiel für das Nachverfolgen der Zeit in Pipeline-Phasen finden Sie unter [Verfolgen, wie lange Chancen in jeder Phase bleiben](/de/user-guide/views-pipelines/how-tos/track-time-in-stage).
</Tip>
...
Den vollständigen Workflow finden Sie unter [Erwarteten Betrag in der Pipeline anzeigen](/de/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline).
...
* [Erwarteten Betrag in der Pipeline anzeigen](/de/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline)
* [Zeit in der Phase nachverfolgen](/de/user-guide/views-pipelines/how-tos/track-time-in-stage)
* [Workflow-Aktionen](/de/user-guide/workflows/capabilities/workflow-actions)
