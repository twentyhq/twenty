...
* **Bulk**: Der Workflow wird einmal ausgeführt und stellt die gesamte Liste der Datensätze als Eingabe zur Verfügung. Das bedeutet, dass der Workflow eine [Iterator-Aktion](/de/user-guide/workflows/capabilities/workflow-actions#iterator) enthalten muss.
