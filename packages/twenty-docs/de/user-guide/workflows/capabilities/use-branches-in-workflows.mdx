...
* [Workflows-FAQ](/de/user-guide/workflows/how-tos/need-more-help/workflows-faq) — Antworten zur parallelen Ausführung
* [Workflow-Aktionen](/de/user-guide/workflows/capabilities/workflow-actions) — verfügbare Aktionen für Verzweigungen
