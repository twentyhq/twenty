---
title: Postfach
description: E-Mail-Integrationsfunktionen in Twenty verstehen.
---

**Hinweis**: Um Ihre E-Mail-Konten zu verbinden und die Synchronisierungseinstellungen zu konfigurieren, besuchen Sie [E-Mail- & Kalendereinrichtung](/de/user-guide/calendar-emails/overview).
...
### Objekte, in denen E-Mails gefunden werden können
...
Twenty importiert E-Mails mit ungefähr **400 Nachrichten pro Minute**. Diese Rate ist derzeit durch das Ratenlimit der Gmail-API begrenzt (und gilt ähnlich für andere Anbieter).

Zur Orientierung:

* 1.000 E-Mails → ~2,5 Minuten
* 10.000 E-Mails → ~25 Minuten
* 50.000 E-Mails → ~2 Stunden
...
Wählen Sie, ob interne E-Mails in Twenty synchronisiert werden:
...
2. Konfigurieren Sie die Ordner im Bereich E-Mail
...
* **Synchronisierungsverzögerungen**: E-Mails erscheinen sofort, aber der erste Import dauert länger
