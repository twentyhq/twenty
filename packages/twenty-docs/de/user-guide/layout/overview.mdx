...
[Navigationsreferenz →](/de/user-guide/layout/capabilities/navigation)
...
[Tabellenansichten →](/de/user-guide/views-pipelines/capabilities/table-views) · [Kanban-Ansichten →](/de/user-guide/views-pipelines/capabilities/kanban-views) · [Kalenderansicht →](/de/user-guide/views-pipelines/capabilities/calendar-view)
...
[Referenz zu Datensatzseiten →](/de/user-guide/layout/capabilities/record-pages)
