...
<Note>Für sehr große Datensätze (Hunderttausende von Datensätzen) verwenden Sie die API. Unsere [Implementierungspartner](/de/user-guide/getting-started/capabilities/implementation-services) können bei Bedarf diese Skripte ausführen.</Note>
...
Weitere Informationen finden Sie in [diesem Artikel](/de/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) mit einer Schritt-für-Schritt-Anleitung zum Vorgehen.
...
* [Bereiten Sie Ihre CSV-Dateien vor](/de/user-guide/data-migration/how-tos/prepare-your-csv-files)
* [Beziehungen zwischen Objekten importieren](/de/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv)
* [Über die API für große Datensätze importieren](/de/user-guide/data-migration/how-tos/import-data-via-api)
