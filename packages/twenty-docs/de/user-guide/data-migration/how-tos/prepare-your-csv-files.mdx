...
<Note>Für Datenmengen mit mehr als 10.000 Datensätzen teile die Daten in mehrere Dateien auf oder verwende den [API-Import](/de/user-guide/data-migration/how-tos/import-data-via-api).</Note>
...
Siehe [Beziehungen importieren](/de/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) für detaillierte Anleitungen.
...
* [Unternehmen importieren](/de/user-guide/data-migration/how-tos/import-companies-via-csv) (diese zuerst importieren)
* [Kontakte importieren](/de/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [Importfehler beheben](/de/user-guide/data-migration/how-tos/fix-import-errors)
