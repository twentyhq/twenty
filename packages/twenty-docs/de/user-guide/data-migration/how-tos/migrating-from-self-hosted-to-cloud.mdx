...
Siehe [So importieren Sie Beziehungen](/de/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) für Details zum Beibehalten von Beziehungen.
...
<Tip>
  Migrieren Sie einen großen oder komplexen Workspace? [Holen Sie sich einen zertifizierten Twenty-Partner](https://twenty.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud), der den Umzug Ende-zu-Ende übernimmt. *(Oder binden Sie unser Team ein: [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
