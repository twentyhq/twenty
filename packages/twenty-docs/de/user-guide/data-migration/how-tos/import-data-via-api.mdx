...
| ----------- | ---------------------------------------------------------------- | ------------------------------------------- |
| **GraphQL** | Flexible Abfragen, Abruf verknüpfter Daten, komplexe Operationen | [API-Dokumentation](/de/developers/extend/api) |
| **REST**    | Einfache CRUD-Operationen, vertraute REST-Muster                 | [API-Dokumentation](/de/developers/extend/api) |
...
* Überprüfen Sie, ob die Formate den Anforderungen von Twenty entsprechen (siehe [Feldzuordnung](/de/user-guide/data-migration/capabilities/field-mapping))
...
Kontaktieren Sie uns unter [contact@twenty.com](mailto:contact@twenty.com) oder informieren Sie sich über unsere [Implementierungsservices](/de/user-guide/getting-started/capabilities/implementation-services).
...
* [API-Dokumentation](/de/developers/extend/api)
