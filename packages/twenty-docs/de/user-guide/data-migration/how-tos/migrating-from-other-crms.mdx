...
Siehe [So bereiten Sie Ihre CSV-Dateien vor](/de/user-guide/data-migration/how-tos/prepare-your-csv-files) für vollständige Formatierungsanforderungen für alle Feldtypen.
...
Siehe [So importieren Sie Beziehungen](/de/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) für detaillierte Anweisungen zum Verknüpfen von Datensätzen.
...
Siehe [So bereiten Sie Ihre CSV-Dateien vor](/de/user-guide/data-migration/how-tos/prepare-your-csv-files) für den vollständigen Formatierungsleitfaden.
...
* [So importieren Sie Unternehmen](/de/user-guide/data-migration/how-tos/import-companies-via-csv)
* [So importieren Sie Kontakte](/de/user-guide/data-migration/how-tos/import-contacts-via-csv)
...
* Siehe [E-Mail & Kalender](/de/user-guide/calendar-emails/overview)
...
Siehe [So beheben Sie Importfehler](/de/user-guide/data-migration/how-tos/fix-import-errors) für detaillierte Schritte zur Fehlerbehebung.
