...
Weitere Details: [Eindeutigkeitsbeschränkungen](/de/user-guide/data-migration/capabilities/uniqueness-constraints)
...
Vollständige Formatreferenz: [Referenz zur Feldzuordnung](/de/user-guide/data-migration/capabilities/field-mapping)
...
Weitere Details: [Beziehungen importieren](/de/user-guide/data-migration/capabilities/import-relations)
...
Siehe: [So importieren Sie Daten über die API](/de/user-guide/data-migration/how-tos/import-data-via-api)
...
4. **Prüfen Sie die Referenzartikel:**
   * [Feldzuordnung](/de/user-guide/data-migration/capabilities/field-mapping)
   * [Eindeutigkeitsbeschränkungen](/de/user-guide/data-migration/capabilities/uniqueness-constraints)
   * [Beziehungen importieren](/de/user-guide/data-migration/capabilities/import-relations)
   * [Fehlerbehandlung](/de/user-guide/data-migration/capabilities/error-handling)
