...
Weitere Informationen finden Sie in unserem dedizierten Artikel: [Beziehungen zwischen Objekten importieren](/de/user-guide/data-migration/capabilities/import-relations)
