...
<CardGroup cols={2}>
  <Card title="Berechtigungen" icon="lock" href="/de/user-guide/permissions-access/capabilities/permissions">
    Erstellen Sie Rollen und konfigurieren Sie Objekt-, Feld- und Einstellungsberechtigungen.
  </Card>
  <Card title="SSO-Konfiguration" icon="key" href="/de/user-guide/permissions-access/capabilities/sso-configuration">
    Richten Sie Single Sign-On mit Ihrem Identitätsanbieter ein.
  </Card>
  <Card title="FAQ" icon="circle-question" href="/de/user-guide/permissions-access/how-tos/permissions-faq">
...
* [Rolle erstellen](/de/user-guide/permissions-access/capabilities/permissions#create-a-role)
* [SSO konfigurieren](/de/user-guide/permissions-access/capabilities/sso-configuration)
* [Teammitglieder verwalten](/de/user-guide/settings/capabilities/member-management)
