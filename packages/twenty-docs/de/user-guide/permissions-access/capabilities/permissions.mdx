...
<Note>
Sie können Rollen nur vorhandenen Mitgliedern des Arbeitsbereichs zuweisen. Um neue Mitglieder einzuladen, verwenden Sie die [Mitgliederverwaltung](/de/user-guide/settings/capabilities/member-management).
</Note>
