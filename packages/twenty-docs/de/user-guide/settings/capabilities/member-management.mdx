...
→ [Weitere Informationen zu Rollen und Berechtigungen](/de/user-guide/permissions-access/capabilities/permissions)
...
* [Berechtigungen](/de/user-guide/permissions-access/capabilities/permissions) — konfigurieren, was jede Rolle tun kann
* [Domain-Einstellungen](/de/user-guide/settings/capabilities/domains-settings) — genehmigte Domains konfigurieren
