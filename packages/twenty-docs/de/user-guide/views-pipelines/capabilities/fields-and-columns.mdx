...
* [Tabellenansichten](/de/user-guide/views-pipelines/capabilities/table-views) — Funktionen der Listenansicht
* [Kanban-Ansichten](/de/user-guide/views-pipelines/capabilities/kanban-views) — kartenbasierte Ansichten
