...
* [Tabellenansichten](/de/user-guide/views-pipelines/capabilities/table-views) — alle Funktionen der Tabellenansicht
* [Filter und Sortierung](/de/user-guide/views-pipelines/capabilities/filters-and-sorting) — Gruppieren mit Filtern kombinieren
