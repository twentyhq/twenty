...
<Tip>
Dies ist ein Beispiel für das Erstellen von [Formel­feldern](/de/user-guide/workflows/how-tos/crm-automations/formula-fields) mit Workflows.
</Tip>
...
* [Formel­felder](/de/user-guide/workflows/how-tos/crm-automations/formula-fields) — berechnete Felder mit Workflows erstellen
* [Kanban-Ansichten](/de/user-guide/views-pipelines/capabilities/kanban-views) — Spaltenaggregationen
* [Benutzerdefinierte Felder erstellen](/de/user-guide/data-model/how-tos/create-custom-fields) — Feldkonfiguration
