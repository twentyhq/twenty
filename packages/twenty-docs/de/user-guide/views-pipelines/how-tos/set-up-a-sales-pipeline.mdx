...
* [Kanban-Ansichten](/de/user-guide/views-pipelines/capabilities/kanban-views) — Aggregationen und Kompaktansicht
* [Filter und Sortierung](/de/user-guide/views-pipelines/capabilities/filters-and-sorting) — gefilterte Ansichten erstellen
