...
<Tip>
Dies ist ein Beispiel dafür, wie man mit Workflows [Formelfelder](/de/user-guide/workflows/how-tos/crm-automations/formula-fields) erstellt – konkret Datumsberechnungen.
</Tip>
...
Da dies die erste Phase ist, wird nur der Eintrittszeitstempel erfasst — es gibt keine vorherige Phase, von der aus berechnet werden kann.
...
* [Workflows](/de/user-guide/workflows/overview) — Grundlagen der Automatisierung
* [So erstellen Sie benutzerdefinierte Felder](/de/user-guide/data-model/how-tos/create-custom-fields) — Feldkonfiguration
* [Kanban-Ansichten](/de/user-guide/views-pipelines/capabilities/kanban-views) — Aggregationen
