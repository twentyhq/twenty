...
Siehe [Viele-zu-Viele-Beziehungen erstellen](/de/user-guide/data-model/how-tos/create-many-to-many-relations) für eine vollständige Schritt-für-Schritt-Anleitung.
