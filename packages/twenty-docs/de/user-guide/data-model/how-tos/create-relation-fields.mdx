...
Siehe [Relationsfelder](/de/user-guide/data-model/capabilities/relation-fields) für Erläuterungen zu Relationstypen.
...
* [Relationsfelder](/de/user-guide/data-model/capabilities/relation-fields) — Typen und Einschränkungen
* [Relationen importieren](/de/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) — verknüpfte Datensätze im Stapel importieren
