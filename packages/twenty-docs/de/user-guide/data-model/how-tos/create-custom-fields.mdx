...
3. Klicke **+ neues Feld**
4. Wählen Sie einen **Feldtyp** (siehe [Felder](/de/user-guide/data-model/capabilities/fields) für alle Typen)
...
<Note>
**Verwenden Sie für Importe API-Namen.** Aktivieren Sie in den Einstellungen den **Erweiterten Modus**, um API-Namen anzuzeigen. Siehe [Feldzuordnung](/de/user-guide/data-migration/capabilities/field-mapping).
</Note>
...
* [Felder](/de/user-guide/data-model/capabilities/fields) — alle Feldtypen erklärt
