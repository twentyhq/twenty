...
* **Kalender & E-Mails:** Synchronisieren Sie Ihr Postfach und Ihren Kalender, um sämtliche Kommunikation in Ihren CRM-Datensätzen zu sehen. [Mehr erfahren](/de/user-guide/calendar-emails/overview).
* **Datenmodell:** Erstellen Sie benutzerdefinierte Objekte und Felder, die zu Ihren individuellen Geschäftsprozessen passen. [Entdecken](/de/user-guide/data-model/overview).
* **Datenmigration:** Importieren und exportieren Sie Ihre Daten per CSV oder API. [Erste Schritte](/de/user-guide/data-migration/overview).
* **Ansichten & Pipelines:** Organisieren Sie Ihre Daten mit Tabellenansichten, Kanban-Boards und Vertriebspipelines. [Entdecken](/de/user-guide/views-pipelines/overview).
* **Workflows:** Automatisieren Sie Ihre Geschäftsprozesse und integrieren Sie externe Tools. [Automatisierungen erstellen](/de/user-guide/workflows/overview).
* **KI:** Erweitern Sie Ihr CRM mit KI-gestützten Funktionen und Agenten. [KI entdecken](/de/user-guide/ai/overview).
* **Dashboards:** Verfolgen Sie die Leistung mit benutzerdefinierten Berichten und Visualisierungen. [Dashboards anzeigen](/de/user-guide/dashboards/overview).
* **Berechtigungen & Zugriff:** Steuern Sie mithilfe rollenbasierter Berechtigungen, wer Ihre Daten anzeigen, bearbeiten und verwalten kann. [Zugriff konfigurieren](/de/user-guide/permissions-access/overview).
...
* **API & Webhooks:** Verbinden Sie sich mit anderen Apps und erstellen Sie benutzerdefinierte Integrationen. [Integration starten](/de/developers/extend/api).
