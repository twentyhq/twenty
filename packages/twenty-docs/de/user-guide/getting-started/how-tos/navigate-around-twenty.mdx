...
Wenn Sie neu bei Ansichten sind, lesen Sie unseren [Leitfaden zu Ansichten & Pipelines](/de/user-guide/views-pipelines/overview), um zu erfahren, wie Sie sie erstellen und anpassen.
