...
<CardGroup cols={2}>
  <Card title="Preispläne" icon="tags" href="/de/user-guide/billing/capabilities/pricing-plans">
    Erfahren Sie mehr über die Preispläne von Twenty und was enthalten ist.
  </Card>
  <Card title="FAQ" icon="circle-question" href="/de/user-guide/billing/how-tos/billing-faq">
...
Weitere Fragen finden Sie in den [Abrechnungs-FAQs](/de/user-guide/billing/how-tos/billing-faq).
