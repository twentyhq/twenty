...
[Datenmodell-Referenz →](/de/user-guide/data-model/overview)
...
[Datenmigrationsleitfaden →](/de/user-guide/data-migration/overview)
...
<CardGroup cols={2}>
  <Card title="Machen Sie sich mit dem Layout vertraut" icon="table-columns" href="/de/getting-started/core-concepts/layout">
    Navigation, Ansichten, Befehlsmenü, Seitenleiste.
  </Card>
  <Card title="Workflows erstellen" icon="bolt" href="/de/user-guide/workflows/overview">
    Automatisieren Sie Ihre Geschäftsprozesse.
  </Card>
  <Card title="Ansichten erstellen" icon="table" href="/de/user-guide/layout/overview">
    Tabelle, Kanban, Kalender – filtern und sortieren Sie Ihre Daten.
  </Card>
  <Card title="API erkunden" icon="plug" href="/de/developers/extend/api">
