...
3. **+ Yeni Alan**'a tıklayın
4. **alan türü** seçin (tüm türler için [Alanlar](/tr/user-guide/data-model/capabilities/fields) bölümüne bakın)
...
<Note>
**İçe aktarmalar için API adlarını kullanın.** API adlarını görmek için Ayarlar'da **Gelişmiş modu** etkinleştirin. Bkz. [Alan Eşleme](/tr/user-guide/data-migration/capabilities/field-mapping).
</Note>
...
* [Alanlar](/tr/user-guide/data-model/capabilities/fields) — tüm alan türleri açıklanır
