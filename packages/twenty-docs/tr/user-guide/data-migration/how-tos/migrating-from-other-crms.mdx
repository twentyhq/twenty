...
Tüm alan türleri için tam biçimlendirme gereksinimleri için [CSV Dosyalarınızı Nasıl Hazırlarsınız](/tr/user-guide/data-migration/how-tos/prepare-your-csv-files) bölümüne bakın.
...
Kayıtları bağlamaya ilişkin ayrıntılı talimatlar için [İlişkiler Nasıl İçe Aktarılır](/tr/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) bölümüne bakın.
...
Tam biçimlendirme kılavuzu için [CSV Dosyalarınızı Nasıl Hazırlarsınız](/tr/user-guide/data-migration/how-tos/prepare-your-csv-files) bölümüne bakın.
...
* [Şirketler Nasıl İçe Aktarılır](/tr/user-guide/data-migration/how-tos/import-companies-via-csv)
* [Kişiler Nasıl İçe Aktarılır](/tr/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [İlişkiler Nasıl İçe Aktarılır](/tr/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv)
...
* Bkz. [E-posta ve Takvim](/tr/user-guide/calendar-emails/overview)
...
Ayrıntılı sorun giderme adımları için [İçe Aktarma Hataları Nasıl Düzeltilir](/tr/user-guide/data-migration/how-tos/fix-import-errors) bölümüne bakın.
