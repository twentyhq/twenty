...
İlişkileri korumaya ilişkin ayrıntılar için [İlişkileri Nasıl İçe Aktarırız](/tr/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) bölümüne bakın.
...
<Tip>
  Büyük veya karmaşık bir çalışma alanını mı taşıyorsunuz? Taşıma sürecinin başından sonuna kadar yönetilmesi için [sertifikalı bir Twenty iş ortağı edinin](https://twenty.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud). *(Veya ekibimizi de sürece dahil edin: [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
