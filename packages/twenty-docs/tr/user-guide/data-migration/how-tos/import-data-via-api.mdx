...
| ----------- | ------------------------------------------------------------ | --------------------------------------- |
| **GraphQL** | Esnek sorgular, ilişkili verileri getirme, karmaşık işlemler | [API Belgeleri](/tr/developers/extend/api) |
| **REST**    | Basit CRUD işlemleri, alışıldık REST kalıpları               | [API Belgeleri](/tr/developers/extend/api) |
...
* Biçimlerin Twenty'nin gereksinimlerine uyduğunu doğrulayın (bkz. [Alan Eşleme](/tr/user-guide/data-migration/capabilities/field-mapping))
...
[contact@twenty.com](mailto:contact@twenty.com) adresinden bizimle iletişime geçin veya [Uygulama Hizmetlerimizi](/tr/user-guide/getting-started/capabilities/implementation-services) keşfedin.
...
* [API Belgeleri](/tr/developers/extend/api)
