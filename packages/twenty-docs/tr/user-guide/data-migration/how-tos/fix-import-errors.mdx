...
Daha fazla ayrıntı için: [Benzersizlik Kısıtlamaları](/tr/user-guide/data-migration/capabilities/uniqueness-constraints)
...
Tam biçim başvurusu için: [Alan Eşleme Başvurusu](/tr/user-guide/data-migration/capabilities/field-mapping)
...
Daha fazla ayrıntı için: [İlişkileri İçe Aktarma](/tr/user-guide/data-migration/capabilities/import-relations)
...
Bkz.: [API ile Veri Nasıl İçe Aktarılır](/tr/user-guide/data-migration/how-tos/import-data-via-api)
...
4. **Referans makaleleri kontrol edin:**
   * [Alan Eşleme](/tr/user-guide/data-migration/capabilities/field-mapping)
   * [Benzersizlik Kısıtlamaları](/tr/user-guide/data-migration/capabilities/uniqueness-constraints)
   * [İlişkileri İçe Aktarma](/tr/user-guide/data-migration/capabilities/import-relations)
   * [Hata İşleme](/tr/user-guide/data-migration/capabilities/error-handling)
