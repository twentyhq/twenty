...
<Note>Çok büyük veri kümeleri (yüz binlerce kayıt) için API'yi kullanın. Gerekirse bu betiklerin çalıştırılmasına [uygulama ortaklarımız](/tr/user-guide/getting-started/capabilities/implementation-services) yardımcı olabilir.</Note>
...
Nasıl ilerleyeceğinize ilişkin adım adım yönergeler için lütfen [bu makaleye](/tr/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) bakın.
...
* [CSV dosyalarınızı hazırlayın](/tr/user-guide/data-migration/how-tos/prepare-your-csv-files)
* [Nesneler arasındaki ilişkileri içe aktarın](/tr/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv)
* [Büyük veri kümeleri için API üzerinden içe aktarın](/tr/user-guide/data-migration/how-tos/import-data-via-api)
