...
**Note**: To connect your email accounts and configure sync settings, visit [Email & Calendar Setup](/tr/user-guide/calendar-emails/overview).
...
* **Güncellemeler**: Yeni e-postalar hemen görünür

### Ne Senkronize Edilmez

* **Dahili E-postalar**: Varsayılan olarak, meslektaşlar arasında (aynı alan adı) gönderilen e-postalar özel kalır (Ayarlar → Genel → Güvenlik bölümünde yapılandırılır)
...
Twenty içinde dahili e-postaların senkronize edilip edilmeyeceğini seçin:

1. **Ayarlar → Genel → Güvenlik** bölümüne gidin
2. **Dahili E-postaları Senkronize Et** seçeneğini açın/kapatın
...
* **Senkronizasyon Gecikmeleri**: E-postalar hemen görünür, ancak ilk içe aktarmalar daha uzun sürer
