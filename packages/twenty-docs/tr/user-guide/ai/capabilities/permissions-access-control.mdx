...
* [İzinler](/tr/user-guide/permissions-access/capabilities/permissions) — rolleri oluşturma ve yönetme hakkında ayrıntılı bilgiler
* [Yapay Zekâ Ajanları](/tr/user-guide/ai/capabilities/ai-agents) — iş akışlarında yapay zekâ yetenekleri
