...
Arama çubuğuna, gezinme çubuğunuzun üst kısmındaki Komut Menüsü üzerinden erişebilir ya da anında odaklanmak için `/` tuşuna basabilirsiniz. Arama tüm nesnelerde çalışır.
...
Görünümler konusunda yeniyseniz, bunları nasıl oluşturup özelleştireceğinizi öğrenmek için [Görünümler ve Boru Hatları kılavuzumuzu](/tr/user-guide/views-pipelines/overview) okuyun.
...
<Note>Ayarlar altında bu bölümlerin tümünü görmüyorsanız, çalışma alanı yöneticinizle iletişime geçin — bazı bölümlerin erişimi kısıtlanmıştır.</Note>
