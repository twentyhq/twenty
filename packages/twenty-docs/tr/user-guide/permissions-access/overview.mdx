...
<CardGroup cols={2}>
  <Card title="İzinler" icon="lock" href="/tr/user-guide/permissions-access/capabilities/permissions">
    Roller oluşturun ve nesne, alan ve ayar izinlerini yapılandırın.
  </Card>
  <Card title="SSO Yapılandırması" icon="key" href="/tr/user-guide/permissions-access/capabilities/sso-configuration">
    Kimlik sağlayıcınızla Tek Oturum Açmayı kurun.
  </Card>
  <Card title="SSS" icon="circle-question" href="/tr/user-guide/permissions-access/how-tos/permissions-faq">
...
* [Rol Oluştur](/tr/user-guide/permissions-access/capabilities/permissions#create-a-role)
* [SSO'yu yapılandırın](/tr/user-guide/permissions-access/capabilities/sso-configuration)
* [Ekip üyelerini yönetin](/tr/user-guide/settings/capabilities/member-management)
