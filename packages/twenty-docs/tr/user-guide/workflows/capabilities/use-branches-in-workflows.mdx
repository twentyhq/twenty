...
* [İş Akışları SSS](/tr/user-guide/workflows/how-tos/need-more-help/workflows-faq) — paralel yürütme hakkında yanıtlar
* [İş Akışı Eylemleri](/tr/user-guide/workflows/capabilities/workflow-actions) — dallar için kullanılabilir eylemler
