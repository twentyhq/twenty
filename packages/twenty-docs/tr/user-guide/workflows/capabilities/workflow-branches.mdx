...
<img src="/images/user-guide/workflows/branches.png" style={{genişlik:'100%'}} />
...
<Note>
Yürütmeyi duraklatmak için bir [Delay](/tr/user-guide/workflows/capabilities/workflow-actions#delay) düğümü kullanabilirsiniz, ancak şu anda "başka bir dal bitene kadar" bekleyecek şekilde yapılandırılamaz.
</Note>

## İlgili

* [İş Akışlarında Dallar Nasıl Kullanılır](/tr/user-guide/workflows/capabilities/use-branches-in-workflows) - Adım adım kılavuz
* [İş Akışı Eylemleri](/tr/user-guide/workflows/capabilities/workflow-actions) - Filtre de dahil olmak üzere kullanılabilir eylemler
