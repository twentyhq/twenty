...
* **Toplu**: İş akışı bir kere çalışacak ve tüm kayıt listesini girdi olarak sağlayacaktır. Bu, iş akışının bir [Yineleyici eylemi](/tr/user-guide/workflows/capabilities/workflow-actions#iterator) içermesi gerektiği anlamına gelir.
