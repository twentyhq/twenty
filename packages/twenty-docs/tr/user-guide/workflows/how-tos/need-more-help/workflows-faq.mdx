...
<AccordionGroup>
  ...
  <Accordion title="Single, Global ve Bulk manuel tetikleyiciler arasındaki fark nedir?">
    ...
    * **Bulk**: Kayıtları birlikte işlemeniz veya kredi kullanımını optimize etmeniz gerektiğinde kullanın (Iterator eylemi gerektirir)
    ...
    Ayrıntılar için [İş Akışı Tetikleyicileri](/tr/user-guide/workflows/capabilities/workflow-triggers) bölümüne bakın.
  </Accordion>
  ...
  <Accordion title="Bir If/Else düğümü görmüyorum. Ne yapmalıyım?">
    ...
    **Geçici çözüm**: Adımınızdan birden fazla dal oluşturun; her biri bir **Filter** eylemiyle başlasın:
    ...
    Adım adım bir kılavuz için [Dalları Nasıl Kullanılır](/tr/user-guide/workflows/capabilities/workflow-branches) bölümüne bakın.
  </Accordion>
  ...
  <Accordion title="İş akışı çalıştırmalarını nasıl incelerim?">
    ...
    * **Veri**: Her adımda giriş/çıkış verilerini görüntüleyin
    ...
    Ayrıntılar için [İş Akışı Çalıştırmaları](/tr/user-guide/workflows/capabilities/workflow-runs) bölümüne bakın.
  </Accordion>
