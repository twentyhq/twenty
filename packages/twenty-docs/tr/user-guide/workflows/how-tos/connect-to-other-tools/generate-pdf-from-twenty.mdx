...
1. **Bir API Anahtarı oluşturun**: **Ayarlar → API'ler**'e gidin ve yeni bir API anahtarı oluşturun. Mantık İşlevi için bu belirtece ihtiyacınız olacak.
...
1. Bir **Kod** eylemi (Mantık İşlevi) ekleyin
...
Her hizmet, bir PDF URL'si döndüren bir API sağlar; ardından bunu Mantık İşlevi'ne iletebilirsiniz.
...
* [İş Akışı Tetikleyicileri](/tr/user-guide/workflows/capabilities/workflow-triggers)
* [Mantıksal İşlevler](/tr/user-guide/workflows/capabilities/workflow-actions#code)
* [Twenty'den Teklif veya Fatura Oluşturun](/tr/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-twenty)
