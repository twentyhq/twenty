...
Standart webhook kurulumu için bkz. [Bir Webhook Tetikleyicisi Kurun](/tr/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger). Bu makale, Typeform'un özel yük yapısı için gereken özel işlemeyi kapsar.
...
<Tip>
Kod eylemlerinde dizileri ele alma hakkında daha fazla ayrıntı için bkz. [Kod Eylemlerinde Dizileri Ele Alma](/tr/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
...
* [Bir Webhook Tetikleyicisi Kurun](/tr/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger)
