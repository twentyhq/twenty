...
* [Twenty'den bir PDF oluşturun](/tr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — oluşturulan PDF'leri kayıtlara ekleyin
...
* [Kazanıldı Otomasyonları](/tr/user-guide/workflows/how-tos/crm-automations/closed-won-automations)
