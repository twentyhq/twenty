...
**Örnek:** Tutar alanını Toplam ile toplayarak aşama başına toplam anlaşma değerini gösterin.
...
* [Kanban Görünümleri](/tr/user-guide/views-pipelines/capabilities/kanban-views) — toplamalar ve kompakt görünüm
* [Filtreler ve Sıralama](/tr/user-guide/views-pipelines/capabilities/filters-and-sorting) — filtrelenmiş görünümler oluşturma
