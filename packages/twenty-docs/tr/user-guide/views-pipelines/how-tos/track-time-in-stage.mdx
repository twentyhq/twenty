...
<Tip>
Bu, İş Akışları kullanılarak [Formül Alanları](/tr/user-guide/workflows/how-tos/crm-automations/formula-fields) oluşturmaya bir örnektir — özellikle tarih hesaplamaları.
</Tip>
...
* [İş Akışları](/tr/user-guide/workflows/overview) — otomasyon temelleri
* [Özel Alanlar Nasıl Oluşturulur](/tr/user-guide/data-model/how-tos/create-custom-fields) — alan yapılandırma
* [Kanban Görünümleri](/tr/user-guide/views-pipelines/capabilities/kanban-views) — toplamalar
