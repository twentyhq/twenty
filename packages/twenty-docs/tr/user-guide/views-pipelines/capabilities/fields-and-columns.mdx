...
* [Tablo Görünümleri](/tr/user-guide/views-pipelines/capabilities/table-views) — liste görünümü özellikleri
* [Kanban Görünümleri](/tr/user-guide/views-pipelines/capabilities/kanban-views) — kart tabanlı görünümler
