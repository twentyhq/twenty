...
[Veri Modeli referansı →](/tr/user-guide/data-model/overview)
...
[Veri Taşıma rehberi →](/tr/user-guide/data-migration/overview)
...
<CardGroup cols={2}>
  <Card title="Düzeni öğrenin" icon="table-columns" href="/tr/getting-started/core-concepts/layout">
    Gezinme, görünümler, komut menüsü, yan panel.
  </Card>
  <Card title="İş Akışları Oluşturun" icon="bolt" href="/tr/user-guide/workflows/overview">
    İş süreçlerinizi otomatikleştirin.
  </Card>
  <Card title="Görünümler Oluşturun" icon="table" href="/tr/user-guide/layout/overview">
    Tablo, kanban, takvim — verilerinizi filtreleyin ve sıralayın.
  </Card>
  <Card title="API'yi Keşfedin" icon="plug" href="/tr/developers/extend/api">
