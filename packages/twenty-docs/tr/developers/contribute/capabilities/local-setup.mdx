...
Projenizi yapılandırmak için çevresel değişkenler veya `.env` dosyaları kullanın. Daha fazla bilgi [burada](/tr/developers/self-host/capabilities/setup).
...
Herhangi bir sorunla karşılaşırsanız, çözümler için [Sorun Giderme](/tr/developers/self-host/capabilities/troubleshooting) sayfasına bakın.
