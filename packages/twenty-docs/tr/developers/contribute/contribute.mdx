...
<CardGroup cols={2}>
  <Card title="Hata Raporları ve İstekler" icon="bug" href="/tr/developers/contribute/capabilities/bug-and-requests">
    Sorunları bildirin veya özellik talep edin
  </Card>
  <Card title="Frontend Geliştirme" icon="browser" href="/tr/developers/contribute/capabilities/frontend-development/folder-architecture-front">
