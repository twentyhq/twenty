...
<CardGroup cols={2}>
  <Card title="API'ler" icon="code" href="/tr/developers/extend/api">
    Twenty'ye programatik olarak bağlanın
  </Card>
  <Card title="Webhooklar" icon="bell" href="/tr/developers/extend/webhooks">
    Olaylardan gerçek zamanlı olarak haberdar olun
  </Card>
  <Card title="Uygulamalar" icon="puzzle-piece" href="/tr/developers/extend/apps/getting-started/quick-start">
