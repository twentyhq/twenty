...
Uygulamanız [yerelde derlenip test edildikten sonra](/tr/developers/extend/apps/getting-started/concepts), dağıtım için iki yolunuz vardır:
...
Pazar yeri alanlarının tam listesi için Uygulama Oluşturma sayfasındaki [defineApplication akordeonu](/tr/developers/extend/apps/config/application#marketplace-metadata)'na bakın (`author`, `category`, `aboutDescription`, `websiteUrl`, `termsUrl`, vb.).
