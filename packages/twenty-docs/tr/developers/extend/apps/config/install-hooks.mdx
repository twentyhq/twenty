...
* Kanca, derleme zamanında otomatik olarak uygulama manifestine (`preInstallLogicFunction` / `postInstallLogicFunction`) eklenir — [`defineApplication()`](/tr/developers/extend/apps/config/application) içinde referans verilecek bir şey yoktur.
