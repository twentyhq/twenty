...
Bir [görünüm](/tr/developers/extend/apps/layout/views), belirli bir nesnenin kaydedilmiş bir listesidir.
Bir [gezinme menüsü öğesi](/tr/developers/extend/apps/layout/navigation-menu-items)
...
Bir [ön uç bileşeni](/tr/developers/extend/apps/layout/front-components), Twenty içinde izole edilmiş bir React bileşenidir. Bizimki seçili kaydı okur, kişi şablonlarını `CoreApiClient` aracılığıyla yükler ve bir önceki bölümdeki rotaya POST isteği gönderir.
...
Bir [komut menüsü öğesi](/tr/developers/extend/apps/layout/command-menu-items) `availabilityType: 'RECORD_SELECTION'` ile, bir Person seçildiğinde görünür ve bileşeni yan panelde açar.
...
Bunu bir [sayfa düzeni](/tr/developers/extend/apps/layout/page-layouts) ile bağlayın. Bir
...
[alan bileşeni referansı](/tr/developers/extend/apps/layout/page-layouts#field-widgets).
...
<Card title="Sırada: bir AI temsilcisi →" icon="robot" href="/tr/developers/extend/apps/tutorials/document-generator/ai-agent">
