...
Tam desen için [Relations](/tr/developers/extend/apps/data/relations) bölümüne bakın.
...
<Card title="Sıradaki: belgeleri oluşturma →" icon="bolt" href="/tr/developers/extend/apps/tutorials/document-generator/generating-documents">
