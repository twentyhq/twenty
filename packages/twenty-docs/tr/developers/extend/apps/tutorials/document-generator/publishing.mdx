...
[Application config](/tr/developers/extend/apps/config/application), pazaryerinde görünen kimliği taşır: yazar, kategori, logo ve destek bağlantıları. `public/` içine bir logo yerleştirin ve `logo` ile referans verin.
...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.twenty.com/tr/developers/extend/apps',
...
[Testing](/tr/developers/extend/apps/operations/testing) ve
[Syncing & recovery](/tr/developers/extend/apps/operations/sync-and-recovery).
...
[Publishing](/tr/developers/extend/apps/operations/publishing).
...
<CardGroup cols={2}>
  <Card title="Veri başvurusu" icon="database" href="/tr/developers/extend/apps/data/overview">
    Her alan türü, ilişki ve indeks seçeneği.
  </Card>
  <Card title="Mantık başvurusu" icon="bolt" href="/tr/developers/extend/apps/logic/overview">
    Cron ve veritabanı olayı tetikleyicileri, anahtar-değer deposu, OAuth bağlantıları.
  </Card>
  <Card title="Düzen başvurusu" icon="table-columns" href="/tr/developers/extend/apps/layout/overview">
