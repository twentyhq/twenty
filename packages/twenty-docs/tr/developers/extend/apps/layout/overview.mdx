...
<CardGroup cols={2}>
  <Card title="Görünümler" icon="list" href="/tr/developers/extend/apps/layout/views">
    `defineView` — kaydedilmiş liste yapılandırmaları: görünür sütunlar, filtreler, gruplar.
  </Card>
  <Card title="Gezinme Menüsü Öğeleri" icon="bars" href="/tr/developers/extend/apps/layout/navigation-menu-items">
    `defineNavigationMenuItem` — görünümlere veya harici URL'lere işaret eden kenar çubuğu girişleri.
  </Card>
  <Card title="Sayfa Düzenleri" icon="table-columns" href="/tr/developers/extend/apps/layout/page-layouts">
    `definePageLayout` ve `definePageLayoutTab` — bir kaydın detay sayfasındaki sekmeler ve bileşenler.
  </Card>
  <Card title="Ön uç bileşenleri" icon="window-maximize" href="/tr/developers/extend/apps/layout/front-components">
    `defineFrontComponent` — Twenty içinde oluşturulan yalıtılmış React bileşenleri.
  </Card>
  <Card title="Komut Menüsü Öğeleri" icon="terminal" href="/tr/developers/extend/apps/layout/command-menu-items">
...
Hâlâ etkin geliştirme aşamasındalar: sandbox kısmi bir DOM uygular, bu nedenle gelişmiş kullanımlar başarısız olabilir. [Mevcut sınırlamalara](/tr/developers/extend/apps/layout/front-components#current-limitations) bakın.
