...
| --------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Dahili betikler, otomasyon                          | [API Anahtarı](/tr/developers/extend/api#authentication)                                                |
...
| UI uzantılarına sahip Twenty Uygulaması             | [Uygulamalar](/tr/developers/extend/apps/getting-started/quick-start) (OAuth otomatik olarak yönetilir) |
