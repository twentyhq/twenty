...
<CardGroup cols={3}>
  <Card href="/tr/developers/extend/apps/getting-started/quick-start" img="/images/user-guide/halftone/dev-apps.png">
  ...
  <Card href="/tr/developers/self-host/capabilities/docker-compose" img="/images/user-guide/halftone/dev-self-host.png">
    <CardTitle>Self-Host</CardTitle>
    Twenty'yi kendi altyapınızda çalıştırın.
  </Card>

  <Card href="/tr/developers/contribute/capabilities/local-setup" img="/images/user-guide/halftone/dev-contribute.png">
