...
→ [Guida completa alla configurazione di email e calendario](/it/user-guide/calendar-emails/overview)
...
<Note>
Prima di invitare il tuo team, verifica il ruolo predefinito in **Impostazioni → Membri → Ruoli**. Ai nuovi membri viene assegnato automaticamente questo ruolo quando si uniscono.
</Note>
...
* [Impostazioni dello spazio di lavoro](/it/user-guide/settings/capabilities/workspace-settings)
* [Impostazioni del profilo](/it/user-guide/settings/capabilities/profile-settings)
* [Impostazioni dell'esperienza](/it/user-guide/settings/capabilities/experience-settings)
