...
→ [Scopri di più su ruoli e autorizzazioni](/it/user-guide/permissions-access/capabilities/permissions)
...
* [Autorizzazioni](/it/user-guide/permissions-access/capabilities/permissions) — configura ciò che ogni ruolo può fare
* [Impostazioni dominio](/it/user-guide/settings/capabilities/domains-settings) — configurare i domini approvati
