...
Leggi [questo articolo](/it/user-guide/data-model/overview) per imparare a progettare il tuo modello di dati.
...
Leggi [questo articolo](/it/user-guide/data-migration/overview) per saperne di più sull'importazione dei dati.
...
Inizia a creare automazioni usando [flussi di lavoro](/it/user-guide/workflows/overview).
