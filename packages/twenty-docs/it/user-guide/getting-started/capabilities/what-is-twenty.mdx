...
* **Calendario ed email:** Sincronizza la tua casella di posta e il calendario per vedere tutte le comunicazioni sui record del tuo CRM. [Scopri di più](/it/user-guide/calendar-emails/overview).
* **Modello dati:** Crea oggetti e campi personalizzati per rispecchiare i tuoi processi aziendali specifici. [Esplora](/it/user-guide/data-model/overview).
* **Migrazione dei dati:** Importa ed esporta i tuoi dati via CSV o API. [Inizia qui](/it/user-guide/data-migration/overview).
* **Viste e pipeline:** Organizza i tuoi dati con viste tabellari, bacheche Kanban e pipeline di vendita. [Scopri](/it/user-guide/views-pipelines/overview).
* **Flussi di lavoro:** Automatizza i tuoi processi aziendali e integra con strumenti esterni. [Crea automazioni](/it/user-guide/workflows/overview).
* **AI:** Potenzia il tuo CRM con funzionalità e agenti basati sull'IA. [Esplora l'IA](/it/user-guide/ai/overview).
* **Dashboard:** Monitora le prestazioni con report e visualizzazioni personalizzati. [Visualizza le dashboard](/it/user-guide/dashboards/overview).
* **Autorizzazioni e accesso:** Controlla chi può visualizzare, modificare e gestire i tuoi dati con autorizzazioni basate sui ruoli. [Configura l'accesso](/it/user-guide/permissions-access/overview).
* **Note e attività:** Crea note e attività collegate ai tuoi record per una collaborazione migliore.
* **API e Webhooks:** Connettiti ad altre app e crea integrazioni personalizzate. [Inizia a integrare](/it/developers/extend/api).
