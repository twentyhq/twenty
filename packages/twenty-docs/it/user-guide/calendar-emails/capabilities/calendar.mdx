...
**Nota**: Per connettere il tuo calendario e configurare le impostazioni di sincronizzazione, visita [Configurazione Email e Calendario](/it/user-guide/calendar-emails/overview).
