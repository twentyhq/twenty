...
[Riferimento alla navigazione →](/it/user-guide/layout/capabilities/navigation)
...
[Viste tabella →](/it/user-guide/views-pipelines/capabilities/table-views) · [Viste Kanban →](/it/user-guide/views-pipelines/capabilities/kanban-views) · [Vista calendario →](/it/user-guide/views-pipelines/capabilities/calendar-view)
...
[Riferimento alle pagine dei record →](/it/user-guide/layout/capabilities/record-pages)
