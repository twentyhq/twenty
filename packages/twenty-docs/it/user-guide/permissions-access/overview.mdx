...
<CardGroup cols={2}>
  <Card title="Permessi" icon="lock" href="/it/user-guide/permissions-access/capabilities/permissions">
    Crea ruoli e configura i permessi per oggetti, campi e impostazioni.
  </Card>
  <Card title="Configurazione SSO" icon="key" href="/it/user-guide/permissions-access/capabilities/sso-configuration">
    Configura il Single Sign-On con il tuo provider di identità.
  </Card>
  <Card title="FAQ" icon="circle-question" href="/it/user-guide/permissions-access/how-tos/permissions-faq">
...
* [Crea un ruolo](/it/user-guide/permissions-access/capabilities/permissions#create-a-role)
* [Configura SSO](/it/user-guide/permissions-access/capabilities/sso-configuration)
* [Gestisci i membri del team](/it/user-guide/settings/capabilities/member-management)
