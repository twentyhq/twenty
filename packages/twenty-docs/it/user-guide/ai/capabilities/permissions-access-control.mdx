...
* [Autorizzazioni](/it/user-guide/permissions-access/capabilities/permissions) — informazioni dettagliate sulla creazione e gestione dei ruoli
* [Agenti AI](/it/user-guide/ai/capabilities/ai-agents) — funzionalità di AI nei flussi di lavoro
