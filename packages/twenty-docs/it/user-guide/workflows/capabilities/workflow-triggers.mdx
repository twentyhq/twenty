...
* **Bulk**: Il flusso di lavoro verrà eseguito una volta, fornendo l'intero elenco di record come input. Questo significa che il flusso di lavoro deve contenere un'[azione Iteratore](/it/user-guide/workflows/capabilities/workflow-actions#iterator).
