...
<Note>
Sebbene tu possa usare un nodo [Delay](/it/user-guide/workflows/capabilities/workflow-actions#delay) per mettere in pausa l'esecuzione, al momento non è configurabile per attendere "fino a quando termina un altro ramo".
</Note>

## Correlati

* [Come usare i rami nei workflow](/it/user-guide/workflows/capabilities/use-branches-in-workflows) - Guida passo passo
* [Azioni del workflow](/it/user-guide/workflows/capabilities/workflow-actions) - Azioni disponibili, incluso Filtro
