...
<AccordionGroup>
  ...
  <Accordion title="Qual è la differenza tra i trigger manuali Single, Global e Bulk?">
    ...
    * **Bulk**: Usalo quando devi elaborare i record insieme o ottimizzare l'uso dei crediti (richiede l'azione Iterator)
    ...
    Vedi [Trigger dei flussi di lavoro](/it/user-guide/workflows/capabilities/workflow-triggers) per i dettagli.
  </Accordion>
  ...
  <Accordion title="Non vedo un nodo If/Else. Cosa devo fare?">
    ...
    **Soluzione temporanea**: Crea più diramazioni dal tuo passaggio, ciascuna iniziando con un'azione **Filtro**:
    ...
    Consulta [Come usare le diramazioni](/it/user-guide/workflows/capabilities/workflow-branches) per una guida passo passo.
  </Accordion>
  ...
  <Accordion title="Come leggere le esecuzioni dei flussi di lavoro?">
    ...
    * **Dati**: Visualizza i dati di input/output a ogni passaggio
    ...
    Vedi [Esecuzioni dei flussi di lavoro](/it/user-guide/workflows/capabilities/workflow-runs) per i dettagli.
  </Accordion>
