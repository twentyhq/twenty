...
Per la configurazione standard del webhook, vedi [Configura un trigger webhook](/it/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger). Questo articolo tratta la gestione specifica richiesta dalla struttura di payload personalizzata di Typeform.
...
<Tip>
Per maggiori dettagli sulla gestione degli array, vedi [Gestire gli array nelle azioni Code](/it/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
...
* [Configura un trigger webhook](/it/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger)
* [Gestire gli array nelle azioni Code](/it/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions)
