...
<Note>
**Limitazione di Attività e Note**: Le relazioni su Attività e Note sono codificate come molte-a-molte e non sono ancora disponibili nei trigger o nelle azioni dei flussi di lavoro. Per accedere a queste relazioni, usa invece le [API](/it/developers/extend/api).
</Note>
...
* [Trigger dei flussi di lavoro](/it/user-guide/workflows/capabilities/workflow-triggers)
