...
<Note>Per set di dati molto grandi (centinaia di migliaia di record), usa le API. I nostri [partner di implementazione](/it/user-guide/getting-started/capabilities/implementation-services) possono aiutarti a eseguire questi script se necessario.</Note>
...
Consulta [questo articolo](/it/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) per una guida passo passo su come procedere.
...
* [Prepara i file CSV](/it/user-guide/data-migration/how-tos/prepare-your-csv-files)
* [Importa le relazioni tra oggetti](/it/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv)
* [Importa tramite API per set di dati di grandi dimensioni](/it/user-guide/data-migration/how-tos/import-data-via-api)
