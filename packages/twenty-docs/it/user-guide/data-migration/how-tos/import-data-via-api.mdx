...
| ----------- | ------------------------------------------------------------------ | -------------------------------------------- |
| **GraphQL** | Query flessibili, recupero di dati correlati, operazioni complesse | [Documentazione API](/it/developers/extend/api) |
| **REST**    | Operazioni CRUD semplici, pattern REST familiari                   | [Documentazione API](/it/developers/extend/api) |
...
* Verifica che i formati soddisfino i requisiti di Twenty (vedi [Mappatura dei campi](/it/user-guide/data-migration/capabilities/field-mapping))
...
Contattaci a [contact@twenty.com](mailto:contact@twenty.com) oppure scopri i nostri [Servizi di implementazione](/it/user-guide/getting-started/capabilities/implementation-services).
...
* [Documentazione API](/it/developers/extend/api)
