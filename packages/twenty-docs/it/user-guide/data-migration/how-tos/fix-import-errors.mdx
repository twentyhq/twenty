...
Per maggiori dettagli: [Vincoli di unicità](/it/user-guide/data-migration/capabilities/uniqueness-constraints)
...
Per il riferimento completo ai formati: [Riferimento alla mappatura dei campi](/it/user-guide/data-migration/capabilities/field-mapping)
...
Per maggiori dettagli: [Importazione delle relazioni](/it/user-guide/data-migration/capabilities/import-relations)
...
Vedi: [Come importare i dati tramite API](/it/user-guide/data-migration/how-tos/import-data-via-api)
...
4. **Consulta gli articoli di riferimento:**
   * [Mappatura dei campi](/it/user-guide/data-migration/capabilities/field-mapping)
   * [Vincoli di unicità](/it/user-guide/data-migration/capabilities/uniqueness-constraints)
   * [Importazione delle relazioni](/it/user-guide/data-migration/capabilities/import-relations)
   * [Gestione degli errori](/it/user-guide/data-migration/capabilities/error-handling)
