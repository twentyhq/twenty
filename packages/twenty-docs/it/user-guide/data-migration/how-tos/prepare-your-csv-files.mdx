...
<Note>Per set di dati superiori a 10.000 record, suddividi in più file oppure usa l'[importazione tramite API](/it/user-guide/data-migration/how-tos/import-data-via-api).</Note>
...
Consulta [Come importare le relazioni](/it/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) per istruzioni dettagliate.
...
* [Importa Aziende](/it/user-guide/data-migration/how-tos/import-companies-via-csv) (importale per prime)
* [Importa Contatti](/it/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [Correggi eventuali errori di importazione](/it/user-guide/data-migration/how-tos/fix-import-errors)
