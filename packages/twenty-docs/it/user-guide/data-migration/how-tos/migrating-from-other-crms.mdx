...
Consulta [Come preparare i tuoi file CSV](/it/user-guide/data-migration/how-tos/prepare-your-csv-files) per i requisiti di formattazione completi per tutti i tipi di campo.
...
Consulta [Come importare le relazioni](/it/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) per istruzioni dettagliate sul collegamento dei record.
...
Consulta [Come preparare i tuoi file CSV](/it/user-guide/data-migration/how-tos/prepare-your-csv-files) per la guida completa alla formattazione.
...
* [Come importare le aziende](/it/user-guide/data-migration/how-tos/import-companies-via-csv)
* [Come importare i contatti](/it/user-guide/data-migration/how-tos/import-contacts-via-csv)
...
* Consulta [Come importare i dati tramite API](/it/user-guide/data-migration/how-tos/import-data-via-api)
...
* Consulta [Email e Calendario](/it/user-guide/calendar-emails/overview)
...
Consulta [Come correggere gli errori di importazione](/it/user-guide/data-migration/how-tos/fix-import-errors) per passaggi dettagliati di risoluzione dei problemi.
