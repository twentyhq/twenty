...
Consulta [Come importare le relazioni](/it/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) per i dettagli su come mantenere le relazioni.
...
* Configura i ruoli in **Impostazioni → Membri → Ruoli**
...
<Tip>
  Stai eseguendo la migrazione di uno spazio di lavoro grande o complesso? [Trova un partner Twenty certificato](https://twenty.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) per gestire l’intera migrazione end-to-end. *(Oppure coinvolgi il nostro team: [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
