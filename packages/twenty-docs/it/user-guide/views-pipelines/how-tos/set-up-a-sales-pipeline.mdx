...
* [Viste Kanban](/it/user-guide/views-pipelines/capabilities/kanban-views) — aggregazioni e vista compatta
* [Filtri e ordinamento](/it/user-guide/views-pipelines/capabilities/filters-and-sorting) — creazione di viste filtrate
