...
<Tip>
Questo è un esempio di creazione di [Campi formula](/it/user-guide/workflows/how-tos/crm-automations/formula-fields) usando i workflow.
</Tip>
...
* [Campi formula](/it/user-guide/workflows/how-tos/crm-automations/formula-fields) — crea campi calcolati usando i workflow
* [Visualizzazioni Kanban](/it/user-guide/views-pipelines/capabilities/kanban-views) — aggregazioni di colonna
* [Come creare campi personalizzati](/it/user-guide/data-model/how-tos/create-custom-fields) — configurazione dei campi
