...
<Tip>
Questo è un esempio di creazione di [Campi formula](/it/user-guide/workflows/how-tos/crm-automations/formula-fields) utilizzando i workflow — in particolare calcoli di date.
</Tip>
...
* [Workflows](/it/user-guide/workflows/overview) — nozioni di base sull'automazione
* [Come creare campi personalizzati](/it/user-guide/data-model/how-tos/create-custom-fields) — configurazione dei campi
* [Viste Kanban](/it/user-guide/views-pipelines/capabilities/kanban-views) — aggregazioni
