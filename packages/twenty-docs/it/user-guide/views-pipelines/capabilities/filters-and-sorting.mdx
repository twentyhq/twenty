...
* [Viste tabella](/it/user-guide/views-pipelines/capabilities/table-views) — funzionalità Raggruppa per
* [Panoramica delle viste](/it/user-guide/views-pipelines/overview) — creazione e gestione delle viste
