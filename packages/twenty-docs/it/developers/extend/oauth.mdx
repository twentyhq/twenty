...
| ------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| Script interni, automazioni                       | [Chiave API](/it/developers/extend/api#authentication)                                          |
...
| App Twenty con estensioni dell'interfaccia utente | [App](/it/developers/extend/apps/getting-started/quick-start) (OAuth è gestito automaticamente) |
