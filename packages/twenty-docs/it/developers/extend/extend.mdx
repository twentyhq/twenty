...
<CardGroup cols={2}>
  <Card title="API" icon="code" href="/it/developers/extend/api">
    Connettiti a Twenty in modo programmatico
  </Card>
  <Card title="Webhooks" icon="bell" href="/it/developers/extend/webhooks">
    Ricevi notifiche sugli eventi in tempo reale
  </Card>
  <Card title="App" icon="puzzle-piece" href="/it/developers/extend/apps/getting-started/quick-start">
