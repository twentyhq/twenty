...
<CardGroup cols={2}>
  <Card title="Configurazione dell'applicazione" icon="rocket" href="/it/developers/extend/apps/config/application">
    `defineApplication` — identità, ruolo predefinito, variabili, metadati del marketplace.
  </Card>
  <Card title="Ruoli e permessi" icon="shield-halved" href="/it/developers/extend/apps/config/roles">
    `defineRole` — dichiara ciò che le funzioni logiche della tua app possono leggere e scrivere.
  </Card>
  <Card title="Hook di installazione" icon="wrench" href="/it/developers/extend/apps/config/install-hooks">
