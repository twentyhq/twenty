...
| ----------------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| `dev`                                           | Monitora i file sorgente e sincronizza in tempo reale le modifiche      | [Guida rapida](/it/developers/extend/apps/getting-started/quick-start)                                           |
| `piano`                                         | Visualizza in anteprima le modifiche ai metadati senza applicarle       | [Sincronizzazione e ripristino](/it/developers/extend/apps/operations/sync-and-recovery#previewing-changes-plan) |
| `applica`                                       | Applica le modifiche ai metadati dopo aver mostrato il piano            | [Sincronizzazione e ripristino](/it/developers/extend/apps/operations/sync-and-recovery)                         |
| `dev:build`                                     | Compila l'app e genera il client API (`--tarball` per creare un `.tgz`) | [Pubblicazione](/it/developers/extend/apps/operations/publishing)                                                |
| `dev:typecheck`                                 | Esegui il controllo dei tipi TypeScript                                 | [Test](/it/developers/extend/apps/operations/testing)                                                            |
| `dev:add`                                       | Genera lo scaffold per una nuova entità                                 | [Scaffolding](/it/developers/extend/apps/getting-started/scaffolding)                                            |
...
| `dev:translations-extract`                      | Estrai le stringhe traducibili nei cataloghi in `locales/`              | [Traduzioni](/it/developers/extend/apps/operations/translations)                                                   |
| `dev:catalog-sync`                              | Attiva la sincronizzazione del catalogo del marketplace                 | [Pubblicazione](/it/developers/extend/apps/operations/publishing#how-marketplace-discovery-works)                |
| `app:publish` / `app:install` / `app:uninstall` | Ciclo di vita delle release                                             | [Pubblicazione](/it/developers/extend/apps/operations/publishing) e questa pagina                                |
| `docker:*`                                      | Gestisci il container del server Twenty locale                          | [Server locale](/it/developers/extend/apps/getting-started/local-server)                                         |
