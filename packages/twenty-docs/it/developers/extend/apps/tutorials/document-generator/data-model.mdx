...
Vedi [Relations](/it/developers/extend/apps/data/relations) per il modello completo.
...
<Card title="Successivo: generare documenti →" icon="bolt" href="/it/developers/extend/apps/tutorials/document-generator/generating-documents">
