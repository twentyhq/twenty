...
A [skill](/it/developers/extend/apps/logic/skills-and-agents) è riutilizzabile
...
Un [agent](/it/developers/extend/apps/logic/skills-and-agents) coppia un prompt con un modello
...
[Capitolo 2](/it/developers/extend/apps/tutorials/document-generator/generating-documents#grant-it-access).
</Note>
...
<Card title="Successivo: pubblicazione →" icon="rocket" href="/it/developers/extend/apps/tutorials/document-generator/publishing">
