...
La [application config](/it/developers/extend/apps/config/application) contiene l'identità
...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.twenty.com/it/developers/extend/apps',
...
[Testing](/it/developers/extend/apps/operations/testing) e
[Sincronizzazione & recupero](/it/developers/extend/apps/operations/sync-and-recovery).
...
[Publishing](/it/developers/extend/apps/operations/publishing).
...
<CardGroup cols={2}>
  <Card title="Riferimento dei dati" icon="database" href="/it/developers/extend/apps/data/overview">
    Ogni tipo di campo, relazione e opzione indice.
  </Card>
  <Card title="Riferimento logico" icon="bolt" href="/it/developers/extend/apps/logic/overview">
    Cron e database-event triggers, il key-value store, connessioni OAuth.
  </Card>
  <Card title="Riferimento del layout" icon="table-columns" href="/it/developers/extend/apps/layout/overview">
