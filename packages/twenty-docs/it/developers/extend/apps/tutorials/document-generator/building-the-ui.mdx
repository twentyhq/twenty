...
Un [view](/it/developers/extend/apps/layout/views) è una lista salvata di un dato oggetto.
Una [voce del menu di navigazione](/it/developers/extend/apps/layout/navigation-menu-items)
...
Un [componente anteriore](/it/developers/extend/apps/layout/front-components) è un componente React
...
Una [voce del menu di comando](/it/developers/extend/apps/layout/command-menu-items) con
...
Monta con un [layout pagina](/it/developers/extend/apps/layout/page-layouts). Un layout
...
I widget `FIELD` supportano anche altre modalità di visualizzazione e opzioni, incluso l'elenco dei record di una relazione annidata a due passaggi di distanza — vedi il [riferimento ai widget field](/it/developers/extend/apps/layout/page-layouts#field-widgets).
...
<Card title="Il prossimo: un agente AI →" icon="robot" href="/it/developers/extend/apps/tutorials/document-generator/ai-agent">
