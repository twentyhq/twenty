...
Ora il core: una [funzione logica](/it/developers/extend/apps/logic/logic-functions)
...
(`yarn test:unit`). Vedi [Testing](/it/developers/extend/apps/operations/testing).
</Tip>

## Il gestore

Il gestore utilizza il [`CoreApiClient`](/it/developers/extend/apps/logic/logic-functions)
...
Vedi [Roles](/it/developers/extend/apps/config/roles) per i permessi a grana più fine.
...
<Card title="Il prossimo: percorsi HTTP →" icon="globo" href="/it/developers/extend/apps/tutorials/document-generator/http-route">
