...
Tutte le modalità richiedono un remoto autenticato. Vedi [Sincronizzazione e ripristino](/it/developers/extend/apps/operations/sync-and-recovery#previewing-changes-plan) per maggiori informazioni su `plan`.
...
Riferimento completo: [Concetti](/it/developers/extend/apps/getting-started/concepts).
