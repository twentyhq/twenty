...
Gli oggetti standard sono oggetti integrati con un set di attributi disponibili per tutti gli utenti. Esempi di oggetti standard in Twenty includono Company e Person. Gli oggetti standard hanno campi standard che sono inoltre disponibili per tutti gli utenti di Twenty, come Company.displayName.
