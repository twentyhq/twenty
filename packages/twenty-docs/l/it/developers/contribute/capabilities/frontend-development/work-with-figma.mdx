...
info: Scopri come puoi collaborare al file Figma di Twenty.
---
...
Nella barra laterale sinistra, puoi accedere alle diverse pagine del file Figma di Twenty. Ecco come sono organizzate:
...
- **Pagina principale:** La seconda pagina è la pagina principale, che mostra l'interfaccia utente completa del progetto. Puoi premere **_Play_** per utilizzare il prototipo completo dell'app.
