...
<Note>
  **L'organizzazione dei file dipende da te.** Il rilevamento delle entità è
  ...
  indipendentemente da dove si trova il file. La struttura delle cartelle sopra
  è una convenzione, non un requisito.
</Note>
...
<CardGroup cols={2}>
  <Card
    title="Modello dati"
    icon="database"
    href="/l/it/developers/extend/apps/data-model"
  >
  ...
  <Card
    ...
    icon="bolt"
    href="/l/it/developers/extend/apps/logic-functions"
  >
  ...
  <Card
    ...
    href="/l/it/developers/extend/apps/front-components"
  >
  ...
  <Card
    title="Disposizione"
    icon="table-columns"
    href="/l/it/developers/extend/apps/layout"
  >
  ...
  <Card
    ...
    icon="robot"
    href="/l/it/developers/extend/apps/skills-and-agents"
  >
  ...
  <Card
    title="CLI e test"
    icon="terminal"
    href="/l/it/developers/extend/apps/cli-and-testing"
  >
  ...
  <Card
    title="Pubblicazione"
    icon="rocket"
    href="/l/it/developers/extend/apps/publishing"
  >
