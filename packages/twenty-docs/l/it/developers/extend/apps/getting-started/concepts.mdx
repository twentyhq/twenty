...
| **Dipendenze condivise**         | Dipendenze condivise dai componenti front-end dell'app, dichiarate in package.json | [Dipendenze condivise](/l/it/developers/extend/apps/layout/front-components#sharing-dependencies-across-front-components) |
...
* **Le funzioni logiche** vengono eseguite in processi Node.js isolati sul server. Accedono ai dati solo tramite il client API tipizzato, che agisce come la persona che ha attivato l'esecuzione o come l'app stessa. Consulta [L'accesso utilizzato da una chiamata](/l/it/developers/extend/apps/logic/logic-functions#whose-access-a-call-uses).
