...
| **Dipendenze condivise**         | Dipendenze condivise dai componenti front dell'app, dichiarate in package.json | [Dipendenze condivise](/l/it/developers/extend/apps/layout/front-components#sharing-dependencies-across-front-components) |
