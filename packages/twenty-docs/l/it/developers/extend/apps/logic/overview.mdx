...
<CardGroup cols={2}>
  ...
  <Card title="Archivio chiave-valore" icon="database" href="/l/it/developers/extend/apps/logic/key-value-store">
    Mantieni lo stato tra le esecuzioni delle funzioni di logica — cache, cursori e asserzioni tra spazi di lavoro.
  </Card>
  <Card title="Processi in background" icon="layer-group" href="/l/it/developers/extend/apps/logic/background-jobs">
    Metti in coda l’esecuzione di una funzione di logica sui worker per superare il timeout per esecuzione.
  </Card>
</CardGroup>
