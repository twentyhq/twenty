...
<Note>
  Questo è diverso da `yarn twenty server logs`, che mostra i log del container
  Docker. `yarn twenty logs` mostra i log di esecuzione delle funzioni della tua
  app dal server Twenty.
</Note>
