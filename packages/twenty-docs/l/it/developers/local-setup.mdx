...
Usa variabili d'ambiente o file `.env` per configurare il tuo progetto. Maggiori informazioni [qui](https://docs.twenty.com/developers/self-hosting/setup)
...
Se riscontri problemi, controlla [Risoluzione dei problemi](https://docs.twenty.com/developers/self-hosting/troubleshooting) per le soluzioni.