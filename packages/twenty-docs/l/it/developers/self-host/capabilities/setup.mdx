...
e `FRONTEND_URL` sono già considerate attendibili.
...
<Warning>
L'aggiornamento a una versione con sessioni tramite cookie rende questo obbligatorio. Il front-end
ora invia le credenziali con ogni richiesta e i browser rifiutano una risposta con credenziali
proveniente da un'origine non dichiarata, quindi l'app non riesce a caricarsi finché non imposti questo valore.
</Warning>
