...
Dovrai aggiornare manualmente nel database la versione del workspace a `0.51.0` ed effettuare l'aggiornamento utilizzando la versione `0.52.11` di Twenty seguendo la guida di aggiornamento appena sopra.
...
**Modifica importante**:
Per migliorare le prestazioni, Twenty ora richiede che la cache Redis sia configurata. Abbiamo aggiornato il nostro [docker-compose.yml](https://raw.githubusercontent.com/twentyhq/twenty/main/packages/twenty-docker/docker-compose.yml) per riflettere questa modifica.
