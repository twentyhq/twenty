...
title: Glossario
icon: book
description: Termini chiave utilizzati in tutto Twenty.
---
...
Le app sono estensioni personalizzate sviluppate sotto forma di codice che possono definire modelli di dati e funzioni di logica. Consentono agli sviluppatori di creare personalizzazioni riutilizzabili che possono essere distribuite in più spazi di lavoro.
