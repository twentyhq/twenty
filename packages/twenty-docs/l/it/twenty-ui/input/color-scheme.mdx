...
export const MyComponent = () => {
  return <ColorSchemeCard variant="Dark" selected={true} />;
};
```
...
| props aggiuntive | `React.ComponentPropsWithoutRef<'div'>` | Proprietà standard dell'elemento HTML `div`                                             |             |

</Tab>

</Tabs>

## Selettore schema di colori
...
export const MyComponent = () => {
  return <ColorSchemePicker value="Dark" onChange />;
};
```
