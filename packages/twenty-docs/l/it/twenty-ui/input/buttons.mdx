  ...
  <Tab title="Utilizzo">
    ...
    export const MyComponent = () => {
      const iconButtons = [
        {
          Icon: IconClipboardText,
          onClick: () => console.log("Pulsante 1 cliccato"),
          isActive: true,
        },
        {
          Icon: IconCheckbox,
          onClick: () => console.log("Pulsante 2 cliccato"),
          isActive: true,
        },
      ];
...
<Tabs>
  ...
  <Tab title="Proprietà">
    ...
    | variante                        | string                           | La variante dello stile visivo del pulsante. Le opzioni includono `primary` e `secondary`    |
    | presto                          | booleano                         | Indica se il pulsante è contrassegnato come "presto" (ad esempio per funzionalità in arrivo) |
    | Icona                           | `React.ComponentType`            | Un componente icona opzionale visualizzato all'interno del pulsante                          |
    | Proprietà del `button` di React | `React.ComponentProps<'button'>` | Sono supportate tutte le proprietà standard del pulsante HTML                                |
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Props">
    ...
    | Proprietà del `button` di React | `React.ButtonHTMLAttributes<HTMLButtonElement>` |             |
  </Tab>
</Tabs>
