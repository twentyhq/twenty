...
<Note>
  Per gli agenti AI che operano all'interno dei flussi di lavoro, l'assegnazione
  di un ruolo garantisce che l'agente non possa accedere o modificare dati al di
  fuori dell'ambito previsto, anche se il flusso di lavoro dispone di
