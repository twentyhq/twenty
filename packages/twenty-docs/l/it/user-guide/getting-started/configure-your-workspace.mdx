...
Leggi [questo articolo](https://docs.twenty.com/user-guide/data-model/customize-your-data-model) per imparare a progettare il tuo modello di dati.
...
Leggi [questo articolo](/user-guide/getting-started/import-export-data) per saperne di più sull'importazione dei dati.
...
Inizia a creare automazioni usando [flussi di lavoro](https://docs.twenty.com/user-guide/workflows/getting-started-workflows).
