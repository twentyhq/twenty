...
Apps are custom extensions built as code that can define data models and logic functions. Consentono agli sviluppatori di creare personalizzazioni riutilizzabili che possono essere distribuite in più spazi di lavoro.
