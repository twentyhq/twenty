...
<Note>
  **Risultato rapido**: Inizia collegando la tua casella di posta. Ciò ti offre
  un valore immediato e aiuta il tuo team a vedere Twenty in azione con dati
  reali. Puoi farlo in Impostazioni → Account.
</Note>
