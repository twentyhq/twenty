...
<Note>
  Questo ti offre un controllo preciso su quali email compaiono nel tuo CRM
  senza sincronizzare tutto.
</Note>
...
<Note>
  Non forniamo un indirizzo email in CC per la sincronizzazione selettiva. Usa
  la funzione di selezione delle cartelle sopra per ottenere lo stesso livello
  di controllo.
</Note>
