...
<Warning>
  Le viste eliminate non possono essere ripristinate. Assicurati di volerla
  rimuovere prima di confermare.
</Warning>
...
<Note>
  La visibilità delle viste predefinite "Tutti [Nome oggetto]" non può essere
  modificata.
</Note>
