...
<Tip>
  Questo è un esempio di creazione di [Campi
  formula](/l/it/user-guide/workflows/how-tos/crm-automations/formula-fields)
  utilizzando i workflow — in particolare calcoli di date.
</Tip>
...
<Note>
  Non servono campi "Giorni in" per Chiuso vinto e Chiuso perso, poiché sono
  fasi finali.
</Note>
...
<Note>
  Per creare un nuovo ramo, fai clic con il tasto destro sul canvas del workflow
  e fai clic su **Nuova azione**. Quindi, collega questa azione al nodo
  precedente trascinando la freccia dal nodo precedente a questa nuova azione.
</Note>
