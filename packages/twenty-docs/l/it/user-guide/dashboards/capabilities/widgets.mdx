...
<Frame>
<img src="/images/user-guide/dashboard/dashboard-widget-table.png" alt="Grafico tabella" />
</Frame>

**Ideali per:**

* Ricerca di singoli elementi
* Verifica dei valori esatti
* Revisione o riferimento

**Esempi di utilizzo:**

* Opportunità in chiusura questo mese
* Nuovi lead di questa settimana
* Fatture scadute

### <span style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}><ChartIcon icon="table" />Tabella</span>

Visualizza i record filtrati direttamente nella tua dashboard.
...
<Note>
**In arrivo**: I grafici a indicatore non sono ancora disponibili ma sono nella nostra roadmap.
</Note>
