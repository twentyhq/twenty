...
Per esempi dettagliati e guida passo-passo, vedi la nostra guida [Automazioni interne](/user-guide/workflows/internal-automations).
...
Per modelli di integrazione dettagliati e guida all'implementazione, vedi la nostra guida [Integrazione di strumenti esterni](/user-guide/workflows/external-tool-integration).

### E se non volessi creare quelle connessioni?

Offriamo [Servizi Professionali](/user-guide/workflows/professional-services) per aiutarti a creare le automazioni di cui hai bisogno.  
