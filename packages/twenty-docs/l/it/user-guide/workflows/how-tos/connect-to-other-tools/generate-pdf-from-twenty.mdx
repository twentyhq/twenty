...
<Tip>
  Con un **Attivatore manuale**, gli utenti possono eseguire questo flusso di
  lavoro utilizzando un pulsante che appare in alto a destra una volta
  selezionato un record, per generare e allegare un PDF.
</Tip>
...
<Note>
  Se alleghi a un oggetto diverso (Person, Opportunity, ecc.), rinomina di
  conseguenza il parametro (ad es. `personId`, `opportunityId`) e aggiorna la
  funzione logica.
</Note>
...
- [Funzioni logiche](/l/it/user-guide/workflows/capabilities/workflow-actions#code)
