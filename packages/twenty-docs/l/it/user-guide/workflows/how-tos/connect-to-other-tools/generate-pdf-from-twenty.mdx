...
Questo flusso di lavoro usa un **Attivatore manuale** così gli utenti possono generare un PDF su richiesta per qualsiasi record selezionato. A **Logic Function** handles:
...
1. **Crea una chiave API**: vai su **Impostazioni → API** e crea una nuova chiave API. You'll need this token for the logic function.
...
* [Logic Functions](/l/it/user-guide/workflows/capabilities/workflow-actions#code)
