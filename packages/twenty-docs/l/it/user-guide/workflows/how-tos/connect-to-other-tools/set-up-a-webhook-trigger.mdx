...
<Tip>
  Per maggiori dettagli sulla gestione degli array, vedi [Gestire gli array
  nelle azioni
  Code](/l/it/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
