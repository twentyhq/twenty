...
<Note>
  **Limitazione di Attività e Note**: Le relazioni su Attività e Note sono
  codificate come molte-a-molte e non sono ancora disponibili nei trigger o
  nelle azioni dei flussi di lavoro. Per accedere a queste relazioni, usa invece
  le [API](/l/it/developers/extend/api).
</Note>
...
<Note>
  Fai attenzione con le sincronizzazioni bidirezionali per evitare loop
  infiniti. Usa filtri per verificare che il valore sia effettivamente cambiato
  prima di aggiornare.
</Note>
