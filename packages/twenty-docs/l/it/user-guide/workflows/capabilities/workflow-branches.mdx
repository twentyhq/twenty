...
<Note>
  Ogni ramo è indipendente. L'aggiunta di un ramo non influisce sugli altri
  percorsi esistenti da quel nodo.
</Note>
...
<Note>
  Sebbene tu possa usare un nodo
  [Delay](/l/it/user-guide/workflows/capabilities/workflow-actions#delay) per
  mettere in pausa l'esecuzione, al momento non è configurabile per attendere
  "fino a quando termina un altro ramo".
</Note>
