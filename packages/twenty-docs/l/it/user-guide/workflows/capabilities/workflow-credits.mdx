...
<Note>
  5 crediti mensili sono generosi per le automazioni standard. La maggior parte
  dei team non supererà questo limite con un utilizzo tipico dei flussi di
  lavoro. I crediti aggiuntivi sono necessari principalmente per le azioni Code
  avanzate e i flussi di lavoro basati sull'AI.
</Note>
