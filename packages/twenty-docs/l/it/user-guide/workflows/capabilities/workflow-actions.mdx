...
<Note>
  Se devi utilizzare chiavi API esterne nel tuo codice, devi inserirle direttamente nel corpo della funzione. You cannot configure API keys elsewhere and reference them in the logic function.
</Note>
