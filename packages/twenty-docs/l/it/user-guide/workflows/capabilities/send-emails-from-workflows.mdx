...
<Note>
  Gli allegati sono statici—lo stesso file viene inviato a tutti i destinatari. For dynamic documents (like personalized quotes), generate and attach files using a [Logic Function](/l/it/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty).
</Note>
