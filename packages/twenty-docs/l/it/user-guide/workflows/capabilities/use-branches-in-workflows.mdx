...
<Note>
  Per creare una nuova diramazione da un passaggio esistente, fai clic sul
  pulsante **+** nel passaggio e aggiungi la tua azione. Puoi aggiungere più
  diramazioni facendo clic su **+** più volte.
</Note>
