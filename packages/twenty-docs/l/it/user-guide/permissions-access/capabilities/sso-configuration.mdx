...
<Tip>
  Hai bisogno di configurare l’SSO per la tua organizzazione? [Trova un partner Twenty certificato](https://twenty.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) specializzato in SSO e configurazione dell’identità. *(Preferisci coinvolgere direttamente Twenty? [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
