...
<CardGroup cols={2}>
  <Card
    title="Permessi"
    icon="lock"
    href="/l/it/user-guide/permissions-access/capabilities/permissions"
  >
  ...
  <Card
    ...
    icon="chiave"
    href="/l/it/user-guide/permissions-access/capabilities/sso-configuration"
  >
  ...
  <Card
    ...
    href="/l/it/user-guide/permissions-access/how-tos/permissions-faq"
  >
