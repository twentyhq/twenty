...
- **Collegare oggetti tra loro**: I campi di relazione collegano i record da diversi oggetti. Per informazioni dettagliate sulla creazione e la gestione delle relazioni, consulta il nostro articolo [Campi di Relazione](/user-guide/data-model/relation-fields).
