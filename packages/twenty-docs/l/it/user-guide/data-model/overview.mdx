...
<Check>
  È solo una proprietà di qualcosa che ho già o ha bisogno delle proprie
  proprietà?
</Check>
<Check>
  Avrò mai bisogno di tenere traccia di più elementi di questo tipo per ogni
  record, senza sapere quanti?
</Check>
