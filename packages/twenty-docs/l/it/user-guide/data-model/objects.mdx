...
**Nota:** Se non sei sicuro se sia necessario un nuovo oggetto o campo, controlla [questo articolo](/user-guide/data-model/customize-your-data-model) per una guida sulla progettazione del tuo modello di dati.
