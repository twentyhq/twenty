...
<Warning>
  **Limitazione di importazione/esportazione**: Le relazioni che puntano a più
  tipi di oggetto non sono ancora supportate per l'importazione/esportazione
  CSV. È nella nostra roadmap.
</Warning>
...
<img
  src="/images/user-guide/fields/junction-relation-diagram.png"
  style={{ width: '100%' }}
/>

<Warning>
  **Funzionalità di laboratorio**: le relazioni di giunzione devono essere
  abilitate in **Impostazioni → Aggiornamenti → Lab** prima dell'uso.
</Warning>
