...
<Warning>
  **Funzionalità Lab**: Le relazioni di giunzione sono attualmente nel Lab.
  Abilita le in **Impostazioni → Aggiornamenti → Lab** prima di seguire questa
  guida.
</Warning>

<Note>
  Questa funzionalità richiede anche che la **Modalità avanzata** sia abilitata
  (tramite l'interruttore in basso a destra nelle Impostazioni).
</Note>
...
<img
  ...
  alt="Nuovo oggetto pivot"
/>

5. Clicca su **Salva**

<Tip>
  **Convenzione di denominazione**: Usa un nome che descriva la relazione, come
  "Assegnazione al progetto" o "Appartenenza al team". Questo rende il modello
  di dati più facile da comprendere.
</Tip>
