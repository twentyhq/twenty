...
<Warning>
  L'eliminazione del workspace rimuove permanentemente tutti i dati e non può
  essere annullata. Tutti i dati del workspace saranno persi per sempre, tutti i
  membri perderanno immediatamente l'accesso, e questa azione non può essere
  revocata.
</Warning>
