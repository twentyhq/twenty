...
<Warning>
  I membri rimossi perdono immediatamente l'accesso. I loro dati (record, note,
  attività) rimangono nello spazio di lavoro.
</Warning>

<Warning>
  **Anche la sincronizzazione email viene rimossa.** Se l'utente eliminato era
  l'unico ad aver sincronizzato determinate email, tali email verranno rimosse
  definitivamente dallo spazio di lavoro.
</Warning>
