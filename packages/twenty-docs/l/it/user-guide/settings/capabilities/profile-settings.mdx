...
<Warning>
  Eliminare il tuo account rimuoverà permanentemente il tuo accesso a tutti i
  workspace. Questa azione non può essere annullata, perderai l'accesso a tutti
  i workspace di cui sei membro e dovresti considerare di lasciare
  individualmente i workspace se vuoi solo uscire da specifici team.
</Warning>
