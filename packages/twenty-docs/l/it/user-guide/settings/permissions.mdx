...
**Nota**: Puoi assegnare ruoli solo ai membri esistenti nello spazio di lavoro. Per invitare nuovi membri, utilizza [Gestione Membri](/user-guide/settings/member-management).
