---
title: Configurazione Email e Calendario
info: "Collega i tuoi account email e calendario."
...
5. Le tue email e gli eventi del calendario inizieranno a sincronizzarsi automaticamente
