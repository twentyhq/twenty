...
Użyj zmiennych środowiskowych lub plików `.env`, aby skonfigurować swój projekt. Więcej informacji [tutaj](https://docs.twenty.com/developers/self-hosting/setup)
...
Jeśli napotkasz jakiekolwiek problemy, sprawdź [Rozwiązywanie problemów](https://docs.twenty.com/developers/self-hosting/troubleshooting) w poszukiwaniu rozwiązań.