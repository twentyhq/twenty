...
Przeczytaj [ten artykuł](https://docs.twenty.com/user-guide/data-model/customize-your-data-model), aby dowiedzieć się, jak zaprojektować swój model danych.
...
Przeczytaj [ten artykuł](/user-guide/getting-started/import-export-data), aby dowiedzieć się więcej o imporcie danych.
...
Zacznij tworzyć automatyzacje za pomocą [Workflows](https://docs.twenty.com/user-guide/workflows/getting-started-workflows).
