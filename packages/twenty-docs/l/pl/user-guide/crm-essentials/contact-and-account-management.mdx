...
Aby dowiedzieć się więcej o konfiguracji tych automatycznych przepływów danych, zapoznaj się z naszą sekcją [Workflows](/user-guide/workflows/getting-started-workflows).
...
Jeśli Twoja firma potrzebuje innych unikalnych pól (jak numery telefonów czy kody referencyjne), możesz skonfigurować to w modelu danych. Odwiedź naszą sekcję [Model Danych](/user-guide/data-model/customize-your-data-model), aby dowiedzieć się, jak ustawić dodatkowe ograniczenia unikalności dla Twoich specyficznych potrzeb.
