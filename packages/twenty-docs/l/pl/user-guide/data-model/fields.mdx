...
1.	Przejdź do `Ustawienia` w lewym panelu bocznym.
...
- **Połącz obiekty razem**: Pola relacji łączą rekordy z różnych obiektów. Aby uzyskać szczegółowe informacje na temat tworzenia i zarządzania relacjami, zobacz nasz [artykuł o Polach Relacji](/user-guide/data-model/relation-fields).
