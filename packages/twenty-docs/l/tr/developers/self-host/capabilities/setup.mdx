...
<Warning>
Ön uç her istekte kimlik bilgileri gönderir ve tarayıcılar, bildirilmeyen bir kökenden gelen kimlik bilgileri içeren
yanıtı reddeder, bu nedenle uygulama, siz bunu ayarlayana kadar yüklenemez.
</Warning>
...
Çoklu çalışma alanı etkinleştirildiğinde, burada her çalışma alanı alt etki alanını listelemeyin.
