...
3. **`.env` Güncelleyin**
   ...
   Kesmeye neden olmadan nasıl döndüreceğinize ilişkin talimatlar için [Anahtar döndürme kılavuzuna](/l/tr/developers/self-host/capabilities/key-rotation) bakın.
