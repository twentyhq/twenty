...
<Warning>
  Docker kapsayıcıları, üretim ortamında barındırma veya kendi kendine
  barındırma içindir. Katkıda bulunmak için lütfen [Yerel
  Kurulum](/l/tr/developers/contribute/capabilities/local-setup) bölümüne bakın.
</Warning>
