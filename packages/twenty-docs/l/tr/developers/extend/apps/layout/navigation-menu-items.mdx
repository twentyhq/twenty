...
<Note>
  **Yaygın hata:** bir görünüm ve gezinme menüsü öğesiyle ilişkilendirilmemiş
  bir nesne oluşturmak, o nesneyi kullanıcılar için görünmez yapar. Teknik/içsel
  bir nesne olmadığı sürece, her özel nesnenin varsayılan bir görünümü *ve* ona
  işaret eden bir kenar çubuğu öğesi olmalıdır.
</Note>
