...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Yerel örnek başlatılsın mı?"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Twenty CLI yetkilendirme ekranı"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Uygulama iskeleti başarıyla oluşturuldu"
  />
</div>
...
<Note>
  Docker yüklü değilse veya çalışmıyorsa, iskelet oluşturucu işletim sisteminiz
  için doğru başlatma komutunu söyleyecektir. Docker çalışır duruma geldiğinde,
  `yarn twenty server start` ile devam edebilirsiniz — yeniden iskelet
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Geliştirme modu terminal çıktısı"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Your Apps listesinde My twenty app gösteriliyor"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Uygulama kaydı ayrıntıları"
  />
</div>
...
<Warning>
  Geliştirme modu yalnızca geliştirme ortamında (`NODE_ENV=development`) çalışan
  Twenty örneklerinde kullanılabilir. Üretim örnekleri, geliştirme eşitleme
  isteklerini reddeder — üretim sunucularına dağıtmak için `yarn twenty deploy`
  kullanın. Bkz. [Uygulamaları
  Yayımlama](/l/tr/developers/extend/apps/publishing).
</Warning>
...
<Note>
  `twenty-sdk`'yi global olarak kurmayın — her uygulama kendi sürümünü kullansın
  diye proje bazında sabitleyin.
</Note>
