...
bu görünümü kenar çubuğuna yerleştirir. Sunucu, her nesnenin varsayılan "Tümü ..." görünümünü zaten otomatik olarak sağladığından, bir uygulamanın tanımladığı görünümler ek, özenle seçilmiş görünümlerdir.
...
[alan bileşeni referansı](/l/tr/developers/extend/apps/layout/page-layouts#field-widgets).
