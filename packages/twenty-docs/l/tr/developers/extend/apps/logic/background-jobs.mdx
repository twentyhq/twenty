...
| ------------ | ---------- | ----------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `retryLimit` | `0`        | `0`–`10`                | Çalıştırma bir hata fırlatırsa ekstra deneme sayısı. Bunu yalnızca iki kez çalıştırılması güvenli olan işleyiciler için artırın. |
...
<Warning>
Yeniden denemeler tüm işleyiciyi yeniden çalıştırır. `retryLimit` değerini `0`’ın üzerine çıkarmadan önce kuyruğa alınan işleyicileri idempotent tutun.
</Warning>
