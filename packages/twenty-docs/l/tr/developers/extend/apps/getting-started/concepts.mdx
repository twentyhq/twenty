...
| ---------------------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **Uygulama**                 | Uygulama kimliği, varsayılan rol, değişkenler                                                           | [Uygulama Yapılandırması](/l/tr/developers/extend/apps/config/application)                                                    |
| **Rol**                      | Nesneler ve alanlar üzerindeki izin kümeleri                                                            | [Roller ve İzinler](/l/tr/developers/extend/apps/config/roles)                                                                |
| **Nesne**                    | Alanlara sahip özel kayıt türleri                                                                       | [Nesneler](/l/tr/developers/extend/apps/data/objects)                                                                         |
...
| **Paylaşılan Bağımlılıklar** | Uygulamanın ön uç bileşenleri tarafından paylaşılan ve package.json dosyasında bildirilen bağımlılıklar | [Paylaşılan Bağımlılıklar](/l/tr/developers/extend/apps/layout/front-components#sharing-dependencies-across-front-components) |
| **Komut Menüsü Öğesi**       | Hızlı işlemler ve Cmd+K girdileri                                                                       | [Komut Menüsü Öğeleri](/l/tr/developers/extend/apps/layout/command-menu-items)                                                |

## Korumalı alan

* **Mantık işlevleri** sunucuda yalıtılmış Node.js işlemlerinde çalışır. Verilere yalnızca, çalıştırmayı tetikleyen kişi veya uygulamanın kendisi olarak hareket eden tür güvenlikli API istemcisi aracılığıyla erişirler. [Bir çağrının hangi erişimi kullandığına](/l/tr/developers/extend/apps/logic/logic-functions#whose-access-a-call-uses) bakın.
...
* **Kurulum öncesi/sonrası ve kaldırma kancaları** — kurulum sırasında veya kaldırılmadan hemen önce çalışan isteğe bağlı işlevler. Ayrıntılar için [Kurulum Kancaları](/l/tr/developers/extend/apps/config/install-hooks) bölümüne bakın.
