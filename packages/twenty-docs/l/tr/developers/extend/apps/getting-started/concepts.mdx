...
<Note>
  **Dosya organizasyonu size kalmış.** Varlık algılama AST tabanlıdır — dosyanın
  nerede bulunduğundan bağımsız olarak SDK `export default defineEntity(...)`
  çağrılarını bulur. Yukarıdaki klasör yapısı bir gelenektir, zorunluluk
  değildir.
</Note>
...
<CardGroup cols={2}>
  <Card
    ...
    href="/l/tr/developers/extend/apps/config/overview"
  >
  ...
  <Card
    title="Veri"
    icon="database"
    href="/l/tr/developers/extend/apps/data/overview"
  >
  ...
  <Card
    title="Mantık"
    icon="bolt"
    href="/l/tr/developers/extend/apps/logic/overview"
  >
  ...
  <Card
    title="Düzen"
    icon="table-columns"
    href="/l/tr/developers/extend/apps/layout/overview"
  >
  ...
  <Card
    title="İşlemler"
    icon="rocket"
    href="/l/tr/developers/extend/apps/operations/overview"
  >
