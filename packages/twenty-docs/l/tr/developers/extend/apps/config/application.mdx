...
- **Değişkenler** _(isteğe bağlı)_ — kodunuza ortam değişkenleri olarak sunulan anahtar–değer çiftleri.
- **Kurulum öncesi / kurulum sonrası kancalar** _(isteğe bağlı)_ — bkz. [Mantık Fonksiyonları](/l/tr/developers/extend/apps/logic/logic-functions).
