...
<Note>
  Bu, Docker konteyner günlüklerini gösteren `yarn twenty docker:logs`
  komutundan farklıdır. `yarn twenty dev:function:logs`, uygulamanızın fonksiyon
  yürütme günlüklerini Twenty sunucusundan gösterir.
</Note>
