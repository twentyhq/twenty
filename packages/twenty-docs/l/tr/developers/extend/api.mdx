...
**Settings → API & Webhooks → + Create key** bölümünde bir API anahtarı oluşturun. Hemen kopyalayın — yalnızca bir kez gösterilir. Keys can be scoped to a specific role under **Settings → Members → Roles → Assignment tab** to limit what they can access.
