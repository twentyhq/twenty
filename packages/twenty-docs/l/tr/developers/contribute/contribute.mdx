...
<CardGroup cols={2}>
  <Card
    title="Hata Raporları ve İstekler"
    icon="bug"
    href="/l/tr/developers/contribute/capabilities/bug-and-requests"
  >
  ...
  <Card
    ...
    icon="browser"
    href="/l/tr/developers/contribute/capabilities/frontend-development"
  >
