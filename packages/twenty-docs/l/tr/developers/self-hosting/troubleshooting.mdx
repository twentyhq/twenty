...
`packages/twenty-front/.env` içinde `VITE_DISABLE_TYPESCRIPT_CHECKER=true`'i açarak arka plan kontrollerini devre dışı bırakın, böylece gerekli RAM miktarını azaltın.
