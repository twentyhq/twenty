...
Projenizi yapılandırmak için çevresel değişkenler veya `.env` dosyaları kullanın. Daha fazla bilgi [burada](https://docs.twenty.com/developers/self-hosting/setup)
...
Herhangi bir sorunla karşılaşırsanız, çözümler için [Sorun Giderme](https://docs.twenty.com/developers/self-hosting/troubleshooting) sayfasına bakın.