...
title: Sözlük
icon: kitap
description: Twenty genelinde kullanılan temel terimler.
---
...
Uygulamalar, veri modellerini ve mantık işlevlerini tanımlayabilen, kod olarak oluşturulmuş özel uzantılardır. Geliştiricilerin birden çok çalışma alanına dağıtılabilen, yeniden kullanılabilir özelleştirmeler oluşturmasına olanak tanır.
...
Tetikleyiciler, bir iş akışının başlangıç noktasıdır — otomasyonu başlatan olay veya koşuldur. Örnekler arasında kayıt oluşturma, kayıt güncellemeleri, webhooklar veya zamanlanmış saatler bulunur.
...
Webhooklar, belirli olaylar gerçekleştiğinde Twenty'den diğer uygulamalara gönderilen otomatik mesajlardır ve gerçek zamanlı veri senkronizasyonu sağlar.
