...
<Note>
  **Hızlı Kazanım**: Posta kutunuzu bağlayarak başlayın. Bu size anında değer
  katar ve ekibinizin gerçek verilerle Twenty'yi çalışırken görmesine yardımcı
  olur. Ayarlar → Hesaplar altında bu işlemi gerçekleştirebilirsiniz.
</Note>
