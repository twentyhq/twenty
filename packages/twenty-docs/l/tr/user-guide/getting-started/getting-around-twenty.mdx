...
Görünümlerle yeniyseniz, bunları nasıl oluşturacağınızı ve özelleştireceğinizi öğrenmek için [Görünüm Yönetimi](/user-guide/crm-essentials/view-management) makalemizi okuyun.
