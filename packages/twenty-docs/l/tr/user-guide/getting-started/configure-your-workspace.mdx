...
Veri modelinizi tasarlamayı öğrenmek için [bu makaleyi](https://docs.twenty.com/user-guide/data-model/customize-your-data-model) okuyabilirsiniz.
...
Veri içe aktarma hakkında daha fazla bilgi almak için [bu makaleyi](/user-guide/getting-started/import-export-data) okuyun.
...
[İş akışlarını](https://docs.twenty.com/user-guide/workflows/getting-started-workflows) kullanarak otomasyonlar oluşturmaya başlayın.
