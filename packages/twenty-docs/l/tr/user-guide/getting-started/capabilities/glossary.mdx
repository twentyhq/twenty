...
Apps are custom extensions built as code that can define data models and logic functions. Geliştiricilerin birden çok çalışma alanına dağıtılabilen, yeniden kullanılabilir özelleştirmeler oluşturmasına olanak tanır.
