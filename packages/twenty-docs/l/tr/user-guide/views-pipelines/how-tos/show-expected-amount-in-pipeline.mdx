...
<Tip>
  Bu, iş akışlarını kullanarak [Formül
  Alanları](/l/tr/user-guide/workflows/how-tos/crm-automations/formula-fields)
  oluşturmanın bir örneğidir.
</Tip>
...
<Note>
  Yeni bir dal oluşturmak için, iş akışı kanvasına sağ tıklayın ve **Yeni
  eylem**'e tıklayın. Ardından, oku önceki düğümden bu yeni eyleme sürükleyerek
  bu eylemi önceki düğüme bağlayın.
</Note>
