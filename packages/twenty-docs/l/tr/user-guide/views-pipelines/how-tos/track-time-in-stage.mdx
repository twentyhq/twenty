...
<Tip>
  Bu, İş Akışları kullanılarak [Formül
  Alanları](/l/tr/user-guide/workflows/how-tos/crm-automations/formula-fields)
  oluşturmaya bir örnektir — özellikle tarih hesaplamaları.
</Tip>
...
<Note>
  Closed Won ve Closed Lost için "Days in" alanlarına ihtiyaç yoktur; çünkü
  bunlar son aşamalardır.
</Note>
...
<Note>
  Yeni bir dal oluşturmak için iş akışı tuvaline sağ tıklayın ve **New
  action**'a tıklayın. Ardından, önceki düğümden bu yeni eyleme oku sürükleyerek
