...
<Frame>
<img src="/images/user-guide/dashboard/dashboard-widget-table.png" alt="Tablo grafik" />
</Frame>

**En uygun:**

* Bireysel öğeleri arama
* Tam değerleri kontrol etme
* Denetim veya referans
...
### <span style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}><ChartIcon icon="table" />Tablo</span>

Filtrelenmiş kayıtları doğrudan panonuzda görün.
...
<Note>
**Yakında**: Gösterge grafikleri henüz mevcut değil, ancak yol haritamızda yer alıyor.
</Note>
