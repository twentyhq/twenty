...
<Note>
  **Görüntüleme sınırları**: Çubuk grafikler en fazla 100 çubuk ve Group By
  kullanılırken çubuk başına 50 grup gösterebilir. "Undisplayed data: max X bars
  per chart" uyarısını görürseniz, verilerinizi daraltmak için filtreler ekleyin
  veya gruplamayı değiştirin (ör. güne yerine haftaya göre gruplayın).
</Note>
...
<Note>
  **Yakında**: Gösterge grafikleri ve tablolar henüz mevcut değil, ancak yol
  haritamızda yer alıyor.
</Note>
