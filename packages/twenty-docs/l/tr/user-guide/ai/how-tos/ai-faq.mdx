...
<AccordionGroup>
  ...
  <Accordion title="Yapay zeka ajanlarının tüm verilerime erişimi olacak mı?">
    Yapay zeka ajanları izin sistemi kapsamında çalışacaktır. You can assign specific roles to AI agents under **Settings → Members → Roles**, giving you full control over what data they can access and what actions they can perform.
  </Accordion>
