...
<Note>
  İş akışları içinde çalışan yapay zekâ ajanları için, rol ataması, iş akışının
  daha geniş izinleri olsa bile, ajanın amaçlanan kapsamı dışındaki verilere
  erişememesini veya onları değiştirememesini sağlar.
</Note>
