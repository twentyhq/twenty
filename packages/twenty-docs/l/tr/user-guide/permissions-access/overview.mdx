...
<CardGroup cols={2}>
  <Card
    title="İzinler"
    icon="lock"
    href="/l/tr/user-guide/permissions-access/capabilities/permissions"
  >
  ...
  <Card
    ...
    icon="anahtar"
    href="/l/tr/user-guide/permissions-access/capabilities/sso-configuration"
  >
  ...
  <Card
    ...
    href="/l/tr/user-guide/permissions-access/how-tos/permissions-faq"
  >
