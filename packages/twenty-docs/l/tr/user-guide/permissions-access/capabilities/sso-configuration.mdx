...
<Tip>
  Kuruluşunuz için SSO yapılandırılması mı gerekiyor? SSO ve kimlik kurulumunda uzmanlaşmış [sertifikalı bir Twenty iş ortağı bulun](https://twenty.com/partners/list?categories=SOLUTIONING\&ref=docs-sso). *(Twenty'yi doğrudan sürece dahil etmeyi mi tercih edersiniz? [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
