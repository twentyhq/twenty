...
<Warning>
  **İçe/Dışa Aktarma kısıtlaması**: Birden fazla nesne türüne işaret eden
  ilişkiler CSV içe/dışa aktarma için henüz desteklenmiyor. Bu özellik yol
  haritamızda.
</Warning>
...
<Warning>
  **Lab Özelliği**: Kesişim ilişkileri, kullanılmadan önce **Settings → Updates
  → Lab** bölümünde etkinleştirilmelidir.
</Warning>
