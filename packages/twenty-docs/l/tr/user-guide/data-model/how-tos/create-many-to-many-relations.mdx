...
<Warning>
**Beta Özelliği**: Bağlantı ilişkileri şu anda beta aşamasındadır. Bu kılavuzu uygulamadan önce **Ayarlar → Topluluk → Özellikler** bölümünde bunları etkinleştirin.
</Warning>

<Note>
Bu özellik ayrıca **Gelişmiş mod**un etkinleştirilmesini gerektirir (Ayarlar'ın sol alt kısmındaki anahtarı kullanın).
</Note>
...
1. **Beta Özelliklerinde Bağlantı İlişkilerini Etkinleştirin**: **Ayarlar → Topluluk → Özellikler** bölümüne gidin ve **Junction Relations**'ı etkinleştirin
2. **Gelişmiş modu etkinleştirin**: Ayarlar kenar çubuğunun sol alt kısmındaki **Advanced mode** anahtarını açın
