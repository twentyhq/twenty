...
<Note>
  **İçe aktarmalar için API adlarını kullanın.** API adlarını görmek için
  Ayarlar'da **Gelişmiş modu** etkinleştirin. Bkz. [Alan
  Eşleme](/l/tr/user-guide/data-migration/capabilities/field-mapping).
</Note>
...
<Note>
  Yinelenenler varsa (silinmiş kayıtlardakiler dahil) bir hata alırsınız. Önce
  yinelenenleri temizleyin.
</Note>
