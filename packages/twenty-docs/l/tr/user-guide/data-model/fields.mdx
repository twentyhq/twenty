...
- **Nesneleri birbiriyle bağlayın**: İlişki alanları farklı nesnelerdeki kayıtlar arasında bağlantılar kurar. İlişkilerin oluşturulması ve yönetilmesi üzerine detaylı bilgi için [İlişki Alanları](/user-guide/data-model/relation-fields) makalemize göz atın.
