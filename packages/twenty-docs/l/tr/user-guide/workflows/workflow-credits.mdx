...
- **Manuel Tetikleme Optimizasyonu**: Manuel tetikleyiciler için `Toplu` kullanılabilirliğini seçerek tek bir iş akışı çalıştırmasında birden fazla kaydı işleyin (detaylar için [İş Akışı Özellikleri](/user-guide/workflows/workflow-features) bölümüne bakın)
