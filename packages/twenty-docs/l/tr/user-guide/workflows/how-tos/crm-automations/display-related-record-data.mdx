...
<Note>
  **Görevler ve Notlar sınırlaması**: Görevler ve Notlar üzerindeki ilişkiler
  çoktan çoğa olarak sabit kodlanmıştır ve henüz iş akışı tetikleyicileri veya
  eylemlerinde mevcut değildir. Bu ilişkilere erişmek için bunun yerine
  [API](/l/tr/developers/extend/api) kullanın.
</Note>
...
<Note>
  Sonsuz döngülerden kaçınmak için çift yönlü senkronizasyonlarda dikkatli olun.
  Güncellemeden önce değerin gerçekten değişip değişmediğini kontrol etmek için
  filtreler kullanın.
</Note>
