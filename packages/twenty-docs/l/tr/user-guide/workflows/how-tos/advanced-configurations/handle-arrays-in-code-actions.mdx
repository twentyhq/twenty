...
<Note>
  Gelecek güncellemelerde diziyle çalışmayı kolaylaştırmak için aktif olarak
  çalışıyoruz.
</Note>

<Tip>
  Kod düzenleyicisinin sağ üst kısmındaki kare simgeye tıklayarak tam ekranda
  görüntüleyin — varsayılan düzenleyici genişliği sınırlı olduğundan faydalıdır.
</Tip>
