...
<Tip>
  Tetikleyici, herhangi bir Fırsat güncellemesinde tetiklenir. Filtre, aşama
  Closed Won olduğunda iş akışının devam etmesini sağlar.
</Tip>
...
- [Twenty'den bir PDF oluşturun](/l/tr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — oluşturulan PDF'leri kayıtlara ekleyin
