...
<Note>
  Her dal bağımsızdır. Bir dal eklemek, o düğümdeki diğer mevcut yolları
  etkilemez.
</Note>
...
<Note>
  Yürütmeyi duraklatmak için bir
  [Delay](/l/tr/user-guide/workflows/capabilities/workflow-actions#delay) düğümü
  kullanabilirsiniz, ancak şu anda "başka bir dal bitene kadar" bekleyecek
