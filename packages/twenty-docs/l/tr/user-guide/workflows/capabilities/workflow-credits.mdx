...
| ---------------------- | ------------------- |
| **Aylık abonelik**     | 5 credits per month |
| **Yıllık abonelik**    | 50 credits per year |

<Note>
5 monthly credits are generous for standard automations. Çoğu ekip, tipik iş akışı kullanımıyla bu sınırı aşmayacaktır. Ek krediler, ağırlıklı olarak ileri düzey Code eylemleri ve yapay zeka destekli iş akışları için gereklidir.
</Note>
