...
| ---------------------- | -------------- |
| **Aylık abonelik**     | Ayda 5 kredi   |
| **Yıllık abonelik**    | Yılda 50 kredi |

<Note>
Aylık 5 kredi, standart otomasyonlar için oldukça cömerttir. Çoğu ekip, tipik iş akışı kullanımıyla bu sınırı aşmayacaktır. Ek krediler, ağırlıklı olarak ileri düzey Code eylemleri ve yapay zeka destekli iş akışları için gereklidir.
</Note>
