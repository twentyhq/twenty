...
<Note>
Yapay zeka aracıları role dayalı izinlere uyar. You can assign specific roles to agents under **Settings → Members → Roles** to control what data they can access. Ayrıntılar için [İzinler](/l/tr/user-guide/permissions-access/capabilities/permissions) bölümüne bakın.
</Note>
