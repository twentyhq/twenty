...
<Note>
  Mevcut bir adımdan yeni bir dal oluşturmak için, adım üzerindeki **+**
  düğmesine tıklayın ve eyleminizi ekleyin. **+**'ı birden çok kez tıklayarak
  birden fazla dal ekleyebilirsiniz.
</Note>
