...
<Warning>
  Çalışma alanınızı silmek tüm verileri kalıcı olarak kaldırır ve geri alınamaz.
  Tüm çalışma alanı verileri sonsuza kadar kaybolacak, tüm üyeler anında erişimi
  kaybedecek ve bu işlem geri döndürülemez.
</Warning>
