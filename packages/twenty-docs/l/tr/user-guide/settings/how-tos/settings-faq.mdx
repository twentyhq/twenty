...
Evet! Go to **Settings → General → Workspace Domain** and click **Customize Domain**. İki seçeneğiniz var:
...
Şirket e-posta adreslerine sahip ekip üyelerinin çalışma alanınıza otomatik olarak katılabilmeleri için onaylı erişim alan adlarını yapılandırabilirsiniz. Go to **Settings → Members → Access** and add your company domain (e.g., `yourcompany.com`).
</Accordion>
</AccordionGroup>
