...
<CardGroup cols={2}>
  <Card title="Pricing Plans" icon="tags" href="/l/tr/user-guide/billing/capabilities/pricing-plans">
    Learn about Twenty's pricing plans and what's included.
  </Card>

  <Card title="FAQ" icon="circle-question" href="/l/tr/user-guide/billing/how-tos/billing-faq">
