...
<Note>
  Bu, her şeyi senkronize etmeden CRM'inizde hangi e-postaların görüneceği
...
<Note>
  Seçici senkronizasyon için bir CC e-posta adresi sağlamıyoruz. Aynı düzeyde
  kontrol sağlamak için yukarıdaki klasör seçimi özelliğini kullanın.
</Note>
