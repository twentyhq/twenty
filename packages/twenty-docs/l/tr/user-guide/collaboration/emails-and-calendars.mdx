---
title: E-postalar ve Takvimler
info: "E-posta görüşmelerinizi CRM kayıtlarınız içinde görüntüleyin ve yönetin."
image: /images/user-guide/emails/emails_header.png
sectionInfo: İletişimi ve ekip iş birliğini merkezileştirin
---
...
**Note**: To connect your email accounts and configure sync settings, visit [Email & Calendar Setup](/l/tr/user-guide/settings/email-calendar-setup).
...
### E-postaları Nerede Bulabilirsiniz
...
E-posta sekmesinin yanında, kaydın planlanan toplantı geçmişini içeren bir `Takvim` sekmesi bulacaksınız.
...
**Görünürlük Ayarları**: Takvim verileri, e-postalarla aynı görünürlük ayarlarını takip eder ve her iki iletişim kanalında tutarlı gizlilik kontrolleri sağlar.
