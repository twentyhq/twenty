...
<Tip>
  Taşınmanızda yardım ister misiniz?

  * **Sizin için yapılır:** verilerinizi, boru hatlarınızı ve kullanıcılarınızı uçtan uca taşımak için [sertifikalı bir Twenty iş ortağı bulun](https://twenty.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm).
