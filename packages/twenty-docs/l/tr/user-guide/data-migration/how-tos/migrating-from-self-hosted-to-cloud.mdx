...
<Note>
  Görünümler, iş akışları ve roller geçişten sonra manuel olarak yeniden
...
<Note>
  Referans için kendi barındırmalı veri modelinizin ekran görüntülerini alın
  veya her iki örneği yan yana açık tutun.
</Note>
...
<Note>
  Kullanıcıların bulut çalışma alanı davetini kabul etmek için kullandıklarıyla
  aynı e-posta adreslerini kullanın.
</Note>
...
<Accordion title="Dosya ekleri ve görseller ne olacak?">
  Dosya ekleri CSV dışa aktarmalarına dahil edilmez. Herhangi bir eki manuel
  olarak yeniden yüklemeniz, API aracılığıyla taşımanız ya da büyük geçişlerde
  yardım için ekibimizle iletişime geçmeniz gerekecek.
</Accordion>

<Accordion title="Geçiş sırasında her iki örneği de çalışır halde tutabilir miyim?">
  Evet, buluta geçişin tamamlandığını doğrulayana kadar kendi barındırmalı
  örneğinizi çalışır durumda tutmanızı öneririz. Sadece her iki yerde de yeni
  veriler oluşturmamaya dikkat edin.
</Accordion>
