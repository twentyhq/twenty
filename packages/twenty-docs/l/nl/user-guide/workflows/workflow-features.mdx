...
Voor praktische voorbeelden van deze functies in actie, zie onze [Interne Automatiseringen](/user-guide/workflows/internal-automations) en [Externe Tool Integratie](/user-guide/workflows/external-tool-integration) handleidingen.
