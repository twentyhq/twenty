...
Om onnodige [her-renders](/developers/frontend-development/best-practices-front#managing-re-renders) te vermijden, zit alle routing logica in een `useEffect` in `PageChangeEffect`.

### State Management

[Recoil](https://recoiljs.org/docs/introduction/core-concepts) verzorgt state management.

Zie [beste praktijken](/developers/frontend-development/best-practices-front#state-management) voor meer informatie over state management.
