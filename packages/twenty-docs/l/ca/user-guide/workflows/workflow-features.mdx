...
Per obtenir exemples pràctics d'aquestes funcions en acció, vegeu les nostres guies d'[Automatitzacions Internes](/user-guide/workflows/internal-automations) i [Integració d'Eines Externes](/user-guide/workflows/external-tool-integration).
