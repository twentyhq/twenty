...
A `packages/twenty-front/.env` descomenta `VITE_DISABLE_TYPESCRIPT_CHECKER=true` per desactivar les comprovacions en segon pla, reduint així la quantitat de RAM necessària.
