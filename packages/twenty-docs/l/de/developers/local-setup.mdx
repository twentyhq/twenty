...
Verwenden Sie Umgebungsvariablen oder `.env`-Dateien, um Ihr Projekt zu konfigurieren. Weitere Informationen [hier](https://docs.twenty.com/developers/self-hosting/setup)
...
Sollten Sie auf ein Problem stoßen, schauen Sie sich die [Fehlerbehebung](https://docs.twenty.com/developers/self-hosting/troubleshooting) für Lösungen an.