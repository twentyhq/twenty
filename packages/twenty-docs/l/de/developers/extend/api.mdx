...
Erstellen Sie einen API-Schlüssel unter **Settings > APIs & Webhooks > + Create key**. Kopieren Sie ihn sofort — er wird nur einmal angezeigt. Keys can be scoped to a specific role under **Settings → Members → Roles → Assignment tab** to limit what they can access.
