...
Eine Front-Komponente allein ist über die Benutzeroberfläche nicht erreichbar – Sie müssen sie _sichtbar machen_. Die beiden Möglichkeiten dafür sind:
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Schnellaktionsschaltfläche oben rechts"
  />
</div>
...
<Warning>
  Geheime Variablen (`isSecret: true`) werden **nicht** in Front-Komponenten
  offengelegt. Sie sind nur in
  [Logikfunktionen](/l/de/developers/extend/apps/logic/logic-functions)
  verfügbar, die serverseitig ausgeführt werden. Dadurch wird verhindert, dass
  sensible Werte wie API-Schlüssel an den Browser gesendet werden.
</Warning>
