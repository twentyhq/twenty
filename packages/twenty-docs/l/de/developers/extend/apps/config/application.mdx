...
Die mit [`defineApplicationRole()`](/l/de/developers/extend/apps/config/roles) deklarierte Rolle steuert, auf was die Logikfunktionen und Front-End-Komponenten der App zugreifen können:
