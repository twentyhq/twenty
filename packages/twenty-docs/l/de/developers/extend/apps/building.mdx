...
<Note>
  **Die Dateiorganisation liegt bei Ihnen.** Die Entitätserkennung ist
  ...
  unabhängig davon, wo sich die Datei befindet. Die obige Ordnerstruktur ist
  eine Konvention, keine Anforderung.
</Note>
...
<CardGroup cols={2}>
  <Card
    title="Datenmodell"
    icon="database"
    href="/l/de/developers/extend/apps/data-model"
  >
  ...
  <Card
    ...
    icon="bolt"
    href="/l/de/developers/extend/apps/logic-functions"
  >
  ...
  <Card
    ...
    href="/l/de/developers/extend/apps/front-components"
  >
  ...
  <Card
    title="Layout"
    icon="table-columns"
    href="/l/de/developers/extend/apps/layout"
  >
  ...
  <Card
    ...
    icon="robot"
    href="/l/de/developers/extend/apps/skills-and-agents"
  >
  ...
  <Card
    title="CLI & Tests"
    icon="terminal"
    href="/l/de/developers/extend/apps/cli-and-testing"
  >
  ...
  <Card
    ...
    icon="rocket"
    href="/l/de/developers/extend/apps/publishing"
  >
