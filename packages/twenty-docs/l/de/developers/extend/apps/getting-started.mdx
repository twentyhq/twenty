...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Soll die lokale Instanz gestartet werden?"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Twenty-CLI-Autorisierungsbildschirm"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="App-Gerüst erfolgreich erstellt"
  />
</div>
...
<Note>
  Wenn Docker nicht installiert ist oder nicht läuft, zeigt das Scaffolding-Tool
  den richtigen Startbefehl für Ihr Betriebssystem an. Sobald Docker läuft,
  können Sie mit `yarn twenty server start` fortfahren — ein erneutes
  Scaffolding ist nicht nötig.
</Note>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Terminalausgabe im Dev-Modus"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Liste &#x22;Your Apps&#x22;, die &#x22;My twenty app&#x22; anzeigt"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Details der Anwendungsregistrierung"
  />
</div>
...
<Warning>
  Der Dev-Modus ist nur auf Twenty-Instanzen verfügbar, die im Entwicklungsmodus
  laufen (`NODE_ENV=development`). Produktionsinstanzen lehnen Dev-Sync-Anfragen
  ab — verwenden Sie `yarn twenty deploy`, um auf Produktionsserver
  bereitzustellen. Siehe [Apps
  veröffentlichen](/l/de/developers/extend/apps/publishing).
</Warning>
...
<Note>
  Installieren Sie `twenty-sdk` nicht global — fixieren Sie es pro Projekt,
  damit jede App ihre eigene Version verwendet.
</Note>
