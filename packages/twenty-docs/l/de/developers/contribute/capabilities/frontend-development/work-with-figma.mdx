...
- **Hauptseite:** Die zweite Seite ist die Hauptseite, die die vollständige Benutzeroberfläche des Projekts zeigt. Sie können **_Play_** drücken, um den vollständigen App-Prototypen zu verwenden.
