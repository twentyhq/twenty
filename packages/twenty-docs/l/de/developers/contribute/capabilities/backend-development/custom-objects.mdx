...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Fragen Sie die /metadata API ab, um benutzerdefinierte Objekte hinzuzufügen"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    src="/images/docs/server/custom-object-schema.png"
    alt="Fragen Sie den /graphql-Endpunkt ab, um Daten abzurufen"
  />
</div>
