...
info: Ein detaillierter Einblick in unsere Server-Ordnerarchitektur
---
...
Weitere Details finden Sie unter [benutzerdefinierte Dekoratoren](https://docs.nestjs.com/custom-decorators).
...
Weitere Details finden Sie unter [Guards](https://docs.nestjs.com/guards).
