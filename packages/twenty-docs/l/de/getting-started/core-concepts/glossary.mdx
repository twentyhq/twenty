...
title: Glossar
icon: book
description: Schlüsselbegriffe, die in Twenty verwendet werden.
---
...
Apps sind benutzerdefinierte Erweiterungen, die als Code erstellt werden und Datenmodelle sowie Logikfunktionen definieren können. Damit können Entwickler wiederverwendbare Anpassungen erstellen, die in mehreren Arbeitsbereichen bereitgestellt werden können.
...
Aufgaben in Twenty CRM sind zugewiesene Aktivitäten in Bezug auf Kontakte, Accounts oder Opportunities.

## Auslöser

Auslöser sind der Ausgangspunkt eines Workflows — das Ereignis oder die Bedingung, die die Automatisierung auslöst. Beispiele sind das Erstellen von Datensätzen, Aktualisierungen von Datensätzen, Webhooks oder geplante Zeitpunkte.
