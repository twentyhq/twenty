...
<Note>
  Damit haben Sie genaue Kontrolle darüber, welche E-Mails in Ihrem CRM
  erscheinen, ohne alles zu synchronisieren.
</Note>
...
<Note>
  Wir stellen keine CC-E-Mail-Adresse für selektives Synchronisieren bereit.
  Verwenden Sie die oben genannte Ordnerauswahl, um das gleiche Maß an Kontrolle
  zu erreichen.
</Note>
