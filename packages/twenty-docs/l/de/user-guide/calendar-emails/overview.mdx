...
<Warning>
  Es können nur echte Postfächer verbunden werden (z.B. support@domain.com mit
  eigenem Posteingang). E-Mail-Aliase, die zu einem anderen Postfach
  weiterleiten, können nicht mit Twenty verbunden werden.
</Warning>
...
<Note>
  Wenn aktiviert, werden Kontakte basierend auf ihrer E-Mail-Domain automatisch
  mit ihren Unternehmensdatensätzen verknüpft. Falls das Unternehmen noch nicht
  existiert, erstellt Twenty es für Sie.
</Note>
...
<Note>
  **Dauer der Erstsynchronisierung**: Die Kalendersynchronisierung wird schnell
  abgeschlossen (in der Regel innerhalb von Minuten), während die
  E-Mail-Synchronisierung bei großen Postfächern länger dauert. Twenty
  importiert E-Mails mit etwa **400 Nachrichten pro Minute** (begrenzt durch die
  Ratenbegrenzung der Gmail API), daher dauert es bei einem Postfach mit 10.000
  E-Mails etwa 25 Minuten. Keine Sorge, wenn Kontakte aus Kalenderereignissen
  vor Ihren E-Mail-Kontakten erscheinen; das ist normales Verhalten.
</Note>
