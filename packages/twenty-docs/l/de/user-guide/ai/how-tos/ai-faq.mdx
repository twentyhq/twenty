...
<AccordionGroup>
  ...
  <Accordion title="Haben KI-Agenten Zugriff auf alle meine Daten?">
    KI-Agenten werden über das Berechtigungssystem verwaltet. You can assign specific roles to AI agents under **Settings → Members → Roles**, giving you full control over what data they can access and what actions they can perform.
  </Accordion>
