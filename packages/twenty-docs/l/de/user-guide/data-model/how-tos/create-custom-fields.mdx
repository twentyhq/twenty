...
<Note>
  **Verwenden Sie für Importe API-Namen.** Aktivieren Sie in den Einstellungen
  den **Erweiterten Modus**, um API-Namen anzuzeigen. Siehe
...
<Note>
  Wenn Duplikate vorhanden sind (auch in gelöschten Datensätzen), erhalten Sie
  eine Fehlermeldung. Bereinigen Sie Duplikate zuerst.
</Note>
