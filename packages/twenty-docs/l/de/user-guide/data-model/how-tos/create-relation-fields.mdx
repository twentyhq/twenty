...
<Note>
  **Relationsnamen können nach dem Erstellen nicht geändert werden** (sie wirken
  sich auf die API aus). Planen Sie Ihre Namen sorgfältig.
</Note>
...
<Note>
  **Das Löschen einer Relation löscht keine Datensätze.** Es wird nur die
  Verknüpfung zwischen ihnen entfernt.
</Note>
