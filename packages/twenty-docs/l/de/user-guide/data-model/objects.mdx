...
**Hinweis:** Wenn Sie sich nicht sicher sind, ob ein neues Objekt oder Feld benötigt wird, lesen Sie [in diesem Artikel](/user-guide/data-model/customize-your-data-model) die Anleitung zum Entwerfen Ihres Datenmodells.
