...
<Check>
Ist dies nur eine Eigenschaft von etwas, das ich bereits habe, oder benötigt es eigene Eigenschaften?
</Check>
<Check>
Werde ich jemals mehrere davon pro Datensatz nachverfolgen müssen, ohne zu wissen, wie viele?
</Check>
<Check>
Verbindet dieses Konzept mehrere unterschiedliche Objekte, nicht nur eines?
</Check>
<Check>
Wird es einen eigenen Lebenszyklus haben (Phasen, Start-/Enddaten)?
</Check>
