...
<Warning>
  **Einschränkung beim Import/Export**: Beziehungen, die auf mehrere Objekttypen
  zeigen, werden für den CSV-Import/-Export noch nicht unterstützt. Dies steht
  auf unserer Roadmap.
</Warning>
...
<Warning>
  **Lab-Funktion**: Verknüpfungsbeziehungen müssen vor der Verwendung unter
  **Einstellungen → Updates → Lab** aktiviert werden.
</Warning>
