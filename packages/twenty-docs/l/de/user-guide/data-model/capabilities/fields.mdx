...
Datenbankindizes werden automatisch verwaltet – eigene hinzuzufügen ist selten notwendig und leicht falsch zu machen. Mit aktiviertem Erweiterten Modus hat jedes Objekt einen Abschnitt **Indexes** unter `Settings → Data Model → <object>` für die Fälle, in denen du weißt, dass du einen brauchst.
