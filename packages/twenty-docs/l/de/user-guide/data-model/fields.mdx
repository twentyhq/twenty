...
- **Verbinden sie Objekte miteinander**: Relationsfelder verknüpfen Datensätze aus verschiedenen Objekten. Für detaillierte Informationen zum Erstellen und Verwalten von Beziehungen siehe unseren [Relationsfelder](/user-guide/data-model/relation-fields) Artikel.
