...
<Note>
  Ansichten, Workflows und Berechtigungen müssen nach der Migration manuell neu
  erstellt werden. Planen Sie Zeit für diese Konfigurationsarbeiten ein.
</Note>
...
<Note>
  Halten Sie dieses Mapping-Dokument während des Imports griffbereit — Sie
  werden darauf verweisen, wenn Sie Spalten zuordnen.
</Note>
...
<Check>
  Zugriffsplan für altes CRM entschieden (zur Referenz behalten? Wann
  deaktivieren?)
</Check>
...
<Accordion title="Was ist mit Dateianhängen?">
  Dateianhänge sind in CSV-Exporten nicht enthalten. Sie müssen sie manuell
  erneut hochladen, über die API migrieren oder unser Team für Unterstützung
  kontaktieren.
</Accordion>

<Accordion title="Kann ich während der Migration beide Systeme weiter betreiben?">
  Ja, wir empfehlen, Ihr altes CRM weiter zu betreiben, bis Sie überprüft haben,
  dass die Migration abgeschlossen ist. Achten Sie einfach darauf, nicht an
  beiden Orten neue Daten zu erstellen.
</Accordion>
