...
<Check>
Datei verwendet UTF-8-Kodierung
</Check>

### Datenqualität

<Check>
Keine doppelten E-Mails (für Personen)
</Check>
<Check>
Keine doppelten Domains (für Unternehmen)
</Check>
<Check>
Alle Datumsangaben verwenden ein einheitliches Format
</Check>
<Check>
Alle Domains verwenden das Format `https://domain.com`
</Check>

### Feldformate

<Check>
Boolesche Felder verwenden `TRUE` oder `FALSE` (Großbuchstaben)
</Check>
<Check>
Auswahlfelder verwenden API-Namen, nicht Anzeigenamen
</Check>
<Check>
Telefonfelder enthalten alle erforderlichen Spalten
</Check>
<Check>
Währungsfelder enthalten sowohl Betrag als auch Währungscode
</Check>
...
<Check>
Relationsspalten verweisen auf vorhandene Datensätze
</Check>
<Check>
Domain-Format entspricht exakt dem Format von Twenty
</Check>
...
<Check>
Auswahloptionen existieren vor dem Import
</Check>
