...
<Warning>
  Wenn Sie Ihr Konto löschen, wird Ihr Zugriff auf alle Arbeitsbereiche
  dauerhaft entfernt. Sie verlieren den Zugriff auf alle Arbeitsbereiche, in
  denen Sie Mitglied sind, und Sie sollten erwägen, sich stattdessen aus
  einzelnen Arbeitsbereichen zu entfernen, wenn Sie nur bestimmte Teams
  verlassen möchten.
</Warning>
