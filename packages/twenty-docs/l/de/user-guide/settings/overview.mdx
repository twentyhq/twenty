...
<Note>
  Bevor Sie Ihr Team einladen, überprüfen Sie die Standardrolle unter
  **Einstellungen → Mitglieder → Rollen**. Neuen Mitgliedern wird diese Rolle
  beim Beitritt automatisch zugewiesen.
</Note>
