...
**Hinweis**: Sie können nur Rollen an vorhandene Mitglieder des Arbeitsbereichs zuweisen. Um neue Mitglieder einzuladen, verwenden Sie die [Mitgliederverwaltung](/user-guide/settings/member-management).
