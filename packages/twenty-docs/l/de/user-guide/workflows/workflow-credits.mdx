...
- **Optimierung manueller Auslöser**: Für manuelle Auslöser wählen Sie die Verfügbarkeit "Massenverarbeitung", um mehrere Datensätze in einem Workflowdurchlauf zu verarbeiten (Einzelheiten finden Sie unter [Workflow-Funktionen](/user-guide/workflows/workflow-features))
