...
<Note>
  **Einschränkung bei Aufgaben und Notizen**: Beziehungen bei Aufgaben und
  Notizen sind fest als Viele-zu-Viele implementiert und stehen in
  Workflow-Auslösern oder -Aktionen noch nicht zur Verfügung. Um auf diese
  Beziehungen zuzugreifen, verwenden Sie stattdessen die
  [API](/l/de/developers/extend/api).
</Note>
...
<Note>
  Seien Sie bei bidirektionalen Synchronisierungen vorsichtig, um
  Endlosschleifen zu vermeiden. Verwenden Sie Filter, um vor dem Aktualisieren
  zu prüfen, ob sich der Wert tatsächlich geändert hat.
</Note>
