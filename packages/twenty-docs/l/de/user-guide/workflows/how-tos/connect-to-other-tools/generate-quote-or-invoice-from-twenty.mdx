...
<Tip>
  Der Auslöser wird bei jeder Opportunity-Aktualisierung ausgelöst. Der Filter
  stellt sicher, dass der Workflow nur fortgesetzt wird, wenn die Phase auf
  Closed Won geändert wird.
</Tip>
