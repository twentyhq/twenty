...
<Tip>
  Weitere Details zum Umgang mit Arrays in Code-Aktionen finden Sie unter
  [Arrays in Code-Aktionen
  verarbeiten](/l/de/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
