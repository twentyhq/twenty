...
Dieser Workflow verwendet einen **Manuellen Auslöser**, damit Benutzer bei Bedarf für jeden ausgewählten Datensatz ein PDF generieren können. A **Logic Function** handles:
...
1. **API-Schlüssel erstellen**: Gehen Sie zu **Einstellungen → APIs** und erstellen Sie einen neuen API-Schlüssel. You'll need this token for the logic function.
...
* [Logic Functions](/l/de/user-guide/workflows/capabilities/workflow-actions#code)
