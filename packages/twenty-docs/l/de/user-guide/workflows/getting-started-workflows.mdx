...
Für detaillierte Beispiele und Schritt-für-Schritt-Anleitungen siehe unseren [Internen Automatisierungen](/user-guide/workflows/internal-automations) Leitfaden.
...
Für detaillierte Integrationsmuster und Implementierungsrichtlinien lesen Sie unseren [Leitfaden zur Integration externer Tools](/user-guide/workflows/external-tool-integration).

### Was ist, wenn ich diese Verbindungen nicht herstellen möchte?

Wir bieten [Professional Services](/user-guide/workflows/professional-services) an, um Ihnen bei der Erstellung der benötigten Automatisierungen zu helfen.  
