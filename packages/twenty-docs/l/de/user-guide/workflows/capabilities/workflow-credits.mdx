...
| -------------------------- | -------------------- |
| **Monatliches Abonnement** | 5 Guthaben pro Monat |
| **Jährliches Abonnement**  | 50 Guthaben pro Jahr |

<Note>
5 Guthaben pro Monat sind für Standardautomatisierungen großzügig bemessen. Die meisten Teams überschreiten dieses Limit bei typischer Nutzung von Workflows nicht. Zusätzliche Guthaben werden vor allem für erweiterte Code-Aktionen und KI-gestützte Workflows benötigt.
</Note>
