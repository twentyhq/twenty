...
<Note>
  5 Credits pro Monat sind für Standardautomatisierungen großzügig bemessen. Die
  meisten Teams überschreiten dieses Limit bei typischer Nutzung von Workflows
  nicht. Zusätzliche Guthaben werden vor allem für erweiterte Code-Aktionen und
  KI-gestützte Workflows benötigt.
</Note>
