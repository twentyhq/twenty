...
<Note>
  Um aus einem bestehenden Schritt eine neue Verzweigung zu erstellen, klicken
  Sie im Schritt auf die Schaltfläche **+** und fügen Sie Ihre Aktion hinzu. Sie
  können mehrere Verzweigungen hinzufügen, indem Sie **+** mehrmals klicken.
</Note>
