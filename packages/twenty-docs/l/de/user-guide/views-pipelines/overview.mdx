...
<Warning>
  Gelöschte Ansichten können nicht wiederhergestellt werden. Stellen Sie vor der
  Bestätigung sicher, dass Sie sie entfernen möchten.
</Warning>
...
<Note>
  Bei den Standardansichten "Alle [Objektname]" kann die Sichtbarkeit nicht
  geändert werden.
</Note>
