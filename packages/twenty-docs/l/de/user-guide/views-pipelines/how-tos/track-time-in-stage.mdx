...
<Tip>
  Dies ist ein Beispiel dafür, wie man mit Workflows
  [Formelfelder](/l/de/user-guide/workflows/how-tos/crm-automations/formula-fields)
  erstellt – konkret Datumsberechnungen.
</Tip>
...
<Note>
  Sie benötigen keine "Days in"-Felder für Closed Won und Closed Lost, da dies
  finale Phasen sind.
</Note>
...
<Note>
  ...
  anschließend diese Aktion mit dem vorherigen Knoten, indem Sie den Pfeil vom
