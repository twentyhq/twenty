...
Apps are custom extensions built as code that can define data models and logic functions. Damit können Entwickler wiederverwendbare Anpassungen erstellen, die in mehreren Workspaces bereitgestellt werden können.
