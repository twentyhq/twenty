...
Lesen [Sie diesen Artikel](https://docs.twenty.com/l/de/user-guide/data-model/customize-your-data-model), um zu erfahren, wie Sie Ihr Datenmodell entwerfen.
...
Beginnen Sie mit der Erstellung von Automatisierungen mit [Workflows](https://docs.twenty.com/l/de/user-guide/workflows/getting-started-workflows).
