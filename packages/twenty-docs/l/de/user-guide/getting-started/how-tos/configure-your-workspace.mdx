...
<Note>
  **Schneller Erfolg**: Beginnen Sie damit, Ihr Postfach zu verbinden. Dies
  bietet Ihnen sofortigen Mehrwert und hilft Ihrem Team, Twenty mit echten Daten
  in Aktion zu sehen. Dies können Sie unter Einstellungen → Konten tun.
</Note>
