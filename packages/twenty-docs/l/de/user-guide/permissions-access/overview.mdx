...
<CardGroup cols={2}>
  <Card
    ...
    icon="lock"
    href="/l/de/user-guide/permissions-access/capabilities/permissions"
  >
    Erstellen Sie Rollen und konfigurieren Sie Objekt-, Feld- und
    Einstellungsberechtigungen.
  </Card>
  <Card
    title="SSO-Konfiguration"
    icon="schlüssel"
    href="/l/de/user-guide/permissions-access/capabilities/sso-configuration"
  >
  ...
  <Card
    ...
    href="/l/de/user-guide/permissions-access/how-tos/permissions-faq"
  >
