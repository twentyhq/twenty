...
### <span style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}><ChartIcon icon="sum" />Aggregatdiagramme</span>

Zeigen Sie einzelne Kennzahlen prominent an.

<Frame>
  <img src="/images/user-guide/dashboard/dashboard-widget-aggregate-chart.png" alt="Aggregatdiagramm" />
</Frame>
