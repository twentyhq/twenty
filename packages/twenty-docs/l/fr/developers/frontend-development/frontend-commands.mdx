...
Pour éviter les [re-renders](/l/fr/developers/frontend-development/best-practices-front#managing-re-renders) inutiles, toute la logique de routage est dans un `useEffect` dans `PageChangeEffect`.

### Gestion de l'État

[Recoil](https://recoiljs.org/docs/introduction/core-concepts) gère la gestion de l'état.

Voir [les meilleures pratiques](/l/fr/developers/frontend-development/best-practices-front#state-management) pour plus d'informations sur la gestion de l'état.
