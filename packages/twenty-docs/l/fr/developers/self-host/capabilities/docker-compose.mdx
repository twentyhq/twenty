...
<Warning>
  Les conteneurs Docker sont destinés à l'hébergement en production ou à
  l'auto-hébergement, pour la contribution veuillez consulter le [Configuration
  Locale](/l/fr/developers/contribute/capabilities/local-setup).
</Warning>
