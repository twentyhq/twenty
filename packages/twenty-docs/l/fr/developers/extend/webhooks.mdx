...
title: Webhooks
icon: satellite-dish
description: Recevez une notification lorsque les enregistrements changent — HTTP POST vers votre point de terminaison à chaque création, mise à jour ou suppression.
---
