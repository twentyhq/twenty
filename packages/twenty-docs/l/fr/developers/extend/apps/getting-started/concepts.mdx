...
| **Dépendances partagées**         | Dépendances partagées par les composants front de l’application, déclarées dans package.json | [Dépendances partagées](/l/fr/developers/extend/apps/layout/front-components#sharing-dependencies-across-front-components) |
