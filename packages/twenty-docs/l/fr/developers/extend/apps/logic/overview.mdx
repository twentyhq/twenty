...
<CardGroup cols={2}>
  ...
  <Card title="Tâches d’arrière-plan" icon="layer-group" href="/l/fr/developers/extend/apps/logic/background-jobs">
    Mettez en file d’attente l’exécution d’une fonction logique sur les workers pour dépasser la limite de temps par exécution.
  </Card>
</CardGroup>
