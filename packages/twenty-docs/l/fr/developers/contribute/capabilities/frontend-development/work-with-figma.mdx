...
<Warning>Vous ne pourrez pas collaborer efficacement sans compte.</Warning>
...
- **Page principale :** La deuxième page est la page principale, qui montre l'interface utilisateur complète du projet. Vous pouvez appuyer sur **_Play_** pour utiliser le prototype complet de l'application.
