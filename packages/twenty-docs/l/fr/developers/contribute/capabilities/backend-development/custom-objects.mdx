...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Interroger l'API /metadata pour ajouter des objets personnalisés"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    src="/images/docs/server/custom-object-schema.png"
    alt="Interroger le point de terminaison /graphql pour obtenir des données"
  />
</div>
