...
For more details: [Uniqueness Constraints](/l/fr/user-guide/data-migration/capabilities/uniqueness-constraints)
...
For complete format reference: [Field Mapping](/l/fr/user-guide/data-migration/capabilities/field-mapping)
...
For more details: [Import Relations](/l/fr/user-guide/data-migration/capabilities/import-relations)
...
4. **Check the reference articles:**
   * [Field Mapping](/l/fr/user-guide/data-migration/capabilities/field-mapping)
   * [Uniqueness Constraints](/l/fr/user-guide/data-migration/capabilities/uniqueness-constraints)
   * [Import Relations](/l/fr/user-guide/data-migration/capabilities/import-relations)
   * [Error Handling](/l/fr/user-guide/data-migration/capabilities/error-handling)
