...
<Note>For larger exports (20,000+ records), use filters to export in batches or use the [API](/l/fr/developers/extend/capabilities/apis).</Note>
...
4. Re-import to update records
   See: [How to Update Existing Records](/l/fr/user-guide/data-migration/how-tos/update-existing-records-via-import)
...
See: [API Documentation](/l/fr/developers/extend/capabilities/apis)
...
* [How to Update Existing Records](/l/fr/user-guide/data-migration/how-tos/update-existing-records-via-import) — edit and re-import your export
* [How to Import Data via API](/l/fr/user-guide/data-migration/how-tos/import-data-via-api) — for large datasets
* [API Documentation](/l/fr/developers/extend/capabilities/apis) — build custom export workflows
