...
| ----------- | ----------------------------------------------------------- | ------------------------------------------------ |
| **GraphQL** | Flexible queries, fetching related data, complex operations | [API Docs](/l/fr/developers/extend/capabilities/apis) |
| **REST**    | Simple CRUD operations, familiar REST patterns              | [API Docs](/l/fr/developers/extend/capabilities/apis) |
...
* Verify formats match Twenty's requirements (see [Field Mapping](/l/fr/user-guide/data-migration/capabilities/field-mapping))
...
Contact us at [contact@twenty.com](mailto:contact@twenty.com) or explore our [Implementation Services](/l/fr/user-guide/getting-started/capabilities/implementation-services).
...
* [API Documentation](/l/fr/developers/extend/capabilities/apis)
