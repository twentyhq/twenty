...
<Note>
  Need to import more than 10,000 companies? Split into multiple files or use the [API import](/l/fr/user-guide/data-migration/how-tos/import-data-via-api).
</Note>
...
1. **[Import People](/l/fr/user-guide/data-migration/how-tos/import-contacts-via-csv)** — link them to Companies using the domain
...
See [How to Update Existing Records](/l/fr/user-guide/data-migration/how-tos/update-existing-records-via-import) for details.
...
* [How to Fix Import Errors](/l/fr/user-guide/data-migration/how-tos/fix-import-errors)
* [Field Mapping Reference](/l/fr/user-guide/data-migration/capabilities/field-mapping)
* [Uniqueness Constraints](/l/fr/user-guide/data-migration/capabilities/uniqueness-constraints)
