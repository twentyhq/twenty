...
See [How to Prepare Your CSV Files](/l/fr/user-guide/data-migration/how-tos/prepare-your-csv-files) for complete formatting requirements for all field types.
...
See [How to Import Relations](/l/fr/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) for detailed instructions on linking records.
...
See [How to Prepare Your CSV Files](/l/fr/user-guide/data-migration/how-tos/prepare-your-csv-files) for complete formatting guide.
...
* [How to Import Companies](/l/fr/user-guide/data-migration/how-tos/import-companies-via-csv)
* [How to Import Contacts](/l/fr/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [How to Import Relations](/l/fr/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv)
...
* See [How to Import Data via API](/l/fr/user-guide/data-migration/how-tos/import-data-via-api)
...
* See [Email & Calendar](/l/fr/user-guide/calendar-emails/overview)
...
See [How to Fix Import Errors](/l/fr/user-guide/data-migration/how-tos/fix-import-errors) for detailed troubleshooting steps.
...
Contact [contact@twenty.com](mailto:contact@twenty.com) or explore our [Implementation Services](/l/fr/user-guide/getting-started/capabilities/implementation-services).
