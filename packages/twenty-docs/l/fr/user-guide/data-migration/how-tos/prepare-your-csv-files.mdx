...
<Note>For datasets larger than 10,000 records, split into multiple files or use the [API import](/l/fr/user-guide/data-migration/how-tos/import-data-via-api).</Note>
...
See [How to Import Relations](/l/fr/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) for detailed instructions.
...
* [Import Companies](/l/fr/user-guide/data-migration/how-tos/import-companies-via-csv) (import these first)
* [Import Contacts](/l/fr/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [Fix any import errors](/l/fr/user-guide/data-migration/how-tos/fix-import-errors)
