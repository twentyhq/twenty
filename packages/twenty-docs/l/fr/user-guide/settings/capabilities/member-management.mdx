...
→ [Learn more about roles and permissions](/l/fr/user-guide/permissions-access/capabilities/permissions)
...
* [Permissions](/l/fr/user-guide/permissions-access/capabilities/permissions) — configure what each role can do
* [Domains Settings](/l/fr/user-guide/settings/capabilities/domains-settings) — configure approved domains
