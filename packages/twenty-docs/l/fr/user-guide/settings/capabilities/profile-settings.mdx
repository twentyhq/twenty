...
<Warning>
  La suppression de votre compte supprimera définitivement votre accès à tous
  les espaces de travail. Cette action ne peut être annulée, vous perdrez
  l'accès à tous les espaces de travail où vous êtes membre, et vous devriez
  envisager de quitter des espaces de travail individuels si vous souhaitez
  uniquement quitter certaines équipes.
</Warning>
