...
<Note>
  Avant d'inviter votre équipe, vérifiez le rôle par défaut dans **Paramètres →
  Rôles**. Les nouveaux membres se voient automatiquement attribuer ce rôle
  lorsqu'ils rejoignent l'espace de travail.
</Note>
