...
- **Connecter les objets ensemble** : Les champs de relation lient les enregistrements de différents objets. Pour des informations détaillées sur la création et la gestion des relations, consultez notre article [Champs de Relation](/fr/user-guide/data-model/relation-fields).
