...
<Check>
  Est-ce simplement une propriété de quelque chose que j'ai déjà, ou a-t-il
  besoin de ses propres propriétés ?
</Check>
<Check>
  Aurai-je jamais besoin d'en suivre plusieurs par enregistrement, sans savoir
  combien ?
</Check>
<Check>
