...
3. Click **+ Add Field**
4. Choose a **field type** (see [Fields](/l/fr/user-guide/data-model/capabilities/fields) for all types)
...
<Note>
  **Use API names for imports.** Enable **Advanced mode** in Settings to see API names. See [Field Mapping](/l/fr/user-guide/data-migration/capabilities/field-mapping).
</Note>
...
* [Fields](/l/fr/user-guide/data-model/capabilities/fields) — all field types explained
