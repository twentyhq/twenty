...
<Warning>
  **Fonctionnalité Lab** : Les relations de jonction sont actuellement dans le
  Lab. Activez-les dans **Paramètres → Mises à jour → Lab** avant de suivre ce
  guide.
</Warning>

<Note>
  Cette fonctionnalité exige également que le **mode avancé** soit activé
  (bascule en bas à droite des Paramètres).
</Note>
...
<Tip>
  **Convention de nommage** : Utilisez un nom qui décrit la relation, comme
  "Affectation de projet" ou "Appartenance à l'équipe". Cela rend le modèle de
  données plus facile à comprendre.
</Tip>
