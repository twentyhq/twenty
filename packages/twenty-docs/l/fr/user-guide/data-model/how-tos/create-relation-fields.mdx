...
See [Relation Fields](/l/fr/user-guide/data-model/capabilities/relation-fields) for relation types explained.
...
* [Relation Fields](/l/fr/user-guide/data-model/capabilities/relation-fields) — types and limitations
* [How to Import Relations](/l/fr/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) — bulk import linked records
