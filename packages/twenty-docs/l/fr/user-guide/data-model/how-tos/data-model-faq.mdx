...
<AccordionGroup>
  ...
  <Accordion title="What are relations to multiple object types (Morph relationships)?">
    ...
    Learn more in [Relation Fields](/l/fr/user-guide/data-model/capabilities/relation-fields).
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Can I import data into custom objects?">
    Yes, you can import CSV data into any object, including custom objects. The import process supports field mapping for custom fields. See [How to Prepare Your CSV Files](/l/fr/user-guide/data-migration/how-tos/prepare-your-csv-files).
  </Accordion>
...
Check our [Implementation Services](/l/fr/user-guide/getting-started/capabilities/implementation-services) for help with complex data model design.
