...
<Warning>
  **Limitation d'import/export** : Les relations pointant vers plusieurs types
  d'objets ne sont pas encore prises en charge pour l'import/export CSV. C'est
...
<Warning>
  **Fonctionnalité de laboratoire**: Les relations de jonction doivent être
  activées dans **Settings → Updates → Lab** avant utilisation.
</Warning>
