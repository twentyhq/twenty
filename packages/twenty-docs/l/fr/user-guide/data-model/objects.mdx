...
**Note :** Si vous n'êtes pas sûr qu'un nouvel objet ou champ soit nécessaire, consultez [cet article](/fr/user-guide/data-model/customize-your-data-model) pour obtenir des conseils sur la conception de votre modèle de données.
