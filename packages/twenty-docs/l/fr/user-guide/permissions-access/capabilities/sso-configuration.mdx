...
<Tip>
  Vous avez besoin de configurer le SSO pour votre organisation ? [Trouvez un partenaire Twenty certifié](https://twenty.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) spécialisé dans la mise en place du SSO et de l’identité. *(Vous préférez impliquer directement Twenty ? [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
