...
<Note>
  Cela vous donne un contrôle précis sur les e-mails qui apparaissent dans votre
  CRM sans tout synchroniser.
</Note>
...
<Note>
  Nous ne fournissons pas d’adresse e-mail en CC pour une synchronisation
  sélective. Utilisez la fonctionnalité de sélection de dossiers ci-dessus pour
  obtenir le même niveau de contrôle.
</Note>
