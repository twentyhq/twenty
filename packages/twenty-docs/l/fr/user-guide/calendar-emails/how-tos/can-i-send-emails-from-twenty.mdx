...
→ Learn about the [Send Email action](/l/fr/user-guide/workflows/capabilities/workflow-actions#send-email)
...
→ See [How to send emails from workflows](/l/fr/user-guide/workflows/capabilities/send-emails-from-workflows) for setup instructions
