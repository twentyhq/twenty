...
* [Permissions](/l/fr/user-guide/permissions-access/capabilities/permissions) — detailed information on creating and managing roles
* [AI Agents](/l/fr/user-guide/ai/capabilities/ai-agents) — AI capabilities in workflows
