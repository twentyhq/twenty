...
* [Workflows Overview](/l/fr/user-guide/workflows/overview) — automation basics
* [AI Permissions](/l/fr/user-guide/ai/capabilities/permissions-access-control) — access control for AI agents
