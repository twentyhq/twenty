...
* [Table Views](/l/fr/user-guide/views-pipelines/capabilities/table-views) — all table view features
* [Filters and Sorting](/l/fr/user-guide/views-pipelines/capabilities/filters-and-sorting) — combine grouping with filters
