...
<Tip>
  Ceci est un exemple de création de [Champs de
...
<Note>
  Pour créer une nouvelle branche, cliquez avec le bouton droit sur la zone de
  travail du workflow et cliquez sur **Nouvelle action**. Puis, reliez cette
  action au nœud précédent en faisant glisser la flèche du nœud précédent vers
