...
* [Kanban Views](/l/fr/user-guide/views-pipelines/capabilities/kanban-views) — aggregations and compact view
* [Filters and Sorting](/l/fr/user-guide/views-pipelines/capabilities/filters-and-sorting) — creating filtered views
