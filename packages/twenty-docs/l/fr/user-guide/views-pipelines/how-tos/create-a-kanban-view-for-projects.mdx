...
* [Kanban Views](/l/fr/user-guide/views-pipelines/capabilities/kanban-views) — aggregations, compact view, stages
* [How to Set Up a Sales Pipeline](/l/fr/user-guide/views-pipelines/how-tos/set-up-a-sales-pipeline) — Kanban for Opportunities
