...
* [Table Views](/l/fr/user-guide/views-pipelines/capabilities/table-views) — group by feature
* [Views Overview](/l/fr/user-guide/views-pipelines/overview) — building and managing views
