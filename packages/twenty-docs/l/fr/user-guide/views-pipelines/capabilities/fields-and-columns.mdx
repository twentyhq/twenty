...
* [Table Views](/l/fr/user-guide/views-pipelines/capabilities/table-views) — list view features
* [Kanban Views](/l/fr/user-guide/views-pipelines/capabilities/kanban-views) — card-based views
