...
* [Fields and Columns](/l/fr/user-guide/views-pipelines/capabilities/fields-and-columns) — configuring which fields to display
* [Filters and Sorting](/l/fr/user-guide/views-pipelines/capabilities/filters-and-sorting) — narrowing down records
