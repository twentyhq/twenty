...
Lisez [cet article](https://docs.twenty.com/l/fr/user-guide/data-model/customize-your-data-model) pour apprendre à concevoir votre modèle de données.
...
Lisez [cet article](/l/fr/user-guide/getting-started/import-export-data) pour en savoir plus sur l'importation de données.
...
Commencez à créer des automatisations en utilisant [les flux de travail](https://docs.twenty.com/l/fr/user-guide/workflows/getting-started-workflows).
