...
Lisez [cet article](https://docs.twenty.com/fr/user-guide/data-model/customize-your-data-model) pour apprendre à concevoir votre modèle de données.
...
Commencez à créer des automatisations en utilisant [les flux de travail](https://docs.twenty.com/fr/user-guide/workflows/getting-started-workflows).
