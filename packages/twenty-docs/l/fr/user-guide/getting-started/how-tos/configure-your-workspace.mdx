...
<Note>
  **Gain rapide**: Commencez par connecter votre boîte aux lettres. Cela vous
  procure une valeur immédiate et aide votre équipe à voir Twenty en action avec
  de vraies données. Vous pouvez le faire sous Paramètres → Comptes.
</Note>
