...
La barre de recherche est accessible via le menu de commandes, en haut de votre barre de navigation, ou en appuyant sur `/` pour y placer immédiatement le curseur. La recherche fonctionne sur tous les objets.
...
<Note>Si vous ne voyez pas toutes ces sections sous Paramètres, contactez l'administrateur de votre espace de travail — certaines sections ont un accès restreint.</Note>
