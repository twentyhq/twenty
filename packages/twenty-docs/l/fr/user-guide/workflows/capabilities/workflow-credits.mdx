...
<Note>
  5 millions de crédits mensuels suffisent largement pour les automatisations
  standard. La plupart des équipes ne dépasseront pas cette limite avec une
  utilisation typique des flux de travail. Des crédits supplémentaires sont
  principalement nécessaires pour les actions de Code avancées et les flux de
  travail alimentés par l'IA.
</Note>
