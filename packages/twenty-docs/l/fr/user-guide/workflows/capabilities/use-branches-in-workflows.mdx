...
<Note>
  Pour créer une nouvelle branche à partir d'une étape existante, cliquez sur le
  bouton **+** sur l'étape et ajoutez votre action. Vous pouvez ajouter
  plusieurs branches en cliquant plusieurs fois sur **+**.
</Note>
