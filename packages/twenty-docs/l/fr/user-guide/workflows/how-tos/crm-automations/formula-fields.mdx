...
<Tip>
  Pour un exemple complet de suivi du temps dans les étapes du pipeline, voir
  [Suivre la durée de présence des opportunités dans chaque
  étape](/l/fr/user-guide/views-pipelines/how-tos/track-time-in-stage).
</Tip>
...
<Note>
  Des valeurs négatives indiquent des tâches en retard. Vous pouvez utiliser ce
  champ pour filtrer ou trier les tâches par urgence.
</Note>
