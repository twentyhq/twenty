...
<Note>
  Nous travaillons activement à faciliter la gestion des tableaux dans de
  futures mises à jour.
</Note>

<Tip>
  Cliquez sur l'icône carrée en haut à droite de l'éditeur de code pour
  l'afficher en plein écran — utile car la largeur par défaut de l'éditeur est
  limitée.
</Tip>
