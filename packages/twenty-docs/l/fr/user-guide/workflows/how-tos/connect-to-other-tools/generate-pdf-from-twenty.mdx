...
Remplacez `targetCompanyId` par le champ approprié :

| Objet              | Nom du champ               |
| ------------------ | -------------------------- |
| Entreprise         | `targetCompanyId`          |
| Personne           | `targetPersonId`           |
| Opportunité        | `targetOpportunityId`      |
| Objet personnalisé | `targetYourCustomObjectId` |
