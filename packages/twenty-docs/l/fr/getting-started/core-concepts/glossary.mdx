...
title: Glossaire
icon: book
description: Termes clés utilisés dans Twenty.
---
...
Les applications sont des extensions personnalisées, créées sous forme de code, qui peuvent définir des modèles de données et des fonctions de logique métier. Elles permettent aux développeurs de créer des personnalisations réutilisables pouvant être déployées sur plusieurs espaces de travail.
