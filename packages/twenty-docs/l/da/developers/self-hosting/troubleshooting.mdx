...
I `packages/twenty-front/.env` fjern kommenteringen af `VITE_DISABLE_TYPESCRIPT_CHECKER=true` for at deaktivere baggrundskontroller, hvilket reducerer behovet for RAM.
