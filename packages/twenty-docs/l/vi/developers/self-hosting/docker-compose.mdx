...
Xem tài liệu [Thiết lập Biến môi trường](https://docs.twenty.com/developers/self-hosting/setup) để cấu hình nâng cao. Tất cả các biến môi trường phải được khai báo trong file docker-compose.yml tại cấp độ máy chủ và / hoặc công nhân tùy thuộc vào biến.
...
Nếu gặp bất kỳ vấn đề nào, hãy kiểm tra [Xử lý sự cố](https://docs.twenty.com/developers/self-hosting/troubleshooting) để tìm giải pháp.
