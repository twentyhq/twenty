...
title: Glossário
icon: book
description: Termos-chave usados no Twenty.
---
...
Um Iterador é uma ação de fluxo de trabalho que percorre um array de itens, executando as ações subsequentes para cada item da lista.
...
Os disparadores são o ponto de partida de um fluxo de trabalho — o evento ou condição que inicia a automação. Exemplos incluem a criação de registros, atualizações de registros, webhooks ou horários agendados.
