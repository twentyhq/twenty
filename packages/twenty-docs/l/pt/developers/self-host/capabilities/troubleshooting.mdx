...
#### Erro "File Not Found" ao testar a função Logic no fluxo de trabalho

Execute o comando `yarn command:prod application:rebuild-default-deps` no seu contêiner twenty-server para corrigir o problema de dependências ausentes.
