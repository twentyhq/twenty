...
Consulte docs [Configurar Variáveis de Ambiente](https://docs.twenty.com/developers/self-hosting/setup) para configurações avançadas. Todas as variáveis de ambiente devem ser declaradas no arquivo docker-compose.yml no nível do servidor e/ou do trabalhador, dependendo da variável.
...
Se você encontrar qualquer problema, verifique [Resolução de Problemas](https://docs.twenty.com/developers/self-hosting/troubleshooting) para soluções.
