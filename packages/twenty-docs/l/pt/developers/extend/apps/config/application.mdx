...
- **Variáveis** _(opcional)_ — pares chave–valor expostos ao seu código como variáveis de ambiente.
- **Hooks de pré-instalação/pós-instalação** _(opcional)_ — consulte [Funções de lógica](/l/pt/developers/extend/apps/logic/logic-functions).
