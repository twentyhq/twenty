...
<Note>
  **A organização de arquivos fica a seu critério.** A detecção de entidades é
  ...
  independentemente de onde o arquivo esteja. A estrutura de pastas acima é uma
  convenção, não um requisito.
</Note>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="database"
    href="/l/pt/developers/extend/apps/data-model"
  >
  ...
  <Card
    ...
    icon="bolt"
    href="/l/pt/developers/extend/apps/logic-functions"
  >
  ...
  <Card
    ...
    href="/l/pt/developers/extend/apps/front-components"
  >
  ...
  <Card
    title="Layout"
    icon="table-columns"
    href="/l/pt/developers/extend/apps/layout"
  >
  ...
  <Card
    ...
    icon="robot"
    href="/l/pt/developers/extend/apps/skills-and-agents"
  >
  ...
  <Card
    title="CLI e Testes"
    icon="terminal"
    href="/l/pt/developers/extend/apps/cli-and-testing"
  >
  ...
  <Card
    title="Publicação"
    icon="rocket"
    href="/l/pt/developers/extend/apps/publishing"
  >
