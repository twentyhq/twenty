...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Deve iniciar instância local?"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Tela de autorização da CLI do Twenty"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Scaffold do aplicativo criado com sucesso"
  />
</div>
...
<Note>
  Se o Docker não estiver instalado ou em execução, a ferramenta de scaffolding
  informará o comando de inicialização correto para o seu sistema operacional.
  Quando o Docker estiver ativo, você pode retomar com `yarn twenty
  docker:start` — sem necessidade de recriar o scaffolding.
</Note>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Saída do terminal no modo de desenvolvimento"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Lista Your Apps exibindo My twenty app"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Detalhes do registro do aplicativo"
  />
</div>
...
<CardGroup cols={2}>
  <Card
    ...
    href="/l/pt/developers/extend/apps/config/overview"
  >
    Identidade do aplicativo, função padrão, hooks de instalação, recursos
    públicos.
  </Card>
  <Card
    title="Data"
    icon="database"
    href="/l/pt/developers/extend/apps/data/overview"
  >
  ...
  <Card
    title="Lógica"
    icon="bolt"
    href="/l/pt/developers/extend/apps/logic/overview"
  >
  ...
  <Card
    title="Layout"
    icon="table-columns"
    href="/l/pt/developers/extend/apps/layout/overview"
  >
  ...
  <Card
    title="Operações"
    icon="rocket"
    href="/l/pt/developers/extend/apps/operations/overview"
  >
