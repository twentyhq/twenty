...
- **Página principal:** A segunda página é a página principal, que mostra a interface completa do usuário do projeto. Você pode pressionar **_Play_** para usar o protótipo completo do aplicativo.
