...
<CardGroup cols={2}>
  <Card
    title="Relatos de bugs e solicitações"
    icon="bug"
    href="/l/pt/developers/contribute/capabilities/bug-and-requests"
  >
  ...
  <Card
    ...
    icon="browser"
    href="/l/pt/developers/contribute/capabilities/frontend-development"
  >
    Contribua para a UI
  </Card>
</CardGroup>
