...
<Warning>
  Excluir sua conta removerá permanentemente seu acesso a todos os workspaces.
  Essa ação não pode ser desfeita; você perderá o acesso a todos os workspaces
  onde é membro e deve considerar sair de workspaces individuais se apenas
  quiser sair de equipes específicas.
</Warning>
