...
<Warning>
  Membros removidos perdem o acesso imediatamente. Os dados deles (registros,
  notas, tarefas) permanecem no espaço de trabalho.
</Warning>

<Warning>
  **A sincronização de e-mail também é removida.** Se o usuário excluído era o
  único que sincronizava determinados e-mails, esses e-mails serão removidos
  permanentemente do espaço de trabalho.
</Warning>
