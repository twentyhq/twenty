...
<Accordion title="Como atualizo o logotipo do meu espaço de trabalho?">
  1. Vá para **Configurações → Geral** 2. Clique no logotipo atual ou na área de
  upload 3. Selecione um arquivo de imagem (PNG, JPEG ou GIF com menos de 10 MB)
  4. O logotipo é atualizado imediatamente
</Accordion>

<Accordion title="Posso ter vários espaços de trabalho?">
  Sim, você pode criar e ser membro de vários espaços de trabalho. Cada espaço
  de trabalho tem seus próprios dados, configurações e assinatura.
</Accordion>
...
<Accordion title="Como ativo a autenticação de dois fatores?">
  1. Vá para **Configurações → Perfil** 2. Encontre a seção 2FA 3. Clique em
  **Ativar 2FA** 4. Escaneie o código QR com seu aplicativo autenticador 5.
  Digite o código de verificação
</Accordion>

<Accordion title="Posso alterar meu endereço de e-mail?">
  Para alterar seu endereço de e-mail, entre em contato pelo
...
<Accordion title="Como altero o formato de data?">
  1. Vá para **Configurações → Experiência** 2. Encontre Formato de data 3.
  Selecione o formato de sua preferência 4. As alterações são aplicadas
  imediatamente
</Accordion>

<Accordion title="Como altero meu fuso horário?">
  1. Vá para **Configurações → Experiência** 2. Encontre o fuso horário 3.
  Selecione seu fuso horário local 4. Todos os carimbos de data e hora serão
  ajustados
</Accordion>
...
<Accordion title="Posso conectar várias contas de e-mail?">
  Sim, você pode conectar várias contas de e-mail. Vá para **Configurações →
  Contas** e adicione contas adicionais conforme necessário.
</Accordion>
...
<Accordion title="É seguro usar os recursos de Acesso antecipado?">
  Os recursos de Acesso antecipado são funcionais, mas podem mudar com base no
  feedback dos usuários. Eles são seguros para usar, mas podem evoluir antes da
