...
Sim! Go to **Settings → General → Workspace Domain** and click **Customize Domain**. Você tem duas opções:
...
Você pode configurar domínios de acesso aprovados para que membros da equipe com endereços de e-mail da empresa possam ingressar automaticamente no seu espaço de trabalho. Go to **Settings → Members → Access** and add your company domain (e.g., `yourcompany.com`).
</Accordion>
</AccordionGroup>
