...
<CardGroup cols={2}>
  <Card
    title="Permissões"
    icon="lock"
    href="/l/pt/user-guide/permissions-access/capabilities/permissions"
  >
    Crie funções e configure permissões de objetos, campos e configurações.
  </Card>
  <Card
    title="Configuração do SSO"
    icon="chave"
    href="/l/pt/user-guide/permissions-access/capabilities/sso-configuration"
  >
  ...
  <Card
    ...
    href="/l/pt/user-guide/permissions-access/how-tos/permissions-faq"
  >
