...
<Tip>
  Precisa de SSO configurado para a sua organização? [Encontre um parceiro Twenty certificado](https://twenty.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) que seja especialista em SSO e configuração de identidade. *(Prefere envolver a Twenty diretamente? [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
