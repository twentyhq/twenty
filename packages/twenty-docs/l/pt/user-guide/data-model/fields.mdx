...
- **Conecte objetos juntos**: Campos de relação ligam registros de diferentes objetos. Para informações detalhadas sobre criar e gerenciar relacionamentos, veja nosso artigo [Campos de Relação](/user-guide/data-model/relation-fields).
