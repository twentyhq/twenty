...
<Warning>
**Recurso Beta**: As relações de junção estão atualmente em beta. Ative-as em **Settings → Community → Features** antes de seguir este guia.
</Warning>

<Note>
Este recurso também requer que o **Modo Avançado** esteja ativado (alternador no canto inferior esquerdo de Settings).
</Note>
...
1. **Ative Relações de Junção em Recursos Beta**: Vá para **Settings → Community → Features** e ative **Junction Relations**
2. **Ative o Modo Avançado**: Ative o **Modo Avançado** no canto inferior esquerdo da barra lateral de Settings
