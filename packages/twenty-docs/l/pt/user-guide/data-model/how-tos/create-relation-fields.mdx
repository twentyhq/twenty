...
<Note>
  **Os nomes das relações não podem ser alterados após a criação** (eles afetam
  a API). Planeje os nomes com cuidado.
</Note>
...
<Note>
  **Excluir uma relação não exclui registros.** Apenas o vínculo entre eles é
  removido.
</Note>
