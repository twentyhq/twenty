...
<Note>
  **Use nomes de API para importações.** Ative o **modo Avançado** em Definições
  para ver os nomes de API. Consulte [Mapeamento de
  Campos](/l/pt/user-guide/data-migration/capabilities/field-mapping).
</Note>
...
<Note>
  Se existirem duplicados (incluindo em registos eliminados), ocorrerá um erro.
  Elimine os duplicados primeiro.
</Note>
