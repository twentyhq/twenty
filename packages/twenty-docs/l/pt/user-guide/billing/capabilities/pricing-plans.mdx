...
<Note>
  Os recursos Premium (SSO, permissões em nível de linha e dados de uso de IA)
  não estão incluídos no plano Pro.
</Note>
...
<img
  src="/images/user-guide/billing/enterprise-key.png"
  alt="Chave Enterprise"
/>
