...
| **Organização (hospedado por conta própria)** | Tudo do Pro + as funcionalidades Premium (SSO, permissões em nível de linha e mais), suporte da equipe Twenty, não é necessário publicar seu código personalizado como código aberto antes de distribuir |
