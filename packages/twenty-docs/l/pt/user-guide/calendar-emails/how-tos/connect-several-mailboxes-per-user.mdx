...
<Note>
  Cada e-mail mostra de qual caixa de correio foi enviado/para qual foi
  recebido, para que você possa acompanhar qual conta foi usada em cada
  comunicação.
</Note>
...
<Warning>
  Somente caixas de correio reais podem ser conectadas. Aliases de e-mail que
  encaminham para outra caixa de correio não podem ser conectados separadamente
  — eles serão sincronizados pela caixa de correio principal.
</Warning>
