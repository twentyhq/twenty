...
3. Conecte uma conta adicional do Google ou da Microsoft, ou de qualquer outro provedor de e-mail que ofereça suporte aos protocolos IMAP/SMTP
...
<Note>Cada e-mail mostra de qual caixa de correio foi enviado ou em qual foi recebido, para que você possa acompanhar qual conta foi usada em cada comunicação.</Note>
