...
<Note>
  Isso lhe dá controle preciso sobre quais emails aparecem no seu CRM sem
  sincronizar tudo.
</Note>
...
<Note>
  Não fornecemos um endereço de email CC para sincronização seletiva. Use o
  recurso de seleção de pastas acima para obter o mesmo nível de controle.
</Note>
