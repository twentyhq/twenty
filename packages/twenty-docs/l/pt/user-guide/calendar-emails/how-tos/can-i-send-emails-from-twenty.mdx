...
<Warning>
  E-mails em massa não devem ser enviados diretamente da sua caixa de entrada
  para proteger a reputação do seu domínio. Utilize uma ferramenta dedicada para
