...
* **Emails Internos**: Por padrão, emails entre colegas (mesmo domínio) permanecem privados (configurado em Settings → General → Security)
...
Escolha se os emails internos são sincronizados no Twenty:

1. Vá para **Settings → General → Security**
2. Ative ou desative **Sync Internal Emails**
