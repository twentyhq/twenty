...
**Nota**: Para conectar suas contas de email e configurar as configurações de sincronização, visite [Configuração de Email & Calendário](/user-guide/settings/email-calendar-setup).
