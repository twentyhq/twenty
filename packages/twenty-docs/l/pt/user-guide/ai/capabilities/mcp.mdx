...
<Warning>
  O MCP está atualmente em **alfa** e está disponível apenas em alguns espaços
  de trabalho. O MCP pode ainda não estar ativado no seu espaço de trabalho.
</Warning>
...
<Note>
  O OAuth requer um cliente MCP que ofereça suporte à [especificação de
  Autorização
  MCP](https://modelcontextprotocol.io/specification/2025-03-26/basic/authorization).
  Claude Desktop, Claude Code, Cursor e ChatGPT oferecem suporte.
</Note>
...
<Warning>
  Sua chave de API concede acesso aos dados do espaço de trabalho. Mantenha-a
  fora do controle de versão e de dotfiles compartilhados.
</Warning>
...
- _"Mostre-me as 5 empresas criadas mais recentemente"_
- _"Crie uma nova pessoa chamada Jane Doe na Acme Corp"_
- _"Encontre todas as oportunidades em aberto com valor superior a $10k"_
