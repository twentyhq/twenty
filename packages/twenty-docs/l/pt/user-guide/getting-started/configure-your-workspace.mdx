...
Leia [este artigo](https://docs.twenty.com/user-guide/data-model/customize-your-data-model) para aprender como projetar seu modelo de dados.
...
Leia [este artigo](/user-guide/getting-started/import-export-data) para saber mais sobre importação de dados.
...
Comece a criar automações usando [fluxos de trabalho](https://docs.twenty.com/user-guide/workflows/getting-started-workflows).
