...
Apps are custom extensions built as code that can define data models and logic functions. Eles permitem que desenvolvedores criem personalizações reutilizáveis que podem ser implantadas em vários espaços de trabalho.
