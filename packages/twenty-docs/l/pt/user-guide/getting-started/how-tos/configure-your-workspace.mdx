...
<Note>
  **Ganho Rápido**: Comece conectando sua caixa de correio. Isso lhe dá um valor
  imediato e ajuda sua equipe a ver o Twenty em ação com dados reais. Você pode
  fazer isso em Configurações → Contas.
</Note>
