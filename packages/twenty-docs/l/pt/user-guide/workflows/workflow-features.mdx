...
Para exemplos práticos dessas funcionalidades em ação, veja nossos guias de [Automatizações Internas](/user-guide/workflows/internal-automations) e [Integração de Ferramentas Externas](/user-guide/workflows/external-tool-integration).
