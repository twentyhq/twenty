...
<Note>
  Os anexos são estáticos — o mesmo arquivo é enviado a todos os destinatários. For dynamic documents (like personalized quotes), generate and attach files using a [Logic Function](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty).
</Note>
