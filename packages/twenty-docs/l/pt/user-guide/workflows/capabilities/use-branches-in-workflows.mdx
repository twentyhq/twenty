...
<Note>
  Para criar uma nova ramificação a partir de uma etapa existente, clique no
  botão **+** na etapa e adicione sua ação. Você pode adicionar várias
  ramificações clicando em **+** várias vezes.
</Note>
