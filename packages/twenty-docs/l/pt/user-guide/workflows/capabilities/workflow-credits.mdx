...
| --------------------- | ------------------- |
| **Assinatura mensal** | 5 créditos por mês  |
| **Assinatura anual**  | 50 créditos por ano |

<Note>
5 créditos mensais são generosos para automações padrão. A maioria das equipes não excederá esse limite com o uso típico de fluxos de trabalho. Créditos adicionais são necessários principalmente para ações de Code avançadas e fluxos de trabalho com tecnologia de IA.
</Note>
