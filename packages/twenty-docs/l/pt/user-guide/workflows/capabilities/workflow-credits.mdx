...
<Note>
  5 créditos mensais são generosos para automações padrão. A maioria das equipes
  não excederá esse limite com o uso típico de fluxos de trabalho. Créditos
  adicionais são necessários principalmente para ações de Code avançadas e
  fluxos de trabalho com tecnologia de IA.
</Note>
