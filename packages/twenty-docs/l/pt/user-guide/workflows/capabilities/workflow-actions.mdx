...
<Note>
  Se você precisar usar chaves de API externas em seu código, deverá inseri-las diretamente no corpo da função. You cannot configure API keys elsewhere and reference them in the logic function.
</Note>
