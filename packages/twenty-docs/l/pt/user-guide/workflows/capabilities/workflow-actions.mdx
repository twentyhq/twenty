...
<Note>
Os agentes de IA respeitam permissões baseadas em funções. You can assign specific roles to agents under **Settings → Members → Roles** to control what data they can access. Veja [Permissões](/l/pt/user-guide/permissions-access/capabilities/permissions) para obter detalhes.
</Note>
