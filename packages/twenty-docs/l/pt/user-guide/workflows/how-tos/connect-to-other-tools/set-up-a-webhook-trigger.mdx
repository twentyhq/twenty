...
<Tip>
  Para mais detalhes sobre como lidar com arrays, consulte [Tratar arrays em
  ações de
  código](/l/pt/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
