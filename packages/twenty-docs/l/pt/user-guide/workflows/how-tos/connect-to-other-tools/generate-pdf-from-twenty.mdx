...
Este fluxo de trabalho utiliza um **Gatilho Manual** para que os utilizadores possam gerar um PDF a pedido para qualquer registo selecionado. A **Logic Function** handles:
...
1. **Crie uma Chave de API**: Vá a **Definições → APIs** e crie uma nova chave de API. You'll need this token for the logic function.
...
* [Logic Functions](/l/pt/user-guide/workflows/capabilities/workflow-actions#code)
