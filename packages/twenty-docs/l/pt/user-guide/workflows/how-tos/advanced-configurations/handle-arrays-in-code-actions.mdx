...
<Note>
  Estamos trabalhando ativamente para tornar o tratamento de arrays mais fácil
  em atualizações futuras.
</Note>

<Tip>
  Clique no ícone quadrado no canto superior direito do editor de código para
  exibi-lo em tela cheia — útil, já que a largura padrão do editor é limitada.
</Tip>
