...
Használj környezeti változókat vagy `.env` fájlokat a projekt konfigurálásához. További információ [itt](https://docs.twenty.com/developers/self-hosting/setup)
