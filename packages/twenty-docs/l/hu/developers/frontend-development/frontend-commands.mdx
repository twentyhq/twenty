...
Az elkerülendő [re-renders](/developers/frontend-development/best-practices-front#managing-re-renders) érdekében az összes útvonalkezelési logika egy `useEffect`-ben található, a `PageChangeEffect`-ben.

### Állapotkezelés

[Recoil](https://recoiljs.org/docs/introduction/core-concepts) kezeli az állapotkezelést.

További információkért lásd [best practices](/developers/frontend-development/best-practices-front#state-management) az állapotkezelésről.
