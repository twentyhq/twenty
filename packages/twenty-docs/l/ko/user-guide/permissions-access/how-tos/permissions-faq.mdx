...
**설정 → 구성원 → 역할**로 이동하여 **Default Role** 옵션을 찾은 뒤, 신규 구성원이 가입할 때 자동으로 부여될 역할을 선택하세요.
</Accordion>
...
행 수준 권한은 **Organization** 요금제에서 제공됩니다. 이를 통해 기준에 따라 특정 레코드에 대한 액세스를 제한할 수 있습니다(예: 자신의 영업 기회만 보기).
</Accordion>
