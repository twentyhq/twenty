...
이 워크플로우는 **수동 트리거**를 사용하므로 사용자가 선택한 레코드에 대해 필요할 때 PDF를 생성할 수 있습니다. A **Logic Function** handles:
...
1. **API 키 생성**: **Settings → APIs**로 이동하여 새 API 키를 만드세요. You'll need this token for the logic function.
...
* [Logic Functions](/l/ko/user-guide/workflows/capabilities/workflow-actions#code)
