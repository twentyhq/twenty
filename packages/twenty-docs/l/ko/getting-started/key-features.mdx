---
title: 핵심 기능
description: 커스텀 데이터 모델부터 AI 기반 자동화까지, Twenty가 제공하는 모든 기능 둘러보기.
icon: 별
---
...
<CardGroup cols={2}>
  ...
  <Card href="/l/ko/user-guide/workflows/overview" img="/images/user-guide/halftone/workflows.png">
    ...
    <br />레코드 변경, 일정, 수동 작업 또는 수신 `webhooks`를 트리거로 `workflows`를 실행하세요.
  </Card>
  ...
  <Card href="/l/ko/developers/self-host/self-host" img="/images/user-guide/halftone/dev-self-host.png">
    ...
    <br />데이터에 대한 완전한 제어와, 일정에 맞춘 업데이트를 제공받으세요.
  </Card>
</CardGroup>
