...
| 속성                                                                                                          | 값                                                                                  | 설명                                                                                                                                                           |
| ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `type`                                                                                                      | `ViewType.TABLE`(기본값), `ViewType.LIST`, `ViewType.KANBAN`, `ViewType.CALENDAR`     | 레코드가 어떻게 배치되는지에 대한 설정입니다. (`FIELDS_WIDGET`, `TABLE_WIDGET`, `KANBAN_WIDGET`, 및 `CALENDAR_WIDGET`도 존재하지만, 페이지 레이아웃 위젯에서 내부적으로 사용됩니다.)                         |
