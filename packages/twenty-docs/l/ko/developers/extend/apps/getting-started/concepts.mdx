...
| **공유 의존성**      | 앱의 프론트 컴포넌트에서 공유되며 package.json에 선언된 의존성 | [공유 의존성](/l/ko/developers/extend/apps/layout/front-components#sharing-dependencies-across-front-components) |
