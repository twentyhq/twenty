...
title: Glosář
icon: kniha
description: Klíčové pojmy používané v Twenty.
---
...
Zobrazení záznamů si můžete přizpůsobit pomocí zobrazení a pro každé zobrazení nastavit různé filtry, rozvržení a možnosti řazení.
