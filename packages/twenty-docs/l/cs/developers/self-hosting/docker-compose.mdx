...
Podívejte se na dokumentaci [Nastavení Proměnných Prostředí](https://docs.twenty.com/developers/self-hosting/setup) pro pokročilou konfiguraci. Všechny proměnné prostředí musí být deklarovány v souboru docker-compose.yml na úrovni serveru a/nebo pracovníka v závislosti na proměnné.
...
Pokud narazíte na jakýkoli problém, zkontrolujte sekci [Řešení potíží](https://docs.twenty.com/developers/self-hosting/troubleshooting) pro možná řešení.
