...
<CardGroup cols={2}>
  <Card
    title="Hlášení chyb a požadavky"
    icon="bug"
    href="/l/cs/developers/contribute/capabilities/bug-and-requests"
  >
  ...
  <Card
    ...
    icon="browser"
    href="/l/cs/developers/contribute/capabilities/frontend-development"
  >
