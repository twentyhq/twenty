...
Použijte proměnné prostředí nebo `.env` soubory, abyste nakonfigurovali váš projekt. Více informací [zde](https://docs.twenty.com/developers/self-hosting/setup)
