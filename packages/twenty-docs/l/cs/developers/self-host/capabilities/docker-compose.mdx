...
<Warning>
  Docker kontejnery jsou určeny pro produkční provoz nebo vlastní hostování. Pro
  přispívání se podívejte na [Lokální
  nastavení](/l/cs/developers/contribute/capabilities/local-setup).
</Warning>
