...
a `FRONTEND_URL` jsou již důvěryhodné.
...
<Warning>
Aktualizace na verzi s relacemi pomocí souborů cookie to vyžaduje. Front-end
nyní posílá přihlašovací údaje u každého požadavku a prohlížeče odmítají odpověď s přihlašovacími údaji z nedeklarovaného původu, takže se aplikace nenačte, dokud to nenastavíte.
</Warning>
