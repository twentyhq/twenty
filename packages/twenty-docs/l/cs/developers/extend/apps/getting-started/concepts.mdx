...
| **Sdílené závislosti**        | Závislosti sdílené front komponentami aplikace, deklarované v package.json | [Sdílené závislosti](/l/cs/developers/extend/apps/layout/front-components#sharing-dependencies-across-front-components) |
