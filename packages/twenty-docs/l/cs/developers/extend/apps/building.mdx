...
<Note>
  **Uspořádání souborů je na vás.** Detekce entit je založená na AST — SDK najde
  volání `export default defineEntity(...)` bez ohledu na to, kde se soubor
  nachází. Výše uvedená struktura složek je konvence, nikoli požadavek.
</Note>
...
<CardGroup cols={2}>
  <Card
    title="Datový model"
    icon="database"
    href="/l/cs/developers/extend/apps/data-model"
  >
  ...
  <Card
    ...
    icon="bolt"
    href="/l/cs/developers/extend/apps/logic-functions"
  >
  ...
  <Card
    ...
    href="/l/cs/developers/extend/apps/front-components"
  >
  ...
  <Card
    title="Rozvržení"
    icon="table-columns"
    href="/l/cs/developers/extend/apps/layout"
  >
  ...
  <Card
    ...
    icon="robot"
    href="/l/cs/developers/extend/apps/skills-and-agents"
  >
  ...
  <Card
    ...
    icon="terminal"
    href="/l/cs/developers/extend/apps/cli-and-testing"
  >
  ...
  <Card
    title="Publikování"
    icon="rocket"
    href="/l/cs/developers/extend/apps/publishing"
  >
