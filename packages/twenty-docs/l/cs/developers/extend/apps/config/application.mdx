...
| `logo`             | Cesta k logu vaší aplikace v balíčku v `public/` (např. `public/logo.png`)                                    |
| `galleryImages`    | Pole cest ke snímkům galerie v balíčku v `public/` (např. `public/screenshot-1.png`)                          |
