...
<AccordionGroup>
<Accordion title="Používáte šifrování při přenosu i v klidu, jaké jsou vaše postupy správy klíčů a jak je izolována data jednotlivých tenantů?">
...
<Accordion title="Jak dlouho jsou soft-smazané záznamy uchovávány v systému?">
