...
<Accordion title="Když vytvořím samostatné rozhraní front end a použiji Twenty jako nezměněný backend, musím tyto změny zveřejnit?">
Ne. Vaše rozhraní front end je vaše vlastní, samostatné dílo a komunikace s Twenty prostřednictvím jeho API na tom nic nemění. Protože samotné Twenty je beze změn, není co zveřejňovat.
</Accordion>
<Accordion title="Když změním kód, abych přidal funkce a dále je přeprodával, musím tyto změny zveřejnit?">
Ano, protože upravujete kód za účelem jeho šíření ostatním, máte povinnost tyto změny zveřejnit. Pokud nechcete své změny zveřejnit, můžete si pořídit licenci Organization.
</Accordion>
</AccordionGroup>
