...
**Poznámka**: Chcete-li připojit své emailové účty a konfigurovat nastavení synchronizace, navštivte [Nastavení Emailu a Kalendáře](/user-guide/settings/email-calendar-setup).
