---
title: Emaily a Kalendáře
info: "Prohlížejte a spravujte emailové konverzace v rámci svých CRM záznamů."
image: /images/user-guide/emails/emails_header.png
sectionInfo: Centralizace komunikace a týmové spolupráce
---
...
**Poznámka**: Chcete-li připojit své emailové účty a konfigurovat nastavení synchronizace, navštivte [Nastavení Emailu a Kalendáře](/l/cs/user-guide/settings/email-calendar-setup).
...
Vedle záložky Emailů najdete záložku `Kalendář`, která obsahuje historii naplánovaných schůzek se záznamem.
...
**Nastavení viditelnosti**: Údaje kalendáře sledují stejná nastavení viditelnosti jako emaily, zajišťují konzistentní kontrolu soukromí napříč oběma kanály komunikace.
