...
<Note>
  **Rychlý tip:** Exportujte několik řádků z objektu, který chcete importovat.
  Exportovaný soubor bude mít přesně takové názvy sloupců, jaké Twenty očekává,
  což při importu usnadní automatické mapování.
</Note>
...
<Note>
  **Pole musí existovat před importem.** Import vytváří záznamy, nikoli pole.
  Vytvořte vlastní pole v **Nastavení → Datový model** před importem.
</Note>
...
<Note>
  **Některá pole mají speciální syntaxi.** Před přípravou importu doporučujeme
  stáhnout ukázkový soubor, abyste viděli očekávanou syntaxi pro každý typ pole.
</Note>
...
<Note>
  Pokud zadáte `id`, musí být ve formátu UUID (např.
...
<Note>
  Nové možnosti výběru se importem automaticky nevytvoří. Před importem je
  musíte přidat v **Nastavení → Datový model**.
</Note>
...
<Note>
  Nové možnosti výběru nebudou importem vytvořeny automaticky. Před importem je
  musíte přidat v **Nastavení → Datový model**.
</Note>
