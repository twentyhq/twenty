...
<Check>
Relace fungují správně (lidé jsou propojeni se společnostmi)
</Check>
<Check>
Přiřazení uživatelů je správně namapováno (vlastník, přiřazený uživatel)
</Check>
<Check>
Vlastní pole vyplněna
</Check>
<Check>
Žádné neočekávané duplicity
</Check>
...
<Check>
Synchronizace e-mailu/kalendáře připojena
</Check>

### Připravenost týmu

<Check>
Tým proškolen v novém systému
</Check>
<Check>
