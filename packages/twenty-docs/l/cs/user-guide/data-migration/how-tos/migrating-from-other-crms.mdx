...
<Tip>
  ...
  * **Vše za vás hotové:** [najděte certifikovaného partnera Twenty](https://twenty.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm), který kompletně převede vaše data, pipeline a uživatele.
