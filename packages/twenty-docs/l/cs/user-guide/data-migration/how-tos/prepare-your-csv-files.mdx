...
<Check>
Žádné duplicitní e-maily (pro lidi) nebo domény (pro společnosti)
</Check>
<Check>
Data používají jednotný formát v celém souboru
</Check>
<Check>
Domény používají formát `https://domain.com`
</Check>
<Check>
Booleovská pole používají `TRUE` nebo `FALSE` (velká písmena)
</Check>
<Check>
Výběrová pole používají názvy API, nikoli zobrazované štítky
</Check>
<Check>
Všechna vlastní pole existují v Nastavení → Datový model
</Check>
<Check>
Nadřazené záznamy byly importovány před podřízenými
</Check>
<Check>
Relační sloupce odkazují na existující záznamy
</Check>
