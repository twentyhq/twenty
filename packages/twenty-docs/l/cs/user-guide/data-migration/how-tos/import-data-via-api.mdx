...
<Note>
  Pro datové sady o stovkách tisíc záznamů je API výrazně rychlejší a
  spolehlivější než více importů CSV.
</Note>
...
<Accordion title="Jak mám řešit duplicity?">
  Nejprve vyhledejte existující záznamy pomocí jedinečných identifikátorů
  (e-mail, doména). Pokud existuje, aktualizujte; pokud ne, vytvořte.
</Accordion>
