...
**Poznámka**: Role můžete přiřazovat pouze stávajícím členům pracovního prostoru. Chcete-li pozvat nové členy, použijte [Správa členů](/user-guide/settings/member-management).
