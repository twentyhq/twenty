...
<Warning>
  Smazáním pracovního prostoru trvale odstraníte všechna data a tuto akci nelze
  zvrátit. Všechna data pracovního prostoru budou navždy ztracena, všichni
  členové okamžitě ztratí přístup a tuto akci nelze zvrátit.
</Warning>
