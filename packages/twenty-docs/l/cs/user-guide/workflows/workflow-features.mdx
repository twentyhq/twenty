...
Pro praktické příklady těchto funkcí v akci, podívejte se na naše průvodce [Interní automatizace](/user-guide/workflows/internal-automations) a [Integrace externích nástrojů](/user-guide/workflows/external-tool-integration).
