...
Pokud spuštění selže, můžete:

* Opravit základní problém a počkat na další aktivaci spouštěče
* U manuálních pracovních postupů spustit znovu se stejnými nebo aktualizovanými daty
* Zkontrolovat logiku pracovního postupu, abyste předešli budoucím selháním
