...
<Note>
  5 měsíčních kreditů je štědrý limit pro standardní automatizace. Většina týmů
  tento limit při typickém používání pracovních postupů nepřekročí. Dodatečné
  kredity jsou potřeba především pro pokročilé akce Code a pracovní postupy s
  využitím AI.
</Note>
