...
<Note>
  Každá větev je nezávislá. Přidání větve neovlivní jiné existující cesty z
  tohoto uzlu.
</Note>
...
<Note>
  Ačkoli můžete k pozastavení běhu použít uzel
  [Delay](/l/cs/user-guide/workflows/capabilities/workflow-actions#delay),
  momentálně jej nelze nastavit tak, aby čekal "dokud neskončí jiná větev".
</Note>
