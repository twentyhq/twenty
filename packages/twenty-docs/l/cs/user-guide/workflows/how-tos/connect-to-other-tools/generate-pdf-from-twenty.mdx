...
Tento pracovní postup používá **Ruční spouštěč**, takže uživatelé mohou na požádání vygenerovat PDF pro libovolný vybraný záznam. A **Logic Function** handles:
...
1. **Vytvořte klíč API**: Přejděte do **Nastavení → API** a vytvořte nový klíč API. You'll need this token for the logic function.
...
* [Logic Functions](/l/cs/user-guide/workflows/capabilities/workflow-actions#code)
