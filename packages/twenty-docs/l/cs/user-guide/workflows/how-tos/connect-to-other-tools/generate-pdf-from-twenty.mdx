...
<Tip>
  S **Ručním spouštěčem** mohou uživatelé spustit tento pracovní postup pomocí
  tlačítka, které se zobrazí vpravo nahoře po výběru záznamu, aby vygenerovali a
  připojili PDF.
</Tip>
...
<Note>
  Pokud připojujete k jinému objektu (Osoba, Příležitost apod.), přejmenujte
  parametr podle toho (např. `personId`, `opportunityId`) a aktualizujte
  logickou funkci.
</Note>
