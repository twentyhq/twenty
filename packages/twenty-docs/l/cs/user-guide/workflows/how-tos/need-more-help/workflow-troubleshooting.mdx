...
<Tip>
  Pokud chcete, aby se pracovní postup spustil jen jednou na záznam, přidejte
  akci Filter, která zkontroluje pole jako `createdAt equals updatedAt` (první
  uložení), nebo použijte vlastní zaškrtávací pole ke sledování, zda už pracovní
  postup běžel.
</Tip>
