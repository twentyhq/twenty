...
<Note>
  **Omezení pro Úkoly a Poznámky**: Relace u Úkolů a Poznámek jsou napevno
  nastaveny jako mnoho k mnoha a zatím nejsou k dispozici ve spouštěčích ani
  akcích pracovních postupů. Pro přístup k těmto relacím použijte místo toho
  [API](/l/cs/developers/extend/api).
</Note>
...
<Note>
  Dávejte pozor u oboustranných synchronizací, abyste se vyhnuli nekonečným
  smyčkám. Před aktualizací použijte filtry ke kontrole, zda se hodnota skutečně
  změnila.
</Note>
