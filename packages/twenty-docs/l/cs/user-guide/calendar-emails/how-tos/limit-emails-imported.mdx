...
<Note>
  Toto vám dává přesnou kontrolu nad tím, které emaily se objeví ve vašem CRM
  bez synchronizace všeho.
</Note>
...
<Note>
  Neposkytujeme CC emailovou adresu pro selektivní synchronizaci. Použijte výše
  uvedenou funkci výběru složek, abyste dosáhli stejné úrovně kontroly.
</Note>
