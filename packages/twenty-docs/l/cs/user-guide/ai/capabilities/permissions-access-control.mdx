...
<Note>
  U agentů AI běžících v pracovních postupech přiřazení role zajistí, že agent
  nebude mít přístup k datům mimo zamýšlený rozsah ani je nebude moci upravovat
  — i když má pracovní postup širší oprávnění.
</Note>
