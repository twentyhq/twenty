...
1. **`learn_tools`** — získat vstupní schéma pro konkrétní nástroje
2. **`execute_tool`** — spustit nástroj

Není potřeba si pamatovat názvy nástrojů. Zeptejte se svého AI asistenta, co umí, a automaticky zavolá `learn_tools`.
