...
<Tip>
  Toto je příklad vytváření [Vzorcová
  pole](/l/cs/user-guide/workflows/how-tos/crm-automations/formula-fields)
  pomocí pracovních postupů — konkrétně výpočtů dat.
</Tip>
...
<Note>
  Pole "Dny v" pro Uzavřeno – vyhráno a Uzavřeno – prohráno nepotřebujete,
  protože to jsou konečné fáze.
</Note>
...
<Note>
  Chcete-li vytvořit novou větev, klikněte pravým tlačítkem na plátno pracovního
  postupu a klikněte na **Nová akce**. Poté propojte tuto akci s předchozím
  uzlem přetažením šipky z předchozího uzlu na tuto novou akci.
</Note>
