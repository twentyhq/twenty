...
Chcete-li odstranit fázi, najeďte na název fáze nebo na ikonu `⋮`, klikněte na `Upravit v nastavení` v nastavení pole výběru a poté klikněte na **Odstranit** vedle příslušné fáze.
