...
Kalendářové zobrazení, které zobrazuje záznamy s poli typu datum. Ideální pro:
...
1. Přejděte k libovolnému objektu (Lidé, Společnosti atd.)
2. V části **Možnosti** vyberte rozložení (Tabulka, Kanban nebo Kalendář) a podle potřeby přidejte filtry a řazení
