...
<CardGroup cols={2}>
  <Card
    title="Oprávnění"
    icon="lock"
    href="/l/cs/user-guide/permissions-access/capabilities/permissions"
  >
  ...
  <Card
    ...
    icon="klíč"
    href="/l/cs/user-guide/permissions-access/capabilities/sso-configuration"
  >
  ...
  <Card
    ...
    href="/l/cs/user-guide/permissions-access/how-tos/permissions-faq"
  >
