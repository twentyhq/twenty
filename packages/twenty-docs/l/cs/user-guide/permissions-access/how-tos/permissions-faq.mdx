...
Přejděte na **Nastavení → Členové → Role**, najděte možnost **Výchozí role** a vyberte, kterou roli mají noví členové po připojení automaticky získat.
</Accordion>
...
Oprávnění na úrovni řádků jsou k dispozici v tarifu **Organization**. To umožní omezit přístup ke konkrétním záznamům na základě kritérií (např. zobrazovat pouze vlastní příležitosti).
</Accordion>
