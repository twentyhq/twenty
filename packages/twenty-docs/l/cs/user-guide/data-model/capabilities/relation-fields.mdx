...
<Warning>
  **Omezení importu/exportu**: Relace směřující k více typům objektů zatím
  nejsou podporovány pro import/export CSV. Je to v našem plánu.
</Warning>
...
<Warning>
  **Experimentální funkce**: Vztahy přes spojovací objekt je před použitím nutné
  povolit v **Settings → Updates → Lab**.
</Warning>
