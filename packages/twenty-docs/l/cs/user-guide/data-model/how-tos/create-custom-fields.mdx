...
<Note>
  **Pro importy používejte názvy API.** V Nastavení povolte **Advanced mode**,
  abyste viděli názvy API. Viz [Mapování
  polí](/l/cs/user-guide/data-migration/capabilities/field-mapping).
</Note>
...
<Note>
  Pokud existují duplicity (včetně těch ve smazaných záznamech), zobrazí se
  chyba. Nejprve odstraňte duplicity.
</Note>
