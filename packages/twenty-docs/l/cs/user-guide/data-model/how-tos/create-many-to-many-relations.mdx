...
<Warning>
  **Lab Feature**: Vztahy přes spojovací objekt jsou momentálně v Lab. Povolte
  je v **Settings → Updates → Lab** předtím, než budete pokračovat podle tohoto
  návodu.
</Warning>

<Note>
  Tato funkce také vyžaduje, aby byl povolen **Advanced mode** (přepínač je
  vpravo dole v Settings).
</Note>
...
<img
  ...
  alt="Nový spojovací objekt"
/>

5. Klikněte na **Uložit**

<Tip>
  **Konvence pojmenování**: Použijte název, který popisuje vztah, například
  "Project Assignment" nebo "Team Membership". Tím bude datový model
  srozumitelnější.
</Tip>
