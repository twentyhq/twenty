...
- **Spojte objekty dohromady**: Relační pole propojují záznamy z různých objektů. Pro podrobné informace o vytváření a správě relací si přečtěte náš [článek o relačních polích](/user-guide/data-model/relation-fields).
