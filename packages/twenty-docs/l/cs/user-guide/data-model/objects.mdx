...
**Poznámka:** Pokud si nejste jisti, zda je potřeba nový objekt nebo pole, přečtěte si [tento článek](/user-guide/data-model/customize-your-data-model) pro další pomoc při návrhu vašeho datového modelu.
