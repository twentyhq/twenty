...
<Note>
  **Rychlý úspěch**: Začněte připojením své poštovní schránky. To vám dává
  okamžitou hodnotu a pomáhá vašemu týmu vidět Twenty v akci s reálnými daty.
  Můžete to udělat v Nastavení → Účty.
</Note>
