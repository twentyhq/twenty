...
Apps are custom extensions built as code that can define data models and logic functions. Umožňují vývojářům vytvářet znovupoužitelné přizpůsobení, které lze nasadit do více pracovních prostorů.
