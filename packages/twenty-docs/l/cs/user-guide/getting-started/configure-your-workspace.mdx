...
Každý podnik funguje odlišně. That's why Twenty lets you shape the CRM around your needs, not force your processes into ours.
**Začněte těmito třemi kroky, abyste to nastavili podle svého.**

**Rychlé vítězství**: Začněte připojením své e-mailové schránky a přizpůsobením svého datového modelu několika klíčovými poli. To vám dává okamžitou hodnotu a pomáhá vašemu týmu vidět Twenty v akci s reálnými daty. Můžete to udělat v Nastavení → Účty.
...
Přečtěte si [tento článek](https://docs.twenty.com/user-guide/data-model/customize-your-data-model), kde se dozvíte, jak navrhnout svůj datový model.
...
Přečtěte si [tento článek](/user-guide/getting-started/import-export-data), kde se dozvíte více o importu dat.
...
Začněte vytvářet automatizace pomocí [workflow](https://docs.twenty.com/user-guide/workflows/getting-started-workflows).
