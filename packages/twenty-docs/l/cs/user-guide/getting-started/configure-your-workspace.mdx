...
Přečtěte si [tento článek](https://docs.twenty.com/l/cs/user-guide/data-model/customize-your-data-model), kde se dozvíte, jak navrhnout svůj datový model.
...
Začněte vytvářet automatizace pomocí [workflow](https://docs.twenty.com/l/cs/user-guide/workflows/getting-started-workflows).
