...
| href | 字符串               | 链接的目标网址或路径                                                                                                                                                                                                                                                               |
| 子元素  | `React.ReactNode` | 在链接中显示的内容                                                                                                                                                                                                                                                                |
| 类型   | 字符串               | 社交連結的類型。 社交連結的類型。 選項包括：`url`、`LinkedIn`和`Twitter` 社交链接的类型。 选项包括：`url`、`LinkedIn` 和 `Twitter` 社交链接的类型。 选项包括：`url`、`LinkedIn` 和 `Twitter` 社交链接的类型。 选项包括：`url`、`LinkedIn` 和 `Twitter` 社交链接的类型。 选项包括：`url`、`LinkedIn` 和 `Twitter` 社交链接的类型。 选项包括：`url`、`LinkedIn` 和 `Twitter` |
| 點擊   | function          | 链接被点击时触发的回调函数                                                                                                                                                                                                                                                            |
