...
為了避免不必要的[重新渲染](/developers/frontend-development/best-practices-front#managing-re-renders)，所有路由邏輯位於 `PageChangeEffect` 的 `useEffect` 中。

### 狀態管理

[Recoil](https://recoiljs.org/docs/introduction/core-concepts) 負責狀態管理。

查看[最佳實踐](/developers/frontend-development/best-practices-front#state-management)，了解有關狀態管理的更多信息。
