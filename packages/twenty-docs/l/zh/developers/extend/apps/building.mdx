...
<Note>
  **文件组织由你决定。** 实体检测基于 AST——无论文件位于何处，SDK 都能找到
  `export default defineEntity(...)` 的调用。
  上述文件夹结构是一种约定，而非强制要求。
</Note>
...
<CardGroup cols={2}>
  <Card
    title="数据模型"
    icon="database"
    href="/l/zh/developers/extend/apps/data-model"
  >
    定义对象、字段、角色和关系。
  </Card>
  <Card
    title="逻辑函数"
    icon="bolt"
    href="/l/zh/developers/extend/apps/logic-functions"
  >
  ...
  <Card
    ...
    href="/l/zh/developers/extend/apps/front-components"
  >
  ...
  <Card
    title="布局"
    icon="table-columns"
    href="/l/zh/developers/extend/apps/layout"
  >
    视图、导航菜单项和记录页面布局。
  </Card>
  <Card
    title="技能与智能体"
    icon="robot"
    href="/l/zh/developers/extend/apps/skills-and-agents"
  >
    具有自定义提示词的 AI 技能与代理。
  </Card>
  <Card
    title="CLI 与测试"
    icon="terminal"
    href="/l/zh/developers/extend/apps/cli-and-testing"
  >
    CLI 命令、测试、资源、远程和 CI。
  </Card>
  <Card
    title="发布"
    icon="rocket"
    href="/l/zh/developers/extend/apps/publishing"
  >
    部署到服务器或发布到应用市场。
  </Card>
</CardGroup>
