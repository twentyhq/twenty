...
<CardGroup cols={2}>
  <Card
    title="视图"
    icon="list"
    href="/l/zh/developers/extend/apps/layout/views"
  >
  ...
  <Card
    title="导航菜单项"
    icon="bars"
    href="/l/zh/developers/extend/apps/layout/navigation-menu-items"
  >
  ...
  <Card
    title="页面布局"
    icon="table-columns"
    href="/l/zh/developers/extend/apps/layout/page-layouts"
  >
  ...
  <Card
    ...
    href="/l/zh/developers/extend/apps/layout/front-components"
  >
  ...
  <Card
    title="命令菜单项"
    icon="terminal"
    href="/l/zh/developers/extend/apps/layout/command-menu-items"
  >
