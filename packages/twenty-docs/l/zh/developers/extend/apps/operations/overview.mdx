...
<CardGroup cols={2}>
  <Card
    title="CLI"
    icon="terminal"
    href="/l/zh/developers/extend/apps/operations/cli"
  >
  ...
  <Card
    title="测试"
    icon="flask"
    href="/l/zh/developers/extend/apps/operations/testing"
  >
  ...
  <Card
    title="发布"
    icon="upload"
    href="/l/zh/developers/extend/apps/operations/publishing"
  >
