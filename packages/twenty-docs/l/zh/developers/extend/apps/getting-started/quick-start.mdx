...
<Note>
  如果未安装或未运行 Docker，脚手架工具会告诉你在所用操作系统上正确的启动命令。
  Docker 启动后，你可以通过 `yarn twenty docker:start`
  继续——无需重新生成脚手架。
</Note>
...
<CardGroup cols={2}>
  <Card
    ...
    href="/l/zh/developers/extend/apps/config/overview"
  >
    应用标识、默认角色、安装钩子、公共资源。
  </Card>
  <Card
    title="数据"
    icon="database"
    href="/l/zh/developers/extend/apps/data/overview"
  >
    对象、字段和双向关系。
  </Card>
  <Card
    title="逻辑"
    icon="bolt"
    href="/l/zh/developers/extend/apps/logic/overview"
  >
  ...
  <Card
    title="布局"
    icon="table-columns"
    href="/l/zh/developers/extend/apps/layout/overview"
  >
    视图、导航、页面布局、前端组件。
  </Card>
  <Card
    title="操作"
    icon="rocket"
    href="/l/zh/developers/extend/apps/operations/overview"
  >
