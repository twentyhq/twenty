...
<CardGroup cols={2}>
  <Card title="APIs" icon="code" href="/l/zh/developers/extend/capabilities/apis">
  ...
  <Card title="Apps" icon="puzzle-piece" href="/l/zh/developers/extend/capabilities/apps">
