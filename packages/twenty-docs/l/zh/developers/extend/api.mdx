...
在 **Settings → API & Webhooks → + Create key** 中创建 API 密钥。 请立即复制——仅显示一次。 Keys can be scoped to a specific role under **Settings → Members → Roles → Assignment tab** to limit what they can access.
