...
是的，您可以在自我主機時免費使用 Twenty。 除了我們核心團隊的支援外，您將可以使用所有包含在（雲端）Pro 訂閱中的內容。 支援可透過我們的 Discord 社群獲得。

如果您想要自我主機並存取（雲端）組織訂閱中的功能，包括我們核心團隊的支援，您可以選擇自我主機中提供的付費組織許可證。 </Accordion>
