...
工作流程是 Twenty 應用內建的功能，用於建立這些自動化。 They give you the building blocks to create exactly what your business needs, when it needs it.
...
如果數據是最新的，你的 CRM 才有用，但沒有人喜歡更新它。 使用工作流程來自動化低價值、可重複的任務，並讓你的團隊專注於重要的事情。
...
關於詳細的例子和步驟指導，請參見我們的[內部自動化](/user-guide/workflows/internal-automations)指南。
...
如需詳細的整合模式和實施指南，請參閱我們的[外部工具整合](/user-guide/workflows/external-tool-integration)指南。

### 如果我不想建立這些連接怎麼辦？

我們提供[專業服務](/user-guide/workflows/professional-services)以協助您創建所需的自動化。  
