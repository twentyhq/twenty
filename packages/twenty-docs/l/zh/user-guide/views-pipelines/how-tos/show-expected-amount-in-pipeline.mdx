...
* [Formula Fields](/l/zh/user-guide/workflows/how-tos/crm-automations/formula-fields) — create calculated fields using workflows
* [Kanban Views](/l/zh/user-guide/views-pipelines/capabilities/kanban-views) — column aggregations
