...
按照我們的[數據模型指南](/user-guide/data-model/customize-your-data-model)：
...
Use the CSV import via the Command Menu  `Cmd + K` (Mac) or `Ctrl + K` (Windows). 查看我們的[數據導入指南](/user-guide/getting-started/import-export-data)以獲取詳細說明。
...
- **使用您設定為唯一的其他欄位**，可以在數據模型部分完成。
  閱讀我們的[導入-導出數據指南](/user-guide/getting-started/import-export-data)，獲取有關在CSV導入中創建關係的詳細說明。
...
發現我們的[實施服務](/user-guide/getting-started/implementation-services)。
