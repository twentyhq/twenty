...
<CardGroup cols={2}>
  <Card title="Permissions" icon="lock" href="/l/zh/user-guide/permissions-access/capabilities/permissions">
    Create roles and configure object, field, and settings permissions.
  </Card>

  <Card title="SSO Configuration" icon="key" href="/l/zh/user-guide/permissions-access/capabilities/sso-configuration">
    Set up Single Sign-On with your identity provider.
  </Card>

  <Card title="FAQ" icon="circle-question" href="/l/zh/user-guide/permissions-access/how-tos/permissions-faq">
