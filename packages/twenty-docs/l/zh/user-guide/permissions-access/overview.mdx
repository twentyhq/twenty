...
<CardGroup cols={2}>
  <Card
    title="权限"
    icon="lock"
    href="/l/zh/user-guide/permissions-access/capabilities/permissions"
  >
    创建角色并配置对象、字段和设置权限。
  </Card>
  <Card
    title="SSO 配置"
    icon="键"
    href="/l/zh/user-guide/permissions-access/capabilities/sso-configuration"
  >
    使用您的身份提供商设置单点登录（SSO）。
  </Card>
  <Card
    ...
    href="/l/zh/user-guide/permissions-access/how-tos/permissions-faq"
  >
    关于角色、权限和 SSO 的常见问题。
  </Card>
</CardGroup>
