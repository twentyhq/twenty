...
Vir praktiese voorbeelde van hierdie kenmerke in aksie, sien ons [Interne Outomasies](/user-guide/workflows/internal-automations) en [Eksterne Gereedskap Integrasie](/user-guide/workflows/external-tool-integration) gidse.
