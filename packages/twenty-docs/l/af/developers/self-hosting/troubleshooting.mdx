...
In `packages/twenty-front/.env` ontmerk `VITE_DISABLE_TYPESCRIPT_CHECKER=true` om agtergrondkontrole uit te skakel, sodoende die hoeveelheid benodige RAM te verminder.
