...
Colaborați cu partenerii Twenty certificați pentru personalizări, integrări avansate și asistență dedicată pentru implementare.
...
<CardGroup cols={2}>
  ...
  <Card title="Fiți asociați de Twenty" icon="envelope" href="mailto:contact@twenty.com">
