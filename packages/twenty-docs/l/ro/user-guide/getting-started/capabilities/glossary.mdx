...
Aplicațiile sunt extensii personalizate sub formă de cod, care pot defini modele de date și funcții de logică. Acestea le permit dezvoltatorilor să creeze personalizări reutilizabile care pot fi implementate în mai multe spații de lucru.
