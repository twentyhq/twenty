...
Citește [acest articol](https://docs.twenty.com/user-guide/data-model/customize-your-data-model) pentru a afla cum să îți proiectezi modelul de date.
...
Citește [acest articol](/user-guide/getting-started/import-export-data) pentru a afla mai multe despre importul de date.
...
Începe să creezi automatizări folosind [fluxuri de lucru](https://docs.twenty.com/user-guide/workflows/getting-started-workflows).
