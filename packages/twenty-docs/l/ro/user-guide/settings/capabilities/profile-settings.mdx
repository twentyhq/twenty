...
<Warning>
  Ștergerea contului va îndepărta permanent accesul la toate spațiile de lucru.
  Această acțiune nu poate fi anulată, vei pierde accesul la toate spațiile de
  lucru unde ești membru și ar trebui să iei în considerare părăsirea spațiilor
  individuale dacă dorești doar să ieși din echipe specifice.
</Warning>
