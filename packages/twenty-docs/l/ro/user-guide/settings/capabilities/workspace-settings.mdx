...
<Warning>
  Ștergerea spațiului de lucru elimină definitiv toate datele și nu poate fi
  anulată. Toate datele spațiului de lucru vor fi pierdute definitiv, toți
  membrii își vor pierde accesul imediat, iar această acțiune nu poate fi
  inversată.
</Warning>
