...
Da! Go to **Settings → General → Workspace Domain** and click **Customize Domain**. Aveți două opțiuni:
...
Puteți configura domenii de acces aprobate astfel încât membrii echipei cu adrese de e-mail ale companiei să se poată alătura automat spațiului dvs. de lucru. Go to **Settings → Members → Access** and add your company domain (e.g., `yourcompany.com`).
</Accordion>
</AccordionGroup>
