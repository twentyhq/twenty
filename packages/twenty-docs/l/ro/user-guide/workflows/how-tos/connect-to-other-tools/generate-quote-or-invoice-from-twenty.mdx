...
<Tip>
  Declanșatorul se activează la orice actualizare a unei Oportunități. Filtrul
  asigură că fluxul de lucru continuă doar când etapa se schimbă la Closed Won.
</Tip>
