...
<Tip>
  Cu un Manual Trigger, utilizatorii pot rula acest flux de lucru folosind un
  buton care apare în dreapta sus după selectarea unei înregistrări, pentru a
  genera și atașa un PDF.
</Tip>
...
<Note>
  Dacă atașați la un alt obiect (Persoană, Oportunitate etc.), redenumiți
  parametrul în mod corespunzător (de ex., `personId`, `opportunityId`) și
  actualizați funcția logică.
</Note>
