...
<Tip>
  Dacă doriți ca fluxul de lucru să ruleze doar o singură dată per înregistrare,
  adăugați o acțiune Filter pentru a verifica un câmp precum `createdAt equals
  updatedAt` (prima salvare) sau folosiți un câmp checkbox personalizat pentru a
  urmări dacă fluxul de lucru a rulat deja.
</Tip>
