...
<Tip>
  Pentru un exemplu complet de urmărire a timpului în stadiile din pipeline,
  vezi [Urmărește cât timp rămân oportunitățile în fiecare
  stadiu](/l/ro/user-guide/views-pipelines/how-tos/track-time-in-stage).
</Tip>
...
<Note>
  Valorile negative indică sarcini întârziate. Poți folosi acest câmp pentru a
  filtra sau sorta sarcinile după urgență.
</Note>
