...
<Note>
  5 credite lunare sunt generoase pentru automatizările standard. Majoritatea
  echipelor nu vor depăși această limită cu utilizarea tipică a fluxurilor de
  lucru. Credite suplimentare sunt necesare în principal pentru acțiuni Code
  avansate și pentru fluxuri de lucru bazate pe AI.
</Note>
