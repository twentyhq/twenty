...
<Note>
  Pentru a crea o ramură nouă dintr-un pas existent, faceți clic pe butonul
  **+** al acelui pas și adăugați acțiunea. Puteți adăuga mai multe ramuri
  făcând clic pe **+** de mai multe ori.
</Note>
