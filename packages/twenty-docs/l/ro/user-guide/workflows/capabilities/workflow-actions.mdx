...
<Note>
Agenții AI respectă permisiunile bazate pe roluri. You can assign specific roles to agents under **Settings → Members → Roles** to control what data they can access. Consultați [Permisiuni](/l/ro/user-guide/permissions-access/capabilities/permissions) pentru detalii.
</Note>
