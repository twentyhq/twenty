...
<Note>
  Acest lucru vă oferă un control precis asupra e-mailurilor care apar în CRM-ul
  dvs., fără a sincroniza totul.
</Note>
...
<Note>
  Nu oferim o adresă de e-mail CC pentru sincronizare selectivă. Utilizați
  funcția de selecție a dosarelor de mai sus pentru a obține același nivel de
  control.
</Note>
