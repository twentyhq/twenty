...
<Note>
  Pentru seturi de date mai mari de 10.000 de înregistrări, împărțiți-le în mai
  multe fișiere sau folosiți [importul prin
...
<Note>
  **Sfat util:** Exportați în schimb câteva înregistrări existente. Acest lucru
  vă oferă exemple reale despre cum ar trebui să fie formatate datele, iar
  denumirile coloanelor se vor asocia automat în timpul importului.
</Note>
...
<Warning>
  **Înregistrările șterse temporar se iau în calcul pentru unicitate.**
  Înregistrările din Meniul Comenzi → Vezi înregistrările șterse vor provoca
  erori de duplicat. Ștergeți-le definitiv sau restaurați-le și actualizați-le.
</Warning>
...
<Note>
  Opțiunile noi de selectare nu sunt create automat. Adăugați-le în **Setări →
  Model de date** înainte de import.
</Note>
