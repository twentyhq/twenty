...
<Tip>
  ...
  * **Realizat pentru tine:** [găsește un partener Twenty certificat](https://twenty.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm) care să îți mute datele, fluxurile și utilizatorii cap-coadă.
