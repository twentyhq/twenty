...
<Note>
  Vizualizările, fluxurile de lucru și rolurile trebuie recreate manual după
  migrare. Planificați timp pentru această muncă de configurare.
</Note>
...
<Note>
  Faceți capturi de ecran ale modelului de date auto-găzduit pentru referință
  sau păstrați ambele instanțe deschise una lângă alta.
</Note>
...
<Note>
  Folosiți aceleași adrese de e-mail pe care utilizatorii le-au folosit pentru a
  accepta invitația la spațiul de lucru din cloud.
</Note>
...
<Accordion title="Cum rămâne cu atașamentele de fișiere și imaginile?">
  Atașamentele de fișiere nu sunt incluse în exporturile CSV. Va trebui să
  reîncărcați manual orice atașamente, să le migrați prin API sau să contactați
  echipa noastră pentru asistență la migrarea de volum mare.
</Accordion>

<Accordion title="Pot păstra ambele instanțe în funcțiune în timpul migrării?">
  Da, recomandăm să păstrați instanța auto-găzduită în funcțiune până când ați
  verificat că migrarea în cloud este completă. Aveți doar grijă să nu creați
  date noi în ambele locuri.
</Accordion>
