...
<Note>
  Pentru seturi de date de ordinul sutelor de mii, API-ul este semnificativ mai
  rapid și mai fiabil decât importurile CSV multiple.
</Note>
...
<Accordion title="Cum gestionez duplicatele?">
  Interogați mai întâi înregistrările existente folosind identificatori unici
  (email, domeniu). Actualizați dacă există, creați dacă nu.
</Accordion>
