...
<Warning>
  **Păstrați cheia API secretă.**
  ...
  Oricine are cheia dvs. API poate accesa și modifica datele din spațiul dvs. de lucru. Nu o includeți niciodată în repozitoare de cod și nu o distribuiți public.
</Warning>
...
1. Accesați **Setări → API și Webhooks**
