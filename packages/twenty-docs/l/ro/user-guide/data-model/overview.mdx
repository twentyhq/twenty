...
<Check>
  Este aceasta doar o proprietate a ceva ce aveți deja sau necesită propriile
  sale proprietăți?
</Check>
<Check>
  Va fi vreodată nevoie să urmăriți mai multe dintre acestea pentru fiecare
  înregistrare, fără a ști câte?
</Check>
<Check>
  Acest concept se conectează la mai multe obiecte diferite, nu doar la unul
  singur?
</Check>
