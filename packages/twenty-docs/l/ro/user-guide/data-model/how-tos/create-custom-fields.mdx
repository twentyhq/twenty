...
<Note>
  **Folosiți numele API pentru importuri.** Activați **modul Avansat** în Setări
  pentru a vedea numele API. Consultați [Maparea
  câmpurilor](/l/ro/user-guide/data-migration/capabilities/field-mapping).
</Note>
...
<Note>
  Dacă există duplicate (inclusiv în înregistrările șterse), veți primi o
  eroare. Eliminați mai întâi duplicatele.
</Note>
