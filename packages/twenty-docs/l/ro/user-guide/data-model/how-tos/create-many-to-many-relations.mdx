...
<Warning>
**Funcție beta**: Relațiile prin obiecte de legătură sunt în prezent în versiune beta. Activați-le în **Settings → Community → Features** înainte de a urma acest ghid.
</Warning>

<Note>
Această funcție necesită, de asemenea, ca **Advanced mode** să fie activat (comutator în stânga jos în Settings).
</Note>
...
1. **Activați Junction Relations în Beta Features**: Mergeți la **Settings → Community → Features** și activați **Junction Relations**
2. **Activați Advanced mode**: Porniți **Advanced mode** în partea stângă jos a barei laterale Settings
...
2. Faceți clic **+ Adăugați un obiect**
