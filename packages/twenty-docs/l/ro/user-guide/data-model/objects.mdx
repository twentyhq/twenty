...
**Notă:** Dacă nu ești sigur(ă) dacă este necesar un nou obiect sau câmp, verifică [acest articol](/user-guide/data-model/customize-your-data-model) pentru sfaturi despre proiectarea modelului tău de date.
