...
- **Conectați obiecte între ele**: Câmpurile de relație leagă înregistrări din diferite obiecte. Pentru informații detaliate despre crearea și gestionarea relațiilor, consultați articolul nostru [Câmpuri de relații](/user-guide/data-model/relation-fields).
