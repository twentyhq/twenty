...
<Note>
  Pentru agenții AI care rulează în cadrul fluxurilor de lucru, atribuirea unui
  Rol asigură că agentul nu poate accesa sau modifica date în afara scopului său
  — chiar dacă fluxul de lucru are permisiuni mai extinse.
</Note>
