...
<AccordionGroup>
  ...
  <Accordion title="Vor avea agenții IA acces la toate datele mele?">
    Agenții IA vor funcționa conform sistemului de permisiuni. You can assign specific roles to AI agents under **Settings → Members → Roles**, giving you full control over what data they can access and what actions they can perform.
  </Accordion>
