...
<AccordionGroup>
  ...
  <Accordion title="Ce capabilități IA sunt disponibile?">
    Două capabilități principale ale IA sunt:
  ...
  <Accordion title="Nu văd un rol pe care l-am atribuit agentului IA, unde este?">
    În mod implicit, lista de roluri este filtrată la roluri ce pot fi atribuite membrilor spațiului de lucru. Dacă un rol poate fi atribuit doar agenților IA, trebuie să modifici filtrul pentru a include rolurile de tip AI-agent.
  </Accordion>
