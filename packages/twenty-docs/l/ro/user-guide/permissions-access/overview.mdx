...
<CardGroup cols={2}>
  <Card
    title="Permisiuni"
    icon="lock"
    href="/l/ro/user-guide/permissions-access/capabilities/permissions"
  >
  ...
  <Card
    ...
    icon="cheie"
    href="/l/ro/user-guide/permissions-access/capabilities/sso-configuration"
  >
  ...
  <Card
    ...
    href="/l/ro/user-guide/permissions-access/how-tos/permissions-faq"
  >
