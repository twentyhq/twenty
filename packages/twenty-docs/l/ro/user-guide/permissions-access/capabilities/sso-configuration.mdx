...
<Tip>
  Ai nevoie de SSO configurat pentru organizația ta? [Găsește un partener Twenty certificat](https://twenty.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) specializat în SSO și configurarea identității. *(Preferi să implici Twenty direct? [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
