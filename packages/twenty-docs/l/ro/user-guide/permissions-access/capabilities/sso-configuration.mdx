...
<Tip>
  Aveți nevoie de configurarea SSO pentru organizația dvs.? [Găsiți un partener Twenty certificat](https://twenty.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) specializat în SSO și configurarea identității. *(Preferiți să implicați Twenty direct? [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
