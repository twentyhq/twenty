...
<Frame>
  <img
    src="/images/user-guide/dashboard/dashboard-widget-bar-chart.png"
    alt="Grafic cu bare"
  />
</Frame>
...
<Note>
  **Limite de afișare**: Graficele cu bare pot afișa maximum 100 de bare și 50
  de grupuri pentru fiecare bară când se utilizează Group By. Dacă vedeți
  avertismentul "Date neafișate: max X bare pe grafic", adăugați filtre pentru a
  restrânge datele sau schimbați gruparea (de ex., grupați pe săptămână în loc
  de zile).
</Note>
...
<Frame>
  <img
    src="/images/user-guide/dashboard/dashboard-widget-pie-chart.png"
    alt="Grafic circular"
  />
</Frame>
...
<Frame>
  <img
    src="/images/user-guide/dashboard/dashboard-widget-line-chart.png"
    alt="Grafic liniar"
  />
</Frame>
...
<Frame>
  <img
    src="/images/user-guide/dashboard/dashboard-widget-aggregate-chart.png"
    alt="Diagramă agregată"
  />
</Frame>
...
<Frame>
  <img
    src="/images/user-guide/dashboard/dashboard-widget-iframe.png"
    alt="iFrame"
  />
</Frame>
...
<Frame>
  <img
    src="/images/user-guide/dashboard/dashboard-widget-rich-text.png"
    alt="Text îmbogățit"
  />
</Frame>
...
<Note>
  **În curând**: Graficele tip indicator (gauge) și tabelele nu sunt încă
  disponibile, dar se află pe foaia noastră de parcurs.
</Note>
