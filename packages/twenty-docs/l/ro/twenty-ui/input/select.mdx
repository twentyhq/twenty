...
| onChange    | funcție | Funcția apelată când valorile selectate se schimbă                                                                                                                                                                                                 |
...
| valoare     | șir     | Reprezintă valoarea momentan selectată. Ar trebui să corespundă uneia dintre proprietățile `value` din tabloul `opțiuni`.                                                                                          |
