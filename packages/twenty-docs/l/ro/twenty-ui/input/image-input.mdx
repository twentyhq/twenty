...
<Tabs>
  ...
  <Tab title="Proprietăți">
    ...
    | onAbort     | funcție | Funcția apelată când utilizatorul face clic pe butonul de anulare în timpul încărcării unei imagini |
    | isUploading | boolean | Indică dacă o imagine este în curs de încărcare                                                     |
