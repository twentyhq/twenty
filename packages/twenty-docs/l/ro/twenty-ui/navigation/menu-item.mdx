  ...
  <Tab title="Utilizare">
    ...
    export const MyComponent = () => {
      const handleMenuItemClick = (event) => {
        console.log("S-a făcut clic pe elementul de meniu!", event);
      };

      const handleButtonClick = (event) => {
        console.log("S-a făcut clic pe butonul cu pictogramă!", event);
      };
      ...
      return (
        <MenuItem
          LeftIcon={IconBell}
          accent="default"
          text="Textul elementului de meniu"
  ...
  <Tab title="Utilizare">
    ...
    export const MyComponent = () => {
      const handleCommandClick = () => {
        console.log("S-a făcut clic pe comandă!");
      };
    ...
    export const MyComponent = () => {
      ...
      return (
        <MenuItemDraggable
          ...
          isTooltipOpen={false}
          onClick={handleMenuItemClick}
          text="Element de meniu glisabil"
...
<Tabs>
  ...
  <Tab title="Proprietăți">
    ...
    | onToggleChange | funcție       | Funcție de callback declanșată când se schimbă starea comutatorului               |
    | toggleSize     | string        | Dimensiunea comutatorului. Poate fi fie \                                         |
    | numeClasă      | string        | Nume opțional pentru stilizare suplimentară                                       |
  </Tab>
</Tabs>
