...
<CardGroup cols={2}>
  <Card title="API-uri" icon="code" href="/l/ro/developers/extend/api">
  ...
  <Card title="Aplicații" icon="puzzle-piece" href="/Ghid de pornire rapidă](/l/ro/developers/extend/apps/getting-started/quick-start">
