...
Creează o cheie API în **Settings → API & Webhooks → + Create key**. Copiază-o imediat — este afișată o singură dată. Keys can be scoped to a specific role under **Settings → Members → Roles → Assignment tab** to limit what they can access.
