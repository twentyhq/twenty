...
<Note>
  **Organizarea fișierelor ține de dvs.** Detectarea entităților este bazată pe
  AST — SDK-ul găsește apelurile `export default defineEntity(...)` indiferent
  unde se află fișierul. Structura de foldere de mai sus este o convenție, nu o
  cerință.
</Note>
...
<CardGroup cols={2}>
  <Card
    title="Model de date"
    icon="database"
    href="/l/ro/developers/extend/apps/data-model"
  >
  ...
  <Card
    ...
    icon="bolt"
    href="/l/ro/developers/extend/apps/logic-functions"
  >
  ...
  <Card
    ...
    href="/l/ro/developers/extend/apps/front-components"
  >
  ...
  <Card
    title="Aspect"
    icon="table-columns"
    href="/l/ro/developers/extend/apps/layout"
  >
    Vizualizări, elemente de navigare și layout-uri ale paginilor de
    înregistrare.
  </Card>
  <Card
    title="Abilități și agenți"
    icon="robot"
    href="/l/ro/developers/extend/apps/skills-and-agents"
  >
  ...
  <Card
    title="CLI & Testare"
    icon="terminal"
    href="/l/ro/developers/extend/apps/cli-and-testing"
  >
  ...
  <Card
    title="Publicare"
    icon="rocket"
    href="/l/ro/developers/extend/apps/publishing"
  >
