...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Ecranul de autentificare Twenty"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Ecranul de autorizare Twenty CLI"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Aplicația a fost creată cu succes"
  />
</div>
...
<Note>
  Dacă Docker nu este instalat sau nu rulează, generatorul de schelet vă va
  indica comanda corectă de pornire pentru sistemul dvs. de operare. După ce
  Docker rulează, puteți continua cu `yarn twenty docker:start` — nu este nevoie
  să recreați scheletul.
</Note>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Ieșirea terminalului în modul de dezvoltare"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Lista Your Apps care afișează My twenty app"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Detalii despre înregistrarea aplicației"
  />
</div>
...
<CardGroup cols={2}>
  <Card
    ...
    href="/l/ro/developers/extend/apps/config/overview"
  >
    Identitatea aplicației, rolul implicit, hook-urile de instalare, resursele
    publice.
  </Card>
  <Card
    title="Date"
    icon="database"
    href="/l/ro/developers/extend/apps/data/overview"
  >
  ...
  <Card
    title="Logică"
    icon="bolt"
    href="/l/ro/developers/extend/apps/logic/overview"
  >
  ...
  <Card
    title="Aspect"
    icon="table-columns"
    href="/l/ro/developers/extend/apps/layout/overview"
  >
  ...
  <Card
    title="Operațiuni"
    icon="rocket"
    href="/l/ro/developers/extend/apps/operations/overview"
  >
