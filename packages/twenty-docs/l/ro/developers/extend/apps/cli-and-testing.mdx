...
<Note>
  Acest lucru este diferit de `yarn twenty server logs`, care afișează jurnalele
  containerului Docker. `yarn twenty logs` afișează jurnalele de execuție ale
  funcțiilor aplicației de pe serverul Twenty.
</Note>
