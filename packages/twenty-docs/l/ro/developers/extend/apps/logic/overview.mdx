...
<CardGroup cols={2}>
  <Card
    ...
    icon="bolt"
    href="/l/ro/developers/extend/apps/logic/logic-functions"
  >
    Blocul de bază — tipuri de declanșatoare, payload-uri și clientul API cu
    tipuri.
  </Card>
  <Card
    title="Abilități și agenți"
    icon="robot"
    href="/l/ro/developers/extend/apps/logic/skills-and-agents"
  >
    Instrucțiuni reutilizabile pentru agenți IA și asistenți cu prompturi de
    sistem personalizate.
  </Card>
  <Card
    title="Conexiuni"
    icon="plug"
    href="/l/ro/developers/extend/apps/logic/connections"
  >
    Credențiale OAuth pe care aplicația ta le deține pentru servicii terțe —
    Linear, GitHub, Slack și altele.
  </Card>
</CardGroup>
...
<Note>
  **Hook-uri de instalare** — cod care rulează înainte sau după instalare —
  folosesc același runtime, dar au propriile lor funcții define și se află sub
  [Config → Install Hooks](/l/ro/developers/extend/apps/config/install-hooks).
</Note>
