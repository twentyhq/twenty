...
- **Variabile** _(opțional)_ — perechi cheie–valoare expuse codului dvs. ca variabile de mediu.
- **Hook-uri de pre-instalare / post-instalare** _(opțional)_ — vedeți [Funcții logice](/l/ro/developers/extend/apps/logic/logic-functions).
