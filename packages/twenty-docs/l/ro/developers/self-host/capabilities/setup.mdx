...
și `FRONTEND_URL` sunt deja de încredere.
...
<Warning>
Actualizarea la o versiune cu sesiuni bazate pe cookie face ca acest lucru să fie obligatoriu. Partea de front-end
acum trimite datele de autentificare la fiecare cerere, iar browserele resping un răspuns cu date de autentificare
