...
<Warning>
  Containerele Docker sunt destinate găzduirii în producție sau auto-găzduirii.
  Pentru a contribui, consultați [Configurarea
  locală](/l/ro/developers/contribute/capabilities/local-setup).
</Warning>
