...
## Actualizarea la v2.34+ — PostgreSQL 15 este versiunea minimă

Twenty v2.34 necesită PostgreSQL 15 sau o versiune mai nouă. Configurația oficială Docker Compose utilizează PostgreSQL 16. Dacă instanța dvs. se conectează la o bază de date administrată extern, actualizați-o înainte de a porni serverul v2.34.

## Actualizări între versiuni (v1.23+)

Începând cu **v1.23**, Twenty suportă actualizări între versiuni. Puteți trece direct de la orice versiune acceptată la cea mai recentă versiune, fără a parcurge fiecare versiune intermediară.

De exemplu, actualizarea de la v1.23 direct la v2.0 este pe deplin suportată.
...
Dacă instanța dvs. este mai veche decât v1.23, trebuie să actualizați incremental prin fiecare versiune majoră etichetată (de la v1.6 la v1.7, apoi de la v1.7 la v1.8 și așa mai departe) până ajungeți la v1.23. De acolo, puteți sări direct la cea mai recentă versiune.
