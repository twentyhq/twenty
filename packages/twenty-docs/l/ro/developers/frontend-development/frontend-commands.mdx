...
Pentru a evita [re-redări](/developers/frontend-development/best-practices-front#managing-re-renders) inutile, toată logica de rutare se află în `useEffect` în `PageChangeEffect`.

### Managementul stării

[Recoil](https://recoiljs.org/docs/introduction/core-concepts) se ocupă de managementul stării.

Consultați [cele mai bune practici](/developers/frontend-development/best-practices-front#state-management) pentru mai multe informații despre managementul stării.
