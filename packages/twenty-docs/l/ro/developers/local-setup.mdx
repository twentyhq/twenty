...
Utilizați variabile de mediu sau fișiere `.env` pentru a configura proiectul dvs. Mai multe informații [aici](https://docs.twenty.com/developers/self-hosting/setup)
