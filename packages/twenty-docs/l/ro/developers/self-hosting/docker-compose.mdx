...
Consultați documentația [Setup Environment Variables](https://docs.twenty.com/developers/self-hosting/setup) pentru configurare avansată. Toate variabilele de mediu trebuie declarate în fișierul docker-compose.yml la nivel de server și/sau de lucru, în funcție de variabilă.
...
Dacă întâmpinați vreo problemă, verificați [Depanare](https://docs.twenty.com/developers/self-hosting/troubleshooting) pentru soluții.
