...
info: Află cum poți colabora cu Figma de la Twenty.
---
...
În bara laterală din stânga, poți accesa diferitele pagini din Figma de la Twenty. Acestea sunt organizate astfel:
...
- **Pagina principală:** A doua pagină este pagina principală, care afișează interfața completă a proiectului. Poți apăsa **_Play_** pentru a utiliza prototipul complet al aplicației.
...
Comută la modul "Developer" în partea dreaptă a barei de instrumente pentru a vedea specificațiile de design, a copia CSS și a accesa resursele.
