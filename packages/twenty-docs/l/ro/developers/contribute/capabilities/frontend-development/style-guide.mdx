...
```tsx
/* ✅ - Bun, un tip separat (OwnProps) este definit explicit pentru
 *      proprietățile componentei
 *    - Această metodă nu include automat prop-ul children. Dacă
 *      vrei să-l incluzi, trebuie să-l specifici în OwnProps.
 */
...
```tsx
/* ✅ - Bun, listează explicit toate proprietățile
 *    - Îmbunătățește lizibilitatea și întreținerea
 */
...
Stilizează componentele cu [Linaria styled](https://linaria.dev/docs/basics#styled).
