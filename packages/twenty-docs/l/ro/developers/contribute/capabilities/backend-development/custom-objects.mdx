...
<div style={{ textAlign: 'center' }}>
  <img
    ...
    alt="Interoghează API-ul /metadata pentru a adăuga obiecte personalizate"
  />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img
    src="/images/docs/server/custom-object-schema.png"
    alt="Interoghează endpoint-ul /graphql pentru a prelua date"
  />
</div>
