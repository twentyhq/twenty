...
これらの自動化をステップバイステップで構築する方法については、[ワークフローセクション](/user-guide/workflows/getting-started-workflows)をご覧ください。 詳細例については、[内部自動化](/user-guide/workflows/internal-automations) および [外部ツール統合](/user-guide/workflows/external-tool-integration) ガイドをご覧ください。
