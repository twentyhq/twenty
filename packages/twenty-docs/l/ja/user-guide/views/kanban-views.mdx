...
カンバンボードを構成し、いくつかのフィールドを表示または隠すことができます。 フィールドを非表示にするには、右上の<b>オプション</b>をクリックし、<b>フィールド</b>をクリックしてオプションリストを表示します。 隠したいフィールドにカーソルを合わせ、`-` ボタンを表示させます。 それをクリックしてフィールドを隠します。
...
すべてのフィールドを隠し、一目で全ての機会の概要をつかむこともできます。 それには、右上の<b>オプション</b>をクリックし、カンバンビューのレイアウトを選択してから<b>コンパクトビュー</b>のトグルをオンにします。
