...
<Note>
  **Use API names for imports.** Enable **Advanced mode** in Settings to see API
  names. See [Field
  Mapping](/l/ja/user-guide/data-migration/capabilities/field-mapping).
</Note>
...
<Note>
  If duplicates exist (including in deleted records), you'll get an error. Clean
  up duplicates first.
</Note>
