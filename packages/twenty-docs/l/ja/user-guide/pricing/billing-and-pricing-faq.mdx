...
（クラウド）Organizationサブスクリプションの機能とサポートを含め、セルフホスティングで利用するには、有料のOrganizationライセンスを選択してください。 </Accordion>
...
ワークフローが実行されるときにリアルタイムでクレジットが差し引かれます。 消費や残りクレジットを追跡するために **設定 → 請求** で使用状況を監視できます。 </Accordion>
