...
環境変数や`.env`ファイルを使ってプロジェクトを設定します。 詳細は[こちら](https://docs.twenty.com/developers/self-hosting/setup)。 詳細は[こちら](https://docs.twenty.com/developers/self-hosting/setup)。
