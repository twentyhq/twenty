...
Consulta los documentos [Configurar Variables de Entorno](https://docs.twenty.com/developers/self-hosting/setup) para configuraciones avanzadas. Todas las variables de entorno deben ser declaradas en el archivo docker-compose.yml en el nivel del servidor y/o trabajador dependiendo de la variable.
...
Si encuentra algún problema, consulte [Solución de Problemas](https://docs.twenty.com/developers/self-hosting/troubleshooting) para soluciones.
