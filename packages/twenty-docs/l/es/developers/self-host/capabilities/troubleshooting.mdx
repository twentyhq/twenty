...
#### Error "File Not Found" al probar la función Logic en el flujo de trabajo

Ejecute el comando `yarn command:prod application:rebuild-default-deps` en su contenedor twenty-server para solucionar el problema de dependencias faltantes.
