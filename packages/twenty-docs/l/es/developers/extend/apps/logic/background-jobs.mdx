...
| ------------ | -------------- | ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `retryLimit` | `0`            | `0`–`10`                 | Intentos adicionales si la ejecución produce una excepción. Solo incrementa este valor para manejadores que se puedan ejecutar dos veces de forma segura. |
