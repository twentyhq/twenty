...
| ------------ | -------------- | ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| `retryLimit` | `0`            | `0`–`10`                 | Intentos adicionales si la ejecución produce una excepción. Solo aumenta este valor para manejadores que sea seguro ejecutar dos veces. |
