...
<Note>
**Error común:** crear un objeto sin un elemento de menú de navegación asociado hace que ese objeto sea inaccesible desde la barra lateral. A menos que sea un objeto técnico/interno, cada objeto personalizado debería tener una entrada en la barra lateral que apunte a él.
</Note>
