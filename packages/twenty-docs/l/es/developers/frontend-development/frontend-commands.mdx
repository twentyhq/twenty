...
Para evitar [re-renderizados](/developers/frontend-development/best-practices-front#managing-re-renders) innecesarios toda la lógica de enrutamiento está en un `useEffect` en `PageChangeEffect`.

### Gestión del Estado

[Recoil](https://recoiljs.org/docs/introduction/core-concepts) maneja la gestión del estado.

Ver [mejores prácticas](/developers/frontend-development/best-practices-front#state-management) para más información sobre la gestión del estado.
