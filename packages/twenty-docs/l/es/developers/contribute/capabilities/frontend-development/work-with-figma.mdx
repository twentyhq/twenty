...
<Warning>No podrás colaborar efectivamente sin una cuenta.</Warning>
...
- **Página principal:** La segunda página es la página principal, que muestra la interfaz de usuario completa del proyecto. Puedes presionar **_Play_** para usar el prototipo completo de la aplicación.
