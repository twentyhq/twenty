...
<Check>
No hay correos duplicados (para Personas)
</Check>
<Check>
No hay dominios duplicados (para Empresas)
</Check>
<Check>
Todas las fechas usan un formato consistente
</Check>
<Check>
Todos los dominios usan el formato `https://domain.com`
</Check>

### Formatos de campos

<Check>
Los campos booleanos usan `TRUE` o `FALSE` (mayúsculas)
</Check>
<Check>
Los campos de selección usan nombres de API, no etiquetas visibles
</Check>
<Check>
Los campos de teléfono tienen todas las columnas obligatorias
</Check>
<Check>
Los campos de moneda tienen tanto Amount como Currency Code
</Check>

### Relaciones

<Check>
Registros padre importados antes que los registros hijo
</Check>
<Check>
...
<Check>
Las opciones de selección existen antes de importar
</Check>
