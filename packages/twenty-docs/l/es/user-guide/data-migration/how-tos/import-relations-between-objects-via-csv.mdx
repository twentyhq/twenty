...
<Note>
  **Qué se puede importar:** Solo relaciones de uno a muchos que apunten a un
  único tipo de objeto. Las relaciones que apuntan a varios tipos de objeto
  (como Notas vinculadas a Personas Y Empresas) aún no son compatibles con la
  importación.
</Note>
...
<Note>
  **Recomendado:** Use `domain` para Empresas y `email` para Personas. Son
  legibles para humanos y fáciles de verificar en su hoja de cálculo.
</Note>
...
<Accordion title="¿Puedo actualizar relaciones en registros existentes?">
  ¡Sí! Incluya el identificador único del registro hijo (p. ej., `email` para
  Personas) y el nuevo valor de la relación. La importación actualizará la
  relación.
</Accordion>

<Accordion title="¿Puedo importar relaciones de muchos a muchos?">
  Las relaciones de muchos a muchos aún no son compatibles con la importación.
...
<Accordion title="¿Puedo vincular a varios tipos de objeto (como Notas a Personas Y Empresas)?">
  ...
  la importación/exportación. Esto está en nuestra hoja de ruta.
</Accordion>
