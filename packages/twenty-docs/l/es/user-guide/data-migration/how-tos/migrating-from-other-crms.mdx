...
* Configura los roles en **Configuración → Miembros → Roles**
...
<Tip>
  ...
  * **Hecho por ti:** [encuentra un partner certificado de Twenty](https://twenty.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm) para mover tus datos, pipelines y usuarios de extremo a extremo.
