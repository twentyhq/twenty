...
<Note>
  You can only assign roles to existing workspace members. To invite new members, use [Member Management](/l/es/user-guide/settings/capabilities/member-management).
</Note>
