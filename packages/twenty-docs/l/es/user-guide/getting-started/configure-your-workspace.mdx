...
Cada empresa funciona de manera diferente. Por eso, Twenty te permite adaptar el CRM a tus necesidades, en lugar de forzar tus procesos en los nuestros.
...
Lee [este artículo](https://docs.twenty.com/user-guide/data-model/customize-your-data-model) para aprender cómo diseñar tu modelo de datos.
...
Lee [este artículo](/user-guide/getting-started/import-export-data) para aprender más sobre la importación de datos.
...
Comienza a crear automatizaciones utilizando [flujos de trabajo](https://docs.twenty.com/user-guide/workflows/getting-started-workflows).
