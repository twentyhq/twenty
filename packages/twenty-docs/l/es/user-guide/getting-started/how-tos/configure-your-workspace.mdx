...
Read [this article](/l/es/user-guide/data-model/overview) to learn how to design your data model.
...
Read [this article](/l/es/user-guide/data-migration/overview) to learn more about data import.
...
Start creating automations using [workflows](/l/es/user-guide/workflows/overview).
