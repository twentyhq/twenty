...
Apps are custom extensions built as code that can define data models and logic functions. Permiten que los desarrolladores creen personalizaciones reutilizables que pueden desplegarse en varios espacios de trabajo.
