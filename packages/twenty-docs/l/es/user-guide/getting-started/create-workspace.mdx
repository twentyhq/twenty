...
info: "Siga una guía paso a paso sobre cómo registrarse en Twenty, elegir un plan de suscripción, confirmar su pago y configurar su cuenta, con consejos adicionales sobre la búsqueda de asistencia si es necesario."
