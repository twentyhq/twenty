...
<Tip>
  This is an example of creating [Formula Fields](/l/es/user-guide/workflows/how-tos/crm-automations/formula-fields) using workflows — specifically date calculations.
</Tip>
...
* [Workflows](/l/es/user-guide/workflows/overview) — automation basics
* [How to Create Custom Fields](/l/es/user-guide/data-model/how-tos/create-custom-fields) — field configuration
* [Kanban Views](/l/es/user-guide/views-pipelines/capabilities/kanban-views) — aggregations
