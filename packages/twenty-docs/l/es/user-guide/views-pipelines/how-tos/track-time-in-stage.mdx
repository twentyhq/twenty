...
<Tip>
  Este es un ejemplo de cómo crear [Campos de
  fórmula](/l/es/user-guide/workflows/how-tos/crm-automations/formula-fields)
  usando flujos de trabajo — específicamente cálculos de fechas.
</Tip>
...
<Note>
  No necesitas campos "Días en" para Cerrado ganado y Cerrado perdido, ya que
  son etapas finales.
</Note>
...
<Note>
  Para crear una nueva rama, haz clic derecho en el lienzo del flujo de trabajo
  y haz clic en **Nueva acción**. Luego, vincula esta acción al nodo anterior
  arrastrando la flecha desde el nodo anterior hasta esta nueva acción.
</Note>
