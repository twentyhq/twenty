...
<Tip>
  This is an example of creating [Formula Fields](/l/es/user-guide/workflows/how-tos/crm-automations/formula-fields) using workflows.
</Tip>
...
* [Formula Fields](/l/es/user-guide/workflows/how-tos/crm-automations/formula-fields) — create calculated fields using workflows
* [Kanban Views](/l/es/user-guide/views-pipelines/capabilities/kanban-views) — column aggregations
