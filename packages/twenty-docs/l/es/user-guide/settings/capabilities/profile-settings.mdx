...
<Warning>
  Eliminar tu cuenta eliminará permanentemente tu acceso a todos los espacios de
  trabajo. Esta acción no se puede deshacer; perderás el acceso a todos los
  espacios de trabajo de los que eres miembro, y deberías considerar salir de
  espacios de trabajo individuales si solo quieres salir de equipos específicos.
</Warning>
