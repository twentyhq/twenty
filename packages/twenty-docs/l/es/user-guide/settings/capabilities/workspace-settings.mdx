...
<Warning>
  Eliminar tu espacio de trabajo elimina permanentemente todos los datos y no se
  puede deshacer. Todos los datos del espacio de trabajo se perderán para
  siempre, todos los miembros perderán el acceso inmediatamente, y esta acción
