...
<Warning>
  Los miembros eliminados pierden el acceso de inmediato. Sus datos (registros,
  notas, tareas) permanecen en el espacio de trabajo.
</Warning>

<Warning>
  **También se elimina la sincronización de correo electrónico.** Si el usuario
  eliminado era el único que sincronizaba ciertos correos electrónicos, esos
  correos se eliminarán permanentemente del espacio de trabajo.
</Warning>
