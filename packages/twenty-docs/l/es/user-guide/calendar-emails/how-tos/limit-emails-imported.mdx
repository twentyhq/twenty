...
<Note>
  Esto te da un control preciso sobre qué correos aparecen en tu CRM sin
  sincronizar todo.
</Note>
...
<Note>
  No proporcionamos una dirección de correo electrónico en CC para la
  sincronización selectiva. Usa la función de selección de carpetas anterior
  para lograr el mismo nivel de control.
</Note>
