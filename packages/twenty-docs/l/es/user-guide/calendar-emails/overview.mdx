...
<Warning>
  Solo se pueden conectar verdaderos buzones (por ejemplo, soporte@dominio.com
  con su propia bandeja de entrada). Los alias de correo electrónico que
  reenvían a otro buzón no se pueden conectar a Twenty.
</Warning>
...
<Note>
  Cuando está habilitado, los contactos se vinculan automáticamente a sus
  registros de Empresa en función de su dominio de correo electrónico. Si la
  Empresa aún no existe, Twenty la crea para ti.
</Note>
...
<Note>
  **Tiempo de la sincronización inicial**: La sincronización del calendario se
  completa rápidamente (normalmente en unos minutos), mientras que la
  sincronización del correo electrónico tarda más en el caso de buzones grandes.
  Twenty importa correos electrónicos a aproximadamente **400 mensajes por
  minuto** (limitado por el límite de tasa de la API de Gmail), por lo que un
  buzón con 10 000 correos electrónicos tarda unos 25 minutos. No te preocupes
  si ves que los contactos de eventos del calendario aparecen antes que tus
  contactos de correo electrónico; es un comportamiento normal.
</Note>
