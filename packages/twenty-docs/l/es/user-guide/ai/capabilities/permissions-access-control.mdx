...
<Note>
  Para los agentes de IA que se ejecutan dentro de flujos de trabajo, la
  asignación de roles garantiza que el agente no pueda acceder ni modificar
  datos fuera de su ámbito previsto—incluso si el flujo de trabajo tiene
