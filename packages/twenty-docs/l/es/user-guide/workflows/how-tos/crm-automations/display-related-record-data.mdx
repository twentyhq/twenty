...
<Note>
  **Limitación de Tareas y Notas**: Las relaciones en Tareas y Notas están
  codificadas como de muchos a muchos y aún no están disponibles en los
  desencadenantes o acciones de flujos de trabajo. Para acceder a estas
  relaciones, usa la [API](/l/es/developers/api).
</Note>
...
<Note>
  Ten cuidado con las sincronizaciones bidireccionales para evitar bucles
  infinitos. Usa filtros para comprobar si el valor realmente cambió antes de
  actualizar.
</Note>
