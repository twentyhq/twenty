...
<Tip>
  Para ver un ejemplo completo de seguimiento del tiempo en etapas del pipeline,
  consulta [Cuánto tiempo permanecen las oportunidades en cada
  etapa](/l/es/user-guide/views-pipelines/how-tos/track-time-in-stage).
</Tip>
...
<Note>
  Los valores negativos indican tareas vencidas. Puedes usar este campo para
  filtrar o ordenar tareas por urgencia.
</Note>
