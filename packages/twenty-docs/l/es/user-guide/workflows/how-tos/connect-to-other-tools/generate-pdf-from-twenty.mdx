...
Este flujo de trabajo utiliza un **Activador manual** para que los usuarios puedan generar un PDF bajo demanda para cualquier registro seleccionado. A **Logic Function** handles:
...
1. **Cree una clave de API**: Vaya a **Settings → APIs** y cree una nueva clave de API. You'll need this token for the logic function.
...
* [Logic Functions](/l/es/user-guide/workflows/capabilities/workflow-actions#code)
