...
<Tip>
  El disparador se activa con cualquier actualización de una Oportunidad. El
  filtro garantiza que el flujo de trabajo solo continúe cuando la etapa cambie
  a Cerrado ganado.
</Tip>
