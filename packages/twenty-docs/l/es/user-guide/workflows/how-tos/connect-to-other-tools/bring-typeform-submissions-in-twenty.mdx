...
<Tip>
  Para más detalles sobre cómo manejar arreglos en acciones de código, consulta
  [Cómo manejar arreglos en acciones de
  código](/l/es/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
