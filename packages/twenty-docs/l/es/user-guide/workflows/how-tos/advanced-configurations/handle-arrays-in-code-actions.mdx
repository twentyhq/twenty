...
<Note>
  Estamos trabajando activamente para facilitar el manejo de arrays en futuras
  actualizaciones.
</Note>

<Tip>
  Haz clic en el icono cuadrado en la parte superior derecha del editor de
  código para mostrarlo en pantalla completa — es útil, ya que el ancho
  predeterminado del editor es limitado.
</Tip>
