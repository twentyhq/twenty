...
<Tip>
  Si solo quieres que el flujo de trabajo se ejecute una vez por registro,
  agrega una acción de filtro para comprobar un campo como `createdAt equals
  updatedAt` (primer guardado) o usa un campo de casilla de verificación
  personalizada para registrar si el flujo de trabajo ya se ejecutó.
</Tip>
