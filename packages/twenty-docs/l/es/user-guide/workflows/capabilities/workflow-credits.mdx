...
<Note>
  5 millones de créditos mensuales son generosos para las automatizaciones
  estándar. La mayoría de los equipos no superarán este límite con un uso típico
  de flujos de trabajo. Los créditos adicionales se necesitan principalmente
  para acciones avanzadas de Code y flujos de trabajo impulsados por IA.
</Note>
