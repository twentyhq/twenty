...
<Note>
  Cada rama es independiente. Añadir una rama no afecta a otras rutas existentes
  desde ese nodo.
</Note>
...
<Note>
  Aunque puedes usar un nodo
  [Delay](/l/es/user-guide/workflows/capabilities/workflow-actions#delay) para
  pausar la ejecución, actualmente no se puede configurar para esperar "hasta
  que otra rama termine".
</Note>
