...
<img
  src="/images/user-guide/workflows/branches-with-filters.png"
  style={{ width: '100%' }}
/>
...
<Note>
  Para crear una nueva rama a partir de un paso existente, haz clic en el botón
  **+** del paso y agrega tu acción. Puedes añadir varias ramas haciendo clic en
  **+** varias veces.
</Note>
