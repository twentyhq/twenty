...
<Note>
  Si necesita usar claves de API externas en su código, debe introducirlas directamente en el cuerpo de la función. You cannot configure API keys elsewhere and reference them in the logic function.
</Note>
