...
Para ejemplos detallados y orientación paso a paso, consulta nuestra guía de [Automatizaciones Internas](/user-guide/workflows/internal-automations).
...
Para patrones de integración detallados y orientación de implementación, consulte nuestra guía de [Integración de Herramientas Externas](/user-guide/workflows/external-tool-integration).

### ¿Qué pasa si no quiero construir esas conexiones?

Ofrecemos [Servicios Profesionales](/user-guide/workflows/professional-services) para ayudarle a crear las automatizaciones que necesite.  
