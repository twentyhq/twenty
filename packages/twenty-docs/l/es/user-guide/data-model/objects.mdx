...
**Nota:** Si no estás seguro de si se necesita un nuevo objeto o campo, consulta [este artículo](/user-guide/data-model/customize-your-data-model) para obtener orientación sobre el diseño de tu modelo de datos.
