...
3. Proceda haciendo clic en `+ Nuevo Campo`.
...
Los índices de base de datos se gestionan automáticamente; crear índices propios rara vez es necesario y es fácil equivocarse. Con el modo avanzado activado, cada objeto tiene una sección de **Índices** en `Settings → Data Model → <object>` para los casos en los que sabes que necesitas uno.
