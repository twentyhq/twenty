...
<Warning>
  **Limitación de importación/exportación**: Las relaciones que apuntan a varios
  tipos de objeto aún no son compatibles con la importación/exportación de CSV.
...
<Warning>
  **Función de laboratorio**: Las relaciones de unión deben habilitarse en
  **Settings → Updates → Lab** antes de usarlas.
</Warning>
