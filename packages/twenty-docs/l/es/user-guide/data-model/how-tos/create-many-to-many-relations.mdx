...
<Warning>
  **Función de laboratorio**: Las relaciones de unión están actualmente en el
  Lab. Actívalas en **Settings → Updates → Lab** antes de seguir esta guía.
</Warning>

<Note>
  Esta función también requiere que **Advanced mode** esté activado (interruptor
  en la esquina inferior derecha de Settings).
</Note>
...
<Tip>
  **Convención de nombres**: Usa un nombre que describa la relación, como
  "Project Assignment" o "Team Membership". Esto hace que el modelo de datos sea
