...
- **Conectar objetos entre sí**: Los campos de relación vinculan registros de diferentes objetos. Para información detallada sobre cómo crear y gestionar relaciones, consulte nuestro artículo [Campos de Relación](/user-guide/data-model/relation-fields).
