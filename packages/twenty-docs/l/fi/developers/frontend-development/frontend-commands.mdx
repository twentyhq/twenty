...
Välttyäksesi tarpeettomilta [uudelleenpiirroilta](/developers/frontend-development/best-practices-front#managing-re-renders), kaikki reitityksen logiikka on `useEffect`-piirissä `PageChangeEffect`-komponentissa.

### Tilanhallinta

[Recoil](https://recoiljs.org/docs/introduction/core-concepts) vastaa tilanhallinnasta.

Katso [best practices](/developers/frontend-development/best-practices-front#state-management) saadaksesi lisätietoa tilanhallinnasta.
