...
See docs [Setup Environment Variables](https://docs.twenty.com/developers/self-hosting/setup) for advanced configuration. Kaikki ympäristömuuttujat on määritettävä docker-compose.yml-tiedostossa palvelin- ja/tai työntekijätasolla muuttujasta riippuen.
...
Jos kohtaat ongelmia, tarkista [Vianmääritys](https://docs.twenty.com/developers/self-hosting/troubleshooting) ratkaisujen saamiseksi.
