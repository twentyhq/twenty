...
Bruk miljøvariabler eller `.env` filer for å konfigurere prosjektet ditt. Mer info [her](https://docs.twenty.com/developers/self-hosting/setup)
...
Hvis du støter på problemer, sjekk [Feilsøking](https://docs.twenty.com/developers/self-hosting/troubleshooting) for løsninger.