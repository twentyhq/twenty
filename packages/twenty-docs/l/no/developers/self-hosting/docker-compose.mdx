...
Se dokumentasjon [Sett Opp Miljøvariabler](https://docs.twenty.com/developers/self-hosting/setup) for avansert konfigurasjon. Alle miljøvariabler må deklareres i docker-compose.yml-filen på server- og/eller arbeidernivå, avhengig av variabelen.
