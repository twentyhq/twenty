...
For å lære mer om å sette opp disse automatiserte dataflytene, se vår [Workflows](/user-guide/workflows/getting-started-workflows) seksjon.
...
Hvis bedriften din trenger andre felt som skal være unike (som telefonnumre eller referansekoder), kan du konfigurere dette i datamodellen din. Gå til vår [Data Model](/user-guide/data-model/customize-your-data-model) seksjon for å lære hvordan du setter opp ytterligere unikhetsbegrensninger til dine spesifikke behov.
