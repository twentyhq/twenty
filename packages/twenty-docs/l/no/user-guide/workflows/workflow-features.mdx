...
For praktiske eksempler på disse funksjonene i aksjon, se våre [Interne Automatiseringer](/user-guide/workflows/internal-automations) og [Ekstern Verktøy Integrasjon](/user-guide/workflows/external-tool-integration) veiledninger.
