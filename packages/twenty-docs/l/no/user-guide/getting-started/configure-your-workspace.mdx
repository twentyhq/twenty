...
Les [denne artikkelen](https://docs.twenty.com/user-guide/data-model/customize-your-data-model) for å lære hvordan du designer din datamodell.
...
Les [denne artikkelen](/user-guide/getting-started/import-export-data) for å lære mer om dataimport.
...
Start å lage automasjoner ved å bruke [arbeidsflyter](https://docs.twenty.com/user-guide/workflows/getting-started-workflows).
