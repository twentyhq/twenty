...
קשרי Morph Many (מגיעים ב**Q4 2025**) מאפשרים לאובייקט אחד להיות קשור לסוגי אובייקטים שונים. לדוגמה, הזדמנות יכולה להיות קשורה לאדם או לחברה.
</Accordion>
...
בדוק את [שירותי ההטמעה](/user-guide/getting-started/implementation-services) שלנו לקבלת עזרה עם עיצוב מודל נתונים מורכב.
