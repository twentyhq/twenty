...
Use environment variables or `.env` files to configure your project. Більше інформації [тут](https://docs.twenty.com/developers/self-hosting/setup)
...
Якщо виникнуть проблеми, перегляньте [Усунення несправностей](https://docs.twenty.com/developers/self-hosting/troubleshooting) для отримання вирішення.