...
Щоб дізнатися більше про налаштування цих автоматизованих потоків даних, ознайомтеся з розділом [Робочі процеси](/user-guide/workflows/getting-started-workflows).
