...
<CardGroup cols={2}>
  <Card
    title="Разрешения"
    icon="lock"
    href="/l/ru/user-guide/permissions-access/capabilities/permissions"
  >
  ...
  <Card
    ...
    icon="ключ"
    href="/l/ru/user-guide/permissions-access/capabilities/sso-configuration"
  >
  ...
  <Card
    ...
    href="/l/ru/user-guide/permissions-access/how-tos/permissions-faq"
  >
