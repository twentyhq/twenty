...
| **Name**           | Reviewer                          |
| **Тип**            | Связь                             |
| **Related Object** | Участник рабочего пространства    |
...
| **Тема**  | A note needs your review                            |
| **Текст** | See example below                                   |
...
* [Create Custom Fields](/l/ru/user-guide/data-model/how-tos/create-custom-fields)
* [Create Relation Fields](/l/ru/user-guide/data-model/how-tos/create-relation-fields)
