...
<Tip>
  Для получения подробностей об обработке массивов в действиях Code см.
  [Обработка массивов в действиях
  Code](/l/ru/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
