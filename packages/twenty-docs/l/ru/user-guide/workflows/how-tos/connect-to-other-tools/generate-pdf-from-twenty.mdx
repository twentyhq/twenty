...
В этом рабочем процессе используется **Ручной триггер**, чтобы пользователи могли по запросу создавать PDF для любой выбранной записи. A **Logic Function** handles:
...
1. **Создайте ключ API**: перейдите в **Настройки → APIs** и создайте новый ключ API. You'll need this token for the logic function.
...
* [Logic Functions](/l/ru/user-guide/workflows/capabilities/workflow-actions#code)
