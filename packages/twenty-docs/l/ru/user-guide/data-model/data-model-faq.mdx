...
Отношения Morph Many (появятся в **Q4 2025**) позволяют одному объекту связаться с несколькими разными типами объектов. Например, Возможность может быть связана с Персоной или Компанией.
</Accordion>
