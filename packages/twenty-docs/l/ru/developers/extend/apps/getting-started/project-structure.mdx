...
<Note>
  **Организация файлов — на ваше усмотрение.** Приведенные выше папки являются
  соглашениями — SDK обнаруживает сущности с помощью AST-анализа вызовов `export
  default defineEntity(...)` независимо от того, где расположен файл.
</Note>
