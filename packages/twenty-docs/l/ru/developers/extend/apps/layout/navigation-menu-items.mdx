...
<Note>
  **Распространенная ошибка:** создание объекта без связанного представления и
  элемента навигационного меню делает этот объект невидимым для пользователей.
  Если только это не технический/внутренний объект, у каждого настраиваемого
  объекта должно быть представление по умолчанию *и* элемент боковой панели,
  указывающий на него.
</Note>
