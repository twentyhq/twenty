...
<CardGroup cols={2}>
  ...
  <Card title="Хранилище ключ-значение" icon="database" href="/l/ru/developers/extend/apps/logic/key-value-store">
    Сохраняйте состояние между запусками логических функций — кэши, курсоры и утверждения между рабочими пространствами.
  </Card>
  <Card title="Фоновые задания" icon="layer-group" href="/l/ru/developers/extend/apps/logic/background-jobs">
