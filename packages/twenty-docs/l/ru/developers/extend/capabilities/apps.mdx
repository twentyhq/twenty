...
| `текст`                      | `object \| null`                      | Parsed request body (JSON)                                                              |
| `isBase64Encoded`            | `логический тип`                      | Whether the body is base64 encoded                                                      |
| `requestContext.http.method` | `строка`                              | HTTP method (GET, POST, PUT, PATCH, DELETE)                                             |
| `requestContext.http.path`   | `строка`                              | Raw request path                                                                        |
