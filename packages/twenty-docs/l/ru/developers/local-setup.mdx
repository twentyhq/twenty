...
Используйте переменные окружения или файлы `.env` для настройки вашего проекта. Подробнее [здесь](https://docs.twenty.com/developers/self-hosting/setup).
...
Если у вас возникли проблемы, проверьте [Устранение неполадок](https://docs.twenty.com/developers/self-hosting/troubleshooting) для получения решений.