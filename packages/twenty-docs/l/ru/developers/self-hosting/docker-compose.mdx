...
<Warning>
Docker containers are for production hosting or self-hosting, for the contribution please check the [Local Setup](https://docs.twenty.com/l/ru/developers/local-setup).
</Warning>
...
See docs [Setup Environment Variables](https://docs.twenty.com/l/ru/developers/self-hosting/setup) for advanced configuration. Все переменные окружения должны быть задекларированы в файле docker-compose.yml на уровне сервера и / или рабочего потока в зависимости от переменной.
