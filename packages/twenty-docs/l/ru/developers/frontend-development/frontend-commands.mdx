...
Чтобы избежать ненужных [перерисовок](/developers/frontend-development/best-practices-front#managing-re-renders), вся логика маршрутизации находится в `useEffect` в `PageChangeEffect`.

### Управление состоянием

[Recoil](https://recoiljs.org/docs/introduction/core-concepts) обрабатывает управление состоянием.

См. [лучшие практики](/developers/frontend-development/best-practices-front#state-management) для получения дополнительной информации об управлении состоянием.
