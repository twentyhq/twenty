...
| Драйвер   | Переменная окружения             | Сценарий использования              | Уровень безопасности    |
| --------- | -------------------------------- | ----------------------------------- | ----------------------- |
| Отключено | `CODE_INTERPRETER_TYPE=DISABLED` | Disable AI code execution           | Н/Д                     |
| Локальный | `CODE_INTERPRETER_TYPE=LOCAL`    | Development only                    | Низкий (без изоляции)   |
