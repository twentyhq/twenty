...
Стилизуйте компоненты с помощью [Linaria styled](https://linaria.dev/docs/basics#styled).
...
Правило ESLint `@typescript-eslint/consistent-type-imports` обеспечивает соблюдение стандарта импортов без ключевого слова type. Это правило создаст ошибки или предупреждения для всех нарушений импорта типов.
