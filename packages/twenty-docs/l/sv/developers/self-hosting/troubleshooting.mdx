...
I `packages/twenty-front/.env` avkommentera `VITE_DISABLE_TYPESCRIPT_CHECKER=true` för att inaktivera bakgrundskontroller och således minska mängden behövt RAM.
