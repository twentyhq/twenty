...
För att undvika onödiga [om-renderingar](/developers/frontend-development/best-practices-front#managing-re-renders) ligger all routinglogik i en `useEffect` i `PageChangeEffect`.

### Tillståndshantering

[Recoil](https://recoiljs.org/docs/introduction/core-concepts) hanterar tillståndshantering.

Se [bästa praxis](/developers/frontend-development/best-practices-front#state-management) för mer information om tillståndshantering.
