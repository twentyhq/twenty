...
<CardGroup cols={2}>
  ...
  <Card title="الاتصالات" icon="plug" href="/l/ar/developers/extend/apps/logic/connections">
    بيانات اعتماد OAuth التي يحتفظ بها تطبيقك للخدمات الخارجية — مثل Linear وGitHub وSlack وغيرها.
  </Card>
  <Card title="مخزن المفاتيح-القيم" icon="قاعدة البيانات" href="/l/ar/developers/extend/apps/logic/key-value-store">
    الاحتفاظ بالحالة بين تشغيلات دالة المنطق — ذاكرات التخزين المؤقت، والمؤشرات، والمطالبات عبر مساحات العمل.
  </Card>
  <Card title="مهام الخلفية" icon="layer-group" href="/l/ar/developers/extend/apps/logic/background-jobs">
    ضع في قائمة الانتظار تشغيل دالة منطقية على العمال لتجاوز مهلة التشغيل لكل عملية.
  </Card>
</CardGroup>
