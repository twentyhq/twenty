...
* يتحكّم `fields` في الأعمدة التي تظهر وترتيبها. يشير كل حقل إلى `fieldMetadataUniversalIdentifier`. للإشارة إلى حقل نظام يتم إنشاؤه تلقائيًا مثل `createdAt`، راجع قسم [استهداف بيانات النظام الوصفية](/l/ar/developers/extend/apps/data/system-fields).
...
| `openRecordIn`                                                                                              | مهمل                                                                                        | لم يعد يُقرأ: أصبح مكان فتح السجلات الآن خاصية في [object](/l/ar/developers/extend/apps/data/objects) (`openRecordIn` على `defineObject()`)، مع الرجوع إلى تفضيل كل عضو الخاص به.                    |
