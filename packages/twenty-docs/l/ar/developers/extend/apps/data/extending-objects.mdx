...
* يمكن أيضًا تعيين `writability` على مستوى الحقل: يقتصر السماح بالكتابة في حالة `MetadataWritability.APPLICATION` على دوال منطق تطبيقك نفسها، بينما يُخصَّص `MetadataWritability.SYSTEM` للبيانات المُدارة بواسطة المنصة. لا يمكن أن يكون مستوى قابلية الكتابة للحقل إلا أكثر تقييدًا من مستوى الكائن الذي ينتمي إليه، ولا تتأثر عمليات القراءة بذلك. راجع [Objects](/l/ar/developers/extend/apps/data/objects) للاطّلاع على الدلالات الكاملة.
