...
<CardGroup cols={2}>
  <Card title="واجهات برمجة التطبيقات" icon="code" href="/l/ar/developers/extend/api">
  ...
  <Card title="التطبيقات" icon="puzzle-piece" href="/l/ar/developers/extend/apps/getting-started/quick-start">
