...
#### خطأ "لم يتم العثور على الملف" أثناء اختبار دالة Logic في سير العمل.

شغّل الأمر `yarn command:prod application:rebuild-default-deps` في حاوية twenty-server لديك لإصلاح مشكلة التبعيات المفقودة.
