...
| -------------- | -------------------------- | -------------------------------- | ----------------------------- |
| معطل           | `SERVERLESS_TYPE=DISABLED` | Disable logic functions entirely | غير متاح                      |
