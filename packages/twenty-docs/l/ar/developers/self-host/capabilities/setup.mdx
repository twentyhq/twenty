...
و`FRONTEND_URL` موثوق بهما بالفعل.
...
<Warning>
الترقية إلى إصدار يستخدم جلسات ملفات تعريف الارتباط تجعل هذا إعدادًا مطلوبًا. الواجهة الأمامية
ترسل الآن بيانات الاعتماد مع كل طلب، وتقوم المتصفحات برفض الاستجابة التي تحتوي على بيانات اعتماد إذا جاءت من مصدر غير مصرح به، لذلك يفشل التطبيق في التحميل حتى تقوم بتعيين هذا الإعداد.
</Warning>
