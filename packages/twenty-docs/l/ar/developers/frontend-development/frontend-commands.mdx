...
"لتجنب [إعادة العرض](/developers/frontend-development/best-practices-front#managing-re-renders) غير الضرورية، يوجد منطق التوجيه في `useEffect` في `PageChangeEffect`."

### "إدارة الحالة"

"[Recoil](https://recoiljs.org/docs/introduction/core-concepts) يتعامل مع إدارة الحالة."

"راجع [أفضل الممارسات](/developers/frontend-development/best-practices-front#state-management) لمزيد من المعلومات حول إدارة الحالة."
