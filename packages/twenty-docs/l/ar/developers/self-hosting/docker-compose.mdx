...
<Warning>
Docker containers are for production hosting or self-hosting, for the contribution please check the [Local Setup](https://docs.twenty.com/l/ar/developers/local-setup).
</Warning>
...
راجع المستندات الخاصة بـ [إعداد متغيرات البيئة](https://docs.twenty.com/l/ar/developers/self-hosting/setup) لإعداد متقدم. يجب إعلان جميع متغيرات البيئة في الملف docker-compose.yml على مستوى الخادم و/أو العامل بناءً على المتغير.
