...
راجع المستندات الخاصة بـ [إعداد متغيرات البيئة](https://docs.twenty.com/developers/self-hosting/setup) لإعداد متقدم. يجب إعلان جميع متغيرات البيئة في الملف docker-compose.yml على مستوى الخادم و/أو العامل بناءً على المتغير.
...
إذا واجهت أي مشكلة، فارجع إلى [استكشاف الأخطاء وإصلاحها](https://docs.twenty.com/developers/self-hosting/troubleshooting) للحصول على الحلول.
