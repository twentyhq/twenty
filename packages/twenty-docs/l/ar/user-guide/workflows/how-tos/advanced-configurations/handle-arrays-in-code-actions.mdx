...
<Tip>
**تريد التكرار على المصفوفة بدلًا من استخراج الحقول؟** عندما تُرجِع خطوة Code أو Logic Function مصفوفة على المستوى الأعلى، يمكنك تمريرها مباشرة إلى [Iterator](/l/ar/user-guide/workflows/capabilities/use-iterator): اختر خيار **Whole list** للخطوة كمُدخل لـ Iterator، ثم ارجع إلى كل عنصر باستخدام `{{iterator.currentItem}}` داخل الحلقة. في هذه الحالة، لا تحتاج إلى إعادة هيكلة المصفوفة إلى كائن.
</Tip>
