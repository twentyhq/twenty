...
<img
  src="/images/user-guide/workflows/create_users_workflow.png"
  style={{ width: '100%' }}
/>
...
<Tip>
  استخدم **Upsert** (تحديث أو إنشاء) بدلًا من إنشاء فروع منفصلة للإنشاء مقابل
  التحديث. إنه أسرع في الإنشاء وأسهل في استكشاف الأخطاء وإصلاحها.
</Tip>
