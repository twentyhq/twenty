...
يستخدم سير العمل هذا **المحفز اليدوي** بحيث يتمكن المستخدمون من إنشاء ملف PDF عند الطلب لأي سجل محدد. A **Logic Function** handles:
...
1. **أنشئ مفتاح API**: انتقل إلى **الإعدادات → واجهات برمجة التطبيقات** ثم أنشئ مفتاح API جديدًا. You'll need this token for the logic function.
...
* [Logic Functions](/l/ar/user-guide/workflows/capabilities/workflow-actions#code)
