...
<Tip>
  للاطلاع على مثال كامل لتتبّع الوقت في مراحل خط الأنابيب، راجع [تتبّع مدة بقاء
  الفرص في كل
  مرحلة](/l/ar/user-guide/views-pipelines/how-tos/track-time-in-stage).
</Tip>
...
<Note>
  تشير القيم السالبة إلى مهام متأخرة عن موعدها. يمكنك استخدام هذا الحقل لتصفية
  المهام أو فرزها حسب الإلحاح.
</Note>
