...
Δείτε τα έγγραφα [Ρύθμιση Μεταβλητών Περιβάλλοντος](https://docs.twenty.com/developers/self-hosting/setup) για προχωρημένες ρυθμίσεις. Όλες οι μεταβλητές περιβάλλοντος πρέπει να δηλωθούν στο αρχείο docker-compose.yml στο επίπεδο του server και/ή worker ανάλογα με τη μεταβλητή.
