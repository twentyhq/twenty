...
Χρησιμοποιήστε περιβαλλοντικές μεταβλητές ή αρχεία `.env` για να διαμορφώσετε το έργο σας. Περισσότερες πληροφορίες [εδώ](https://docs.twenty.com/developers/self-hosting/setup)
...
Εάν συναντήσετε κάποιο πρόβλημα, ελέγξτε την [Αντιμετώπιση Προβλημάτων](https://docs.twenty.com/developers/self-hosting/troubleshooting) για λύσεις.