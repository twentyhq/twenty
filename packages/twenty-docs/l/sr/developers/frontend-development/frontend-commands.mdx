...
Да би се избегло непотребно [поновно рендеровање](/developers/frontend-development/best-practices-front#managing-re-renders) сва логика рутирања је у `useEffect` у `PageChangeEffect`.

### Управљање стањем

[Recoil](https://recoiljs.org/docs/introduction/core-concepts) се бави управљањем стањем.

Погледајте [најбоље праксе](/developers/frontend-development/best-practices-front#state-management) за више информација о управљању стањем.
