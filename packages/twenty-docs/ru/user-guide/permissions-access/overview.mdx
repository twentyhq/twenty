...
<CardGroup cols={2}>
  <Card title="Разрешения" icon="lock" href="/ru/user-guide/permissions-access/capabilities/permissions">
    Создавайте роли и настраивайте разрешения для объектов, полей и настроек.
  </Card>
  <Card title="Конфигурация SSO" icon="key" href="/ru/user-guide/permissions-access/capabilities/sso-configuration">
    Настройте единый вход (SSO) с вашим провайдером удостоверений.
  </Card>
  <Card title="Частые вопросы" icon="circle-question" href="/ru/user-guide/permissions-access/how-tos/permissions-faq">
...
* [Создать роль](/ru/user-guide/permissions-access/capabilities/permissions#create-a-role)
* [Настроить SSO](/ru/user-guide/permissions-access/capabilities/sso-configuration)
* [Управлять участниками команды](/ru/user-guide/settings/capabilities/member-management)
