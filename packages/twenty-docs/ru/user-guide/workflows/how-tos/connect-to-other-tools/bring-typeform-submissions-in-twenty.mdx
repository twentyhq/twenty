...
Для стандартной настройки вебхука см. [Настройка триггера вебхука](/ru/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger). В этой статье рассматривается специальная обработка, требуемая для пользовательской структуры полезной нагрузки Typeform.
...
<Tip>
Для получения подробностей об обработке массивов в действиях Code см. [Обработка массивов в действиях Code](/ru/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
...
* [Настройка триггера вебхука](/ru/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger)
* [Обработка массивов в действиях Code](/ru/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions)
