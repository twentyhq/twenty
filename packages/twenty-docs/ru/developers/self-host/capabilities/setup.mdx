...
<Warning>
**Устанавливаете впервые?** Следуйте [руководству по установке Docker Compose](/ru/developers/self-host/capabilities/docker-compose), чтобы запустить Twenty, затем вернитесь сюда для настройки.
</Warning>
...
Чтобы выполнить ротацию `ENCRYPTION_KEY` без простоя, см. [руководство по ротации ключей](/ru/developers/self-host/capabilities/key-rotation).
