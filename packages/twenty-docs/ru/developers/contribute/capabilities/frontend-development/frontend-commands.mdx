...
Чтобы избежать ненужных [перерисовок](/ru/developers/contribute/capabilities/frontend-development/best-practices-front#managing-re-renders), вся логика маршрутизации находится в `useEffect` в `PageChangeEffect`.

### Управление состоянием

[Jotai](https://jotai.org/) отвечает за управление состоянием.

[лучшие практики](/ru/developers/contribute/capabilities/frontend-development/best-practices-front#state-management) для получения дополнительной информации об управлении состоянием.
