...
<CardGroup cols={2}>
  <Card title="API" icon="code" href="/ru/developers/extend/api">
    Подключайтесь к Twenty программно
  </Card>
  <Card title="Вебхуки" icon="bell" href="/ru/developers/extend/webhooks">
    Получайте уведомления о событиях в реальном времени
  </Card>
  <Card title="Приложения" icon="puzzle-piece" href="/ru/developers/extend/apps/getting-started/quick-start">
