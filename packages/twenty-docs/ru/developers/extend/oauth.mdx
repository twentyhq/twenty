...
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| Внутренние скрипты, автоматизация                                  | [Ключ API](/ru/developers/extend/api#authentication)                                                      |
...
| Приложение Twenty с расширениями пользовательского интерфейса (UI) | [Приложения](/ru/developers/extend/apps/getting-started/quick-start) (OAuth обрабатывается автоматически) |
