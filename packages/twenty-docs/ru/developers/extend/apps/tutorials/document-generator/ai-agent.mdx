...
[Навык](/ru/developers/extend/apps/logic/skills-and-agents) — это многократно используемые инструкции, то есть знания, которые вы прикрепляете к агентам. Мы учим модель использования
инструмента.
...
[Агент](/ru/developers/extend/apps/logic/skills-and-agents) сочетает промпт с моделью. Установите `responseFormat` явно во избежание предупреждения о строительстве.
...
[Глава 2](/ru/developers/extend/apps/tutorials/document-generator/generating-documents#grant-it-access).
</Note>
...
<Card title="Далее: публикация →" icon="rocket" href="/ru/developers/extend/apps/tutorials/document-generator/publishing">
