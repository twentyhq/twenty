...
[view](/ru/developers/extend/apps/layout/views) — это сохраненный список объектов.
[пункт меню навигации](/ru/developers/extend/apps/layout/navigation-menu-items)
...
[передний компонент](/ru/developers/extend/apps/layout/front-components) — компонент React
...
[пункт меню команды](/ru/developers/extend/apps/layout/command-menu-items) с
...
Монтируйте его с [разметкой](/ru/developers/extend/apps/layout/page-layouts). Макет
...
[справочник по виджетам field](/ru/developers/extend/apps/layout/page-layouts#field-widgets).
...
<Card title="Далее: Агент ИИ →" icon="robot" href="/ru/developers/extend/apps/tutorials/document-generator/ai-agent">
