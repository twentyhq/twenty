...
<CardGroup cols={3}>
  <Card href="/ru/developers/extend/apps/getting-started/quick-start" img="/images/user-guide/halftone/dev-apps.png">
  ...
  <Card href="/ru/developers/self-host/capabilities/docker-compose" img="/images/user-guide/halftone/dev-self-host.png">
    <CardTitle>Развертывайте у себя</CardTitle>
    Запускайте Twenty в собственной инфраструктуре.
  </Card>

  <Card href="/ru/developers/contribute/capabilities/local-setup" img="/images/user-guide/halftone/dev-contribute.png">
