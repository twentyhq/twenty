...
See docs [Setup Environment Variables](https://twenty.com/developers/self-hosting/setup) for advanced configuration. All environment variables must be declared in the docker-compose.yml file at the server and / or worker level depending on the variable.
...
If you encounter any problem, check [Troubleshooting](https://twenty.com/developers/self-hosting/troubleshooting) for solutions.
