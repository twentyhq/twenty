---
title: Integrations
description: Connect Twenty to your existing tools and build custom automations.
image: /images/user-guide/integrations/plug.png
---

<Frame>
  <img src="/images/user-guide/integrations/plug.png" alt="Integrations" />
</Frame>
...
For email and calendar setup, visit [Email & Calendar Setup](/user-guide/calendar-emails/getting-started/email-calendar-setup).
...
Learn more in our [Workflows section](/user-guide/workflows/overview).
