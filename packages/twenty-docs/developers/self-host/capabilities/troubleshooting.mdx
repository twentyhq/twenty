...
#### 'File Not Found' error while testing Logic function in workflow

Run `yarn command:prod application:rebuild-default-deps` command in your twenty-server container to fix missing dependencies issue.
