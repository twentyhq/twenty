---
title: Getting started with Twenty apps
image: /images/user-guide/home/custom-objects.png
info: Create, run, and iterate on your first Twenty application
---

Build your first Twenty app in minutes. This guide walks you through creating a new app, authenticating with your workspace, and running in development.
...
See also: the CLI reference pages for [create-twenty-app](/developers/twenty-apps/cli/create-twenty-app) and [twenty-sdk CLI](/developers/twenty-apps/cli/twenty-sdk).

## What is a Twenty app?

A Twenty app extends your Twenty workspace with custom data objects and serverless functions. You define your entities and functions locally, and the Twenty CLI keeps your workspace in sync during development.
...
Your credentials are stored per-user in `~/.twenty/config.json`. You can maintain multiple profiles and switch using `--workspace <name>`. See details in the [twenty-sdk CLI reference](/developers/twenty-apps/cli/twenty-sdk#configuration).
...
- CLI for development: [twenty-sdk CLI](/developers/twenty-apps/cli/twenty-sdk)
- Scaffolding new apps: [create-twenty-app](/developers/twenty-apps/cli/create-twenty-app)
