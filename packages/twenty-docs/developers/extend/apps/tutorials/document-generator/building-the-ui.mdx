...
const DocumentViewer = () => {
  ...
  // ...load { content, file } for recordId, then render the template body plus
  // quick links to the shareable web page and the PDF:
  return (
    <div style={styles.scroll}>
      <div style={styles.actions}>
        <a style={styles.actionLink} href={webUrl}>Open web page</a>
        {document.pdfUrl ? (
          <a style={styles.actionLink} href={document.pdfUrl}>Download PDF</a>
        ) : null}
      </div>
