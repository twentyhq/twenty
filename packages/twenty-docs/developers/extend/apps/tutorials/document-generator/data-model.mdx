...
<Tip>
Scaffold entity files with `yarn twenty dev:add object` — it generates a valid
UUID and the right folder for you. Below we show the finished files.
</Tip>
...
says whether it's written for a Person or a Company.
...
export default defineObject({
  ...
  fields: [
    ...
    { universalIdentifier: TEMPLATE_BODY_FIELD_UNIVERSAL_IDENTIFIER,
      type: FieldType.TEXT, name: 'body', label: 'Body', icon: 'IconFileText',
...
[`document.object.ts`](https://github.com/twentyhq/twenty/blob/main/packages/twenty-apps/public/document-generator/src/objects/document.object.ts).
