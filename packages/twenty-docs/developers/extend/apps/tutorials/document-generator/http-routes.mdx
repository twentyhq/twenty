...
sanitized) and drops it into a styled, printable page — the same polished look as
the PDF. [See the helper](https://github.com/twentyhq/twenty/blob/main/packages/twenty-apps/public/document-generator/src/utils/render-document.ts).
