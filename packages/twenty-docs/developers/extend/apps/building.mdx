...
| Entity | Purpose | Docs |
|--------|---------|------|
| **Application** | App identity, permissions, variables | [Data Model](/developers/extend/apps/data/data-model) |
| **Role** | Permission sets for objects and fields | [Data Model](/developers/extend/apps/data/data-model) |
| **Object** | Custom data tables with fields | [Data Model](/developers/extend/apps/data/data-model) |
| **Field** | Extend existing objects, define relations | [Data Model](/developers/extend/apps/data/data-model) |
| **Logic Function** | Server-side TypeScript with triggers | [Logic Functions](/developers/extend/apps/logic/logic-functions) |
| **Front Component** | Sandboxed React UI in Twenty's page | [Front Components](/developers/extend/apps/layout/front-components) |
...
| **View** | Pre-configured record list views | [Layout](/developers/extend/apps/layout/views-and-pages) |
| **Navigation Menu Item** | Custom sidebar entries | [Layout](/developers/extend/apps/layout/views-and-pages) |
| **Page Layout** | Custom record page tabs and widgets | [Layout](/developers/extend/apps/layout/views-and-pages) |
...
<CardGroup cols={2}>
  ...
  <Card title="Layout" icon="table-columns" href="/developers/extend/apps/layout/views-and-pages">
