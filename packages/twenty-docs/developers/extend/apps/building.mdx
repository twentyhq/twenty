...
import { definePostInstallLogicFunction, type PostInstallPayload } from 'twenty-sdk';

const handler = async (payload: PostInstallPayload): Promise<void> => {
