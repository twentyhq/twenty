...
- **Billable operations** *(optional)* — what your app charges credits for; see [Charging Credits](/developers/extend/apps/logic/credits).
...
| `pricingDescription` | What the app costs, in one short friendly line shown next to the install button (e.g. `$0.02 per minute recorded`). Set it if your app [charges credits](/developers/extend/apps/logic/credits) |
