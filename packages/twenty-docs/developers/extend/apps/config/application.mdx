...
| `aboutDescription` | Longer markdown description for the "About" tab. If omitted, the marketplace uses the package's `README.md` from npm. Raw HTML, including `<img>` tags, shows as plain text and does not render |
