...
<CardGroup cols={2}>
  ...
  <Card title="Timeline Activity Types" icon="clock-rotate-left" href="/developers/extend/apps/config/timeline-activity-types">
    `timelineActivityTypes` — declare the kinds of entry your app writes to a record's timeline, and how each one is drawn.
  </Card>
</CardGroup>
