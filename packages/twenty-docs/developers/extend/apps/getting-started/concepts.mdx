...
│   └── front-component-shared-dependencies.ts ← defineFrontComponentSharedDependencies (optional, one per app)
...
| **Shared Dependencies** | Dependencies shared by the app's front components | [Shared Dependencies](/developers/extend/apps/layout/front-components#sharing-dependencies-across-front-components) |
