...
│   └── vendor.ts                ← defineVendor (optional, one per app)
...
| **Vendor** | Dependencies shared by the app's front components | [Vendor Bundle](/developers/extend/apps/layout/front-components#sharing-dependencies-with-a-vendor-bundle) |
