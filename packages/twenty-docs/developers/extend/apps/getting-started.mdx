...
- `--example <name-or-url>` — (optional) initialize from an example (name or GitHub URL)
...
```bash filename="Terminal"
npx create-twenty-app@latest my-twenty-app --example <name-or-url>
```

Examples are sourced from the [twenty-apps/examples](https://github.com/twentyhq/twenty/tree/main/packages/twenty-apps/examples) directory on GitHub. You can also pass any GitHub URL as the example value.
