...
- `--example <name>` — (optional) initialize from an example
...
```bash filename="Terminal"
npx create-twenty-app@latest my-twenty-app --example <name>
```

Examples are sourced from the [twenty-apps/examples](https://github.com/twentyhq/twenty/tree/main/packages/twenty-apps/examples) directory on GitHub.
