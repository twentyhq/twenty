...
- A **page layout** of type `RECORD_PAGE` targets an object and can embed [front components](/developers/extend/apps/layout/front-components) inside its tabs as widgets.
