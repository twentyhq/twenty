...
<CardGroup cols={2}>
  ...
  <Card title="Page Layouts" icon="table-columns" href="/developers/extend/apps/layout/page-layouts">
    `definePageLayout`, `definePageLayoutTab` and `definePageLayoutWidget` — tabs and widgets on a record's detail page.
  </Card>
...
| **Record detail page** | The tabs and widgets on a record page (your own object's, or a standard one) | `definePageLayout`, `definePageLayoutTab`, `definePageLayoutWidget` |
| **Inside any of the above** | A custom React widget — buttons, forms, dashboards, integrations | `defineFrontComponent` |
| **App settings** | A custom tab on the app's settings page, in place of the generated variables UI | `defineSettingsFrontComponent` |
