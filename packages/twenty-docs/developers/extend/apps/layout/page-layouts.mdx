...
- `type` is a `PageLayoutType` enum value: `RECORD_INDEX`, `RECORD_PAGE`, `DASHBOARD` or `STANDALONE_PAGE`. Use `PageLayoutType.RECORD_PAGE` to customize the detail view of a specific object.
