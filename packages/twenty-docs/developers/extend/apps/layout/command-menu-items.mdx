...
| `isLayoutCustomizationAllowedOnCurrentPage` | `boolean` | Whether the current page supports entering layout customization. False on AI chat and Settings pages; does not check permissions or whether editing is already active. |
