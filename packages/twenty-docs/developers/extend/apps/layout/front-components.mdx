...
| ----------------------------------- | --------------------------------------------------------------- |
| `twenty-ui/primitives/input`        | `Input`, `Field`, `Checkbox`, `Switch`, and other form controls |
| `twenty-ui/primitives/data-display` | `Tag`, `Status`, `Chip`, and `Avatar`                           |
...
| `twenty-ui/input`                   | `Button` and additional inputs                                  |
