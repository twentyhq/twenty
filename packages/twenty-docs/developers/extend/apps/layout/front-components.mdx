...
Your app's settings page opens on a **General** tab holding the settings every app shares — auto-upgrade, App URL and connections. Those are system-managed and an app cannot override them.
