...
The About tab renders markdown only and shows raw HTML as plain text. README images embedded with `<img>` tags, badges and `<div align="center">` blocks therefore do not render in the marketplace.
</Note>
