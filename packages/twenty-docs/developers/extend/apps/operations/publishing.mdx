...
```bash filename="Terminal"
yarn twenty remote:add --workspace-url https://your-twenty-server.com --as production
```
...
```bash filename="Terminal"
yarn twenty docker:catalog-sync
# To target a specific remote:
# yarn twenty docker:catalog-sync --remote production
```
