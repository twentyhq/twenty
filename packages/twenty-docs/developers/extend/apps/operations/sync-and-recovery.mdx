...
- **Concurrent operation error** — `APPLICATION_OPERATION_IN_PROGRESS`; another install, upgrade, or uninstall for this app is already running. Wait for it to finish before retrying.
