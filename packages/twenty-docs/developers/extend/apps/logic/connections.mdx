...
export default defineConnectionProvider({
  ...
  // Optional: universalIdentifier of a logic function in this app to run right
  // after a connection is established. See "Run a logic function on connect".
  // onConnectLogicFunctionUniversalIdentifier: '3a2b1c0d-...-...',
});
```
...
export default defineConnectionProvider({
  ...
  onConnectLogicFunctionUniversalIdentifier: '3a2b1c0d-1111-4222-8333-444455556666',
});
```
