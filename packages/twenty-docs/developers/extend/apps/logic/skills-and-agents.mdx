...
workspace member, for example through a link record your app maintains. To gate
who may trigger privileged runs, see [Permission checks on the invoking
user](/developers/extend/apps/logic/logic-functions#permission-checks-on-the-invoking-user).
