...
workspace member. [`getTriggeredBy`](/developers/extend/apps/logic/logic-functions#knowing-who-triggered-a-run)
names that person and reports what they are allowed to do.
