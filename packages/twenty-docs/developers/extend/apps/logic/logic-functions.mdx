...
<Note>
**The context tells you who triggered the run, not what the run may do.** A logic function always acts with its application's own access, whoever triggered it. Use these ids to attribute records or to enforce your own business rules, not as a substitute for permissions.
</Note>
