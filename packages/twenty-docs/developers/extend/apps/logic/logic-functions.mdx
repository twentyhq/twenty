...
// and rawBody included), verifies the request signature, and does the
// real work.
const handler = async (event: RoutePayload) => {
...
```
POST https://your-twenty-server.com/server-routes/:resolverLogicFunctionUniversalIdentifier
```
