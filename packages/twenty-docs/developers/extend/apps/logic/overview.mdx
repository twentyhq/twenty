...
<CardGroup cols={2}>
  ...
  <Card title="Ingesting Messages" icon="inbox-in" href="/developers/extend/apps/logic/messaging-ingestion">
    Write conversations from your provider into those channels — threading and de-duplication included.
  </Card>
