...
<CardGroup cols={2}>
  <Card title="Workflows (experimental)" icon="diagram-project" href="/developers/extend/apps/logic/workflows">
    Development POC for app-owned manual workflows with one updatable core version.
  </Card>
