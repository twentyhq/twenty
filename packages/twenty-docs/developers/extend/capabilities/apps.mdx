...
- **Settings** — Applications can define a custom settings tab. When `settingsCustomTabFrontComponentId` is set on the application entity, a "Custom" tab appears in the application's settings page and renders that front component.
