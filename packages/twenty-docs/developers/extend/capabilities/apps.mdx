...
The first time you run `yarn app:auth`, you'll be prompted for:
...
yarn app:auth --workspace my-custom-workspace
```
...
- Authentication errors: run `yarn app:auth` and ensure your API key has the required permissions.
