...
- **Operations**: Create multiple records
...
<Tip>
Use batch operations to maximize throughput — process up to 200 records in a single API call instead of making individual requests.
</Tip>
