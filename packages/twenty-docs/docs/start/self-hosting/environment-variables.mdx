...
<OptionTable options={[
    ['EMAIL_FROM_ADDRESS', 'noreply@yourdomain.com', 'Global email From: header whilst sending emails'],
    ['EMAIL_SYSTEM_ADDRESS', 'system@yourdomain.com', 'Email address used to send system information'],
    ['EMAIL_FROM_NAME', 'John from YourDomain', 'Global name From: header whilst sending emails'],
...
<OptionTable options={[
  ['INACTIVE_DAYS_BEFORE_EMAIL', '', 'Number of inactive days before sending workspace deleting warning email'],
  ['INACTIVE_DAYS_BEFORE_DELETE', '', 'Number of inactive days before deleting workspace'],
  ]}></OptionTable>
