...
This quick-start guide walks you through the basics you need to know to start using Twenty to its full potential in no time.
...
<div style={{textAlign: 'center'}}>
    <img src="/img/user-guide/attach-files-to-records.png" alt="Attach files to records" />
</div>
...
<div style={{textAlign: 'center'}}>
    <img src="/img/user-guide/view-favorite-records.png" alt="View favorite records"/>
</div>
