...
<div style={{textAlign: 'center'}}>
    <img src="/img/user-guide/all-opportunities.png" alt="All opportunities"/>
</div>
...
<div style={{textAlign: 'center'}}>
    <img src="/img/user-guide/filter-opportunities.png" alt="Filter opportunities"/>
</div>
...
<div style={{textAlign: 'center'}}>
    <img src="/img/user-guide/display-fields.png" alt="Display fields"/>
</div>
...
<div style={{textAlign: 'center'}}>
    <img src="/img/user-guide/compact-opportunities-view.png" alt="Compact opportunities view"/>
</div>