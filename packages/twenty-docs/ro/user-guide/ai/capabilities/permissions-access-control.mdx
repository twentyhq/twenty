...
* [Permisiuni](/ro/user-guide/permissions-access/capabilities/permissions) — informații detaliate despre crearea și gestionarea rolurilor
* [Agenți AI](/ro/user-guide/ai/capabilities/ai-agents) — capabilități AI în fluxuri de lucru
