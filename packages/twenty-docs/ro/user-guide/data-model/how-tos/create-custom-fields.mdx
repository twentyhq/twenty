...
3. Click **+ Câmp nou**
4. Alegeți un **tip de câmp** (consultați [Câmpuri](/ro/user-guide/data-model/capabilities/fields) pentru toate tipurile)
...
<Note>
**Folosiți numele API pentru importuri.** Activați **modul Avansat** în Setări pentru a vedea numele API. Consultați [Maparea câmpurilor](/ro/user-guide/data-migration/capabilities/field-mapping).
</Note>
...
* [Câmpuri](/ro/user-guide/data-model/capabilities/fields) — toate tipurile de câmpuri explicate
