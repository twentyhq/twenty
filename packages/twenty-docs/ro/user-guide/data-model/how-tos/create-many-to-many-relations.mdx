...
* [Câmpuri de relație](/ro/user-guide/data-model/capabilities/relation-fields) — explicații despre tipurile de relații
* [Creați obiecte personalizate](/ro/user-guide/data-model/how-tos/create-custom-objects) — cum să creați obiecte
* [Creați câmpuri de relație](/ro/user-guide/data-model/how-tos/create-relation-fields) — configurare de bază a relațiilor
