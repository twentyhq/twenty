...
Consultați [Cum să creați relații de tip multe-la-multe](/ro/user-guide/data-model/how-tos/create-many-to-many-relations) pentru un ghid complet, pas cu pas.
