...
* **Calendar și e-mailuri:** Sincronizați-vă căsuța poștală și calendarul pentru a vedea toate comunicările în înregistrările dvs. din CRM. [Aflați mai multe](/ro/user-guide/calendar-emails/overview).
* **Model de date:** Creați obiecte și câmpuri personalizate, adaptate proceselor dvs. de afaceri unice. [Explorați](/ro/user-guide/data-model/overview).
* **Migrarea datelor:** Importați și exportați datele prin CSV sau API. [Începeți](/ro/user-guide/data-migration/overview).
* **Vizualizări și pipeline-uri:** Organizați-vă datele cu vizualizări tabelare, panouri kanban și fluxuri de vânzări. [Descoperiți](/ro/user-guide/views-pipelines/overview).
* **Fluxuri de lucru:** Automatizați procesele de afaceri și integrați cu instrumente externe. [Creați automatizări](/ro/user-guide/workflows/overview).
* **IA:** Îmbunătățiți CRM-ul cu funcționalități bazate pe IA și agenți IA. [Explorați IA](/ro/user-guide/ai/overview).
* **Tablouri de bord:** Urmăriți performanța cu rapoarte și vizualizări personalizate. [Vizualizați tablourile de bord](/ro/user-guide/dashboards/overview).
* **Permisiuni și acces:** Controlați cine poate vizualiza, edita și gestiona datele dvs. cu permisiuni bazate pe roluri. [Configurați accesul](/ro/user-guide/permissions-access/overview).
* **Note și sarcini:** Creați note și sarcini legate de înregistrările dvs. pentru o colaborare mai bună.
* **API și Webhooks:** Conectați-vă la alte aplicații și creați integrări personalizate. [Începeți integrarea](/ro/developers/extend/api).
