...
Citește [acest articol](/ro/user-guide/data-model/overview) pentru a afla cum să îți proiectezi modelul de date.
...
Citește [acest articol](/ro/user-guide/data-migration/overview) pentru a afla mai multe despre importul de date.
...
Începe să creezi automatizări folosind [fluxuri de lucru](/ro/user-guide/workflows/overview).
