...
| ----------- | --------------------------------------------------------------------- | ------------------------------------------ |
| **GraphQL** | Interogări flexibile, preluarea datelor asociate, operațiuni complexe | [Documentație API](/ro/developers/extend/api) |
| **REST**    | Operațiuni CRUD simple, tipare REST familiare                         | [Documentație API](/ro/developers/extend/api) |
...
* Verificați că formatele corespund cerințelor Twenty (consultați [Maparea câmpurilor](/ro/user-guide/data-migration/capabilities/field-mapping))
...
Contactați-ne la [contact@twenty.com](mailto:contact@twenty.com) sau explorați [Serviciile noastre de implementare](/ro/user-guide/getting-started/capabilities/implementation-services).
...
* [Documentație API](/ro/developers/extend/api)
