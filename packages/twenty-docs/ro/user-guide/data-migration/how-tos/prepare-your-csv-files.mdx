...
<Note>Pentru seturi de date mai mari de 10.000 de înregistrări, împărțiți-le în mai multe fișiere sau folosiți [importul prin API](/ro/user-guide/data-migration/how-tos/import-data-via-api).</Note>
...
Consultați [Cum să importați relații](/ro/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) pentru instrucțiuni detaliate.
...
* [Importați companii](/ro/user-guide/data-migration/how-tos/import-companies-via-csv) (importați-le pe acestea mai întâi)
* [Importați contacte](/ro/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [Remediați eventualele erori de import](/ro/user-guide/data-migration/how-tos/fix-import-errors)
