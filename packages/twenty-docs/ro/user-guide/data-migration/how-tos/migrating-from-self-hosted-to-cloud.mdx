...
Consultați [Cum să importați relații](/ro/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) pentru detalii despre menținerea relațiilor.
...
<Tip>
  Migrați un spațiu de lucru mare sau complex? [Găsiți un partener Twenty certificat](https://twenty.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) care să gestioneze migrarea de la un capăt la altul. *(Sau implicați echipa noastră: [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
