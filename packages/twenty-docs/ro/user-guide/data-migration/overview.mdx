...
<Note>Pentru seturi de date foarte mari (sute de mii de înregistrări), utilizați API-ul. Partenerii noștri de [implementare](/ro/user-guide/getting-started/capabilities/implementation-services) vă pot ajuta să rulați aceste scripturi, dacă este nevoie.</Note>
...
Consultați [acest articol](/ro/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) pentru un ghid pas cu pas despre cum să procedați.
...
* [Pregătiți fișierele CSV](/ro/user-guide/data-migration/how-tos/prepare-your-csv-files)
* [Importați relații între obiecte](/ro/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv)
* [Importați prin API pentru seturi mari de date](/ro/user-guide/data-migration/how-tos/import-data-via-api)
