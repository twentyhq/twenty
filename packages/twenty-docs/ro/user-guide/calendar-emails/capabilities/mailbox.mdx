...
**Notă**: Pentru a conecta conturile de e-mail și a configura setările de sincronizare, vizitați <a href="/ro/user-guide/calendar-emails/overview">Configurare e-mail și calendar</a>.
