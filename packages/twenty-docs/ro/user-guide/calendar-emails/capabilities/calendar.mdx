...
**Notă**: Pentru a vă conecta calendarul și a configura setările de sincronizare, vizitați [Configurare e-mail și calendar](/ro/user-guide/calendar-emails/overview).
