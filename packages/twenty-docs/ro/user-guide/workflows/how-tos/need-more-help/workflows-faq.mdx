...
<AccordionGroup>
  ...
  <Accordion title="Care este diferența dintre declanșatoarele manuale Single, Global și Bulk?">
    ...
    * **Bulk**: Utilizați când aveți nevoie să procesați înregistrările împreună sau să optimizați utilizarea creditelor (necesită acțiunea Iterator)
    ...
    Consultați [Declanșatoare ale fluxurilor de lucru](/ro/user-guide/workflows/capabilities/workflow-triggers) pentru detalii.
  </Accordion>
  ...
  <Accordion title="Nu văd un nod If/Else. Ce ar trebui să fac?">
    ...
    **Soluție temporară**: Creați mai multe ramuri din pasul dvs., fiecare începând cu o acțiune **Filter**:
    ...
    Consultați [Cum să utilizați ramurile](/ro/user-guide/workflows/capabilities/workflow-branches) pentru un ghid pas cu pas.
  </Accordion>
  ...
  <Accordion title="Cum citesc rulările fluxului de lucru?">
    ...
    * **Date**: Vizualizați datele de intrare/ieșire la fiecare pas
    ...
    Consultați [Rulări ale fluxurilor de lucru](/ro/user-guide/workflows/capabilities/workflow-runs) pentru detalii.
  </Accordion>
