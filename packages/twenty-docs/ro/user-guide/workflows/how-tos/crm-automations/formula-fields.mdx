...
<Tip>
Pentru un exemplu complet de urmărire a timpului în stadiile din pipeline, vezi [Urmărește cât timp rămân oportunitățile în fiecare stadiu](/ro/user-guide/views-pipelines/how-tos/track-time-in-stage).
</Tip>
...
Vezi [Cum să afișezi suma estimată în pipeline](/ro/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline) pentru fluxul de lucru complet.
...
* [Cum să afișezi suma estimată în pipeline](/ro/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline)
* [Cum să urmărești timpul în stadiu](/ro/user-guide/views-pipelines/how-tos/track-time-in-stage)
