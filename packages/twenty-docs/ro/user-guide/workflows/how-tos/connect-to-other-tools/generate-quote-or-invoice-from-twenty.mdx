...
* [Generați un PDF din Twenty](/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — atașați PDF-uri generate la înregistrări
...
* [Automatizări pentru Closed Won](/ro/user-guide/workflows/how-tos/crm-automations/closed-won-automations)
