...
* **Bulk**: Fluxul de lucru va rula o dată, furnizând întreaga listă de înregistrări ca intrare. Aceasta înseamnă că fluxul de lucru trebuie să conțină o [acțiune Iterator](/ro/user-guide/workflows/capabilities/workflow-actions#iterator).
