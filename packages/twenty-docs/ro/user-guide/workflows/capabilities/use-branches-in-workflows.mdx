...
* [Întrebări frecvente despre fluxuri de lucru](/ro/user-guide/workflows/how-tos/need-more-help/workflows-faq) — răspunsuri despre execuția în paralel
* [Acțiuni ale fluxurilor de lucru](/ro/user-guide/workflows/capabilities/workflow-actions) — acțiuni disponibile pentru ramuri
