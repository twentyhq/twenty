...
<Note>
Deși puteți utiliza un nod [Întârziere](/ro/user-guide/workflows/capabilities/workflow-actions#delay) pentru a întrerupe execuția, în prezent nu poate fi configurat să aștepte "până când se termină o altă ramificație".
</Note>

## Conexe

* [Cum să utilizați ramificațiile în fluxuri de lucru](/ro/user-guide/workflows/capabilities/use-branches-in-workflows) - Ghid pas cu pas
* [Acțiuni ale fluxului de lucru](/ro/user-guide/workflows/capabilities/workflow-actions) - Acțiuni disponibile, inclusiv Filtru
