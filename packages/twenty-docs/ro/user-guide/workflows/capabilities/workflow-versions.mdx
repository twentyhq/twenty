...
* [Noțiuni de bază despre fluxuri de lucru](/ro/user-guide/workflows/overview)
* [Execuții ale fluxurilor de lucru](/ro/user-guide/workflows/capabilities/workflow-runs)
