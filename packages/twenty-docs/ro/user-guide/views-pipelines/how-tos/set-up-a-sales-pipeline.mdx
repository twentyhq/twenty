...
* [Vizualizări Kanban](/ro/user-guide/views-pipelines/capabilities/kanban-views) — agregări și vizualizare compactă
* [Filtre și sortare](/ro/user-guide/views-pipelines/capabilities/filters-and-sorting) — crearea vizualizărilor filtrate
