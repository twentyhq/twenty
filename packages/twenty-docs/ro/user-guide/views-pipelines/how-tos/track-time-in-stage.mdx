...
<Tip>
Acesta este un exemplu de creare a [Câmpurilor de formulă](/ro/user-guide/workflows/how-tos/crm-automations/formula-fields) folosind fluxuri de lucru — în special calcule de date.
</Tip>
...
* [Fluxuri de lucru](/ro/user-guide/workflows/overview) — elemente de bază ale automatizării
* [Cum să creați câmpuri personalizate](/ro/user-guide/data-model/how-tos/create-custom-fields) — configurarea câmpurilor
* [Vizualizări Kanban](/ro/user-guide/views-pipelines/capabilities/kanban-views) — agregări
