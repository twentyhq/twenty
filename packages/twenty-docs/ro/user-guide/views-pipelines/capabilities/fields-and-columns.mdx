...
* [Vizualizări de Tabel](/ro/user-guide/views-pipelines/capabilities/table-views) — funcționalități ale vizualizării de listă
* [Vizualizări Kanban](/ro/user-guide/views-pipelines/capabilities/kanban-views) — vizualizări bazate pe carduri
