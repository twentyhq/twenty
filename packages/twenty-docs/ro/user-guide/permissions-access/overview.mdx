...
<CardGroup cols={2}>
  <Card title="Permisiuni" icon="lock" href="/ro/user-guide/permissions-access/capabilities/permissions">
    Creați roluri și configurați permisiunile pentru obiecte, câmpuri și setări.
  </Card>
  <Card title="Configurare SSO" icon="key" href="/ro/user-guide/permissions-access/capabilities/sso-configuration">
    Configurați autentificarea unică (SSO) cu furnizorul dvs. de identitate.
  </Card>
  <Card title="Întrebări frecvente" icon="circle-question" href="/ro/user-guide/permissions-access/how-tos/permissions-faq">
...
* [Crează un rol](/ro/user-guide/permissions-access/capabilities/permissions#create-a-role)
* [Configurați SSO](/ro/user-guide/permissions-access/capabilities/sso-configuration)
* [Gestionați membrii echipei](/ro/user-guide/settings/capabilities/member-management)
