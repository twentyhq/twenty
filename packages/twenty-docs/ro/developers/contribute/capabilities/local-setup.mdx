...
Utilizați variabile de mediu sau fișiere `.env` pentru a configura proiectul dvs. Mai multe informații [aici](/ro/developers/self-host/capabilities/setup).
...
Dacă întâmpinați vreo problemă, verificați [Depanare](/ro/developers/self-host/capabilities/troubleshooting) pentru soluții.
