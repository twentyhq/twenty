...
[application config](/ro/developers/extend/apps/config/application) posedă identitatea
...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.twenty.com/ro/developers/extend/apps',
...
[Testing](/ro/developers/extend/apps/operations/testing) şi
[Sincronizare şi Recuperare](/ro/developers/extend/apps/operations/sync-and-recovery).
...
[Publishing](/ro/developers/extend/apps/operations/publishing).
...
<CardGroup cols={2}>
  <Card title="Referință date" icon="database" href="/ro/developers/extend/apps/data/overview">
    Fiecare tip de câmp, relatie si optiune indice.
  </Card>
  <Card title="Referință logică" icon="bolt" href="/ro/developers/extend/apps/logic/overview">
    Cron and database-event triggers, the key-value store, OAuth connections.
  </Card>
  <Card title="Referință schemă" icon="table-columns" href="/ro/developers/extend/apps/layout/overview">
