...
Un [view](/ro/developers/extend/apps/layout/views) este o listă salvată a unui obiect dat.
Un [element meniu de navigare](/ro/developers/extend/apps/layout/navigation-menu-items)
introduce această vizualizare în bara laterală. Serverul creează deja automat pentru fiecare obiect vizualizarea implicită "All ...", astfel încât vizualizările pe care le definește o aplicație sunt unele suplimentare, selectate cu atenție.
...
O [componentă frontală](/ro/developers/extend/apps/layout/front-components) este o componentă React
...
Un [element meniu de comandă](/ro/developers/extend/apps/layout/command-menu-items) cu
...
Montaţi cu un [aspect de pagină](/ro/developers/extend/apps/layout/page-layouts). Un layout
...
Widgeturile `FIELD` acceptă și alte moduri de afișare și opțiuni, inclusiv
listarea înregistrărilor unei relații imbricate aflate la două salturi distanță — consultă
[referința pentru widgetul field](/ro/developers/extend/apps/layout/page-layouts#field-widgets).
