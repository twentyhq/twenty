...
Acum, nucleul: o [funcţie logică](/ro/developers/extend/apps/logic/logic-functions)
...
('test yarn:unit'). Vezi [Testing](/ro/developers/extend/apps/operations/testing).
</Tip>

## Gestionarul

Gestionarul folosește [`CoreApiClient`](/ro/developers/extend/apps/logic/logic-functions)
...
Vezi [Roles](/ro/developers/extend/apps/config/roles) pentru permisiunile cu bobul superior.
