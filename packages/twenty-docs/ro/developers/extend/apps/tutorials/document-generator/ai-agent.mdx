...
Un [skill](/ro/developers/extend/apps/logic/skills-and-agents) este reutilizabil
...
Un [agent](/ro/developers/extend/apps/logic/skills-and-agents) împerechează o recomandare cu un model
...
[capitolul 2](/ro/developers/extend/apps/tutorials/document-generator/generating-documents#grant-it-access).
</Note>
