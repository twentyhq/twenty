...
| ----------------------------------------------- | ----------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `dev`                                           | Monitorizează fișierele sursă și sincronizează în timp real modificările                  | [Ghid de pornire rapidă](/ro/developers/extend/apps/getting-started/quick-start)                              |
| `plan`                                          | Previzualizează modificările metadatelor fără a le aplica                                 | [Sincronizare și recuperare](/ro/developers/extend/apps/operations/sync-and-recovery#previewing-changes-plan) |
| `aplică`                                        | Aplică modificările metadatelor după afișarea planului                                    | [Sincronizare și recuperare](/ro/developers/extend/apps/operations/sync-and-recovery)                         |
| `dev:build`                                     | Compilează aplicația și generează clientul API (`--tarball` pentru a împacheta un `.tgz`) | [Publicare](/ro/developers/extend/apps/operations/publishing)                                                 |
| `dev:typecheck`                                 | Rulează verificarea tipurilor TypeScript                                                  | [Testare](/ro/developers/extend/apps/operations/testing)                                                      |
| `dev:add`                                       | Creează scheletul unei entități noi                                                       | [Generarea scheletului](/ro/developers/extend/apps/getting-started/scaffolding)                               |
...
| `dev:translations-extract`                      | Extrage șirurile traducibile în cataloagele din `locales/`                                | [Traduceri](/ro/developers/extend/apps/operations/translations)                                                 |
| `dev:catalog-sync`                              | Declanșează o sincronizare a catalogului marketplace-ului                                 | [Publicare](/ro/developers/extend/apps/operations/publishing#how-marketplace-discovery-works)                 |
| `app:publish` / `app:install` / `app:uninstall` | Ciclul de viață al lansărilor                                                             | [Publicare](/ro/developers/extend/apps/operations/publishing) și această pagină                               |
| `docker:*`                                      | Administrează containerul serverului Twenty local                                         | [Server local](/ro/developers/extend/apps/getting-started/local-server)                                       |
