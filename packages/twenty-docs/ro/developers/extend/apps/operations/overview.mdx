...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/ro/developers/extend/apps/operations/cli">
    Referință pentru `yarn twenty` — exec, logs, uninstall, remotes.
  </Card>
  <Card title="Sincronizare și recuperare" icon="compass" href="/ro/developers/extend/apps/operations/sync-and-recovery">
    Ce comandă și când, citirea diferențelor de sincronizare și o schemă de recuperare.
  </Card>
  <Card title="Testare" icon="flask" href="/ro/developers/extend/apps/operations/testing">
    Configurare Vitest, teste de integrare, verificare a tipurilor, flux de lucru CI.
  </Card>
  <Card title="Publicare" icon="upload" href="/ro/developers/extend/apps/operations/publishing">
