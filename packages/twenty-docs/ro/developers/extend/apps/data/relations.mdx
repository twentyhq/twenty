...
Puteți, de asemenea, să declarați o relație direct în [`defineObject`](/ro/developers/extend/apps/data/objects). Când este inline, omiteți `objectUniversalIdentifier` — este moștenit de la obiectul părinte:
