...
Toate modurile necesită o conexiune la distanță autentificată. Vezi [Sincronizare și recuperare](/ro/developers/extend/apps/operations/sync-and-recovery#previewing-changes-plan) pentru mai multe detalii despre `plan`.
...
Referință completă: [Concepte](/ro/developers/extend/apps/getting-started/concepts).
