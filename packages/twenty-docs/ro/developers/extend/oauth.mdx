...
| ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| Scripturi interne, automatizare                             | [Cheie API](/ro/developers/extend/api#authentication)                                              |
...
| Aplicație Twenty cu extensii UI                             | [Aplicații](/ro/developers/extend/apps/getting-started/quick-start) (OAuth este gestionat automat) |
