...
Pentru a primi date externe, consultați [Configurați un declanșator Webhook](/ro/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger).
