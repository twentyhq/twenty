...
<CardGroup cols={2}>
  <Card title="API-uri" icon="code" href="/ro/developers/extend/api">
    Conectați-vă programatic la Twenty
  </Card>
  <Card title="Webhook-uri" icon="bell" href="/ro/developers/extend/webhooks">
    Primiți notificări despre evenimente în timp real
  </Card>
  <Card title="Aplicații" icon="puzzle-piece" href="/ro/developers/extend/apps/getting-started/quick-start">
