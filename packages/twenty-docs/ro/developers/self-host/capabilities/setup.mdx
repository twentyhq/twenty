...
<Warning>
**Prima instalare?** Urmați [ghidul de instalare Docker Compose](/ro/developers/self-host/capabilities/docker-compose) pentru a rula Twenty, apoi reveniți aici pentru configurare.
</Warning>
...
Pentru a roti `ENCRYPTION_KEY` fără timp de nefuncționare, vezi [Ghidul de rotație a cheilor](/ro/developers/self-host/capabilities/key-rotation).
