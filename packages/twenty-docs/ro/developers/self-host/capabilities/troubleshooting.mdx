...
#### Eroare „Fișier negăsit” la testarea funcției Logic într-un flux de lucru.

Rulați comanda `yarn command:prod application:rebuild-default-deps` în containerul twenty-server pentru a remedia problema dependențelor lipsă.
