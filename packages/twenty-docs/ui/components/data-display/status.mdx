...
`Status` combines a colored dot, a text label, and an optional loader. Use it for workflow or record states. Use [Tag](/ui/components/data-display/tag) for a category without the status indicator.

<StoryEmbed storyId="ui-data-display-status--default" title="Status example" />
