...
<StoryEmbed
  title="Elevated icon action"
  storyId="ui-components-iconbutton--elevated"
  height={180}
/>
...
<StoryEmbed
  title="Elevated icon action with tooltip"
  storyId="ui-components-iconbutton--elevated-tooltip"
  height={180}
/>
