...
Use `LightButton` for a lightweight action. It composes
[Button](/ui/components/input/button) with a ghost surface, small size, regular
...
[ButtonGroup](/ui/components/input/button-group) can set a shared size, surface,
