...
The code editor has a separate entry point, `twenty-ui/code-editor`. Since 2.42.0, other components do not require Monaco. Earlier versions need `monaco-editor` even if you never render a code editor.
