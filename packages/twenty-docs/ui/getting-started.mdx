...
`monaco-editor` powers the code editor components, but install it even if you never render an editor: the `twenty-ui/primitives/input`, `twenty-ui/primitives/feedback`, and `twenty-ui/primitives/navigation` entry points reference it, and bundlers fail to resolve it otherwise.
...
[Button](/ui/components/input/button) interaction contract. Routing and page
...
Shared components combine primitives into design presets and reusable app building blocks. Import them from `twenty-ui/components`.
...
Foundational controls come from `twenty-ui/primitives` or its family subpaths. Each page includes usage examples, interaction guidance, and a generated API reference.

| Family       | Primitives                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Data display | [Avatar](/ui/components/data-display/avatar), [Chip](/ui/components/data-display/chip), [Tag](/ui/components/data-display/tag), [Status](/ui/components/data-display/status)                                                                                                                                                                                                                                                                                                                                      |
| Forms        | [Button](/ui/components/input/button), [ButtonGroup](/ui/components/input/button-group), [Field](/ui/components/input/field), [Input](/ui/components/input/input), [InputGroup](/ui/components/input/input-group), [Textarea](/ui/components/input/textarea), [Checkbox](/ui/components/input/checkbox), [Radio](/ui/components/input/radio), [RadioGroup](/ui/components/input/radio-group), [Select](/ui/components/input/select), [Slider](/ui/components/input/slider), [Switch](/ui/components/input/switch) |
