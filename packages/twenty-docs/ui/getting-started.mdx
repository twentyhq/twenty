...
The code editor has a separate entry point, `twenty-ui/components/code-editor`. Since 2.42.0, other components do not require Monaco. Earlier versions need `monaco-editor` even if you never render a code editor.

To use the code editor, install its optional peer dependencies and configure Monaco workers for your bundler before mounting it:
