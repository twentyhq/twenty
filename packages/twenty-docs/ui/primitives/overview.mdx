...
State belongs to the part that manages the interaction. Configure radio selection on [RadioGroup](/ui/primitives/input/radio-group), not on each Radio. Display components such as Text do not have a controlled or uncontrolled mode. [Toast](/ui/components/toast) delegates its visibility and removal to the application.
...
| Family        | Primitives                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Accessibility | [VisibilityHidden](/ui/primitives/accessibility/visibility-hidden)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| Data display  | [Avatar](/ui/primitives/data-display/avatar), [Chip](/ui/primitives/data-display/chip), [ColorSample](/ui/primitives/data-display/color-sample), [Pill](/ui/primitives/data-display/pill), [Status](/ui/primitives/data-display/status), [Tag](/ui/primitives/data-display/tag)                                                                                                                                                                                                                                                                                               |
| Feedback      | [Banner](/ui/primitives/feedback/banner), [CircularProgressBar](/ui/primitives/feedback/circular-progress-bar), [Loader](/ui/primitives/feedback/loader), [ProgressBar](/ui/primitives/feedback/progress-bar)                                                                                                                                                                                                                                                                                                                                                                 |
| Forms         | [Button](/ui/primitives/input/button), [ButtonGroup](/ui/primitives/input/button-group), [Checkbox](/ui/primitives/input/checkbox), [Field](/ui/primitives/input/field), [Input](/ui/primitives/input/input), [InputGroup](/ui/primitives/input/input-group), [Radio](/ui/primitives/input/radio), [RadioGroup](/ui/primitives/input/radio-group), [SegmentedControl](/ui/primitives/input/segmented-control), [Select](/ui/primitives/input/select), [Slider](/ui/primitives/input/slider), [Switch](/ui/primitives/input/switch), [Textarea](/ui/primitives/input/textarea) |
| Layout        | [AnimatedExpandableContainer](/ui/primitives/layout/animated-expandable-container), [HorizontalSeparator](/ui/primitives/layout/horizontal-separator), [ResizeHandle](/ui/primitives/layout/resize-handle), [TextDirectionProvider](/ui/primitives/layout/text-direction-provider)                                                                                                                                                                                                                                                                                            |
| Navigation    | [ClickToActionLink](/ui/primitives/navigation/click-to-action-link), [ListItem](/ui/primitives/navigation/list-item), [Tabs](/ui/primitives/navigation/tabs)                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Surfaces      | [AlertDialog](/ui/primitives/surfaces/alert-dialog), [Card](/ui/primitives/surfaces/card), [Dialog](/ui/primitives/surfaces/dialog), [Menu](/ui/primitives/surfaces/menu), [Popover](/ui/primitives/surfaces/popover), [Tooltip](/ui/primitives/surfaces/tooltip)                                                                                                                                                                                                                                                                                                             |
| Typography    | [Heading](/ui/primitives/typography/heading), [OverflowingTextWithTooltip](/ui/primitives/typography/overflowing-text-with-tooltip), [Text](/ui/primitives/typography/text)                                                                                                                                                                                                                                                                                                                                                                                                   |
