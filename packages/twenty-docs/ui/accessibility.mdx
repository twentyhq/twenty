...
Use [VisibilityHidden](/ui/primitives/accessibility/visibility-hidden) when supporting text should remain available to assistive technology without being displayed.
