...
[Referência do modelo de dados →](/pt/user-guide/data-model/overview)
...
[Guia de migração de dados →](/pt/user-guide/data-migration/overview)
...
<CardGroup cols={2}>
  <Card title="Conheça o layout" icon="table-columns" href="/pt/getting-started/core-concepts/layout">
    Navegação, vistas, menu de comandos, painel lateral.
  </Card>
  <Card title="Criar fluxos de trabalho" icon="bolt" href="/pt/user-guide/workflows/overview">
    Automatize seus processos de negócios.
  </Card>
  <Card title="Criar vistas" icon="table" href="/pt/user-guide/layout/overview">
    Tabela, kanban, calendário — filtre e ordene os seus dados.
  </Card>
  <Card title="Explorar a API" icon="plug" href="/pt/developers/extend/api">
