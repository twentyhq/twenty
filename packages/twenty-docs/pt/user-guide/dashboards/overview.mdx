...
* Gráficos de indicador ainda não estão disponíveis.
</Note>
...
* [Widgets e visualizações](/pt/user-guide/dashboards/capabilities/widgets)
* [Referência das configurações de gráfico](/pt/user-guide/dashboards/capabilities/chart-settings)
* [FAQ de painéis](/pt/user-guide/dashboards/how-tos/dashboards-faq)
