...
Campos de fórmula estão chegando em **H2 2026**. Enquanto isso, você pode usar fluxos de trabalho para calcular e atualizar valores de campos automaticamente.
</Accordion>

<Accordion title="Posso ter campos aninhados nos meus objetos?">
Campos aninhados estão vindo em **H2 2026**. Atualmente, você pode usar fluxos de trabalho para trazer valores de campos de objetos relacionados. Por exemplo, para exibir a indústria de uma empresa em um registro de Pessoa, crie um campo personalizado em Pessoas e use um fluxo de trabalho para sincronizar o valor.
</Accordion>

<Accordion title="Posso reordenar campos em objetos?">
Sim, vá para Configurações → Modelo de dados → objeto de sua escolha → Layout e clique em **Personalizar página de registro**. Se este botão estiver desativado, você deve criar um registro.
</Accordion>
</AccordionGroup>
...
Relações entre muitíssimas estão chegando em **H2 2026**. Atualmente, crie um objeto intermediário com dois relacionamentos de um-para-muitos como uma solução alternativa.
...
Saiba mais em [Campos de relação](/pt/user-guide/data-model/capabilities/relation-fields).
</Accordion>
...
Sim, você pode importar dados CSV para qualquer objeto, incluindo objetos personalizados. O processo de importação oferece suporte ao mapeamento de campos para campos personalizados. Consulte [Como preparar seus arquivos CSV](/pt/user-guide/data-migration/how-tos/prepare-your-csv-files).
</Accordion>
...
<Accordion title="Quantos campos um único objeto pode ter?">
O número máximo de campos que um único objeto pode ter é de 1600 campos como limites por Postgres, incluindo campos existentes e excluídos. Esteja ciente de que Vinte não vão consertar sua área de trabalho se o limite de 1600 campos for atingido, conforme se enquadra em nossa política de Uso Justo.
</Accordion>
</AccordionGroup>

## Precisa de mais ajuda?

Confira nossos [Serviços de implementação](/pt/user-guide/getting-started/capabilities/implementation-services) para obter ajuda com o design de modelos de dados complexos.
