...
3. Clique **+ Novo Campo**
4. Escolha um **tipo de campo** (consulte [Campos](/pt/user-guide/data-model/capabilities/fields) para ver todos os tipos)
...
<Note>
**Use nomes de API para importações.** Ative o **modo Avançado** em Definições para ver os nomes de API. Consulte [Mapeamento de Campos](/pt/user-guide/data-migration/capabilities/field-mapping).
</Note>
...
* [Campos](/pt/user-guide/data-model/capabilities/fields) — todos os tipos de campo explicados
