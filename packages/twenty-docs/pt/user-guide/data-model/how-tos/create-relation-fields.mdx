...
Veja [Campos de relação](/pt/user-guide/data-model/capabilities/relation-fields) para entender os tipos de relação.
...
* [Campos de relação](/pt/user-guide/data-model/capabilities/relation-fields) — tipos e limitações
* [Como importar relações](/pt/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) — importar em massa registros vinculados
