...
* [Campos de Relação](/pt/user-guide/data-model/capabilities/relation-fields) — tipos de relação explicados
* [Criar Objetos Personalizados](/pt/user-guide/data-model/how-tos/create-custom-objects) — como criar objetos
* [Criar Campos de Relação](/pt/user-guide/data-model/how-tos/create-relation-fields) — configuração básica de relação
