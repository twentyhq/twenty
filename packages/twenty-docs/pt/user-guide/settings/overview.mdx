...
→ [Guia completo de configuração de e-mail e calendário](/pt/user-guide/calendar-emails/overview)
...
* [Configurações do espaço de trabalho](/pt/user-guide/settings/capabilities/workspace-settings)
* [Configurações do perfil](/pt/user-guide/settings/capabilities/profile-settings)
* [Configurações de experiência](/pt/user-guide/settings/capabilities/experience-settings)
