...
* [Gatilhos de Fluxo de Trabalho](/pt/user-guide/workflows/capabilities/workflow-triggers)
* [Enviar e-mails a partir de Fluxos de Trabalho](/pt/user-guide/workflows/capabilities/send-emails-from-workflows)
* [Criar campos personalizados](/pt/user-guide/data-model/how-tos/create-custom-fields)
* [Criar campos de relação](/pt/user-guide/data-model/how-tos/create-relation-fields)
