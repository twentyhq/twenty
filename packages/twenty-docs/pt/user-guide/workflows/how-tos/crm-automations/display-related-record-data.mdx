...
<Note>
**Limitação de Tarefas e Notas**: As relações em Tarefas e Notas são pré-definidas como muitos-para-muitos e ainda não estão disponíveis em gatilhos ou ações de fluxos de trabalho. Para aceder a estas relações, use antes a [API](/pt/developers/extend/api).
</Note>
...
* [Ações de Fluxo de Trabalho](/pt/user-guide/workflows/capabilities/workflow-actions)
