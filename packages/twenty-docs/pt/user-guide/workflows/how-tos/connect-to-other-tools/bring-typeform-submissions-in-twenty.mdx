...
Para a configuração padrão de webhook, consulte [Configurar um gatilho de Webhook](/pt/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger). Este artigo aborda o tratamento específico necessário para a estrutura de carga útil personalizada do Typeform.
...
<Tip>
Para mais detalhes sobre como lidar com arrays, consulte [Tratar arrays em ações de código](/pt/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
...
* [Configurar um gatilho de Webhook](/pt/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger)
* [Lidar com arrays em ações de código](/pt/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions)
