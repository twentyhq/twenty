...
* [Gerar um PDF a partir do Twenty](/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — anexar PDFs gerados aos registros
...
* [Automações de Closed Won](/pt/user-guide/workflows/how-tos/crm-automations/closed-won-automations)
