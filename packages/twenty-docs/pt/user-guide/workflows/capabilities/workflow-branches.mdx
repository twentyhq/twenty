...
<Note>
Embora você possa usar um nó [Atraso](/pt/user-guide/workflows/capabilities/workflow-actions#delay) para pausar a execução, atualmente não é possível configurá-lo para esperar "até que outra ramificação termine".
</Note>

## Relacionados

* [Como usar ramificações em Fluxos de Trabalho](/pt/user-guide/workflows/capabilities/use-branches-in-workflows) - Guia passo a passo
* [Ações de Fluxo de Trabalho](/pt/user-guide/workflows/capabilities/workflow-actions) - Ações disponíveis, incluindo Filtro
