...
* [Perguntas frequentes sobre fluxos de trabalho](/pt/user-guide/workflows/how-tos/need-more-help/workflows-faq) — respostas sobre execução paralela
* [Ações de Fluxo de Trabalho](/pt/user-guide/workflows/capabilities/workflow-actions) — ações disponíveis para ramificações
