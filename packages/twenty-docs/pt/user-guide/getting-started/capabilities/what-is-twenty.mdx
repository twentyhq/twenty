...
* **Calendário e E-mails:** Sincronize sua caixa de entrada e calendário para ver todas as comunicações nos seus registros do CRM. [Saiba mais](/pt/user-guide/calendar-emails/overview).
* **Modelo de Dados:** Crie objetos e campos personalizados para atender aos seus processos de negócios específicos. [Explorar](/pt/user-guide/data-model/overview).
* **Migração de Dados:** Importe e exporte seus dados via CSV ou API. [Comece](/pt/user-guide/data-migration/overview).
* **Visualizações e Pipelines:** Organize seus dados com visualizações em tabela, quadros kanban e pipelines de vendas. [Descubra](/pt/user-guide/views-pipelines/overview).
* **Fluxos de Trabalho:** Automatize seus processos de negócios e integre com ferramentas externas. [Crie automações](/pt/user-guide/workflows/overview).
* **IA:** Aprimore seu CRM com recursos e agentes com tecnologia de IA. [Explorar IA](/pt/user-guide/ai/overview).
* **Painéis:** Acompanhe o desempenho com relatórios personalizados e visualizações personalizadas. [Ver painéis](/pt/user-guide/dashboards/overview).
* **Permissões e Acesso:** Controle quem pode visualizar, editar e gerenciar seus dados com permissões baseadas em funções. [Configurar acesso](/pt/user-guide/permissions-access/overview).
* **Notas e Tarefas:** Crie notas e tarefas vinculadas aos seus registros para uma melhor colaboração.
* **API e Webhooks:** Conecte-se a outros aplicativos e crie integrações personalizadas. [Comece a integrar](/pt/developers/extend/api).
