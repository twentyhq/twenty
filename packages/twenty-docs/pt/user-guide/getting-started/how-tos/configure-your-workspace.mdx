...
Leia [este artigo](/pt/user-guide/data-model/overview) para aprender como projetar seu modelo de dados.
...
Leia [este artigo](/pt/user-guide/data-migration/overview) para saber mais sobre importação de dados.
...
Comece a criar automações usando [workflows](/pt/user-guide/workflows/overview).
