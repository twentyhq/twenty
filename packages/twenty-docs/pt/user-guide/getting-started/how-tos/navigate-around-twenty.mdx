...
Se você é novo em Visualizações, leia nosso [Guia de Visualizações e Pipelines](/pt/user-guide/views-pipelines/overview) para aprender a criá-las e personalizá-las.
...
<Note>Se você não ver todas essas seções nas Configurações, entre em contato com o administrador do seu espaço de trabalho — algumas seções têm acesso restrito.</Note>
