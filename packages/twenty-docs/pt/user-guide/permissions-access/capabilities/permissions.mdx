...
<Note>
Você só pode atribuir funções a membros existentes do espaço de trabalho. Para convidar novos membros, use [Gestão de Membros](/pt/user-guide/settings/capabilities/member-management).
</Note>
