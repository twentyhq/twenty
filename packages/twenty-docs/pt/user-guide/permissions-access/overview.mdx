...
<CardGroup cols={2}>
  <Card title="Permissões" icon="lock" href="/pt/user-guide/permissions-access/capabilities/permissions">
    Crie funções e configure permissões de objetos, campos e configurações.
  </Card>
  <Card title="Configuração do SSO" icon="key" href="/pt/user-guide/permissions-access/capabilities/sso-configuration">
    Configure o Single Sign-On com o seu provedor de identidade.
  </Card>
  <Card title="FAQ" icon="circle-question" href="/pt/user-guide/permissions-access/how-tos/permissions-faq">
...
* [Crie uma função](/pt/user-guide/permissions-access/capabilities/permissions#create-a-role)
* [Configure o SSO](/pt/user-guide/permissions-access/capabilities/sso-configuration)
* [Gerencie os membros da equipe](/pt/user-guide/settings/capabilities/member-management)
