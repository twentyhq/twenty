...
* [Campos e colunas](/pt/user-guide/views-pipelines/capabilities/fields-and-columns) — configurando quais campos exibir
* [Filtros e ordenação](/pt/user-guide/views-pipelines/capabilities/filters-and-sorting) — restringindo os registros
