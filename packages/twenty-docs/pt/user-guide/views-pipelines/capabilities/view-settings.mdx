...
* [Visão geral de visualizações](/pt/user-guide/views-pipelines/overview) — criação de visualizações
* [Como restringir o acesso](/pt/user-guide/views-pipelines/how-tos/restrict-access-to-your-view) — guia passo a passo
