...
| Número           | Igual a, Maior que, Menor que, Está vazio            |
| Data             | Igual a, Antes de, Depois de, Está vazio             |
...
* [Visualizações de Tabela](/pt/user-guide/views-pipelines/capabilities/table-views) — recurso Agrupar por
