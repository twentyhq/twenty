...
* [Visualizações de Tabela](/pt/user-guide/views-pipelines/capabilities/table-views) — recursos da visualização de lista
* [Visualizações Kanban](/pt/user-guide/views-pipelines/capabilities/kanban-views) — visualizações baseadas em cartões
