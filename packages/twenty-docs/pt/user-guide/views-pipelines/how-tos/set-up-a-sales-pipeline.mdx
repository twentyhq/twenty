...
* [Visualizações Kanban](/pt/user-guide/views-pipelines/capabilities/kanban-views) — agregações e visualização compacta
* [Filtros e Ordenação](/pt/user-guide/views-pipelines/capabilities/filters-and-sorting) — criando visualizações filtradas
