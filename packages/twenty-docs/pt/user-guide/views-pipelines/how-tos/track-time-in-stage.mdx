...
<Tip>
Este é um exemplo de criação de [Campos de fórmula](/pt/user-guide/workflows/how-tos/crm-automations/formula-fields) usando fluxos de trabalho — especificamente cálculos de datas.
</Tip>
...
Como esta é a primeira etapa, apenas o carimbo de data e hora de entrada é registrado — não há etapa anterior a partir da qual calcular.
...
* [Workflows](/pt/user-guide/workflows/overview) — noções básicas de automação
* [Como criar campos personalizados](/pt/user-guide/data-model/how-tos/create-custom-fields) — configuração de campos
* [Visualizações de Kanban](/pt/user-guide/views-pipelines/capabilities/kanban-views) — agregações
