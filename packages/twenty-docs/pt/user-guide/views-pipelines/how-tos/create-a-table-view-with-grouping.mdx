...
* [Visualizações de Tabela](/pt/user-guide/views-pipelines/capabilities/table-views) — todos os recursos da visualização de tabela
* [Filtros e ordenação](/pt/user-guide/views-pipelines/capabilities/filters-and-sorting) — combine o agrupamento com filtros
