...
* [Visualizações Kanban](/pt/user-guide/views-pipelines/capabilities/kanban-views) — agregações, visualização compacta, etapas
* [Como configurar um pipeline de vendas](/pt/user-guide/views-pipelines/how-tos/set-up-a-sales-pipeline) — Kanban para oportunidades
