...
<Tip>
Este é um exemplo de criação de [Campos de fórmula](/pt/user-guide/workflows/how-tos/crm-automations/formula-fields) usando fluxos de trabalho.
</Tip>
...
* [Campos de fórmula](/pt/user-guide/workflows/how-tos/crm-automations/formula-fields) — crie campos calculados usando fluxos de trabalho
* [Visualizações de Kanban](/pt/user-guide/views-pipelines/capabilities/kanban-views) — agregações por coluna
