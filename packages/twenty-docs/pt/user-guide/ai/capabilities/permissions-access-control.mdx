...
* [Permissões](/pt/user-guide/permissions-access/capabilities/permissions) — informações detalhadas sobre como criar e gerenciar funções
* [Agentes de IA](/pt/user-guide/ai/capabilities/ai-agents) — recursos de IA em fluxos de trabalho
