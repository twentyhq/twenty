...
<CardGroup cols={2}>
  <Card title="Planos de preços" icon="tags" href="/pt/user-guide/billing/capabilities/pricing-plans">
    Saiba mais sobre os planos de preços da Twenty e o que está incluído.
  </Card>
  <Card title="Perguntas frequentes" icon="circle-question" href="/pt/user-guide/billing/how-tos/billing-faq">
...
Para mais perguntas, consulte as [Perguntas frequentes sobre cobrança](/pt/user-guide/billing/how-tos/billing-faq).
