...
<Note>Para conjuntos de dados muito grandes (centenas de milhares de registos), utilize a API. Os nossos [parceiros de implementação](/pt/user-guide/getting-started/capabilities/implementation-services) podem ajudar a executar estes scripts, se necessário.</Note>
...
Consulte [este artigo](/pt/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) para um guia passo a passo sobre como proceder.
...
* [Prepare os seus ficheiros CSV](/pt/user-guide/data-migration/how-tos/prepare-your-csv-files)
* [Importar relações entre objetos](/pt/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv)
* [Importar via API para conjuntos de dados de grande dimensão](/pt/user-guide/data-migration/how-tos/import-data-via-api)
