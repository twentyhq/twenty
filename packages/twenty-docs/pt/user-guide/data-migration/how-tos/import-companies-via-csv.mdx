...
<Note>
Precisa de importar mais de 10 000 empresas? Divida em vários ficheiros ou use a [importação via API](/pt/user-guide/data-migration/how-tos/import-data-via-api).
</Note>
...
1. **[Importar Pessoas](/pt/user-guide/data-migration/how-tos/import-contacts-via-csv)** — ligue-as a Empresas utilizando o domínio
...
Veja [Como Atualizar Registos Existentes](/pt/user-guide/data-migration/how-tos/update-existing-records-via-import) para obter detalhes.
...
* [Como Corrigir Erros de Importação](/pt/user-guide/data-migration/how-tos/fix-import-errors)
* [Referência de Mapeamento de Campos](/pt/user-guide/data-migration/capabilities/field-mapping)
