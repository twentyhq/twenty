...
Veja [Como importar relações](/pt/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) para detalhes sobre a manutenção das relações.
...
<Tip>
  Migrando um espaço de trabalho grande ou complexo? [Encontre um parceiro Twenty certificado](https://twenty.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) para cuidar da migração de ponta a ponta. *(Ou envolva a nossa equipe: [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
