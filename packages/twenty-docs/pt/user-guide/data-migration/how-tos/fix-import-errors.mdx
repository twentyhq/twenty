...
Para mais detalhes: [Restrições de Unicidade](/pt/user-guide/data-migration/capabilities/uniqueness-constraints)
...
Para referência completa de formatos: [Referência de Mapeamento de Campos](/pt/user-guide/data-migration/capabilities/field-mapping)
...
Para mais detalhes: [Importação de Relações](/pt/user-guide/data-migration/capabilities/import-relations)
...
Consulte: [Como Importar Dados via API](/pt/user-guide/data-migration/how-tos/import-data-via-api)
...
4. **Consulte os artigos de referência:**
   * [Mapeamento de Campos](/pt/user-guide/data-migration/capabilities/field-mapping)
   * [Restrições de Unicidade](/pt/user-guide/data-migration/capabilities/uniqueness-constraints)
   * [Importação de Relações](/pt/user-guide/data-migration/capabilities/import-relations)
   * [Tratamento de Erros](/pt/user-guide/data-migration/capabilities/error-handling)
