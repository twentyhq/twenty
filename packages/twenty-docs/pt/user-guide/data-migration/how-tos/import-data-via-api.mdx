...
| ----------- | ------------------------------------------------------------------------ | --------------------------------------------- |
| **GraphQL** | Consultas flexíveis, obtenção de dados relacionados, operações complexas | [Documentação da API](/pt/developers/extend/api) |
| **REST**    | Operações CRUD simples, padrões REST familiares                          | [Documentação da API](/pt/developers/extend/api) |
...
* Verifique se os formatos correspondem aos requisitos da Twenty (veja [Mapeamento de Campos](/pt/user-guide/data-migration/capabilities/field-mapping))
...
Contacte-nos em [contact@twenty.com](mailto:contact@twenty.com) ou explore os nossos [Serviços de Implementação](/pt/user-guide/getting-started/capabilities/implementation-services).
...
* [Documentação da API](/pt/developers/extend/api)
