...
<Note>Para conjuntos de dados maiores que 10.000 registros, divida em vários arquivos ou use a [importação via API](/pt/user-guide/data-migration/how-tos/import-data-via-api).</Note>
...
Veja [Como importar relações](/pt/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) para instruções detalhadas.
...
* [Importar Empresas](/pt/user-guide/data-migration/how-tos/import-companies-via-csv) (importe-as primeiro)
* [Importar Contatos](/pt/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [Corrigir quaisquer erros de importação](/pt/user-guide/data-migration/how-tos/fix-import-errors)
