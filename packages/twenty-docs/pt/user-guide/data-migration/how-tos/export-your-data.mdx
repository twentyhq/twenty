...
<Note>Para exportações maiores (20,000+ registros), use filtros para exportar em lotes ou use a [API](/pt/developers/extend/api).</Note>
...
4. Reimporte para atualizar os registros
   Veja: [Como Atualizar Registros Existentes](/pt/user-guide/data-migration/how-tos/update-existing-records-via-import)
...
Veja: [Documentação da API](/pt/developers/extend/api)
...
* [Como Atualizar Registros Existentes](/pt/user-guide/data-migration/how-tos/update-existing-records-via-import) — edite e reimporte sua exportação
* [Como Importar Dados via API](/pt/user-guide/data-migration/how-tos/import-data-via-api) — para conjuntos de dados grandes
* [Documentação da API](/pt/developers/extend/api) — crie fluxos de trabalho de exportação personalizados
