...
**Nota**: Para conectar seu calendário e configurar as configurações de sincronização, visite [Configuração de Email & Calendário](/pt/user-guide/calendar-emails/overview).
