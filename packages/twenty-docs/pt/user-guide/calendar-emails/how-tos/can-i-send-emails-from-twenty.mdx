...
→ Saiba mais sobre a [ação Enviar e-mail](/pt/user-guide/workflows/capabilities/workflow-actions#send-email)
...
→ Consulte [Como enviar e-mails a partir de Fluxos de Trabalho](/pt/user-guide/workflows/capabilities/send-emails-from-workflows) para obter instruções de configuração
