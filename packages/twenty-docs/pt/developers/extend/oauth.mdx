...
| -------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| Scripts internos, automatização                    | [Chave de API](/pt/developers/extend/api#authentication)                                               |
...
| Aplicação Twenty com extensões de UI               | [Aplicações](/pt/developers/extend/apps/getting-started/quick-start) (OAuth é tratado automaticamente) |
