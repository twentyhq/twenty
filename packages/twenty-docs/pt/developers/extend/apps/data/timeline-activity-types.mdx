...
Criar eventos explícitos com [`createTimelineActivity()`](/pt/developers/extend/apps/logic/logic-functions#create-a-timeline-activity). O código do aplicativo usa identificadores universais estáveis; Vinte resolvem os IDs de metadados específicos de instalação.
...
| `name`                                            | Sim         | Nome programático local do aplicativo; deve ser exclusivo dentro do aplicativo       |
