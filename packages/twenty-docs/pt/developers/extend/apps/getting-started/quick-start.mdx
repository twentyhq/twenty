...
Todos os modos precisam de um remoto autenticado. Veja [Sincronização e recuperação](/pt/developers/extend/apps/operations/sync-and-recovery#previewing-changes-plan) para mais detalhes sobre `plan`.
...
Referência completa: [Conceitos](/pt/developers/extend/apps/getting-started/concepts).
...
<CardGroup cols={2}>
  ...
  <Card title="Data" icon="database" href="/pt/developers/extend/apps/data/overview">
