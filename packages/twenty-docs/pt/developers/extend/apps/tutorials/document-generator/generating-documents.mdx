...
Agora o núcleo: uma [função lógica](/pt/developers/extend/apps/logic/logic-functions)
...
(`yarn test:unit`). Ver [Testing](/pt/developers/extend/apps/operations/testing).
</Tip>

## O manipulador

O manipulador usa o [`CoreApiClient`](/pt/developers/extend/apps/logic/logic-functions)
...
Ver [Roles](/pt/developers/extend/apps/config/roles) para permissões refinadas.
