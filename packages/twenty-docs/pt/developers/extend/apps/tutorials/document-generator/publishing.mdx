...
A [aplicação config](/pt/developers/extend/apps/config/application) transporta a identidade
...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.twenty.com/pt/developers/extend/apps',
...
[Testing](/pt/developers/extend/apps/operations/testing) e
[Sincronização e recuperação](/pt/developers/extend/apps/operations/sync-and-recovery).
...
[Publishing](/pt/developers/extend/apps/operations/publishing).
...
<CardGroup cols={2}>
  <Card title="Referência de dados" icon="database" href="/pt/developers/extend/apps/data/overview">
    Todos os tipos de campo, relação e opção de índice.
  </Card>
  <Card title="Referência lógica" icon="bolt" href="/pt/developers/extend/apps/logic/overview">
    Gatilhos Cron e database-event trigers, a loja chave-valor, conexões OAuth
  </Card>
  <Card title="Referência do layout" icon="table-columns" href="/pt/developers/extend/apps/layout/overview">
    Layouts da página, widgets do painel e mais superfícies da UI.
  </Card>
  <Card title="Operações" icon="rocket" href="/pt/developers/extend/apps/operations/overview">
