...
A [skill](/pt/developers/extend/apps/logic/skills-and-agents) é reutilizável
...
Um [agent](/pt/developers/extend/apps/logic/skills-and-agents) emparelha um prompt com um modelo
...
[Capítulo 2](/pt/developers/extend/apps/tutorials/document-generator/generating-documents#grant-it-access).
</Note>
