...
A [view](/pt/developers/extend/apps/layout/views) é uma lista salva de um determinado objeto.
Um [item de menu de navegação](/pt/developers/extend/apps/layout/navigation-menu-items)
...
A [front component](/pt/developers/extend/apps/layout/front-components) é um componente React
...
Um [item de menu de comando](/pt/developers/extend/apps/layout/command-menu-items) com
...
Monte-o com um [layout da página](/pt/developers/extend/apps/layout/page-layouts). Um
...
[referência do widget de campo](/pt/developers/extend/apps/layout/page-layouts#field-widgets).
