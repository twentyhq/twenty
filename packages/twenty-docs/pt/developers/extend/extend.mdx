...
<CardGroup cols={2}>
  <Card title="APIs" icon="code" href="/pt/developers/extend/api">
    Conecte-se ao Twenty programaticamente
  </Card>
  <Card title="Webhooks" icon="bell" href="/pt/developers/extend/webhooks">
    Receba notificações de eventos em tempo real
  </Card>
  <Card title="Aplicativos" icon="puzzle-piece" href="/desenvolvedores/estend/apps/getting-started/quick-start">
