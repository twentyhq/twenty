...
Use variáveis de ambiente ou arquivos `.env` para configurar seu projeto. Mais informações [aqui](/pt/developers/self-host/capabilities/setup).
...
Se encontrar algum problema, verifique [Resolução de Problemas](/pt/developers/self-host/capabilities/troubleshooting) para soluções.
