...
<CardGroup cols={2}>
  <Card title="Relatos de bugs e solicitações" icon="bug" href="/pt/developers/contribute/capabilities/bug-and-requests">
    Relate problemas ou solicite funcionalidades
  </Card>
  <Card title="Desenvolvimento Frontend" icon="browser" href="/desenvolvedores/contribuir/recursos/frontend-development/folder-architecture-front">
    Contribua para a UI
  </Card>
</CardGroup>
