...
<CardGroup cols={2}>
  <Card title="APIs" icon="code" href="/es/developers/extend/api">
    Conéctate a Twenty de forma programática
  </Card>
  <Card title="Webhooks" icon="bell" href="/es/developers/extend/webhooks">
    Recibe notificaciones de eventos en tiempo real
  </Card>
  <Card title="Aplicaciones" icon="puzzle-piece" href="/es/developers/extend/apps/getting-started/quick-start">
