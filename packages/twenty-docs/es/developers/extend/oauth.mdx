...
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| Scripts internos, automatización                     | [Clave de API](/es/developers/extend/api#authentication)                                                   |
...
| Aplicación de Twenty con extensiones de UI           | [Aplicaciones](/es/developers/extend/apps/getting-started/quick-start) (OAuth se gestiona automáticamente) |
