...
Para recibir datos externos, consulta [Configurar un disparador de webhook](/es/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger).
