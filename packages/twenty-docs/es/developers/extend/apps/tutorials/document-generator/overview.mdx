...
| ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| [1. Modelo de datos](/es/developers/extend/apps/tutorials/document-generator/data-model)                       | Objetos, campos y una relación                                                                                                  | [Data](/es/developers/extend/apps/data/overview)                            |
| [2. Generando documentos](/es/developers/extend/apps/tutorials/document-generator/generating-documents)        | Una función lógica (herramienta (AI + acción de flujo de trabajo) que rellena una plantilla de Markdown y adjunta un PDF pulido | [Funciones lógicas](/es/developers/extend/apps/logic/logic-functions)       |
| [3. Rutas HTTP](/es/developers/extend/apps/tutorials/document-generator/http-routes)                           | Ejecutando JSON y una página HTML compartible desde rutas                                                                       | [Funciones lógicas](/es/developers/extend/apps/logic/logic-functions)       |
| [4. Construir la interfaz de usuario](/es/developers/extend/apps/tutorials/document-generator/building-the-ui) | Vistas, navegación, menú de comandos y componentes frontales que previsualizan un documento y editan una plantilla              | [Diseño](/es/developers/extend/apps/layout/overview)                        |
| [5. An AI agent](/es/developers/extend/apps/tutorials/document-generator/ai-agent)                             | Agente + habilidad                                                                                                              | [Habilidades y agentes](/es/developers/extend/apps/logic/skills-and-agents) |
| [6. Publicación](/es/developers/extend/apps/tutorials/document-generator/publishing)                           | Envíalo al mercado                                                                                                              | [Publicación](/es/developers/extend/apps/operations/publishing)             |

## Prerrequisitos

Deberías haber terminado el [Inicio rápido](/es/developers/extend/apps/getting-started/quick-start):
