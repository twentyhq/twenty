...
Una [skill](/es/developers/extend/apps/logic/skills-and-agents) es reutilizable
...
Un [agent](/es/developers/extend/apps/logic/skills-and-agents) empareja un símbolo de espera de órdenes con un modelo
...
[Capítulo 2](/es/developers/extend/apps/tutorials/document-generator/generating-documents#grant-it-access).
</Note>
