...
Ahora el núcleo: una [función lógica](/es/developers/extend/apps/logic/logic-functions)
...
(`yarn test:unit`). Ver [Testing](/es/developers/extend/apps/operations/testing).
</Tip>

## El manejador

El manejador utiliza el [`CoreApiClient`](/es/developers/extend/apps/logic/logic-functions)
...
Ver [Roles](/es/developers/extend/apps/config/roles) para obtener permisos más finos.
