...
Una [view](/es/developers/extend/apps/layout/views) es una lista guardada de un objeto dado.
Un [elemento del menú de navegación](/es/developers/extend/apps/layout/navigation-menu-items)
...
Un [componente delantero](/es/developers/extend/apps/layout/front-components) es un componente de React
...
Un [elemento del menú de comandos](/es/developers/extend/apps/layout/command-menu-items) con
...
Montarlo con un [diseño de página](/es/developers/extend/apps/layout/page-layouts). Un diseño de
...
[referencia del widget de campo](/es/developers/extend/apps/layout/page-layouts#field-widgets).
