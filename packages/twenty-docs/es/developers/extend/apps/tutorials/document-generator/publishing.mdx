...
La [configuración de la aplicación](/es/developers/extend/apps/config/application) lleva los enlaces
...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.twenty.com/es/developers/extend/apps',
...
[Testing](/es/developers/extend/apps/operations/testing) y
[Sincronizando y recuperando](/es/developers/extend/apps/operations/sync-and-recovery).
...
[Publishing](/es/developers/extend/apps/operations/publishing).
...
<CardGroup cols={2}>
  <Card title="Referencia de datos" icon="database" href="/es/developers/extend/apps/data/overview">
    Cada tipo de campo, relación y opción de índice.
  </Card>
  <Card title="Referencia lógica" icon="bolt" href="/es/developers/extend/apps/logic/overview">
    Activadores de eventos Cron y base de datos, el almacén clave-valor, conexiones OAuth.
  </Card>
  <Card title="Referencia del diseño" icon="table-columns" href="/es/developers/extend/apps/layout/overview">
