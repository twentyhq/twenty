...
Un **elemento del menú de navegación** es una entrada en la barra lateral izquierda. Usa `defineNavigationMenuItem()` para distribuir enlaces personalizados en la barra lateral — normalmente uno por cada [vista](/es/developers/extend/apps/layout/views) que publiques — o para apuntar a URL externas.
