...
<CardGroup cols={2}>
  <Card title="Informes de errores y solicitudes" icon="bug" href="/es/developers/contribute/capabilities/bug-and-requests">
    Reporta problemas o solicita funcionalidades
  </Card>
  <Card title="Desarrollo Frontend" icon="browser" href="/es/developers/contribute/capabilities/frontend-development/folder-architecture-front">
