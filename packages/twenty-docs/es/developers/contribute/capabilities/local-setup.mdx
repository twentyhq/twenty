...
Usa variables de entorno o archivos `.env` para configurar tu proyecto. Más información [aquí](/es/developers/self-host/capabilities/setup).
...
Si encuentras algún problema, consulta [Solución de Problemas](/es/developers/self-host/capabilities/troubleshooting) para ver soluciones.
