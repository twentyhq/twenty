...
Si eres nuevo en las Vistas, lee nuestra [guía de Vistas y canalizaciones](/es/user-guide/views-pipelines/overview) para aprender cómo crearlas y personalizarlas.
...
<Note>Si no ves todas esas secciones en Configuración, contacta a tu administrador del espacio de trabajo — algunas secciones tienen acceso restringido.</Note>
