...
**Nota**: Para conectar sus cuentas de correo electrónico y configurar los ajustes de sincronización, visite [Configuración de Correo Electrónico y Calendario](/es/user-guide/calendar-emails/overview).
...
* **Correos electrónicos internos**: De forma predeterminada, los correos entre colegas (mismo dominio) permanecen privados (configurado en Ajustes → General → Seguridad)
