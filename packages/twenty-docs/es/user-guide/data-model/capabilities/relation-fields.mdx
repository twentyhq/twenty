...
Consulta [Cómo crear relaciones de muchos a muchos](/es/user-guide/data-model/how-tos/create-many-to-many-relations) para obtener una guía completa paso a paso.
