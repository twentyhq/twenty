...
<Note>
Solo puedes asignar roles a miembros existentes del espacio de trabajo. Para invitar a nuevos miembros, utiliza [Gestión de Miembros](/es/user-guide/settings/capabilities/member-management).
</Note>
...
<Note>
Los permisos a nivel de fila son una **función Premium** disponible en el plan **Organization** (en la nube y autoalojado).
</Note>

Los permisos a nivel de fila permiten restringir qué registros individuales puede ver o editar un rol, en función de criterios dinámicos. A diferencia de los permisos de objeto (que se aplican a un tipo de objeto completo), los permisos a nivel de fila evalúan cada registro de forma independiente.

**Casos de uso de ejemplo:**

* Los representantes de ventas solo pueden ver sus propias oportunidades
* Los gerentes pueden ver todos los registros de su región
* Los agentes de soporte solo pueden ver los tickets que les han sido asignados

Para configurar los permisos a nivel de fila, abre un rol, ve a la pestaña **Objetos** y usa la sección **Nivel de fila** para definir condiciones de filtro para un objeto específico.
