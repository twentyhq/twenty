...
<CardGroup cols={2}>
  <Card title="Permisos" icon="lock" href="/es/user-guide/permissions-access/capabilities/permissions">
    Crea roles y configura permisos de objetos, campos y configuración.
  </Card>
  <Card title="Configuración de SSO" icon="key" href="/es/user-guide/permissions-access/capabilities/sso-configuration">
    Configura el inicio de sesión único (SSO) con tu proveedor de identidad.
  </Card>
  <Card title="Preguntas frecuentes" icon="circle-question" href="/es/user-guide/permissions-access/how-tos/permissions-faq">
...
* [Crea un rol](/es/user-guide/permissions-access/capabilities/permissions#create-a-role)
* [Configurar SSO](/es/user-guide/permissions-access/capabilities/sso-configuration)
* [Administrar miembros del equipo](/es/user-guide/settings/capabilities/member-management)
