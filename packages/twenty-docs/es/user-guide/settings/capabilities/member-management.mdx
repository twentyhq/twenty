...
→ [Más información sobre roles y permisos](/es/user-guide/permissions-access/capabilities/permissions)
...
* [Permisos](/es/user-guide/permissions-access/capabilities/permissions) — configura lo que cada rol puede hacer
* [Configuración del dominio](/es/user-guide/settings/capabilities/domains-settings) — configurar los dominios aprobados
