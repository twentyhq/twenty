...
* **Bulk**: El flujo de trabajo se ejecutará una vez, proporcionando la lista completa de registros como entrada. Esto significa que el flujo de trabajo debe contener una [Acción Iterator](/es/user-guide/workflows/capabilities/workflow-actions#iterator).
