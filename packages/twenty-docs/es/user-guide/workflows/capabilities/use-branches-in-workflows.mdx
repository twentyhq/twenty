...
* [Preguntas frecuentes sobre flujos de trabajo](/es/user-guide/workflows/how-tos/need-more-help/workflows-faq) — respuestas sobre la ejecución en paralelo
* [Acciones de flujos de trabajo](/es/user-guide/workflows/capabilities/workflow-actions) — acciones disponibles para las ramas
