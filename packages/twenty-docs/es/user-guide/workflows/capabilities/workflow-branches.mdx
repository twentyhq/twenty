...
<Note>
Aunque puedes usar un nodo [Delay](/es/user-guide/workflows/capabilities/workflow-actions#delay) para pausar la ejecución, actualmente no se puede configurar para esperar "hasta que otra rama termine".
</Note>

## Relacionado

* [Cómo usar las ramas en flujos de trabajo](/es/user-guide/workflows/capabilities/use-branches-in-workflows) - Guía paso a paso
* [Acciones de flujo de trabajo](/es/user-guide/workflows/capabilities/workflow-actions) - Acciones disponibles, incluyendo Filter
