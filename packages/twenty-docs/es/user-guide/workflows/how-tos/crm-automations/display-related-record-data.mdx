...
<Note>
**Limitación de Tareas y Notas**: Las relaciones en Tareas y Notas están codificadas como de muchos a muchos y aún no están disponibles en los desencadenantes o acciones de flujos de trabajo. Para acceder a estas relaciones, usa la [API](/es/developers/extend/api).
</Note>
...
* [Acciones de flujos de trabajo](/es/user-guide/workflows/capabilities/workflow-actions)
