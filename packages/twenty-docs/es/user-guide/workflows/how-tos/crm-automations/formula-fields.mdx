...
<Tip>
Para ver un ejemplo completo de seguimiento del tiempo en etapas del pipeline, consulta [Cuánto tiempo permanecen las oportunidades en cada etapa](/es/user-guide/views-pipelines/how-tos/track-time-in-stage).
</Tip>
...
Consulta [Cómo mostrar el importe esperado en el pipeline](/es/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline) para ver el flujo de trabajo completo.
...
* [Cómo mostrar el importe esperado en el pipeline](/es/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline)
* [Cómo realizar el seguimiento del tiempo en la etapa](/es/user-guide/views-pipelines/how-tos/track-time-in-stage)
