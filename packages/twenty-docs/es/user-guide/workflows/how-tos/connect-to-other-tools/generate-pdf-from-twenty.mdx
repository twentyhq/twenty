...
Reemplace `targetCompanyId` por el campo correspondiente:

| Objeto               | Nombre del campo           |
| -------------------- | -------------------------- |
| Empresa              | `targetCompanyId`          |
| Persona              | `targetPersonId`           |
| Oportunidad          | `targetOpportunityId`      |
...
2. Pase la URL de PDF devuelta a la función de lógica como parámetro
...
* [Disparadores de flujos de trabajo](/es/user-guide/workflows/capabilities/workflow-triggers)
* [Funciones de lógica](/es/user-guide/workflows/capabilities/workflow-actions#code)
* [Generar una cotización o factura desde Twenty](/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-twenty)
