...
* [Generar un PDF desde Twenty](/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — adjuntar los PDF generados a los registros
...
* [Automatizaciones de Cerrado ganado](/es/user-guide/workflows/how-tos/crm-automations/closed-won-automations)
