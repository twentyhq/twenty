...
Para la configuración estándar de webhooks, consulta [Configurar un disparador de Webhook](/es/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger). Este artículo cubre el manejo específico requerido para la estructura de carga útil personalizada de Typeform.
...
<Tip>
Para más detalles sobre cómo manejar arreglos en acciones de código, consulta [Cómo manejar arreglos en acciones de código](/es/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
...
* [Configurar un disparador de Webhook](/es/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger)
* [Manejar arreglos en acciones de código](/es/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions)
