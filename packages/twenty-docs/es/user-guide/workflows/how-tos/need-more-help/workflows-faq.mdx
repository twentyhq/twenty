...
<AccordionGroup>
  ...
  <Accordion title="¿Por qué no puedo activar un flujo de trabajo?">
    ...
    **Solución**: Ponte en contacto con el administrador de tu espacio de trabajo para que te conceda acceso a flujos de trabajo en **Configuración → Miembros → Roles**.
  ...
  <Accordion title="¿Cuál es la diferencia entre los disparadores manuales Single, Global y Bulk?">
    ...
    * **Bulk**: Úsalo cuando necesites procesar registros en conjunto u optimizar el uso de créditos (requiere la acción Iterator)
    ...
    Consulta [Disparadores de flujos de trabajo](/es/user-guide/workflows/capabilities/workflow-triggers) para más detalles.
  </Accordion>
  ...
  <Accordion title="No veo un nodo If/Else. ¿Qué debo hacer?">
    ...
    **Solución provisional actual**: Crea varias ramas desde tu paso, cada una comenzando con una acción **Filter**:
    ...
    Consulta [Cómo usar ramas](/es/user-guide/workflows/capabilities/workflow-branches) para ver una guía paso a paso.
  </Accordion>
  ...
  <Accordion title="¿Cómo leo las ejecuciones de flujos de trabajo?">
    ...
    * **Datos**: Visualiza los datos de entrada/salida en cada paso
    ...
    Consulta [Ejecuciones de flujos de trabajo](/es/user-guide/workflows/capabilities/workflow-runs) para más detalles.
  </Accordion>
