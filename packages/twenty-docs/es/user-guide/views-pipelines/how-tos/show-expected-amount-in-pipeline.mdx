...
<Tip>
Este es un ejemplo de creación de [Campos de fórmula](/es/user-guide/workflows/how-tos/crm-automations/formula-fields) usando flujos de trabajo.
</Tip>
...
* [Campos de fórmula](/es/user-guide/workflows/how-tos/crm-automations/formula-fields) — crea campos calculados usando flujos de trabajo
* [Vistas Kanban](/es/user-guide/views-pipelines/capabilities/kanban-views) — agregaciones por columna
