...
* [Vistas Kanban](/es/user-guide/views-pipelines/capabilities/kanban-views) — agregaciones y vista compacta
* [Filtros y ordenación](/es/user-guide/views-pipelines/capabilities/filters-and-sorting) — creación de vistas filtradas
