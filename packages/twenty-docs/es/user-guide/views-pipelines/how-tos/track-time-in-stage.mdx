...
<Tip>
Este es un ejemplo de cómo crear [Campos de fórmula](/es/user-guide/workflows/how-tos/crm-automations/formula-fields) usando flujos de trabajo — específicamente cálculos de fechas.
</Tip>
...
* [Flujos de trabajo](/es/user-guide/workflows/overview) — conceptos básicos de automatización
* [Cómo crear campos personalizados](/es/user-guide/data-model/how-tos/create-custom-fields) — configuración de campos
* [Vistas Kanban](/es/user-guide/views-pipelines/capabilities/kanban-views) — agregaciones
