...
* [Permisos](/es/user-guide/permissions-access/capabilities/permissions) — información detallada sobre la creación y gestión de roles
* [Agentes de IA](/es/user-guide/ai/capabilities/ai-agents) — capacidades de IA en flujos de trabajo
