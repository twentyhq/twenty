...
| ----------- | --------------------------------------------------------------------------- | ------------------------------------------------- |
| **GraphQL** | Consultas flexibles, obtención de datos relacionados, operaciones complejas | [Documentación de la API](/es/developers/extend/api) |
| **REST**    | Operaciones CRUD simples, patrones REST familiares                          | [Documentación de la API](/es/developers/extend/api) |
...
* Verifica que los formatos cumplan los requisitos de Twenty (consulta [Asignación de campos](/es/user-guide/data-migration/capabilities/field-mapping))
...
Contáctanos en [contact@twenty.com](mailto:contact@twenty.com) o explora nuestros [Servicios de implementación](/es/user-guide/getting-started/capabilities/implementation-services).
...
* [Documentación de la API](/es/developers/extend/api)
