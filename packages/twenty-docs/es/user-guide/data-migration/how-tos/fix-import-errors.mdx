...
Para más detalles: [Restricciones de unicidad](/es/user-guide/data-migration/capabilities/uniqueness-constraints)
...
**Solución:** Usa el formato `YYYY-MM-DD` de forma consistente en todo el archivo
...
Para la referencia completa de formatos: [Referencia de asignación de campos](/es/user-guide/data-migration/capabilities/field-mapping)
...
Para más detalles: [Importar relaciones](/es/user-guide/data-migration/capabilities/import-relations)
...
4. **Consulta los artículos de referencia:**
   ...
   * [Importar relaciones](/es/user-guide/data-migration/capabilities/import-relations)
   * [Manejo de errores](/es/user-guide/data-migration/capabilities/error-handling)
