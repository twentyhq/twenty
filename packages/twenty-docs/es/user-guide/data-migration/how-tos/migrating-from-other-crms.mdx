...
Consulta [Cómo preparar tus archivos CSV](/es/user-guide/data-migration/how-tos/prepare-your-csv-files) para conocer los requisitos de formato completos para todos los tipos de campos.
...
Consulta [Cómo importar relaciones](/es/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) para obtener instrucciones detalladas sobre cómo vincular registros.
...
Consulta [Cómo preparar tus archivos CSV](/es/user-guide/data-migration/how-tos/prepare-your-csv-files) para obtener la guía de formato completa.
...
* [Cómo importar Empresas](/es/user-guide/data-migration/how-tos/import-companies-via-csv)
* [Cómo importar Contactos](/es/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [Cómo importar relaciones](/es/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv)
...
* Consulta [Cómo importar datos mediante la API](/es/user-guide/data-migration/how-tos/import-data-via-api)
...
* Consulta [Correo y calendario](/es/user-guide/calendar-emails/overview)
...
Consulta [Cómo corregir errores de importación](/es/user-guide/data-migration/how-tos/fix-import-errors) para obtener pasos detallados de solución de problemas.
