...
<Note>Para conjuntos de datos de más de 10.000 registros, divídelos en varios archivos o usa la [importación por API](/es/user-guide/data-migration/how-tos/import-data-via-api).</Note>
...
Consulta [Cómo importar relaciones](/es/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) para obtener instrucciones detalladas.
...
* [Importar empresas](/es/user-guide/data-migration/how-tos/import-companies-via-csv) (importa estas primero)
* [Importar contactos](/es/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [Corregir errores de importación](/es/user-guide/data-migration/how-tos/fix-import-errors)
