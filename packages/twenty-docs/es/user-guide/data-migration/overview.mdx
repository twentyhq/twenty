...
<Note>Para conjuntos de datos muy grandes (cientos de miles de registros), use la API. Nuestros [socios de implementación](/es/user-guide/getting-started/capabilities/implementation-services) pueden ayudar a ejecutar estos scripts si es necesario.</Note>
...
Consulte [este artículo](/es/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) para ver una guía paso a paso sobre cómo proceder.
...
* [Prepare sus archivos CSV](/es/user-guide/data-migration/how-tos/prepare-your-csv-files)
* [Importe relaciones entre objetos](/es/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv)
* [Importe mediante API para conjuntos de datos grandes](/es/user-guide/data-migration/how-tos/import-data-via-api)
