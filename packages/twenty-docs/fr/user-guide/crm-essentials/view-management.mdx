...
Pour une organisation des données plus avancée, consultez notre section [Modèle de données](/fr/user-guide/data-model/customize-your-data-model) pour en savoir plus sur la personnalisation des champs et des objets.
