...
<Note>Pour les ensembles de données supérieurs à 10 000 enregistrements, divisez-les en plusieurs fichiers ou utilisez l’[importation via l’API](/fr/user-guide/data-migration/how-tos/import-data-via-api).</Note>
...
Consultez [Comment importer des relations](/fr/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) pour des instructions détaillées.
...
* [Importer des entreprises](/fr/user-guide/data-migration/how-tos/import-companies-via-csv) (importez-les d’abord)
* [Importer des contacts](/fr/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [Corriger les erreurs d’importation](/fr/user-guide/data-migration/how-tos/fix-import-errors)
