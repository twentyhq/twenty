...
Pour plus de détails : [Contraintes d'unicité](/fr/user-guide/data-migration/capabilities/uniqueness-constraints)
...
Pour la référence complète des formats : [Correspondance des champs](/fr/user-guide/data-migration/capabilities/field-mapping)
...
Pour plus de détails : [Import des relations](/fr/user-guide/data-migration/capabilities/import-relations)
...
4. **Consultez les articles de référence :**
   * [Correspondance des champs](/fr/user-guide/data-migration/capabilities/field-mapping)
   * [Contraintes d'unicité](/fr/user-guide/data-migration/capabilities/uniqueness-constraints)
   * [Import des relations](/fr/user-guide/data-migration/capabilities/import-relations)
   * [Gestion des erreurs](/fr/user-guide/data-migration/capabilities/error-handling)
