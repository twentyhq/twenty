...
| ----------- | ----------------------------------------------------------------------- | ------------------------------------------------ |
| **GraphQL** | Requêtes flexibles, récupération de données liées, opérations complexes | [Documentation de l'API](/fr/developers/extend/api) |
| **REST**    | Opérations CRUD simples, modèles REST familiers                         | [Documentation de l'API](/fr/developers/extend/api) |
...
* Vérifiez que les formats correspondent aux exigences de Twenty (voir [Correspondance des champs](/fr/user-guide/data-migration/capabilities/field-mapping))
...
Contactez-nous à [contact@twenty.com](mailto:contact@twenty.com) ou découvrez nos [services de mise en œuvre](/fr/user-guide/getting-started/capabilities/implementation-services).
...
* [Documentation de l'API](/fr/developers/extend/api)
