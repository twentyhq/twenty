...
* [Autorisations](/fr/user-guide/permissions-access/capabilities/permissions) — informations détaillées sur la création et la gestion des rôles
* [Agents IA](/fr/user-guide/ai/capabilities/ai-agents) — fonctionnalités d’IA dans les flux de travail
