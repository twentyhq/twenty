...
Lisez [cet article](/fr/user-guide/data-model/overview) pour apprendre à concevoir votre modèle de données.
...
Lisez [cet article](/fr/user-guide/data-migration/overview) pour en savoir plus sur l'importation de données.
...
Commencez à créer des automatisations en utilisant [les flux de travail](/fr/user-guide/workflows/overview).
