...
<Accordion title="How can I disable my workspace?">Si vous souhaitez juste désactiver votre espace de travail (et non le supprimer), allez dans `Paramètres → Facturation` et cliquez sur `Annuler le plan`.
</Accordion>
