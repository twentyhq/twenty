...
→ [Guide complet de configuration des e-mails et du calendrier](/fr/user-guide/calendar-emails/overview)
...
<Note>
Avant d'inviter votre équipe, vérifiez le rôle par défaut dans **Paramètres → Membres → Rôles**. Les nouveaux membres se voient automatiquement attribuer ce rôle lorsqu'ils rejoignent l'espace de travail.
</Note>
...
* [Paramètres de l’espace de travail](/fr/user-guide/settings/capabilities/workspace-settings)
* [Paramètres du profil](/fr/user-guide/settings/capabilities/profile-settings)
* [Paramètres de l’expérience](/fr/user-guide/settings/capabilities/experience-settings)
