...
* [FAQ sur les flux de travail](/fr/user-guide/workflows/how-tos/need-more-help/workflows-faq) — réponses concernant l'exécution parallèle
* [Actions de workflows](/fr/user-guide/workflows/capabilities/workflow-actions) — actions disponibles pour les branches
