...
* **En vrac** : Le workflow s'exécutera une fois, fournissant la liste complète des enregistrements en entrée. Cela signifie que le flux de travail doit contenir une [Action d'itération](/fr/user-guide/workflows/capabilities/workflow-actions#iterator).
