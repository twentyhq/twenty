...
* [Actions de workflows](/fr/user-guide/workflows/capabilities/workflow-actions)
* [Envoyer des e-mails depuis des workflows](/fr/user-guide/workflows/capabilities/send-emails-from-workflows)
