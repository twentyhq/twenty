...
* [Envoyer des e-mails depuis des flux de travail](/fr/user-guide/workflows/capabilities/send-emails-from-workflows)
* [Créer des champs personnalisés](/fr/user-guide/data-model/how-tos/create-custom-fields)
* [Créer des champs de relation](/fr/user-guide/data-model/how-tos/create-relation-fields)
