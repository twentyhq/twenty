...
<Tip>
Pour un exemple complet de suivi du temps dans les étapes du pipeline, voir [Suivre la durée de présence des opportunités dans chaque étape](/fr/user-guide/views-pipelines/how-tos/track-time-in-stage).
</Tip>
...
Voir [Comment afficher le montant attendu dans le pipeline](/fr/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline) pour le workflow complet.
...
* [Comment afficher le montant attendu dans le pipeline](/fr/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline)
* [Comment suivre le temps par étape](/fr/user-guide/views-pipelines/how-tos/track-time-in-stage)
