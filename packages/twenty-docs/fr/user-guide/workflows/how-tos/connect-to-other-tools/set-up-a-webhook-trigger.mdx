...
<Tip>
Pour plus de détails sur la gestion des tableaux, voir [Gérer les tableaux dans les actions Code](/fr/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>

## Connexes

* [Déclencheurs de flux de travail](/fr/user-guide/workflows/capabilities/workflow-triggers)
* [Actions de flux de travail](/fr/user-guide/workflows/capabilities/workflow-actions)
