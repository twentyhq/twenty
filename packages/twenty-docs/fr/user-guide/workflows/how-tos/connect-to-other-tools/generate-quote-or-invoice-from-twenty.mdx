...
* [Générer un PDF à partir de Twenty](/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — joindre les PDF générés aux enregistrements
...
* [Automatisations Closed Won](/fr/user-guide/workflows/how-tos/crm-automations/closed-won-automations)
