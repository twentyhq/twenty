...
Pour la configuration standard d'un webhook, voir [Configurer un déclencheur de webhook](/fr/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger). Cet article couvre le traitement spécifique nécessaire pour la structure de charge utile personnalisée de Typeform.
...
<Tip>
Pour plus de détails sur la gestion des tableaux dans les actions Code, voir [Gérer les tableaux dans les actions Code](/fr/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
...
* [Configurer un déclencheur de webhook](/fr/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger)
* [Gérer les tableaux dans les actions Code](/fr/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions)
