...
* [Champs de relation](/fr/user-guide/data-model/capabilities/relation-fields) — types de relation expliqués
* [Créer des objets personnalisés](/fr/user-guide/data-model/how-tos/create-custom-objects) — comment créer des objets
* [Créer des champs de relation](/fr/user-guide/data-model/how-tos/create-relation-fields) — configuration de base des relations
