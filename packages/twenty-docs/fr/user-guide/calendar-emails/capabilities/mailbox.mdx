...
**Remarque** : Pour connecter vos comptes e-mail et configurer les paramètres de synchronisation, rendez-vous sur [Configuration des e-mails et calendriers](/fr/user-guide/calendar-emails/overview).
