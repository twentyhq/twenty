...
<Note>
Vous ne pouvez attribuer des rôles qu'aux membres existants de l'espace de travail. Pour inviter de nouveaux membres, utilisez [Gestion des Membres](/fr/user-guide/settings/capabilities/member-management).
</Note>
