...
<CardGroup cols={2}>
  <Card title="Permissions" icon="lock" href="/fr/user-guide/permissions-access/capabilities/permissions">
    Créez des rôles et configurez les autorisations sur les objets, les champs et les paramètres.
  </Card>
  <Card title="Configuration SSO" icon="key" href="/fr/user-guide/permissions-access/capabilities/sso-configuration">
    Configurez l’authentification unique avec votre fournisseur d’identité.
  </Card>
  <Card title="FAQ" icon="circle-question" href="/fr/user-guide/permissions-access/how-tos/permissions-faq">
...
* [Créer un rôle](/fr/user-guide/permissions-access/capabilities/permissions#create-a-role)
* [Configurer le SSO](/fr/user-guide/permissions-access/capabilities/sso-configuration)
* [Gérer les membres de l’équipe](/fr/user-guide/settings/capabilities/member-management)
