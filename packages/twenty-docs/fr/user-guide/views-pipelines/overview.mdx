...
* [Vues de Tableau](/fr/user-guide/views-pipelines/capabilities/table-views)
* [Vues Kanban](/fr/user-guide/views-pipelines/capabilities/kanban-views)
* [Filtres et tri](/fr/user-guide/views-pipelines/capabilities/filters-and-sorting)
* [Paramètres de la vue](/fr/user-guide/views-pipelines/capabilities/view-settings)
