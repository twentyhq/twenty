...
<Tip>
Ceci est un exemple de création de [Champs de formule](/fr/user-guide/workflows/how-tos/crm-automations/formula-fields) à l'aide de workflows.
</Tip>
...
* [Champs de formule](/fr/user-guide/workflows/how-tos/crm-automations/formula-fields) — créer des champs calculés à l'aide de workflows
* [Vues Kanban](/fr/user-guide/views-pipelines/capabilities/kanban-views) — agrégations de colonnes
* [Comment créer des champs personnalisés](/fr/user-guide/data-model/how-tos/create-custom-fields) — configuration des champs
