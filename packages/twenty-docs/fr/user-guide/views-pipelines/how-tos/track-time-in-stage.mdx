...
<Tip>
Voici un exemple de création de [champs de formule](/fr/user-guide/workflows/how-tos/crm-automations/formula-fields) à l'aide de Workflows — plus précisément des calculs de dates.
</Tip>
...
* [Workflows](/fr/user-guide/workflows/overview) — principes de l'automatisation
* [Comment créer des champs personnalisés](/fr/user-guide/data-model/how-tos/create-custom-fields) — configuration des champs
* [Vues Kanban](/fr/user-guide/views-pipelines/capabilities/kanban-views) — agrégations
