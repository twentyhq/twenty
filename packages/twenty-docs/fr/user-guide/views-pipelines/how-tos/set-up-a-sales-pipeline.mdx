...
* [Vues Kanban](/fr/user-guide/views-pipelines/capabilities/kanban-views) — agrégations et vue compacte
* [Filtres et tri](/fr/user-guide/views-pipelines/capabilities/filters-and-sorting) — création de vues filtrées
