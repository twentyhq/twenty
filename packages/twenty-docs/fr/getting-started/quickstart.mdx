...
[Référence du modèle de données →](/fr/user-guide/data-model/overview)
...
[Guide de migration des données →](/fr/user-guide/data-migration/overview)
...
<CardGroup cols={2}>
  <Card title="Découvrez l’interface" icon="table-columns" href="/fr/getting-started/core-concepts/layout">
    Navigation, vues, menu de commandes, panneau latéral.
  </Card>
  <Card title="Créer des workflows" icon="bolt" href="/fr/user-guide/workflows/overview">
    Automatisez vos processus métier.
  </Card>
  <Card title="Créer des vues" icon="table" href="/fr/user-guide/layout/overview">
    Tableau, kanban, calendrier — filtrez et triez vos données.
  </Card>
  <Card title="Explorer l'API" icon="plug" href="/fr/developers/extend/api">
