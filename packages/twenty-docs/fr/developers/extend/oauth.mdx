...
| -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Scripts internes, automatisation                               | [Clé API](/fr/developers/extend/api#authentication)                                                     |
...
| Application Twenty avec des extensions d’interface utilisateur | [Applications](/fr/developers/extend/apps/getting-started/quick-start) (OAuth est géré automatiquement) |
