...
Pour recevoir des données externes, voir [Configurer un déclencheur de webhook](/fr/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger).
