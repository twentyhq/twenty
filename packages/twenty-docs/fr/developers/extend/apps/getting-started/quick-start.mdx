...
Tous les modes nécessitent un serveur distant authentifié. Voir [synchronisation et récupération](/fr/developers/extend/apps/operations/sync-and-recovery#previewing-changes-plan) pour plus d’informations sur `plan`.
...
Référence complète : [Concepts](/fr/developers/extend/apps/getting-started/concepts).

## Prochaines étapes

<CardGroup cols={2}>
  <Card title="Configuration" icon="screwdriver-wrench" href="/fr/developers/extend/apps/config/overview">
    Identité de l’application, rôle par défaut, hooks d’installation et de désinstallation, ressources publiques.
  </Card>
  <Card title="Données" icon="database" href="/fr/developers/extend/apps/data/overview">
    Objets, champs et relations bidirectionnelles.
  </Card>
  <Card title="Logique" icon="bolt" href="/fr/developers/extend/apps/logic/overview">
    Fonctions logiques, compétences, agents et connexions OAuth.
  </Card>
  <Card title="Disposition" icon="table-columns" href="/fr/developers/extend/apps/layout/overview">
