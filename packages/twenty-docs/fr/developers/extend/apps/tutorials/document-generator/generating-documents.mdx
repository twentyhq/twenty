...
Maintenant le cœur : une [fonction logique](/fr/developers/extend/apps/logic/logic-functions)
...
(`yarn test:unit`). Voir [Testing](/fr/developers/extend/apps/operations/testing).
</Tip>

## Le gestionnaire

Le gestionnaire utilise le [`CoreApiClient`](/fr/developers/extend/apps/logic/logic-functions)
...
Voir [Roles](/fr/developers/extend/apps/config/roles) pour des autorisations plus fines.
