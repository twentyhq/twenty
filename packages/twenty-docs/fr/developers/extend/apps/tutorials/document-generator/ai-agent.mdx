...
Un [skill](/fr/developers/extend/apps/logic/skills-and-agents) est des instructions réutilisables
...
Un [agent](/fr/developers/extend/apps/logic/skills-and-agents) paie une invite avec un modèle
...
[Chapitre 2](/fr/developers/extend/apps/tutorials/document-generator/generating-documents#grant-it-access).
</Note>
