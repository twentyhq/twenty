...
| -------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| [1. Modèle de données](/fr/developers/extend/apps/tutorials/document-generator/data-model)                  | Objets, champs et une relation                                                                                   | [Données](/fr/developers/extend/apps/data/overview)                         |
| [2. Générer des documents](/fr/developers/extend/apps/tutorials/document-generator/generating-documents)    | Une fonction logique (outil IA + action de workflow) qui remplit un modèle Markdown et y joint un PDF soigné     | [Fonctions logiques](/fr/developers/extend/apps/logic/logic-functions)      |
| [3. Routes HTTP](/fr/developers/extend/apps/tutorials/document-generator/http-routes)                       | Servir du JSON et une page HTML partageable depuis des routes                                                    | [Fonctions logiques](/fr/developers/extend/apps/logic/logic-functions)      |
| [4. Créer l’interface utilisateur](/fr/developers/extend/apps/tutorials/document-generator/building-the-ui) | Vues, navigation, menu de commandes et composants frontaux qui prévisualisent un document et modifient un modèle | [Mise en page](/fr/developers/extend/apps/layout/overview)                  |
| [5. Un agent IA](/fr/developers/extend/apps/tutorials/document-generator/ai-agent)                          | Agent + compétence                                                                                               | [Compétences et agents](/fr/developers/extend/apps/logic/skills-and-agents) |
| [6. Publication](/fr/developers/extend/apps/tutorials/document-generator/publishing)                        | Publiez-la sur la place de marché                                                                                | [Publication](/fr/developers/extend/apps/operations/publishing)             |

## Prérequis

Vous devez avoir terminé le [démarrage rapide](/fr/developers/extend/apps/getting-started/quick-start) :
...
<Card title="Commencez à construire →" icon="database" href="/fr/developers/extend/apps/tutorials/document-generator/data-model">
