...
Utilisez des variables d'environnement ou des fichiers `.env` pour configurer votre projet. Plus d'informations [ici](/fr/developers/self-host/capabilities/setup).
...
Si vous rencontrez un problème, consultez [Dépannage](/fr/developers/self-host/capabilities/troubleshooting) pour des solutions.
