...
<CardGroup cols={2}>
  <Card title="Signalements de bogues et demandes" icon="bug" href="/fr/developers/contribute/capabilities/bug-and-requests">
    Signalez des problèmes ou demandez des fonctionnalités
  </Card>
  <Card title="Développement frontend" icon="browser" href="/fr/developers/contribute/capabilities/frontend-development/folder-architecture-front">
