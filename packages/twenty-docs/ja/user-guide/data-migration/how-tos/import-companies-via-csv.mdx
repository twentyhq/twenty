...
<Note>
10,000 社を超えてインポートする必要がありますか？ 複数のファイルに分割するか、[API インポート](/ja/user-guide/data-migration/how-tos/import-data-via-api) を使用します。
</Note>
...
1. **[People をインポート](/ja/user-guide/data-migration/how-tos/import-contacts-via-csv)** — ドメインを使って Companies にリンクします
...
詳細は [既存レコードを更新する方法](/ja/user-guide/data-migration/how-tos/update-existing-records-via-import) を参照してください。
...
* [インポートエラーを解決する方法](/ja/user-guide/data-migration/how-tos/fix-import-errors)
* [フィールドマッピングのリファレンス](/ja/user-guide/data-migration/capabilities/field-mapping)
* [一意性制約](/ja/user-guide/data-migration/capabilities/uniqueness-constraints)
