...
* [Twenty から PDF を生成する](/ja/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — 生成された PDF をレコードに添付する
...
* [Closed Won の自動化](/ja/user-guide/workflows/how-tos/crm-automations/closed-won-automations)
