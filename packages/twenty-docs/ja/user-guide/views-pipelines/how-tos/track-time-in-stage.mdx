...
<Tip>
これは、ワークフローを使って[数式フィールド](/ja/user-guide/workflows/how-tos/crm-automations/formula-fields)を作成する例で、特に日付計算です。
</Tip>
...
* [ワークフロー](/ja/user-guide/workflows/overview) — 自動化の基本
* [カスタムフィールドの作成方法](/ja/user-guide/data-model/how-tos/create-custom-fields) — フィールドの設定
* [カンバンビュー](/ja/user-guide/views-pipelines/capabilities/kanban-views) — 集計
