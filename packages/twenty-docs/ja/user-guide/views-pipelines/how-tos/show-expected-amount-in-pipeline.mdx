...
<Tip>
これは、ワークフローを使用して[数式フィールド](/ja/user-guide/workflows/how-tos/crm-automations/formula-fields)を作成する例です。
</Tip>
...
* [数式フィールド](/ja/user-guide/workflows/how-tos/crm-automations/formula-fields) — ワークフローを使って計算フィールドを作成
* [カンバンビュー](/ja/user-guide/views-pipelines/capabilities/kanban-views) — 列の集計
* [カスタムフィールドの作成方法](/ja/user-guide/data-model/how-tos/create-custom-fields) — フィールド設定
