...
リレーションの種類については、[Relation Fields](/ja/user-guide/data-model/capabilities/relation-fields) を参照してください。
...
* [Relation Fields](/ja/user-guide/data-model/capabilities/relation-fields) — 種類と制限事項
* [How to Import Relations](/ja/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) — リンクされたレコードを一括インポート
