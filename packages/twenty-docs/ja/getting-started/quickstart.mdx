...
[データモデルリファレンス →](/ja/user-guide/data-model/overview)
...
[データ移行ガイド →](/ja/user-guide/data-migration/overview)
...
<CardGroup cols={2}>
  <Card title="レイアウトを理解する" icon="table-columns" href="/ja/getting-started/core-concepts/layout">
    ナビゲーション、ビュー、コマンドメニュー、サイドパネル。
  </Card>
  <Card title="ワークフローを構築" icon="bolt" href="/ja/user-guide/workflows/overview">
    ビジネスプロセスを自動化します。
  </Card>
  <Card title="ビューを作成" icon="table" href="/ja/user-guide/layout/overview">
    テーブル、かんばん、カレンダー — データをフィルターおよびソートします。
  </Card>
  <Card title="API を探索" icon="plug" href="/ja/developers/extend/api">
