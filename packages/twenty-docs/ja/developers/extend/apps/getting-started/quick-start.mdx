...
すべてのモードで、認証済みのリモートが必要です。 `plan` の詳細については、[Syncing & recovery](/ja/developers/extend/apps/operations/sync-and-recovery#previewing-changes-plan) を参照してください。
...
完全なリファレンス: [Concepts](/ja/developers/extend/apps/getting-started/concepts)。
