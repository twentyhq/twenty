...
[skill](/ja/developers/extend/apps/logic/skills-and-agents) は
...
[agent](/ja/developers/extend/apps/logic/skills-and-agents) はプロンプトを
...
詳しくは、[第2章](/ja/developers/extend/apps/tutorials/document-generator/generating-documents#grant-it-access) を参照してください。
</Note>
...
<Card title="次へ: 公開 →" icon="rocket" href="/ja/developers/extend/apps/tutorials/document-generator/publishing">
