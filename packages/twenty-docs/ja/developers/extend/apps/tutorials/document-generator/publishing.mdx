...
[アプリケーション config](/ja/developers/extend/apps/config/application) は、マーケットプレイスに表示される
...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.twenty.com/ja/developers/extend/apps',
...
最終確認として有用です。
[Testing](/ja/developers/extend/apps/operations/testing) と
[Syncing & recovery](/ja/developers/extend/apps/operations/sync-and-recovery) を参照してください。
...
詳細とリリースのチェックリスト:
[Publishing](/ja/developers/extend/apps/operations/publishing).
...
<CardGroup cols={2}>
  <Card title="データ参照" icon="database" href="/ja/developers/extend/apps/data/overview">
    すべてのフィールドタイプ、リレーション、インデックスオプション。
  </Card>
  <Card title="ロジックリファレンス" icon="bolt" href="/ja/developers/extend/apps/logic/overview">
    Cronとdatabase-event トリガー、キー値ストア、OAuth 接続。
  </Card>
  <Card title="レイアウト参照" icon="table-columns" href="/ja/developers/extend/apps/layout/overview">
    ページレイアウト、ダッシュボードウィジェット、およびより多くのUIサーフェス。
  </Card>
  <Card title="オペレーション" icon="rocket" href="/ja/developers/extend/apps/operations/overview">
    CLI、テスト、リモコン、CI。
  </Card>
</CardGroup>
