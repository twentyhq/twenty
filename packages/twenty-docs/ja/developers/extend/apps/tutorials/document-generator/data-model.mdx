...
フルパターンについては [Relations](/ja/developers/extend/apps/data/relations) を参照してください。
...
<Card title="次へ: ドキュメントの生成 →" icon="bolt" href="/ja/developers/extend/apps/tutorials/document-generator/generating-documents">
