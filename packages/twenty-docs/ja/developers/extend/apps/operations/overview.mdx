...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/ja/developers/extend/apps/operations/cli">
    `yarn twenty` リファレンス — exec、logs、uninstall、remotes。
  </Card>
  <Card title="同期と復旧" icon="compass" href="/ja/developers/extend/apps/operations/sync-and-recovery">
    どのコマンドをいつ使うか、同期の差分の読み方、そして復旧の手順。
  </Card>
  <Card title="テスト" icon="flask" href="/ja/developers/extend/apps/operations/testing">
    Vitest のセットアップ、統合テスト、型チェック、CI ワークフロー。
  </Card>
  <Card title="公開" icon="upload" href="/ja/developers/extend/apps/operations/publishing">
