...
| シナリオ                   | 認証方法                                                                         |
| ---------------------- | ---------------------------------------------------------------------------- |
| 社内向けスクリプト、自動化          | [API キー](/ja/developers/extend/api#authentication)                              |
| ユーザーの代理として動作する外部アプリ    | **OAuth — 認可コード**                                                            |
| サーバー間、ユーザーコンテキストなし     | **OAuth — クライアントクレデンシャル**                                                    |
| UI 拡張機能を備えた Twenty アプリ | [アプリ](/ja/developers/extend/apps/getting-started/quick-start)（OAuth は自動で処理されます） |
