...
Pokud jste ve Zobrazeních noví, přečtěte si náš [průvodce Zobrazeními a pipeline](/cs/user-guide/views-pipelines/overview), kde se dozvíte, jak je vytvářet a přizpůsobovat.
