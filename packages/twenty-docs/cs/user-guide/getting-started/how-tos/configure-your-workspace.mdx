...
Přečtěte si [tento článek](/cs/user-guide/data-model/overview), kde se dozvíte, jak navrhnout svůj datový model.
...
Přečtěte si [tento článek](/cs/user-guide/data-migration/overview), kde se dozvíte více o importu dat.
...
Začněte vytvářet automatizace pomocí [workflow](/cs/user-guide/workflows/overview).
