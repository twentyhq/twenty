...
<CardGroup cols={2}>
  <Card title="Cenové plány" icon="tags" href="/cs/user-guide/billing/capabilities/pricing-plans">
    Zjistěte více o cenových plánech Twenty a o tom, co je zahrnuto.
  </Card>
  <Card title="Časté dotazy" icon="circle-question" href="/cs/user-guide/billing/how-tos/billing-faq">
...
Další otázky najdete v [FAQ k fakturaci](/cs/user-guide/billing/how-tos/billing-faq).
