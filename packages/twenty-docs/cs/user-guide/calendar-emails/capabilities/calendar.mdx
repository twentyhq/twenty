...
**Poznámka**: Chcete-li připojit svůj kalendář a konfigurovat nastavení synchronizace, navštivte [Nastavení Emailu a Kalendáře](/cs/user-guide/calendar-emails/overview).
