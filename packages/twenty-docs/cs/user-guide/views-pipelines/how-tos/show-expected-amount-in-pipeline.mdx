...
<Tip>
Toto je příklad vytváření [Vzorcových polí](/cs/user-guide/workflows/how-tos/crm-automations/formula-fields) pomocí pracovních postupů.
</Tip>
...
* [Vzorcová pole](/cs/user-guide/workflows/how-tos/crm-automations/formula-fields) — vytvářejte vypočtená pole pomocí pracovních postupů
* [Zobrazení Kanban](/cs/user-guide/views-pipelines/capabilities/kanban-views) — agregace sloupců
* [Jak vytvořit vlastní pole](/cs/user-guide/data-model/how-tos/create-custom-fields) — konfigurace polí
