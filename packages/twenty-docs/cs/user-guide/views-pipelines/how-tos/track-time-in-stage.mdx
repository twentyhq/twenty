...
<Tip>
Toto je příklad vytváření [Vzorcová pole](/cs/user-guide/workflows/how-tos/crm-automations/formula-fields) pomocí pracovních postupů — konkrétně výpočtů dat.
</Tip>
...
* [Pracovní postupy](/cs/user-guide/workflows/overview) — základy automatizace
* [Jak vytvořit vlastní pole](/cs/user-guide/data-model/how-tos/create-custom-fields) — konfigurace polí
* [Kanbanová zobrazení](/cs/user-guide/views-pipelines/capabilities/kanban-views) — agregace
