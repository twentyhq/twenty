...
* [Kanban zobrazení](/cs/user-guide/views-pipelines/capabilities/kanban-views) — agregace a kompaktní zobrazení
* [Filtry a řazení](/cs/user-guide/views-pipelines/capabilities/filters-and-sorting) — tvorba filtrovaných zobrazení
