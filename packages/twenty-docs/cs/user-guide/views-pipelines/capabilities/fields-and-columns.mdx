...
* [Tabulková zobrazení](/cs/user-guide/views-pipelines/capabilities/table-views) — funkce seznamového zobrazení
* [Kanban zobrazení](/cs/user-guide/views-pipelines/capabilities/kanban-views) — zobrazení založená na kartách
