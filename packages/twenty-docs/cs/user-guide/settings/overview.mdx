...
→ [Kompletní průvodce nastavením e-mailu a kalendáře](/cs/user-guide/calendar-emails/overview)
...
<Note>
Před pozváním týmu zkontrolujte výchozí roli v **Nastavení → Členové → Role**. Novým členům je tato role automaticky přiřazena, když se připojí.
</Note>
...
* [Nastavení pracovního prostoru](/cs/user-guide/settings/capabilities/workspace-settings)
* [Nastavení profilu](/cs/user-guide/settings/capabilities/profile-settings)
* [Nastavení prostředí](/cs/user-guide/settings/capabilities/experience-settings)
