...
<Warning>
**Beta Feature**: Vztahy přes spojovací objekt jsou momentálně v beta verzi. Povolte je v **Settings → Community → Features** předtím, než budete pokračovat podle tohoto návodu.
</Warning>

<Note>
Tato funkce také vyžaduje, aby byl povolen **Advanced mode** (přepínač je vlevo dole v Settings).
</Note>
...
1. **Povolte Junction Relations v Beta Features**: Přejděte do **Settings → Community → Features** a povolte **Junction Relations**
2. **Povolte Advanced mode**: Zapněte **Advanced mode** vlevo dole na postranním panelu Settings
...
* [Relační pole](/cs/user-guide/data-model/capabilities/relation-fields) — vysvětlení typů vztahů
* [Vytváření vlastních objektů](/cs/user-guide/data-model/how-tos/create-custom-objects) — jak vytvářet objekty
* [Vytváření relačních polí](/cs/user-guide/data-model/how-tos/create-relation-fields) — základní nastavení vztahů
