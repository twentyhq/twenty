...
4. Zvolte **typ pole** (všechny typy viz [Pole](/cs/user-guide/data-model/capabilities/fields))
...
<Note>
**Pro importy používejte názvy API.** V Nastavení povolte **Advanced mode**, abyste viděli názvy API. Viz [Mapování polí](/cs/user-guide/data-migration/capabilities/field-mapping).
</Note>
...
* [Pole](/cs/user-guide/data-model/capabilities/fields) — vysvětlení všech typů polí
