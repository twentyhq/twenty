...
Viz [Relační pole](/cs/user-guide/data-model/capabilities/relation-fields) s vysvětlením typů relací.
...
* [Relační pole](/cs/user-guide/data-model/capabilities/relation-fields) — typy a omezení
* [Jak importovat relace](/cs/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) — hromadný import propojených záznamů
