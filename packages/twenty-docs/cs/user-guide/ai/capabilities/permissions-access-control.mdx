...
* [Oprávnění](/cs/user-guide/permissions-access/capabilities/permissions) — podrobné informace o vytváření a správě rolí
* [Agenti AI](/cs/user-guide/ai/capabilities/ai-agents) — možnosti AI v pracovních postupech
