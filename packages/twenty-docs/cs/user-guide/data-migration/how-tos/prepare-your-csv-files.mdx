...
<Note>U datasetů větších než 10 000 záznamů je rozdělte do více souborů nebo použijte [import přes API](/cs/user-guide/data-migration/how-tos/import-data-via-api).</Note>
...
Podrobné pokyny najdete v [Jak importovat relace](/cs/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv).
...
* [Importovat společnosti](/cs/user-guide/data-migration/how-tos/import-companies-via-csv) (importujte je jako první)
* [Importovat kontakty](/cs/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [Opravit chyby importu](/cs/user-guide/data-migration/how-tos/fix-import-errors)
