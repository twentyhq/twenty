...
| ----------- | ----------------------------------------------------------------- | ----------------------------------------- |
| **GraphQL** | Flexibilní dotazy, získávání souvisejících dat, komplexní operace | [Dokumentace API](/cs/developers/extend/api) |
| **REST**    | Jednoduché CRUD operace, známé postupy REST                       | [Dokumentace API](/cs/developers/extend/api) |
...
* Ověřte, že formáty odpovídají požadavkům Twenty (viz [Mapování polí](/cs/user-guide/data-migration/capabilities/field-mapping))
...
Kontaktujte nás na [contact@twenty.com](mailto:contact@twenty.com) nebo prozkoumejte naše [Implementační služby](/cs/user-guide/getting-started/capabilities/implementation-services).
...
* [Dokumentace API](/cs/developers/extend/api)
