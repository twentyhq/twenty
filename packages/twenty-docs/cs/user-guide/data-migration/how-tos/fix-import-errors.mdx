...
Více podrobností: [Omezení jedinečnosti](/cs/user-guide/data-migration/capabilities/uniqueness-constraints)
...
Úplná referenční příručka k formátům: [Mapování polí](/cs/user-guide/data-migration/capabilities/field-mapping)
...
Více podrobností: [Import relací](/cs/user-guide/data-migration/capabilities/import-relations)
...
4. **Zkontrolujte referenční články:**
   * [Mapování polí](/cs/user-guide/data-migration/capabilities/field-mapping)
   * [Omezení jedinečnosti](/cs/user-guide/data-migration/capabilities/uniqueness-constraints)
   * [Import relací](/cs/user-guide/data-migration/capabilities/import-relations)
   * [Zpracování chyb](/cs/user-guide/data-migration/capabilities/error-handling)
