...
Viz [Jak importovat relace](/cs/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) pro podrobnosti o zachování relací.
...
* Nakonfigurujte role v **Settings → Members → Roles**
...
<Tip>
  Migrujete velký nebo složitý pracovní prostor? [Najměte si certifikovaného partnera Twenty](https://twenty.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud), který za vás zajistí kompletní přesun od začátku do konce. *(Nebo do komunikace zapojte náš tým: [contact@twenty.com](mailto:contact@twenty.com).)*
</Tip>
