...
<Note>
Role můžete přiřazovat pouze stávajícím členům pracovního prostoru. Chcete-li pozvat nové členy, použijte [Správa členů](/cs/user-guide/settings/capabilities/member-management).
</Note>
