...
<CardGroup cols={2}>
  <Card title="Oprávnění" icon="lock" href="/cs/user-guide/permissions-access/capabilities/permissions">
    Vytvářejte role a spravujte oprávnění k objektům, polím a nastavením.
  </Card>
  <Card title="Konfigurace SSO" icon="key" href="/cs/user-guide/permissions-access/capabilities/sso-configuration">
    Nastavte jednotné přihlášení (SSO) se svým poskytovatelem identity.
  </Card>
  <Card title="Nejčastější dotazy" icon="circle-question" href="/cs/user-guide/permissions-access/how-tos/permissions-faq">
...
* [Vytvořit roli](/cs/user-guide/permissions-access/capabilities/permissions#create-a-role)
* [Nakonfigurujte SSO](/cs/user-guide/permissions-access/capabilities/sso-configuration)
* [Spravujte členy týmu](/cs/user-guide/settings/capabilities/member-management)
