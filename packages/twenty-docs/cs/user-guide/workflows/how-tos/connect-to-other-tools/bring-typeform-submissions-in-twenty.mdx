...
Pro standardní nastavení webhooku viz [Nastavení spouštěče webhooku](/cs/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger). Tento článek se věnuje specifickému zpracování požadovanému pro vlastní strukturu payloadu Typeformu.
...
<Tip>
Další podrobnosti o práci s poli v akcích Code viz [Práce s poli v akcích Code](/cs/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
...
* [Nastavení spouštěče webhooku](/cs/user-guide/workflows/how-tos/connect-to-other-tools/set-up-a-webhook-trigger)
* [Práce s poli v akcích Code](/cs/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions)
