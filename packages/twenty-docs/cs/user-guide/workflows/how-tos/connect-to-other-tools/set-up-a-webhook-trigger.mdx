...
<Tip>
Další podrobnosti o práci s poli viz [Zpracování polí v akcích Code](/cs/user-guide/workflows/how-tos/advanced-configurations/handle-arrays-in-code-actions).
</Tip>
