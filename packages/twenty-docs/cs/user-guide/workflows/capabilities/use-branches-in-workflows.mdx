...
* [Často kladené dotazy k pracovním postupům](/cs/user-guide/workflows/how-tos/need-more-help/workflows-faq) — odpovědi týkající se paralelního provádění
* [Akce pracovních postupů](/cs/user-guide/workflows/capabilities/workflow-actions) — dostupné akce pro větve
