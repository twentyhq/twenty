...
<Note>
Ačkoli můžete k pozastavení běhu použít uzel [Delay](/cs/user-guide/workflows/capabilities/workflow-actions#delay), momentálně jej nelze nastavit tak, aby čekal "dokud neskončí jiná větev".
</Note>

## Související

* [Jak používat větve v pracovních postupech](/cs/user-guide/workflows/capabilities/use-branches-in-workflows) - Průvodce krok za krokem
* [Akce pracovního postupu](/cs/user-guide/workflows/capabilities/workflow-actions) - Dostupné akce včetně Filtru
