...
* **Hromadné**: Pracovní postup bude spuštěn jednou, poskytne celý seznam záznamů jako vstup. To znamená, že pracovní postup musí obsahovat [akci Iterator](/cs/user-guide/workflows/capabilities/workflow-actions#iterator).
