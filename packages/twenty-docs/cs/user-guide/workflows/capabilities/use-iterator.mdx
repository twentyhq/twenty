...
### Výběr pole, přes které se bude iterovat

Většinu zdrojů polí (Search Records, vícehodnotové pole ve webhooku, hromadný ruční spouštěč) lze vybrat přímo v nástroji pro výběr proměnných.

Když krok **Code** nebo **Logic Function** vrátí *pole nejvyšší úrovně*, jeho výstup se v nástroji pro výběr proměnných zobrazí jako indexované položky (`0`, `1`, `2`, …). Chcete-li iterovat přes celé pole, vyberte u daného kroku možnost **Whole list** — Iterator pak automaticky odvodí strukturu každé položky ze seznamu.
...
V nástroji pro výběr proměnných můžete buď přejít do konkrétního pole aktuální položky, nebo zvolit **Use the whole item** pro odkaz na celou aktuální položku (`{{iterator.currentItem}}`). Výběr celé položky je užitečný, když chcete předat celý záznam přímo do následujícího kroku, místo abyste ho znovu sestavovali pole po poli.
...
* [Akce pracovních postupů](/cs/user-guide/workflows/capabilities/workflow-actions)
* [Jak používat větve](/cs/user-guide/workflows/capabilities/use-branches-in-workflows)
* [Často kladené dotazy k pracovním postupům](/cs/user-guide/workflows/how-tos/need-more-help/workflows-faq)
