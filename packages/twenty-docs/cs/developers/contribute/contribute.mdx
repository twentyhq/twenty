...
<CardGroup cols={2}>
  <Card title="Hlášení chyb a požadavky" icon="bug" href="/cs/developers/contribute/capabilities/bug-and-requests">
    Nahlaste problémy nebo požádejte o nové funkce
  </Card>
  <Card title="Vývoj frontendu" icon="browser" href="/cs/developers/contribute/capabilities/frontend-development/folder-architecture-front">
