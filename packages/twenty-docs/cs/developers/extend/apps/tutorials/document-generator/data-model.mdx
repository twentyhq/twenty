...
Celý vzor viz [Relations](/cs/developers/extend/apps/data/relations).
...
<Card title="Další: generování dokumentů →" icon="bolt" href="/cs/developers/extend/apps/tutorials/document-generator/generating-documents">
