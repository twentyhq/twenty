...
Nyní jádro: [logická funkce](/cs/developers/extend/apps/logic/logic-functions)
...
(`yarn test:unit`). Viz [Testing](/cs/developers/extend/apps/operations/testing).
</Tip>

## Řidič

Pracovník používá vygenerovaná [`CoreApiClient`](/cs/developers/extend/apps/logic/logic-functions)
...
Pro jemnozrnná oprávnění viz [Roles](/cs/developers/extend/apps/config/roles).
...
<Card title="Další: HTTP trasy →" icon="zeměkoule" href="/cs/developers/extend/apps/tutorials/document-generator/http-routes">
