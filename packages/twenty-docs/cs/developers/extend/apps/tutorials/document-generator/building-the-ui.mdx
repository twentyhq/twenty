...
[view](/cs/developers/extend/apps/layout/views) je uložený seznam daného objektu.
[Položka navigačního menu](/cs/developers/extend/apps/layout/navigation-menu-items)
umístí toto zobrazení do postranního panelu. Server už pro každý objekt automaticky poskytuje výchozí zobrazení „All ...“, takže zobrazení, která aplikace definuje, jsou další, pečlivě vybraná.
...
[přední komponenta](/cs/developers/extend/apps/layout/front-components) je komponenta React
...
[položka příkazu](/cs/developers/extend/apps/layout/command-menu-items) s
...
Připojit ji s [page layout](/cs/developers/extend/apps/layout/page-layouts). Rozvržení
...
Widgety `FIELD` podporují také další režimy zobrazení a možnosti, včetně
výpisu záznamů vnořené relace vzdálené o dva kroky — viz
[referenční dokumentaci k widgetu Field](/cs/developers/extend/apps/layout/page-layouts#field-widgets).
...
<Card title="Další: agent AI →" icon="robot" href="/cs/developers/extend/apps/tutorials/document-generator/ai-agent">
