...
[application config](/cs/developers/extend/apps/config/application) nese
...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.twenty.com/cs/developers/extend/apps',
...
[Testing](/cs/developers/extend/apps/operations/testing) a
[Synchronizace a obnovy](/cs/developers/extend/apps/operations/sync-and-recovery).
...
[Publishing](/cs/developers/extend/apps/operations/publishing).
...
<CardGroup cols={2}>
  <Card title="Odkaz na údaje" icon="database" href="/cs/developers/extend/apps/data/overview">
    Každý typ pole, vztah a index.
  </Card>
  <Card title="Logický odkaz" icon="bolt" href="/cs/developers/extend/apps/logic/overview">
    Cron a databázová událost, klíčový obchod, připojení OAuth.
  </Card>
  <Card title="Odkaz na rozložení" icon="table-columns" href="/cs/developers/extend/apps/layout/overview">
