...
[skill](/cs/developers/extend/apps/logic/skills-and-agents) je opakovaně použitelné
...
[agent](/cs/developers/extend/apps/logic/skills-and-agents) spáruje výzvu s modelem
...
[Chapter 2](/cs/developers/extend/apps/tutorials/document-generator/generating-documents#grant-it-access).
</Note>
...
<Card title="Další: publikování →" icon="rocket" href="/cs/developers/extend/apps/tutorials/document-generator/publishing">
