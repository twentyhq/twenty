...
| ----------------------------------------------- | ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| `dev`                                           | Sleduje zdrojové soubory a živě synchronizuje změny                                 | [Rychlý start](/cs/developers/extend/apps/getting-started/quick-start)                                      |
| `plán`                                          | Náhled změn metadat bez jejich aplikování                                           | [Synchronizace a obnovení](/cs/developers/extend/apps/operations/sync-and-recovery#previewing-changes-plan) |
| `použít`                                        | Aplikovat změny metadat po zobrazení plánu                                          | [Synchronizace a obnovení](/cs/developers/extend/apps/operations/sync-and-recovery)                         |
| `dev:build`                                     | Zkompilovat aplikaci a vygenerovat API klienta (`--tarball` pro zabalení do `.tgz`) | [Publikování](/cs/developers/extend/apps/operations/publishing)                                             |
| `dev:typecheck`                                 | Spustit kontrolu typů TypeScriptu                                                   | [Testování](/cs/developers/extend/apps/operations/testing)                                                  |
| `dev:add`                                       | Vytvořit kostru nové entity                                                         | [Scaffolding](/cs/developers/extend/apps/getting-started/scaffolding)                                       |
...
| `dev:translations-extract`                      | Extrahovat přeložitelné řetězce do katalogů v `locales/`                            | [Překlady](/cs/developers/extend/apps/operations/translations)                                                |
| `dev:catalog-sync`                              | Spustit synchronizaci katalogu tržiště                                              | [Publikování](/cs/developers/extend/apps/operations/publishing#how-marketplace-discovery-works)             |
| `app:publish` / `app:install` / `app:uninstall` | Životní cyklus vydání                                                               | [Publikování](/cs/developers/extend/apps/operations/publishing) a tato stránka                              |
| `docker:*`                                      | Spravovat kontejner lokálního serveru Twenty                                        | [Lokální server](/cs/developers/extend/apps/getting-started/local-server)                                   |
