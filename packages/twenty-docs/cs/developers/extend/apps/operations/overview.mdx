...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/cs/developers/extend/apps/operations/cli">
    Referenční přehled `yarn twenty` — exec, logs, uninstall, remotes.
  </Card>
  <Card title="Synchronizace a obnovení" icon="compass" href="/cs/developers/extend/apps/operations/sync-and-recovery">
    Který příkaz kdy použít, jak číst diff synchronizace a postup obnovy.
  </Card>
  <Card title="Testování" icon="flask" href="/cs/developers/extend/apps/operations/testing">
    Nastavení Vitestu, integrační testy, kontrola typů, workflow CI.
  </Card>
  <Card title="Publikování" icon="upload" href="/cs/developers/extend/apps/operations/publishing">
