...
| ---------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| Interní skripty, automatizace                        | [Klíč API](/cs/developers/extend/api#authentication)                                            |
...
| Aplikace Twenty s rozšířeními uživatelského rozhraní | [Aplikace](/cs/developers/extend/apps/getting-started/quick-start) (OAuth je řešen automaticky) |
