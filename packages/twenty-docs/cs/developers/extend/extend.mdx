...
<CardGroup cols={2}>
  <Card title="API" icon="code" href="/cs/developers/extend/api">
    Programově se připojte k Twenty
  </Card>
  <Card title="Webhooky" icon="bell" href="/cs/developers/extend/webhooks">
    Dostávejte oznámení o událostech v reálném čase
  </Card>
  <Card title="Aplikace" icon="puzzle-piece" href="/cs/developers/extend/apps/getting-started/quick-start">
