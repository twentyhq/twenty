...
<Warning>
**Instalujete poprvé?** Postupujte podle [průvodce instalací Docker Compose](/cs/developers/self-host/capabilities/docker-compose) k rozchození Twenty, a poté se sem vraťte pro konfiguraci.
</Warning>
...
Jak provést rotaci `ENCRYPTION_KEY` bez výpadku, najdete v [průvodci rotací klíče](/cs/developers/self-host/capabilities/key-rotation).
