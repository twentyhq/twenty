...
<CardGroup cols={2}>
  <Card title="الصلاحيات" icon="lock" href="/ar/user-guide/permissions-access/capabilities/permissions">
    أنشئ أدوارًا وكوّن أذونات الكائنات والحقول والإعدادات.
  </Card>
  <Card title="تكوين تسجيل الدخول الأحادي (SSO)" icon="key" href="/ar/user-guide/permissions-access/capabilities/sso-configuration">
    إعداد تسجيل الدخول الأحادي مع موفّر الهوية لديك.
  </Card>
  <Card title="الأسئلة الشائعة" icon="circle-question" href="/ar/user-guide/permissions-access/how-tos/permissions-faq">
...
* [إنشاء دور](/ar/user-guide/permissions-access/capabilities/permissions#create-a-role)
* [تكوين SSO](/ar/user-guide/permissions-access/capabilities/sso-configuration)
* [إدارة أعضاء الفريق](/ar/user-guide/settings/capabilities/member-management)
