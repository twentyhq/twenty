...
* [إنشاء PDF من عشرين سنتي](/ar/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) - إرفاق ملفات PDFs التي تم إنشاؤها بالسجلات
* [مشغلات سير العمل](/ar/user-guide/workflows/capabilities/workflow-triggers)
* [إجراءات سير العمل](/ar/user-guide/workflows/capabilities/workflow-actions)
* [أتمتة Closed Won](/ar/user-guide/workflows/how-tos/crm-automations/closed-won-automations)
