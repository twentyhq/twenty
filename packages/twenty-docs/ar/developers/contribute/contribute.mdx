...
<CardGroup cols={2}>
  <Card title="تقارير الأخطاء والطلبات" icon="bug" href="/ar/developers/contribute/capabilities/bug-and-requests">
    أبلغ عن المشكلات أو اطلب ميزات
  </Card>
  <Card title="تطوير الواجهة الأمامية" icon="browser" href="/ar/developers/contribute/capabilities/frontend-development/folder-architecture-front">
