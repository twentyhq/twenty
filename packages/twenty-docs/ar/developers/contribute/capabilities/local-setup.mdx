...
استخدم متغيرات البيئة أو ملفات `.env` لتكوين مشروعك. المزيد من المعلومات [هنا](/ar/developers/self-host/capabilities/setup).
...
إذا واجهت أي مشكلة، فارجع إلى [استكشاف الأخطاء وإصلاحها](/ar/developers/self-host/capabilities/troubleshooting) للحصول على الحلول.
