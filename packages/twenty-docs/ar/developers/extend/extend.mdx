...
<CardGroup cols={2}>
  <Card title="واجهات برمجة التطبيقات" icon="code" href="/ar/developers/extend/api">
    اتصل بـ Twenty برمجياً
  </Card>
  <Card title="الويب هوكس" icon="bell" href="/ar/developers/extend/webhooks">
    احصل على إشعارات بالأحداث في الوقت الفعلي
  </Card>
  <Card title="التطبيقات" icon="puzzle-piece" href="/ar/developers/extend/apps/getting-started/quick-start">
