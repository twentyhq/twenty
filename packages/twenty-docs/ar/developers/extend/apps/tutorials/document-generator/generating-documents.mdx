...
الآن النواة الأساسية: [دالة المنطقية](/ar/developers/extend/apps/logic/logic-functions)
...
('اختبار yarn:unit\`). انظر [Testing](/ar/developers/extend/apps/operations/testing).
</Tip>

## المعالج

يستخدم المعالج [`CoreApiClient`](/ar/developers/extend/apps/logic/logic-functions)
...
انظر [Roles](/ar/developers/extend/apps/config/rolesللحصول على أذونات مأخوذة من الحبوب الأكثر.
...
<Card title="التالي: طرق HTTP →" icon="الكرة الأرضية" href="/ar/developers/extend/apps/tutorials/document-Generator/http-routes">
