...
A [view](/ar/developers/extend/apps/layout/views) هي قائمة محفوظة لكائن معين.
ويضع [عنصر قائمة التنقل](/ar/developers/extend/apps/layout/navigation-menu-items)
هذا العرض في الشريط الجانبي. يوفر الخادم بالفعل طريقة العرض الافتراضية "All ..." لكل كائن تلقائيًا، لذا فإن طرق العرض التي يعرّفها التطبيق تكون إضافية ومُنتقاة بعناية.
...
[مكون أمامي](/ar/developers/extend/apps/layout/front-components) هو مكون React
...
[أمر قائمة](/ar/developers/extend/apps/layout/command-menu-items) مع
...
قم بتحميلها مع [تخطيط الصفحة](/ar/developers/extend/apps/layout/page-layouts). يضيف تخطيط
...
تدعم عناصر واجهة المستخدم `FIELD` أوضاع عرض وخيارات أخرى أيضًا، بما في ذلك
سرد سجلات علاقة متداخلة على بعد مستويين — راجع
[مرجع عنصر واجهة مستخدم الحقل](/ar/developers/extend/apps/layout/page-layouts#field-widgets).
...
<Card title="التالي : وكيل AI →" icon="robot" href="/ar/developers/extend/apps/tutorials/document-Generator/ai-agent">
