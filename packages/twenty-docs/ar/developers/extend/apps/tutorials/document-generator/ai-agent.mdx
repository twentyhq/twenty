...
A [skill](/ar/developers/extend/apps/logic/skills-and-agents) قابل لإعادة الاستخدام- المعرفة التي تربطها بالوكلاء. علمنا النموذج كيفية استخدام
  الأداة.
...
[agent](/ar/developers/extend/apps/logic/skills-and-agents) يزوج موجه مع نموذج
...
[الفصل 2](/ar/developers/extend/apps/tutorials/document-generator/generating-documents#grant-it-access).
</Note>
...
<Card title="التالي: النشر →" icon="rocket" href="/ar/developers/extend/apps/tutorials/document-generator/النشر">
