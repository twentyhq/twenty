...
انظر [Relations](/ar/developers/extend/apps/data/relations) للاطلاع على النمط الكامل.
...
<Card title="التالي: توليد الوثائق →" icon="bolt" href="/ar/developers/extend/apps/tutorials/document-Generator/التوليد-المستندات">
