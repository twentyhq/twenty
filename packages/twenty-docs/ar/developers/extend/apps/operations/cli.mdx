...
| ----------------------------------------------- | ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------- |
| `dev`                                           | يراقب ملفات المصدر ويزامن التغييرات مباشرة                                           | [البدء السريع](/ar/developers/extend/apps/getting-started/quick-start)                                 |
| `الخطة`                                         | معاينة تغييرات البيانات الوصفية بدون تطبيقها                                         | [المزامنة والاستعادة](/ar/developers/extend/apps/operations/sync-and-recovery#previewing-changes-plan) |
| `تطبيق`                                         | تطبيق تغييرات البيانات الوصفية بعد عرض الخطة                                         | [المزامنة والاستعادة](/ar/developers/extend/apps/operations/sync-and-recovery)                         |
| `dev:build`                                     | ترجمة التطبيق وإنشاء عميل واجهة برمجة التطبيقات (استخدم `--tarball` لحزم ملف `.tgz`) | [النشر](/ar/developers/extend/apps/operations/publishing)                                              |
| `dev:typecheck`                                 | تشغيل فحص الأنواع في TypeScript                                                      | [الاختبار](/ar/developers/extend/apps/operations/testing)                                              |
| `dev:add`                                       | إنشاء هيكل كيان جديد                                                                 | [إنشاء الهياكل](/ar/developers/extend/apps/getting-started/scaffolding)                                |
...
| `dev:translations-extract`                      | استخراج السلاسل القابلة للترجمة إلى كتالوجات `locales/`                              | [الترجمات](/ar/developers/extend/apps/operations/translations)                                           |
| `dev:catalog-sync`                              | تشغيل مزامنة كتالوج السوق                                                            | [النشر](/ar/developers/extend/apps/operations/publishing#how-marketplace-discovery-works)              |
| `app:publish` / `app:install` / `app:uninstall` | دورة حياة الإصدارات                                                                  | [النشر](/ar/developers/extend/apps/operations/publishing) وهذه الصفحة                                  |
| `docker:*`                                      | إدارة حاوية خادم Twenty المحلي                                                       | [الخادم المحلي](/ar/developers/extend/apps/getting-started/local-server)                               |
