...
<CardGroup cols={2}>
  <Card title="العروض" icon="list" href="/ar/developers/extend/apps/layout/views">
    `defineView` — تكوينات قوائم محفوظة: الأعمدة الظاهرة، وعوامل التصفية، والمجموعات.
  </Card>
  <Card title="عناصر قائمة التنقّل" icon="bars" href="/ar/developers/extend/apps/layout/navigation-menu-items">
    `defineNavigationMenuItem` — إدخالات في الشريط الجانبي تشير إلى العروض أو عناوين URL الخارجية.
  </Card>
  <Card title="تخطيطات الصفحات" icon="table-columns" href="/ar/developers/extend/apps/layout/page-layouts">
    `definePageLayout` و`definePageLayoutTab` — علامات التبويب والويدجتات في صفحة تفاصيل السجل.
  </Card>
  <Card title="المكوّنات الأمامية" icon="window-maximize" href="/ar/developers/extend/apps/layout/front-components">
    `defineFrontComponent` — مكوّنات React معزولة (sandboxed) يتم عرضها داخل Twenty.
  </Card>
  <Card title="عناصر قائمة الأوامر" icon="terminal" href="/ar/developers/extend/apps/layout/command-menu-items">
...
لا تزال قيد التطوير النشط: يطبّق الـ sandbox شجرة DOM جزئية، لذلك قد تفشل حالات الاستخدام المتقدمة. راجع [القيود الحالية](/ar/developers/extend/apps/layout/front-components#current-limitations).
