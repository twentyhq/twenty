...
| -------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| البرامج النصية الداخلية، والأتمتة            | [مفتاح API](/ar/developers/extend/api#authentication)                                               |
| تطبيق خارجي يعمل نيابةً عن مستخدم            | **OAuth — رمز التفويض**                                                                          |
| من خادم إلى خادم، دون سياق مستخدم            | **OAuth — بيانات اعتماد العميل**                                                                 |
| تطبيق Twenty مع امتدادات واجهة المستخدم (UI) | [التطبيقات](/ar/developers/extend/apps/getting-started/quick-start) (يتم التعامل مع OAuth تلقائيًا) |
