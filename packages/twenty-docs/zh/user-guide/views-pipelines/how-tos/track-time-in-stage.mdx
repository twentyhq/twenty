...
<Tip>
这是一个使用工作流创建[公式字段](/zh/user-guide/workflows/how-tos/crm-automations/formula-fields)的示例——具体为日期计算。
</Tip>
...
* [工作流](/zh/user-guide/workflows/overview) — 自动化基础
* [如何创建自定义字段](/zh/user-guide/data-model/how-tos/create-custom-fields) — 字段配置
* [看板视图](/zh/user-guide/views-pipelines/capabilities/kanban-views) — 汇总
