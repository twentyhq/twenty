...
* [从 Twenty 生成 PDF](/zh/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — 将生成的 PDF 附加到记录
* [工作流触发器](/zh/user-guide/workflows/capabilities/workflow-triggers)
* [工作流操作](/zh/user-guide/workflows/capabilities/workflow-actions)
* [赢单自动化](/zh/user-guide/workflows/how-tos/crm-automations/closed-won-automations)
