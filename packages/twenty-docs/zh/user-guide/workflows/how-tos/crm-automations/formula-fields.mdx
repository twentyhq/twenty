...
<Tip>
有关在流水线阶段跟踪时间的完整示例，请参阅 [跟踪机会在每个阶段停留时长](/zh/user-guide/views-pipelines/how-tos/track-time-in-stage)。
</Tip>
...
完整工作流请参阅 [如何在流水线中显示预期金额](/zh/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline)。
...
* [如何在流水线中显示预期金额](/zh/user-guide/views-pipelines/how-tos/show-expected-amount-in-pipeline)
* [如何跟踪阶段时长](/zh/user-guide/views-pipelines/how-tos/track-time-in-stage)
* [工作流操作](/zh/user-guide/workflows/capabilities/workflow-actions)
