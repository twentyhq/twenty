...
在 [关系字段](/zh/user-guide/data-model/capabilities/relation-fields) 中了解更多。
</Accordion>
...
是的，您可以将 CSV 数据导入任何对象，包括自定义对象。 导入过程支持自定义字段的映射。 参见 [如何准备 CSV 文件](/zh/user-guide/data-migration/how-tos/prepare-your-csv-files)。
</Accordion>
...
查看我们的 [实施服务](/zh/user-guide/getting-started/capabilities/implementation-services) 以获取复杂数据模型设计方面的帮助。
