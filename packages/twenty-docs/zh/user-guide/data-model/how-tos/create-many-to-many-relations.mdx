...
* [关系字段](/zh/user-guide/data-model/capabilities/relation-fields) — 关系类型说明
* [创建自定义对象](/zh/user-guide/data-model/how-tos/create-custom-objects) — 如何创建对象
* [创建关系字段](/zh/user-guide/data-model/how-tos/create-relation-fields) — 基本关系设置
