...
<Note>对于超过 10,000 条记录的数据集，请拆分为多个文件，或使用[API 导入](/zh/user-guide/data-migration/how-tos/import-data-via-api)。</Note>
...
详细说明请参见[如何导入关系](/zh/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv)。
...
* [导入公司](/zh/user-guide/data-migration/how-tos/import-companies-via-csv)（先导入这些）
* [导入联系人](/zh/user-guide/data-migration/how-tos/import-contacts-via-csv)
* [修复任何导入错误](/zh/user-guide/data-migration/how-tos/fix-import-errors)
