...
<Note>对于更大的导出（20,000+ 条记录），请使用筛选器分批导出，或使用 [API](/zh/developers/extend/api)。</Note>
...
3. 编辑导出的文件
4. 重新导入以更新记录
   参见：[如何更新现有记录](/zh/user-guide/data-migration/how-tos/update-existing-records-via-import)
...
参见：[API 文档](/zh/developers/extend/api)
...
* [如何更新现有记录](/zh/user-guide/data-migration/how-tos/update-existing-records-via-import) — 编辑并重新导入您的导出文件
* [如何通过 API 导入数据](/zh/user-guide/data-migration/how-tos/import-data-via-api) — 适用于大型数据集
* [API 文档](/zh/developers/extend/api) — 构建自定义导出工作流
