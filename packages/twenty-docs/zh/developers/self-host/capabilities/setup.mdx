...
<Warning>
**第一次安装？** 请按照 [Docker Compose 安装指南](/zh/developers/self-host/capabilities/docker-compose) 获得 Twenty 运行，然后返回此处进行配置。
</Warning>
...
要在不停机的情况下轮换 `ENCRYPTION_KEY`，请参阅[密钥轮换指南](/zh/developers/self-host/capabilities/key-rotation)。
