...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/zh/developers/extend/apps/operations/cli">
    `yarn twenty` 参考——exec、logs、uninstall、remotes。
  </Card>
  <Card title="同步与恢复" icon="compass" href="/zh/developers/extend/apps/operations/sync-and-recovery">
    在阅读同步差异时应使用哪些命令，以及分步恢复流程。
  </Card>
  <Card title="测试" icon="flask" href="/zh/developers/extend/apps/operations/testing">
    Vitest 配置、集成测试、类型检查、CI 工作流。
  </Card>
  <Card title="发布" icon="upload" href="/zh/developers/extend/apps/operations/publishing">
