...
完整模式请参阅 [Relations](/zh/developers/extend/apps/data/relations)。
...
<Card title="下一步：生成文档 →" icon="bolt" href="/zh/developers/extend/apps/tutorials/document-generator/generating-document">
  写下填充模板的逻辑函数。
</Card>
