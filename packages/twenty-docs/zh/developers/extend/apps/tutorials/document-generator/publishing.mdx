...
[应用程序配置](/zh/developers/extend/apps/config/application) 带有显示在市场中的
身份：作者、类别、标志和支持
...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.twenty.com/zh/developers/extend/apps',
...
这是一次很好的最终健全性检查。 见
[Testing](/zh/developers/extend/apps/operations/testing) 和
[同步和恢复](/zh/developers/extend/apps/operations/sync-and-recovery)。
...
详细信息和发布检查列表：
[Publishing](/zh/developers/extend/apps/operations/publishing)。
...
<CardGroup cols={2}>
  <Card title="数据参考" icon="database" href="/zh/developers/extend/apps/data/overview">
    每个字段类型、关系和索引选项。
  </Card>
  <Card title="逻辑引用" icon="bolt" href="/zh/developers/extend/apps/logic/overview">
    Cron 和数据库事件触发了密钥价值存储，OAuth 连接。
  </Card>
  <Card title="布局引用" icon="table-columns" href="/zh/developers/extend/apps/layout/overview">
    页面布局、仪表板小部件和更多用户界面。
  </Card>
