...
[skill](/zh/developers/extend/apps/logic/skills-and-agents) 是可重复使用的
...
[agent](/zh/developers/extend/apps/logic/skills-and-agents) 与
...
详见[第 2 章](/zh/developers/extend/apps/tutorials/document-generator/generating-documents#grant-it-access)。
</Note>
...
<Card title="下一步：发布 →" icon="rocket" href="/zh/developers/extend/apps/tutorials/document-generator/发布">
  添加市场元数据和发布。
</Card>
