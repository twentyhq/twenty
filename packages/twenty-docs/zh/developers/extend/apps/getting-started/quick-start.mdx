...
所有模式都需要经过身份验证的远程服务器。 有关 `plan` 的更多信息，请参见 [同步与恢复](/zh/developers/extend/apps/operations/sync-and-recovery#previewing-changes-plan)。
...
完整参考：[概念](/zh/developers/extend/apps/getting-started/concepts)。
