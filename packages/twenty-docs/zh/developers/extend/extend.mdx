...
<CardGroup cols={2}>
  <Card title="接口" icon="code" href="/zh/developers/extend/api">
    以编程方式连接到 Twenty
  </Card>
  <Card title="Webhooks" icon="bell" href="/zh/developers/extend/webhooks">
    实时接收事件通知
  </Card>
  <Card title="应用" icon="puzzle-piece" href="/zh/developers/extend/apps/getting-started/快速启动">
    以代码方式构建自定义项
  </Card>
</CardGroup>
