...
describe('canBeCastAsNumberOrNull', () => {
  ...
  it(`should return true if number - interger`, () => {
    expect(canBeCastAsNumberOrNull(9)).toBeTruthy();
  });

  it(`should return true if number - float`, () => {
    expect(canBeCastAsNumberOrNull(9.1)).toBeTruthy();
  });
...
describe('castAsNumberOrNull', () => {
  ...
  it(`should cast a float string to a float`, () => {
