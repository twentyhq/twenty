...
const ExtendSubscriptionFormModal = lazy(() =>
  import(
    '@/action-menu/actions/record-actions/single-record/subscription-actions/components/ExtendSubscriptionFormModal'
  ).then((m) => ({ default: m.ExtendSubscriptionFormModal })),
);
