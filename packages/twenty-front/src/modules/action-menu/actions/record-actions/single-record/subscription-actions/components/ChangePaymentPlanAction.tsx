...
const ChangePaymentPlanFormModal = lazy(() =>
  import(
    '@/action-menu/actions/record-actions/single-record/subscription-actions/components/ChangePaymentPlanFormModal'
  ).then((m) => ({ default: m.ChangePaymentPlanFormModal })),
);
