// Auto-generated from twenty-ui theme — do not edit manually.
// Regenerate: node -e "const{themeCssVariables}=require('./packages/twenty-ui/dist/theme.cjs');console.log(JSON.stringify(themeCssVariables,null,2))"
// This static copy avoids wyw-in-js evaluating the twenty-ui dist bundle
// (which contains third-party code incompatible with wyw's sandbox).

// Static copy of MOBILE_VIEWPORT from twenty-ui/theme (CSS vars don't work in media queries)
export const MOBILE_VIEWPORT = 768;

// Static copy of GRAY_SCALE_LIGHT from twenty-ui/theme
...
export const themeCssVariables: DeepCSSVariableRefs<ThemeType> = {
  ...
  clickableElementBackgroundTransition: "var(--t-clickable-element-background-transition)",
