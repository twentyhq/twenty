...
export const ExportNoteActionSingleRecordAction = () => {
  ...
  const handleClick = async () => {
    ...
    const { exportBlockNoteEditorToPdf } = await import(
      '@/command-menu-item/actions/record-actions/single-record/utils/exportBlockNoteEditorToPdf'
    );
    ...
    //   '@/command-menu-item/actions/record-actions/single-record/utils/exportBlockNoteEditorToDocx'
    // );
