import { type CommandMenuItemScope } from '@/command-menu-item/actions/types/CommandMenuItemScope';
import { type CommandMenuItemType } from '@/command-menu-item/actions/types/CommandMenuItemType';
