import { ACTION_MENU_CONFIRMATION_MODAL_RESULT_BROWSER_EVENT_NAME } from '@/command-menu-item/confirmation-modal/constants/ActionMenuConfirmationModalResultBrowserEventName';
import { ACTION_MENU_CONFIRMATION_MODAL_INSTANCE_ID } from '@/command-menu-item/confirmation-modal/constants/ActionMenuConfirmationModalId';
import { actionMenuConfirmationModalConfigState } from '@/command-menu-item/confirmation-modal/states/actionMenuConfirmationModalState';
import {
  type ActionMenuConfirmationModalResult,
  type ActionMenuConfirmationModalResultBrowserEventDetail,
} from '@/command-menu-item/confirmation-modal/types/ActionMenuConfirmationModalResultBrowserEventDetail';
