import { RECORD_AGNOSTIC_ACTIONS_CONFIG } from '@/command-menu-item/record-agnostic/constants/RecordAgnosticActionsConfig';
import { RecordAgnosticActionsKeys } from '@/command-menu-item/record-agnostic/types/RecordAgnosticActionsKeys';
