import { simpleRelationFilterValueSchema } from '../simpleRelationFilterValueSchema';

describe('simpleRelationFilterValueSchema', () => {
  describe('UUID validation', () => {
    it('should accept valid UUIDs', () => {
      ...
      validUuids.forEach((uuid) => {
        ...
        const singleResult = simpleRelationFilterValueSchema.safeParse(uuid);
        ...
        // Test as array
        const arrayResult = simpleRelationFilterValueSchema.safeParse([uuid]);
  ...
  describe('Variable syntax validation', () => {
    it('should accept valid variable syntax', () => {
      ...
      validVariables.forEach((variable) => {
        // Test as single value
        const singleResult =
          simpleRelationFilterValueSchema.safeParse(variable);
        expect(singleResult.success).toBe(true);
        if (singleResult.success) {
        ...
        // Test as array
        const arrayResult = simpleRelationFilterValueSchema.safeParse([
          variable,
        ]);
        expect(arrayResult.success).toBe(true);
        if (arrayResult.success) {
  ...
  describe('Input type handling', () => {
    it('should handle string input with valid JSON', () => {
      ...
      const result = simpleRelationFilterValueSchema.safeParse(input);
