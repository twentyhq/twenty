...
import { SettingsDataRoleOverviewEffect } from '@/settings/roles/graph-overview/SettingsDataRoleOverviewEffect';
import { SettingsDataRoleOverviewRoles } from '@/settings/roles/graph-overview/SettingsDataRoleOverviewRoles';
...
const nodeTypes: NodeTypes = {
  object: SettingsDataRoleOverviewRoles,
};
...
export const SettingsDataRoleOverview = () => {
  ...
  return (
    <StyledContainer>
      <StyledCloseButton>
        <Button Icon={IconX} to="/settings/roles"></Button>
      </StyledCloseButton>
      <SettingsDataRoleOverviewEffect
        setEdges={setEdges}
        setNodes={setNodes}
      />
