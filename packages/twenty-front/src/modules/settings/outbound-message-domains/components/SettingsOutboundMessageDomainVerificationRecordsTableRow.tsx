...
type SettingsOutboundMessageDomainVerificationRecordsTableRowProps = {
  verificationRecord: VerificationRecord;
};

export const SettingsOutboundMessageDomainVerificationRecordsTableRow = ({
  verificationRecord,
}: SettingsOutboundMessageDomainVerificationRecordsTableRowProps) => {
