...
export const settingsDataModelFieldMorphRelationFormSchema = z.object({
  ...
  // For regular RELATION fields on junction (singular field ID)
  junctionTargetFieldId: z.string().uuid().optional(),
  // For MORPH_RELATION fields on junction (references morphId for auto-discovery)
  junctionTargetMorphId: z.string().uuid().optional(),
});
