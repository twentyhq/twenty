  ...
  return (
    ...
    >
      ...
      <StyledSectionContainer>
        ...
        >
          {t`Credits are added on top of the plan allowance and are spent only once it runs out. They carry over in full from one billing period to the next and stay available until they are used up.`}
        </Section>
      </StyledSectionContainer>
