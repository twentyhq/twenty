...
const SettingsWorkspaceCommunications = lazy(() =>
	import(
		"~/pages/settings/communications/SettingsWorkspaceCommunications"
	).then((module) => ({
...
const SettingsWorkspaceCommunicationGroupChannelDetail = lazy(() =>
	import(
		"~/pages/settings/communications/SettingsWorkspaceCommunicationGroupChannelDetail"
	).then((module) => ({
...
const SettingsWorkspaceNewUnsubscribeTopic = lazy(() =>
	import(
		"~/pages/settings/communications/SettingsWorkspaceNewUnsubscribeTopic"
	).then((module) => ({
...
const SettingsWorkspaceUnsubscribeTopicDetail = lazy(() =>
	import(
		"~/pages/settings/communications/SettingsWorkspaceUnsubscribeTopicDetail"
	).then((module) => ({
