...
export type EnhancedModalLayoutProps = React.PropsWithChildren & {
  size?: ModalSize;
  padding?: ModalPadding;
  className?: string;
  ...
  modalVariant?: ModalVariants;
    ...
    | { isClosable?: false; onClose?: never } // or the absence of `isClosable`
  );
...
export const EnhancedModalLayout = ({
  children,
  size = 'medium',
  padding = 'medium',
  className,
...
EnhancedModalLayout.Header = ModalLayoutHeader;
EnhancedModalLayout.Content = ModalLayoutContent;
EnhancedModalLayout.Footer = ModalLayoutFooter;
