...
const meta: Meta<typeof RecordCalendarGrid> = {
  ...
  component: RecordCalendarGrid,
  args: { calendarLayout: ViewCalendarLayout.MONTH },
  decorators: [
    (Story) => {
...
export default meta;
type Story = StoryObj<typeof RecordCalendarGrid>;

export const Month: Story = {};

export const Week: Story = {
  args: { calendarLayout: ViewCalendarLayout.WEEK },
};

export const Day: Story = {
  args: { calendarLayout: ViewCalendarLayout.DAY },
};
