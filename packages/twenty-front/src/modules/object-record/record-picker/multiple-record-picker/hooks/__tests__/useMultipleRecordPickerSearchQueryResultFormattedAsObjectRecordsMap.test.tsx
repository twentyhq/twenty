...
import { useMultipleRecordPickerSearchQueryResultFormattedAsObjectRecordsMap } from '@/object-record/record-picker/multiple-record-picker/hooks/useMultipleRecordPickerSearchQueryResultFormattedAsObjectRecordsMap';
import { MultipleRecordPickerComponentInstanceContext } from '@/object-record/record-picker/multiple-record-picker/states/contexts/MultipleRecordPickerComponentInstanceContext';
import { generatedMockObjectMetadataItems } from '~/testing/mock-data/generatedMockObjectMetadataItems';

const instanceId = 'instanceId';
const Wrapper = ({ children }: { children: React.ReactNode }) => (
  <MultipleRecordPickerComponentInstanceContext.Provider value={{ instanceId }}>
...
describe('useMultipleRecordPickerSearchQueryResultFormattedAsObjectRecordsMap', () => {
  it('should return object formatted from objectMetadataItemsState', async () => {
    const { result } = renderHook(
      () => {
        return {
          formattedRecord:
            useMultipleRecordPickerSearchQueryResultFormattedAsObjectRecordsMap(
              {
