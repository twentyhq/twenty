...
import { useRecordTableGqlOperationFields } from '@/object-record/record-index/hooks/useRecordTableGqlOperationFields';
...
export const useLoadRecordIndexTable = (objectNameSingular: string) => {
  ...
  const operationFields = useRecordTableGqlOperationFields();
