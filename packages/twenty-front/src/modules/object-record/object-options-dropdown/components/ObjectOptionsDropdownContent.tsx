...
import { ObjectOptionsDropdownMineFilterFieldsContent } from '@/object-record/object-options-dropdown/components/ObjectOptionsDropdownMineFilterFieldsContent';
...
export const ObjectOptionsDropdownContent = () => {
  ...
  switch (currentContentId) {
    ...
    case 'mineFilterFields':
      return <ObjectOptionsDropdownMineFilterFieldsContent />;
    case 'visibility':
