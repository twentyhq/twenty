...
export const PdfFieldInput = () => {
  const { t } = useLingui();
  const { recordId, objectMetadataNameSingular, fieldDefinition, draftValue, setDraftValue, setFieldValue } = usePdfField();
      ...
      <FieldInputContainer>
        <StyledContainer>
          <StyledButtonRow>
            <Button
              Icon={IconUpload}
              title={isUploading ? t`Uploading...` : t`Upload PDFs`}
              variant="secondary"
