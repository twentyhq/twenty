  ...
  const actions: NavigationMenuItemOption[] = [
    {
      id: 'up',
      label: t`Move up`,
      icon: <ColoredIcon Icon={IconChevronUp} />,
      isDisabled: index <= 0,
    ...
    },
    {
      id: 'down',
      label: t`Move down`,
      icon: <ColoredIcon Icon={IconChevronDown} />,
    ...
    },
    {
      ...
      icon: <ColoredIcon Icon={IconFolderSymlink} />,
    ...
    },
    {
      ...
      icon: <ColoredIcon Icon={IconRowInsertTop} />,
      hasSubMenu: true,
    ...
    },
    {
      ...
      icon: <ColoredIcon Icon={IconRowInsertBottom} />,
      hasSubMenu: true,
    ...
    },
    {
      ...
      icon: <ColoredIcon Icon={IconTrash} />,
      accent: 'danger',
  ...
  const folders: NavigationMenuItemOption[] = [
    {
      id: 'workspace',
      label: t`Workspace`,
      icon: <ColoredIcon Icon={IconFolder} />,
