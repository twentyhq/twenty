...
import { NavigationMenuItemFolderReadOnly } from '@/navigation-menu-item/display/folder/NavigationMenuItemFolderReadOnly';
...
const LazyWorkspaceNavigationMenuItemsFolder = lazy(() =>
  import(
    '@/navigation-menu-item/display/folder/WorkspaceNavigationMenuItemsFolder'
