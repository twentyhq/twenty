import { WorkspaceDndKitDroppableSlot } from '@/navigation-menu-item/display/dnd/WorkspaceDndKitDroppableSlot';
...
import { WorkspaceOrphanDropTarget } from '@/navigation-menu-item/display/sections/WorkspaceOrphanDropTarget';
