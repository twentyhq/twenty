...
// The handful of moments people actually mean when they say "later", in the
// order they come. An option that is already behind, or that lands on the
// same moment as another, is left out rather than shown twice.
