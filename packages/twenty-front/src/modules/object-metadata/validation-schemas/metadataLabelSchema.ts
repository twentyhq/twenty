...
import { z } from 'zod';
import { METADATA_LABEL_ALPHANUMERIC_PATTERN } from '~/pages/settings/data-model/constants/MetadataLabelalphanumericPattern';
...
export const metadataLabelSchema = (existingLabels?: string[]) => {
  return z
    ...
    .regex(
      METADATA_LABEL_ALPHANUMERIC_PATTERN,
      errors.LabelUnsupportedSpecialCharacters,
    )
