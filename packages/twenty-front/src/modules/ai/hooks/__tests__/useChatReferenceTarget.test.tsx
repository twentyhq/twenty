...
const openRecordTargetMock = jest.fn();
const openViewTargetMock = jest.fn();
const openFieldMetadataTargetMock = jest.fn();

jest.mock('@/ai/hooks/useChatTargetNavigation', () => ({
  useChatTargetNavigation: () => ({
    openRecordTarget: openRecordTargetMock,
    openViewTarget: openViewTargetMock,
    openFieldMetadataTarget: openFieldMetadataTargetMock,
  }),
}));
...
describe('useChatReferenceTarget', () => {
  ...
  it('should open a field beside the conversation on the chat page', () => {
    ...
    expect(openFieldMetadataTargetMock).toHaveBeenCalledWith({
      fieldMetadataId: companyNameFieldMetadataItem?.id,
    });
  });
  ...
  it('should open a record beside the conversation on the chat page', () => {
    ...
    expect(openRecordTargetMock).toHaveBeenCalledWith({
      objectNameSingular: 'company',
      recordId: RECORD_ID,
    });
  });
