...
const NON_CRITICAL_ERROR_CODES = new Set([
    ...
    async (event: PromiseRejectionEvent) => {
      ...
      try {
        ...
        captureException(error, (scope) => {
          ...
          if (hasErrorCode(error) && NON_CRITICAL_ERROR_CODES.has(error.code)) {
            ...
            scope.setLevel('warning');
            scope.setTag('error-expectedness', 'non-error-promise-rejection');
          }
