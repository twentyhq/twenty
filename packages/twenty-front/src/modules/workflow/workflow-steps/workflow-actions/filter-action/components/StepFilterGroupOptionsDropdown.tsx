...
type StepFilterGroupOptionsDropdownProps = {
  stepFilterGroupId: string;
};

export const StepFilterGroupOptionsDropdown = ({
  stepFilterGroupId,
}: StepFilterGroupOptionsDropdownProps) => {
  const { deleteStepFilterGroup } = useContext(StepFilterContext);
