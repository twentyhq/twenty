import { BODY_TYPES } from '@/modules/workflow/workflow-steps/workflow-actions/http-request-action/constants/HttpRequest';
import { getBodyTypeFromHeaders } from '@/modules/workflow/workflow-steps/workflow-actions/http-request-action/utils/getBodyTypeFromHeaders';
