...
describe('getTriggerIconColor', () => {
  ...
  it('returns the blue color for database event from theme', () => {
    const result = getTriggerIconColor({ theme: mockTheme , triggerType: 'DATABASE_EVENT' });

    expect(result).toBe(COLOR.blue);
  });

  it('returns the purple color for cron from theme', () => {
    const result = getTriggerIconColor({ theme: mockTheme , triggerType: 'CRON' });
  ...
  it('works with different theme configurations', () => {
    ...
    const result = getTriggerIconColor({ theme: differentTheme, triggerType: 'DATABASE_EVENT' });
  ...
  it('maintains reference to theme.color.blue', () => {
    ...
    const result = getTriggerIconColor({ theme: customTheme, triggerType: 'DATABASE_EVENT' });
