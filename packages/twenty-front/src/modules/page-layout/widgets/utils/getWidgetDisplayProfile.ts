import { DEFAULT_WIDGET_DISPLAY_PROFILE } from '@/page-layout/widgets/constants/DefaultWidgetDisplayProfile';
import { WIDGET_DISPLAY_PROFILES } from '@/page-layout/widgets/constants/WidgetDisplayProfiles';
