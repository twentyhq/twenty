...
import { useRefetchRelationFieldOnRecordChange } from '@/object-record/record-field/ui/hooks/useRefetchRelationFieldOnRecordChange';
...
export const FieldWidget = ({ widget }: FieldWidgetProps) => {
  ...
  useRefetchRelationFieldOnRecordChange({
    recordId: targetRecord.id,
