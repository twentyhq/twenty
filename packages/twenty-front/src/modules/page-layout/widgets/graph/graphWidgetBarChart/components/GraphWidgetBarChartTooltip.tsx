...
import { type BarDatumWithGeometry } from '@/page-layout/widgets/graph/graphWidgetBarChart/utils/createFloatingAnchorFromBarGeometry';
...
type GraphWidgetBarChartTooltipProps = {
  ...
  hoveredBarDatum: BarDatumWithGeometry;
