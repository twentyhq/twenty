...
import { generateGroupByQueryVariablesFromLineChartConfiguration } from '@/page-layout/widgets/graph/utils/generateGroupByQueryVariablesFromLineChartConfiguration';
import { useQuery } from '@apollo/client';
import { useMemo } from 'react';
import { isDefined } from 'twenty-shared/utils';
import { type LineChartConfiguration } from '~/generated-metadata/graphql';

export const useGraphWidgetLineChartGroupByQuery = ({
  ...
  const groupByQueryVariables =
    generateGroupByQueryVariablesFromLineChartConfiguration({
      objectMetadataItem,
      lineChartConfiguration: configuration,
