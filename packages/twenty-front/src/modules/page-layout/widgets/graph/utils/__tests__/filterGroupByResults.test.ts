...
describe('filterGroupByResults', () => {
  ...
  describe('omitNullValues filtering', () => {
    it('should filter out null values', () => {
      const rawResults = [
        createMockResult(null),
        createMockResult(100),
        createMockResult(200),
      ];

      const filtered = filterGroupByResults({
        rawResults,
        filterOptions: { omitNullValues: true },
        aggregateField: mockAggregateField,
        aggregateOperation: AggregateOperations.SUM,
        aggregateOperationFromRawResult: 'SUM_amount',
        objectMetadataItem: mockObjectMetadataItem,
      ...
      expect(filtered).toHaveLength(2);
      expect(filtered[0].SUM_amount).toBe(100);
      expect(filtered[1].SUM_amount).toBe(200);
    });
    ...
    it('should filter out both null and zero values', () => {
      const rawResults = [
        createMockResult(null),
        createMockResult(0),
        createMockResult(100),
  ...
  describe('combined filtering', () => {
    it('should apply both range and omitNullValues filters', () => {
      const rawResults = [
        createMockResult(null),
        createMockResult(0),
        createMockResult(500),
