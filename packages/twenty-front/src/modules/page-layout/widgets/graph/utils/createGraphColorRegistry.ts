...
export const createGraphColorRegistry = (
  ...
  mauve: {
    name: 'mauve',
    gradient: {
      normal: [theme.color.mauve3, theme.color.mauve5],
      hover: [theme.color.mauve7, theme.color.mauve8],
    },
    solid: theme.color.mauve8,
    variations: [
      theme.color.mauve1,
      theme.color.mauve2,
      theme.color.mauve3,
  ...
  slate: {
    name: 'slate',
    gradient: {
      normal: [theme.color.slate3, theme.color.slate5],
      hover: [theme.color.slate7, theme.color.slate8],
    },
    solid: theme.color.slate8,
    variations: [
      theme.color.slate1,
      theme.color.slate2,
      theme.color.slate3,
  ...
  sage: {
    name: 'sage',
    gradient: {
      normal: [theme.color.sage3, theme.color.sage5],
      hover: [theme.color.sage7, theme.color.sage8],
    },
    solid: theme.color.sage8,
    variations: [
      theme.color.sage1,
      theme.color.sage2,
      theme.color.sage3,
  ...
  olive: {
    name: 'olive',
    gradient: {
      normal: [theme.color.olive3, theme.color.olive5],
      hover: [theme.color.olive7, theme.color.olive8],
    },
    solid: theme.color.olive8,
    variations: [
      theme.color.olive1,
      theme.color.olive2,
      theme.color.olive3,
  ...
  sand: {
    name: 'sand',
    gradient: {
      normal: [theme.color.sand3, theme.color.sand5],
      hover: [theme.color.sand7, theme.color.sand8],
    },
    solid: theme.color.sand8,
    variations: [
      theme.color.sand1,
      theme.color.sand2,
      theme.color.sand3,
