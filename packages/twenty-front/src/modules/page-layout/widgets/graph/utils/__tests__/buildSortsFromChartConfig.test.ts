...
describe('buildSortsFromChartConfig', () => {
  ...
  describe('Undefined or null orderBy', () => {
    it('should return empty array when primaryAxisOrderBy is undefined', () => {
    ...
    it('should return empty array when primaryAxisOrderBy is null', () => {
      const config = createBarChartConfig(null as unknown as GraphOrderBy);
