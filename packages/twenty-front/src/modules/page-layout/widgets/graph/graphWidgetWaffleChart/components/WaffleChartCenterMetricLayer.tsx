import { useWaffleChartCenterMetricData } from '@/page-layout/widgets/graph/graphWidgetWaffleChart/hooks/useWaffleChartCenterMetricData';
import { useTheme } from '@emotion/react';
import styled from '@emotion/styled';
import { AnimatePresence, motion } from 'framer-motion';
import { type WaffleChartConfiguration } from '~/generated/graphql';

type WaffleChartCenterMetricProps = {
...
export const WaffleChartCenterMetric = ({
  objectMetadataItemId,
  configuration,
  show,
}: WaffleChartCenterMetricProps) => {
  const theme = useTheme();

  const { centerMetricValue, centerMetricLabel } = useWaffleChartCenterMetricData({
    objectMetadataItemId,
    configuration,
    skip: !show,
  });
