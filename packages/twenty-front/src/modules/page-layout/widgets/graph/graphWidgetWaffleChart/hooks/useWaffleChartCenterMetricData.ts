...
type UseWaffleChartCenterMetricDataProps = {
  objectMetadataItemId: string;
  configuration: WaffleChartConfiguration;
  skip: boolean;
};

type UseWaffleChartCenterMetricDataResult = {
  centerMetricValue: string | number | undefined;
  centerMetricLabel: string;
};

export const useWaffleChartCenterMetricData = ({
  objectMetadataItemId,
  configuration,
  skip,
}: UseWaffleChartCenterMetricDataProps): UseWaffleChartCenterMetricDataResult => {
