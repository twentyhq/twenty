...
import { getBarChartAxisConfigs } from '@/page-layout/widgets/graph/graph-widget-bar-chart/utils/getBarChartAxisConfigs';
import {
  getBarChartTickConfig,
  type BarChartTickConfig,
} from '@/page-layout/widgets/graph/graph-widget-bar-chart/utils/getBarChartTickConfig';
