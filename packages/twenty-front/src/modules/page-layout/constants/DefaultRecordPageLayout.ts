  ...
  tabs: [
    {
      ...
      universalIdentifier: 'default-tab-fields',
      isActive: true,
      title: 'Home',
      icon: 'IconHome',
      position: 100,
      ...
      widgets: [
        {
          ...
          universalIdentifier: 'default-widget-fields',
          isActive: true,
    ...
    },
    {
      ...
      universalIdentifier: 'default-tab-timeline',
      isActive: true,
      title: 'Timeline',
      ...
      widgets: [
        {
          ...
          universalIdentifier: 'default-widget-timeline',
          isActive: true,
    ...
    },
    {
      ...
      universalIdentifier: 'default-tab-tasks',
      isActive: true,
      title: 'Tasks',
      icon: 'IconCheckbox',
      position: 300,
      ...
      widgets: [
        {
          ...
          universalIdentifier: 'default-widget-tasks',
          isActive: true,
    ...
    },
    {
      ...
      universalIdentifier: 'default-tab-notes',
      isActive: true,
      title: 'Notes',
      icon: 'IconNotes',
      position: 400,
      ...
      widgets: [
        {
          ...
          universalIdentifier: 'default-widget-notes',
          isActive: true,
    ...
    },
    {
      ...
      universalIdentifier: 'default-tab-files',
      isActive: true,
      title: 'Files',
      icon: 'IconPaperclip',
      position: 500,
      ...
      widgets: [
        {
          ...
          universalIdentifier: 'default-widget-files',
          isActive: true,
