...
export type UserWorkspace = {
  ...
  settingsPermissions?: Maybe<Array<Setting>>;
  updatedAt: Scalars['DateTime'];
  user: User;
  userId: Scalars['String'];
