...
export type UserWorkspace = {
  ...
  deletedAt?: Maybe<Scalars['DateTime']>;
  id: Scalars['UUID'];
  settingsPermissions?: Maybe<Array<Scalars['String']>>;
  updatedAt: Scalars['DateTime'];
  user: User;
  userId: Scalars['String'];
