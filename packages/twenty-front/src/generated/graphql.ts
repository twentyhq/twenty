...
export type GetCoreWorkflowsWithCurrentVersionQueryVariables = Exact<{
  coreWorkflowIds: Array<Scalars['UUID']['input']> | Scalars['UUID']['input'];
}>;
