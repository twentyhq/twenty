...
export type TimelineCalendarEventCallRecordingFragmentFragment = {
	__typename?: "TimelineCalendarEventCallRecording";
	id: any;
	status: CallRecordingStatus;
...
export type GetCoreWorkflowsQuery = {
	__typename?: "Query";
	coreWorkflows: {
		__typename?: "CoreWorkflowConnection";
		totalCount: number;
...
export type UpdateWorkflowVersionTriggerMutation = {
	__typename?: "Mutation";
...
export type GetWorkflowVersionContentQuery = {
	__typename?: "Query";
	workflowVersionContent: {
		__typename?: "WorkflowVersionContent";
		workflowVersionId: any;
		trigger?: any | null;
		steps?: any | null;
	};
};
...
export const TimelineCalendarEventCallRecordingFragmentFragmentDoc = {
	...
	definitions: [
		{
			...
			name: {
				kind: "Name",
				value: "TimelineCalendarEventCallRecordingFragment",
			},
			typeCondition: {
				kind: "NamedType",
				name: { kind: "Name", value: "TimelineCalendarEventCallRecording" },
			},
			selectionSet: {
				kind: "SelectionSet",
				selections: [
	...
	TimelineCalendarEventCallRecordingFragmentFragment,
	unknown
>;
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					...
					{
						kind: "Field",
						name: { kind: "Name", value: "callRecordings" },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{
...
export const GetCoreWorkflowsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetCoreWorkflows" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
				...
				},
				{
					...
					type: {
						kind: "NamedType",
						name: { kind: "Name", value: "CoreWorkflowOrderByField" },
					},
				},
				{
					kind: "VariableDefinition",
					...
					type: {
						kind: "NamedType",
						name: { kind: "Name", value: "CoreWorkflowOrderByDirection" },
					},
				},
			],
			selectionSet: {
				...
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "coreWorkflows" },
						arguments: [
							{
								kind: "Argument",
								name: { kind: "Name", value: "first" },
	...
	GetCoreWorkflowsQueryVariables
>;
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							...
							name: {
								kind: "Name",
								value: "UpdateWorkflowVersionTriggerInput",
							},
						},
					},
				},
...
>;
export const GetWorkflowVersionContentDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetWorkflowVersionContent" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
			...
			selectionSet: {
				...
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "workflowVersionContent" },
						arguments: [
							{
								kind: "Argument",
								name: { kind: "Name", value: "workflowVersionId" },
	...
	GetWorkflowVersionContentQuery,
