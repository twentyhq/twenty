...
export type ConfigVariable = {
  ...
  isWritableInAdminPanel: Scalars['Boolean']['output'];
  name: Scalars['String']['output'];
...
export type GetDatabaseConfigVariableQuery = { __typename?: 'Query', getDatabaseConfigVariable: { __typename?: 'ConfigVariable', name: string, description: string, value?: any | null, isSensitive: boolean, isEnvOnly: boolean, isWritableInAdminPanel: boolean, type: ConfigVariableType, options?: any | null, source: ConfigSource } };
