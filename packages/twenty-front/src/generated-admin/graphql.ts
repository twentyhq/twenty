...
export type AllWorkspacesUpgradeStatus = {
  __typename?: 'AllWorkspacesUpgradeStatus';
  behindCount: Scalars['Int'];
  computedAt: Scalars['DateTime'];
  failedCount: Scalars['Int'];
  instanceUpgradeStatus: InstanceUpgradeStatus;
  totalCount: Scalars['Int'];
  upToDateCount: Scalars['Int'];
  workspacesBehindIds: Array<Scalars['UUID']>;
  workspacesFailedIds: Array<Scalars['UUID']>;
};
...
export type Mutation = {
  ...
  refreshUpgradeStatus: AllWorkspacesUpgradeStatus;
...
export type Query = {
  ...
  getAllWorkspacesUpgradeStatus: AllWorkspacesUpgradeStatus;
...
export type RefreshUpgradeStatusMutation = { __typename?: 'Mutation', refreshUpgradeStatus: { __typename?: 'AllWorkspacesUpgradeStatus', totalCount: number, upToDateCount: number, behindCount: number, failedCount: number, workspacesBehindIds: Array<string>, workspacesFailedIds: Array<string>, computedAt: string, instanceUpgradeStatus: { __typename?: 'InstanceUpgradeStatus', inferredVersion?: string | null, health: UpgradeHealth, latestCommand?: { __typename?: 'LatestUpgradeCommand', name: string, status: string, executedByVersion: string, errorMessage?: string | null, createdAt: string } | null } } };
...
export type GetAllWorkspacesUpgradeStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllWorkspacesUpgradeStatusQuery = { __typename?: 'Query', getAllWorkspacesUpgradeStatus: { __typename?: 'AllWorkspacesUpgradeStatus', totalCount: number, upToDateCount: number, behindCount: number, failedCount: number, workspacesBehindIds: Array<string>, workspacesFailedIds: Array<string>, computedAt: string, instanceUpgradeStatus: { __typename?: 'InstanceUpgradeStatus', inferredVersion?: string | null, health: UpgradeHealth, latestCommand?: { __typename?: 'LatestUpgradeCommand', name: string, status: string, executedByVersion: string, errorMessage?: string | null, createdAt: string } | null } } };
...
export const GetAllWorkspacesUpgradeStatusDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetAllWorkspacesUpgradeStatus"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getAllWorkspacesUpgradeStatus"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"instanceUpgradeStatus"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"inferredVersion"}},{"kind":"Field","name":{"kind":"Name","value":"health"}},{"kind":"Field","name":{"kind":"Name","value":"latestCommand"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"executedByVersion"}},{"kind":"Field","name":{"kind":"Name","value":"errorMessage"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"totalCount"}},{"kind":"Field","name":{"kind":"Name","value":"upToDateCount"}},{"kind":"Field","name":{"kind":"Name","value":"behindCount"}},{"kind":"Field","name":{"kind":"Name","value":"failedCount"}},{"kind":"Field","name":{"kind":"Name","value":"workspacesBehindIds"}},{"kind":"Field","name":{"kind":"Name","value":"workspacesFailedIds"}},{"kind":"Field","name":{"kind":"Name","value":"computedAt"}}]}}]}}]} as unknown as DocumentNode<GetAllWorkspacesUpgradeStatusQuery, GetAllWorkspacesUpgradeStatusQueryVariables>;
