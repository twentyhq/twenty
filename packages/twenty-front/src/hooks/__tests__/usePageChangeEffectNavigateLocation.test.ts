...
const testCases: {
	...
	},
	{
		...
		isWorkspaceSuspended: false,
		onboardingStatus: OnboardingStatus.PLAN_REQUIRED,
		verifyEmailRedirectPath: "/nextPath?key=value",
		res: "/nextPath?key=value",
	},
	{
		loc: AppPath.VerifyEmail,
		isLogged: true,
	...
	{
		loc: AppPath.WorkspaceActivation,
		isLogged: true,
		isWorkspaceSuspended: false,
		onboardingStatus: OnboardingStatus.PLAN_REQUIRED,
		res: AppPath.PlanRequired,
	...
	{
		loc: AppPath.PlanRequiredSuccess,
		isLogged: true,
		isWorkspaceSuspended: false,
		onboardingStatus: OnboardingStatus.PLAN_REQUIRED,
		res: undefined,
	...
	},
	{
		...
		onboardingStatus: OnboardingStatus.COMPLETED,
		res: undefined,
		objectNamePluralFromParams: "existing-object",
		objectNamePluralFromMetadata: "existing-object",
	},
	{
		loc: AppPath.RecordIndexPage,
		isLogged: true,
		isWorkspaceSuspended: false,
		onboardingStatus: OnboardingStatus.COMPLETED,
		res: AppPath.NotFound,
		objectNamePluralFromParams: "non-existing-object",
		objectNamePluralFromMetadata: "existing-object",
	},
	{
		loc: AppPath.RecordIndexPage,
		...
		objectNamePluralFromParams: "non-existing-object",
		objectNamePluralFromMetadata: "existing-object",
		isMinimalMetadataReady: false,
	},

	{
		loc: AppPath.RecordShowPage,
		isLogged: true,
		isWorkspaceSuspended: false,
		onboardingStatus: OnboardingStatus.PLAN_REQUIRED,
		res: AppPath.PlanRequired,
	...
	{
		loc: AppPath.WorkflowCoreIndexPage,
		isLogged: true,
		isWorkspaceSuspended: false,
		onboardingStatus: OnboardingStatus.PLAN_REQUIRED,
		res: AppPath.PlanRequired,
	...
	},
	{
		...
		onboardingStatus: OnboardingStatus.COMPLETED,
		res: undefined,
		pageLayoutId: "valid-id",
		useQueryResult: { loading: true },
	},
	{
		loc: AppPath.PageLayoutPage,
		isLogged: true,
		...
		onboardingStatus: OnboardingStatus.COMPLETED,
		res: AppPath.NotFound,
		pageLayoutId: "non-existent-id",
		useQueryResult: { data: { getPageLayout: null }, loading: false },
	},
	{
		loc: AppPath.PageLayoutPage,
		isLogged: true,
		...
		onboardingStatus: OnboardingStatus.COMPLETED,
		res: AppPath.NotFound,
		pageLayoutId: "wrong-type-id",
		useQueryResult: {
			data: { getPageLayout: { type: PageLayoutType.RECORD_PAGE } },
			loading: false,
		},
	},
	{
		...
		onboardingStatus: OnboardingStatus.COMPLETED,
		res: undefined,
		pageLayoutId: "valid-standalone-id",
		useQueryResult: {
			data: { getPageLayout: { type: PageLayoutType.STANDALONE_PAGE } },
			loading: false,
		},
	},

	{
		loc: AppPath.SettingsCatchAll,
		isLogged: true,
		isWorkspaceSuspended: false,
		onboardingStatus: OnboardingStatus.PLAN_REQUIRED,
		res: AppPath.PlanRequired,
	...
	{
		loc: AppPath.DevelopersCatchAll,
		isLogged: true,
		isWorkspaceSuspended: false,
		onboardingStatus: OnboardingStatus.PLAN_REQUIRED,
		res: AppPath.PlanRequired,
	...
	// returnToPath: should redirect to saved path instead of defaultHomePagePath
	{
		...
		isWorkspaceSuspended: false,
		onboardingStatus: OnboardingStatus.COMPLETED,
		returnToPath: "/authorize?clientId=abc",
		res: "/authorize?clientId=abc",
	},
	{
		loc: AppPath.SignInUp,
		isLogged: true,
	...
	},
	{
		...
		isWorkspaceSuspended: false,
		onboardingStatus: OnboardingStatus.COMPLETED,
		returnToPath: "/settings/api-keys",
		res: "/settings/api-keys",
	},

	{
		...
		onboardingStatus: OnboardingStatus.COMPLETED,
		isBillingEnabled: false,
		shouldOpenAiChatAfterOnboarding: true,
		res: getAppPath(AppPath.AiChat, { threadId: null }),
	},
	{
		loc: AppPath.InviteTeam,
		isLogged: true,
