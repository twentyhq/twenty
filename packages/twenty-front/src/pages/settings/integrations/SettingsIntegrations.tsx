...
import { IconBrandWhatsapp, IconBrandSlack, IconNotion, IconCreditCard, IconBrandTelegram, IconUsers } from '@tabler/icons-react';
...
export const SettingsIntegrations = () => {
  ...
  const integrations = [
    ...
    { id: 'notion', name: 'Notion', description: 'Sincronización de notas', icon: IconNotion, color: '#000000', connected: false },
