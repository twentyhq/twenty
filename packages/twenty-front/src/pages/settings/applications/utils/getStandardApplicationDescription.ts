...
Remove this app and the rest of the workspace has nothing to hang off.

#### Build your own app

Extend your workspace with your own objects, fields, logic functions, or AI skills. Scaffold a new app in one command:
