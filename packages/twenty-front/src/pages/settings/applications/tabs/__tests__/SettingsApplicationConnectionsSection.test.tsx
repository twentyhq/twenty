...
describe('SettingsApplicationConnectionsSection', () => {
  ...
  it('does not render a logo placeholder when the provider has no logo', () => {
    mockedUseFindApplicationConnectionProviders.mockReturnValue({
      connectionProviders: [
        {
          id: 'provider-1',
    ...
    expect(
      container.querySelector('[data-type="app"]'),
    ).not.toBeInTheDocument();
  });

  it('renders the provider logo when the provider has one', () => {
    mockedUseFindApplicationConnectionProviders.mockReturnValue({
      connectionProviders: [
        {
          id: 'provider-1',
          ...
          name: 'google-calendar',
          displayName: 'Google Calendar',
          logoUrl: 'https://crm.example.com/public-assets/logo.svg',
          oauth: {
            scopes: ['calendar.readonly'],
            isClientCredentialsConfigured: true,
          },
    ...
    expect(container.querySelector('[data-type="app"]')).toBeInTheDocument();
  });
