...
type MockedWorkspaceMmeber = Omit<WorkspaceMember, 'agentId'>;
...
> & {
  ...
  workspaceMembers: MockedWorkspaceMmeber[];
...
export const mockCurrentWorkspace: Omit<
  Workspace,
  'stripeIntegrations' | 'billingPlans'
> = {
...
export const mockedWorkspaceMemberData: MockedWorkspaceMmeber = {
