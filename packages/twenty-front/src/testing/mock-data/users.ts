...
type MockedUser = Pick<
  ...
  | 'userVars'
> & {
  workspaceMember: Omit<WorkspaceMember, 'agentId'> | null;
  locale: string;
  currentWorkspace: Omit<Workspace, 'stripeIntegrations'>;
  workspaces: Array<{ workspace: Omit<Workspace, 'stripeIntegrations'> }>;
  workspaceMembers: Omit<WorkspaceMember, 'agentId'>[];
...
export const mockCurrentWorkspace: Omit<Workspace, 'stripeIntegrations'> = {
...
export const mockedWorkspaceMemberData: Omit<WorkspaceMember, 'agentId'> = {
