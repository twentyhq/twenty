...
export type AuthTokenFragmentFragment = { token: string, expiresAt: any };

export type ExchangeAuthorizationCodeQueryVariables = Exact<{
  authorizationCode: Scalars['String'];
  codeVerifier?: InputMaybe<Scalars['String']>;
  clientSecret?: InputMaybe<Scalars['String']>;
}>;
...
export type ExchangeAuthorizationCodeQuery = { exchangeAuthorizationCode: { loginToken: { token: string, expiresAt: any }, accessToken: { token: string, expiresAt: any }, refreshToken: { token: string, expiresAt: any } } };
...
export const ExchangeAuthorizationCodeDocument = gql`
    query ExchangeAuthorizationCode($authorizationCode: String!, $codeVerifier: String, $clientSecret: String) {
...
/**
 * __useExchangeAuthorizationCodeQuery__
 *
 * To run a query within a React component, call `useExchangeAuthorizationCodeQuery` and pass it any options that fit your needs.
 * When your component renders, `useExchangeAuthorizationCodeQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useExchangeAuthorizationCodeQuery({
 *   variables: {
 ...
 * });
 */
export function useExchangeAuthorizationCodeQuery(baseOptions: Apollo.QueryHookOptions<ExchangeAuthorizationCodeQuery, ExchangeAuthorizationCodeQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ExchangeAuthorizationCodeQuery, ExchangeAuthorizationCodeQueryVariables>(ExchangeAuthorizationCodeDocument, options);
      }
export function useExchangeAuthorizationCodeLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ExchangeAuthorizationCodeQuery, ExchangeAuthorizationCodeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ExchangeAuthorizationCodeQuery, ExchangeAuthorizationCodeQueryVariables>(ExchangeAuthorizationCodeDocument, options);
        }
export type ExchangeAuthorizationCodeQueryHookResult = ReturnType<typeof useExchangeAuthorizationCodeQuery>;
export type ExchangeAuthorizationCodeLazyQueryHookResult = ReturnType<typeof useExchangeAuthorizationCodeLazyQuery>;
export type ExchangeAuthorizationCodeQueryResult = Apollo.QueryResult<ExchangeAuthorizationCodeQuery, ExchangeAuthorizationCodeQueryVariables>;
